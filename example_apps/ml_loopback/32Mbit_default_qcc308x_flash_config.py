...

{
    ...
    "layout": [
        ...
        ("apps_p0",         {"capacity": 145 * 4 * 1024,  "authenticate": True, "src_file_signed": True}),
        ("apps_p1",         {"capacity": 257 * 4 * 1024,  "authenticate": False}),
        ...
        ("ro_fs",           {"capacity":  36 * 4 * 1024,  "authenticate": False})
    ]
}
