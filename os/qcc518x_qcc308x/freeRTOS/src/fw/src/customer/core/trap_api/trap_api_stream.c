...
{
    IPC_STREAM_RFCOMM_SINK_FROM_DLCI ipc_send_prim;
    IPC_SINK_RSP ipc_recv_prim;
    TP_BD_ADDR_T tpaddr_fw;
    ...
    ipc_send_prim.dlci = dlci;
    ipc_transaction(IPC_SIGNAL_ID_STREAM_RFCOMM_SINK_FROM_DLCI, &ipc_send_prim, sizeof(ipc_send_prim),
                    IPC_SIGNAL_ID_STREAM_RFCOMM_SINK_FROM_DLCI_RSP, &ipc_recv_prim);
    return SINK_FROM_ID(ipc_recv_prim.ret);
}
