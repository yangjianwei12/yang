...
/**
 * Type definition for bitserial error status bits.
 */
typedef enum bitserial_error_status_bits
{
    BITSERIAL_TRANSACTION_PART2_MASK = BITSERIAL0_TRANSACTION_PART2_MASK
} bitserial_error_status_bits;
