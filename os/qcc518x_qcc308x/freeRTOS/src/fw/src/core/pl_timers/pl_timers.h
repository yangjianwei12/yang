...
/**
 * \brief Schedules a background event to occur at the absolute time specified.
 * When the event occurs the selected handler function will be called.
 *
 * \param[in] time_when Absolute time value at which to trigger an event
 * \param[in] TimerEventFunction function to call at requested time
 * \param[in] iarg Integer value to be passed to handler
 * \param[in] data_pointer Value passed as input to TimerEventFunction
 *
 ...
 * \ingroup alt_interface
 */
extern tTimerId timer_schedule_bg_event_at_alt(
        TIME time_when,
        tTimerEventFunctionAlt TimerEventFunction,
        uint16 iarg,
        void *data_pointer);
...
/**
 * \brief Schedules a background event to occur at the relative time specified
 * from current time. When the event occurs the selected handler function will
 * be called.
 *
 * \param[in] time_when Relative time value (in us) at which to trigger an event
 * \param[in] TimerEventFunction function to call at requested time
 * \param[in] iarg Integer value to be passed to handler
 * \param[in] data_pointer Value passed as input to TimerEventFunction
 *
 ...
 * \ingroup alt_interface
 */
extern tTimerId timer_schedule_bg_event_in_alt(
        INTERVAL time_when,
        tTimerEventFunctionAlt TimerEventFunction,
        uint16 iarg,
        void *data_pointer);
