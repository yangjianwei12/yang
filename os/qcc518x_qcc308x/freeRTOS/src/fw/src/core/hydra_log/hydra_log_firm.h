...
#define /*lint --e{774}  --e{607} --e{960} --e{685} --e{568} --e{42} --e{40} */ HYDRA_LOG5(lvl, fmt, a1, a2, a3, a4, a5) \
    do                                                          \
    {                                                           \
        if (HYDRA_LOG_MAX_LEVEL >= (lvl))                       \
        {                                                       \
...
#define /*lint --e{774}  --e{607} --e{960} --e{685} --e{568} --e{42} --e{40} */ HYDRA_LOG6(lvl, fmt, a1, a2, a3, a4, a5, a6) \
    do                                                          \
    {                                                           \
        if (HYDRA_LOG_MAX_LEVEL >= (lvl))                       \
        {                                                       \
