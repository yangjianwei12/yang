...
void hydra_log_firm_5(const char *event_key, hydra_log_elem p1, \
        hydra_log_elem p2, hydra_log_elem p3, hydra_log_elem p4, \
        hydra_log_elem p5)
{
    hydra_log_firm_variadic(event_key, 5, p1, p2, p3, p4, p5);
}

void hydra_log_firm_6(const char *event_key, hydra_log_elem p1, \
        hydra_log_elem p2, hydra_log_elem p3, hydra_log_elem p4, \
        hydra_log_elem p5, hydra_log_elem p6)
{
    hydra_log_firm_variadic(event_key, 6, p1, p2, p3, p4, p5, p6);
}
