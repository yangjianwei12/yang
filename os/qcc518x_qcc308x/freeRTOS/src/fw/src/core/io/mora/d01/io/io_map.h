...
extern volatile uint32  BITSERIAL0_CONFIG3;                  /* RW   7 bits */
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_BITSERIAL2
#define __IO_MAP_H__IO_MAP_MODULE_BITSERIAL2

/* -- bitserial2 -- Bitserializer regs -- */

/* Declarations of read/write/mixed registers */
extern volatile uint32  BITSERIAL2_CLK_CONTROL;              /* RW  10 bits */
extern volatile uint32  BITSERIAL2_CLK_RATE_HI;              /* RW  16 bits */
extern volatile uint32  BITSERIAL2_CLK_RATE_LO;              /* RW  16 bits */
extern volatile uint32  BITSERIAL2_CLK_SAMP_OFFSET;          /* RW  16 bits */
extern volatile uint32  BITSERIAL2_CONFIG;                   /* RW  16 bits */
extern volatile uint32  BITSERIAL2_CONFIG2;                  /* RW  15 bits */
extern volatile uint32  BITSERIAL2_CONFIG3;                  /* RW   7 bits */
extern volatile uint32  BITSERIAL2_CONFIG_SEL_TIME;          /* RW  16 bits */
extern volatile uint32  BITSERIAL2_CONFIG_SEL_TIME2;         /* RW   4 bits */
extern volatile uint32  BITSERIAL2_CURATOR_SSID;             /* RW   4 bits */
extern volatile uint32  BITSERIAL2_DEBUG_SEL;                /* RW   9 bits */
extern volatile uint32  BITSERIAL2_DEEP_SLEEP_ACTIVE;        /* RW   1 bits */
extern volatile uint32  BITSERIAL2_DEGLITCH_EN;              /* RW   2 bits */
extern volatile uint32  BITSERIAL2_I2C_ADDRESS;              /* RW  10 bits */
extern volatile uint32  BITSERIAL2_INTERBYTE_SPACING;        /* RW  16 bits */
extern volatile uint32  BITSERIAL2_INTERRUPT_CLEAR;          /* RW  14 bits */
extern volatile uint32  BITSERIAL2_INTERRUPT_EN;             /* RW  14 bits */
extern volatile uint32  BITSERIAL2_INTERRUPT_SOURCE_CLEAR;   /* RW  14 bits */
extern volatile uint32  BITSERIAL2_REMOTE_SUBSYSTEM_SSID;    /* RW   4 bits */
extern volatile uint32  BITSERIAL2_RWB;                      /* RW   2 bits */
extern volatile uint32  BITSERIAL2_RX_BUFFER;                /* RW  12 bits */
extern volatile uint32  BITSERIAL2_RX_BUFFER2;               /* RW  12 bits */
extern volatile uint32  BITSERIAL2_SET_SEL_INACTIVE;         /* RW   1 bits */
extern volatile uint32  BITSERIAL2_SLAVE_DATA_READY_BYTE;    /* RW   8 bits */
extern volatile uint32  BITSERIAL2_SLAVE_NUM_PROTOCOL_WORDS;  /* RW  16 bits */
extern volatile uint32  BITSERIAL2_SLAVE_READ_COMMAND_BYTE;  /* RW   8 bits */
extern volatile uint32  BITSERIAL2_SLAVE_UNDERFLOW_BYTE;     /* RW   8 bits */
extern volatile uint32  BITSERIAL2_STREAMING_THRESHOLD;      /* RW  16 bits */
extern volatile uint32  BITSERIAL2_TXRX_LENGTH;              /* RW  16 bits */
extern volatile uint32  BITSERIAL2_TXRX_LENGTH2;             /* RW  16 bits */
extern volatile uint32  BITSERIAL2_TX_BUFFER;                /* RW  12 bits */
extern volatile uint32  BITSERIAL2_TX_BUFFER2;               /* RW  12 bits */
extern volatile uint32  BITSERIAL2_WORD_CONFIG;              /* RW  12 bits */

/* Declarations of read only registers */
extern volatile uint32  BITSERIAL2_ERROR_STATUS;             /* R    9 bits */
extern volatile uint32  BITSERIAL2_I2C_ACKS;                 /* R   16 bits */
extern volatile uint32  BITSERIAL2_INTERRUPT_SOURCE;         /* R   14 bits */
extern volatile uint32  BITSERIAL2_INTERRUPT_STATUS;         /* R   14 bits */
extern volatile uint32  BITSERIAL2_SLAVE_READ_COUNT;         /* R   16 bits */
extern volatile uint32  BITSERIAL2_SLAVE_WRITE_COUNT;        /* R   16 bits */
extern volatile uint32  BITSERIAL2_STATUS;                   /* R   13 bits */
extern volatile uint32  BITSERIAL2_WORDS_SENT;               /* R   16 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_BITSERIAL2 */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_BITSERIAL2) */
...
extern volatile uint32  HOST_SYS_BITSERIAL_2_CLK_INPUT_PIO_CTRL;  /* RW   7 bits */
extern volatile uint32  HOST_SYS_BITSERIAL_2_CLK_OUTPUT_PIO_CTRL;  /* RW   7 bits */
extern volatile uint32  HOST_SYS_BITSERIAL_2_DATA_INPUT_PIO_CTRL;  /* RW   7 bits */
extern volatile uint32  HOST_SYS_BITSERIAL_2_DATA_OUTPUT_PIO_CTRL;  /* RW   7 bits */
extern volatile uint32  HOST_SYS_BITSERIAL_2_SEL_INPUT_PIO_CTRL;  /* RW   7 bits */
extern volatile uint32  HOST_SYS_BITSERIAL_2_SEL_OUTPUT_PIO_CTRL;  /* RW   7 bits */
extern volatile uint32  HOST_SYS_BTM_DEBUG_SELECT;           /* RW   6 bits */
extern volatile uint32  HOST_SYS_CLK_80M_DIV;                /* RW   8 bits */
extern volatile host_sys_block_ids  HOST_SYS_CONFIG_ENABLES;             /* RW   6 bits */
extern volatile uint32  HOST_SYS_CONFIG_FORCE_CLK_ENABLES;   /* RW   8 bits */
extern volatile host_sys_block_ids  HOST_SYS_CONFIG_MASK_HW_CLK_REQS;    /* RW   6 bits */
...
extern volatile host_sys_block_ids  HOST_SYS_POWER_ENABLES;              /* RW   6 bits */
extern volatile uint32  HOST_SYS_REG_ACCESS_SUBSYS_IN_ADDR_EN;  /* RW  16 bits */
extern volatile host_sys_block_ids  HOST_SYS_SCALED_CLK_VETO_EN;         /* RW   6 bits */
...
extern volatile uint32  HOST_SYS_UART_SINGLE_WIRE_ENABLE;    /* RW   1 bits */
extern volatile uint32  HOST_SYS_UART_SINGLE_WIRE_TX_NOT_RX;  /* RW   1 bits */
extern volatile uint32  HOST_SYS_USB_PHY_POWER_EN;           /* RW   1 bits */
extern volatile uint32  USB_TX_PREFETCH_RAM_0_TO_3_EMAS;     /* RW   4 bits */
...
extern volatile uint32  USB_TX_PREFETCH_RAM_RDT;             /* RW   1 bits */
extern volatile uint32  USB_TX_PREFETCH_RAM_READ_ASSIST;     /* RW   3 bits */

/* Declarations of read only registers */
extern volatile uint32  HOST_SYS_BUILD_OPTIONS;              /* R    6 bits */
extern volatile host_sys_block_ids  HOST_SYS_HIFS_BUILT;                 /* R    6 bits */
extern volatile host_sys_block_ids  HOST_SYS_POWER_STATUS;               /* R    6 bits */
...
extern volatile uint32  MAC_OPERAND_MODE;                    /* RW   4 bits */
...
extern volatile uint32  APPS_SYS_CPU0_TCM_REMAP_CONTROLS;    /* RW   1 bits */
extern volatile uint32  APPS_SYS_CPU1_TCM_REMAP_CONTROLS;    /* RW   1 bits */
...
extern volatile uint32  APPS_SYS_PIO_MUX[2];                 /* RW  64 bits */
...
extern volatile uint32  RAM_SEQUENCER_ACTIVE_STATUS;         /* R   10 bits */
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_K32_DEBUG_REGFILE
#define __IO_MAP_H__IO_MAP_MODULE_K32_DEBUG_REGFILE
...
/* Declarations of read/write/mixed registers */
extern volatile uint32  REGFILE_B0;                          /* RW  32 bits */
extern volatile uint32  REGFILE_B1;                          /* RW  32 bits */
extern volatile uint32  REGFILE_B4;                          /* RW  32 bits */
extern volatile uint32  REGFILE_B5;                          /* RW  32 bits */
extern volatile uint32  REGFILE_FP;                          /* RW  32 bits */
extern volatile uint32  REGFILE_I0;                          /* RW  32 bits */
extern volatile uint32  REGFILE_I1;                          /* RW  32 bits */
extern volatile uint32  REGFILE_I2;                          /* RW  32 bits */
extern volatile uint32  REGFILE_I3;                          /* RW  32 bits */
extern volatile uint32  REGFILE_I4;                          /* RW  32 bits */
extern volatile uint32  REGFILE_I5;                          /* RW  32 bits */
extern volatile uint32  REGFILE_I6;                          /* RW  32 bits */
extern volatile uint32  REGFILE_I7;                          /* RW  32 bits */
extern volatile uint32  REGFILE_L0;                          /* RW  32 bits */
extern volatile uint32  REGFILE_L1;                          /* RW  32 bits */
extern volatile uint32  REGFILE_L4;                          /* RW  32 bits */
extern volatile uint32  REGFILE_L5;                          /* RW  32 bits */
extern volatile uint32  REGFILE_M0;                          /* RW  32 bits */
extern volatile uint32  REGFILE_M1;                          /* RW  32 bits */
extern volatile uint32  REGFILE_M2;                          /* RW  32 bits */
extern volatile uint32  REGFILE_M3;                          /* RW  32 bits */
extern volatile uint32  REGFILE_R0;                          /* RW  32 bits */
extern volatile uint32  REGFILE_R1;                          /* RW  32 bits */
extern volatile uint32  REGFILE_R10;                         /* RW  32 bits */
extern volatile uint32  REGFILE_R2;                          /* RW  32 bits */
extern volatile uint32  REGFILE_R3;                          /* RW  32 bits */
extern volatile uint32  REGFILE_R4;                          /* RW  32 bits */
extern volatile uint32  REGFILE_R5;                          /* RW  32 bits */
extern volatile uint32  REGFILE_R6;                          /* RW  32 bits */
extern volatile uint32  REGFILE_R7;                          /* RW  32 bits */
extern volatile uint32  REGFILE_R8;                          /* RW  32 bits */
extern volatile uint32  REGFILE_R9;                          /* RW  32 bits */
extern volatile uint32  REGFILE_RFLAGS;                      /* RW  32 bits */
extern volatile uint32  REGFILE_RLINK;                       /* RW  32 bits */
extern volatile uint32  REGFILE_RMAC0;                       /* RW  32 bits */
extern volatile uint32  REGFILE_RMAC1;                       /* RW  32 bits */
extern volatile uint32  REGFILE_RMAC2;                       /* RW  32 bits */
extern volatile uint32  REGFILE_RMAC24;                      /* RW  32 bits */
extern volatile uint32  REGFILE_RMACB0;                      /* RW  32 bits */
extern volatile uint32  REGFILE_RMACB1;                      /* RW  32 bits */
extern volatile uint32  REGFILE_RMACB2;                      /* RW  32 bits */
extern volatile uint32  REGFILE_RMACB24;                     /* RW  32 bits */
extern volatile uint32  REGFILE_SP;                          /* RW  32 bits */

/* Declarations of read only registers */
extern volatile uint32  REGFILE_NUM_CORE_STALLS;             /* R   32 bits */
extern volatile uint32  REGFILE_NUM_INSTRS;                  /* R   32 bits */
extern volatile uint32  REGFILE_NUM_RUNCLKS;                 /* R   32 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_K32_DEBUG_REGFILE */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_K32_DEBUG_REGFILE) */
...
extern volatile uint32  BITSERIAL1_CONFIG3;                  /* RW   7 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO1_EVENT_CAUSE_CLEAR_DATA[2];  /* RW  64 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO1_EVENT_FALLING_ENABLE[2];  /* RW  64 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO1_EVENT_RISING_ENABLE[2];  /* RW  64 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO2_EVENT_CAUSE_CLEAR_DATA[2];  /* RW  64 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO2_EVENT_FALLING_ENABLE[2];  /* RW  64 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO2_EVENT_RISING_ENABLE[2];  /* RW  64 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_INVERT[2];  /* RW  64 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_MASK[2];  /* RW  64 bits */
...
/* Declarations of read only registers */
extern volatile uint32  KALIMBA_PIO_INT_PIO1_EVENT_CAUSE[2];  /* R   64 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_PIO2_EVENT_CAUSE[2];  /* R   64 bits */
...
extern volatile uint32  KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_STATUS[2];  /* R   64 bits */
...
/* Declarations of read only registers */
extern volatile uint32  BUS_PROC_STREAM_STATUS;              /* R    1 bits */
...
extern volatile uint32  SUPPORT_RAS;                         /* RW   1 bits */
