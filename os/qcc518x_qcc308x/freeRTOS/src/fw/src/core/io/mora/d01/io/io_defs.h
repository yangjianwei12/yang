...
#define CHIP_REGISTER_HASH 0xC6A6
...
#define P0D_P1_DM_RAM_LOWER                                (0x00040000u)
#define P0D_P1_DM_RAM_UPPER                                (0x00068000u)
#define P0D_P0_DM_RAM_LOWER                                (0x00000000u)
#define P0D_P0_DM_RAM_UPPER                                (0x0000c000u)
...
#define P1D_P0_DM_RAM_UPPER                                (0x0000c000u)
#define P1D_P1_DM_RAM_LOWER                                (0x00040000u)
#define P1D_P1_DM_RAM_UPPER                                (0x00068000u)
...
#define PxD_P0_DM_RAM_UPPER                                (0x0000c000u)
#define PxD_P1_DM_RAM_LOWER                                (0x00040000u)
#define PxD_P1_DM_RAM_UPPER                                (0x00068000u)
#define PxD_SHARED_DM_RAM_LOWER                            (0x10000000u)
#define PxD_SHARED_DM_RAM_UPPER                            (0x10010000u)
#define PxD_TCM0_LOWER                                     (0x20000000u)
#define PxD_TCM0_UPPER                                     (0x20008000u)
#define PxD_TCM1_LOWER                                     (0x20020000u)
#define PxD_TCM1_UPPER                                     (0x20040000u)
...
#define PxD_P1_CACHE_DATA_RAM_UPPER                        (0x30038000u)
#define PxD_P1_CACHE_DATA_RAM0_LOWER                       (0x30030000u)
#define PxD_P1_CACHE_DATA_RAM0_UPPER                       (0x30034000u)
#define PxD_P1_CACHE_DATA_RAM1_LOWER                       (0x30034000u)
#define PxD_P1_CACHE_DATA_RAM1_UPPER                       (0x30038000u)
#define PxD_P1_CACHE_TAG_RAM_LOWER                         (0x30038000u)
#define PxD_P1_CACHE_TAG_RAM_UPPER                         (0x30038800u)
...
#define PxP_TCM0_SIZE                                      (0x00008000u)
#define PxP_TCM1_LOWER                                     (0x00820000u)
#define PxP_TCM1_UPPER                                     (0x00840000u)
#define PxP_TCM1_SIZE                                      (0x00020000u)
...
#define ADDR_SEL_PM_LSB                                    (0x00000011u)
...
#define MAP_P0_DM_RAM_UPPER                                (0x0000c000u)
#define MAP_P1_DM_RAM_LOWER                                (0x00040000u)
#define MAP_P1_DM_RAM_UPPER                                (0x00068000u)
#define MAP_TCM0_LOWER                                     (0x20000000u)
#define MAP_TCM0_UPPER                                     (0x20008000u)
#define MAP_TCM1_LOWER                                     (0x20020000u)
#define MAP_TCM1_UPPER                                     (0x20040000u)
...
#define MAP_P1_CACHE_DATA_RAM_UPPER                        (0x30038000u)
#define MAP_P1_CACHE_DATA_RAM0_LOWER                       (0x30030000u)
#define MAP_P1_CACHE_DATA_RAM0_UPPER                       (0x30034000u)
#define MAP_P1_CACHE_DATA_RAM1_LOWER                       (0x30034000u)
#define MAP_P1_CACHE_DATA_RAM1_UPPER                       (0x30038000u)
#define MAP_P1_CACHE_TAG_RAM_LOWER                         (0x30038000u)
#define MAP_P1_CACHE_TAG_RAM_UPPER                         (0x30038800u)
#define MAP_SHARED_DM_RAM_LOWER                            (0x10000000u)
#define MAP_SHARED_DM_RAM_UPPER                            (0x10010000u)
...
enum clkgen_debug_clocks_enum
{
   ...
   MAX_CLKGEN_DEBUG_CLOCKS                  = (int)0x19
};
#define NUM_CLKGEN_DEBUG_CLOCKS (0x1A)
...
enum system_bus_enum
{
   ...
   SYSTEM_BUS_NUM_SUBSYSTEMS                = (int)0x5,
   SYSTEM_BUS_RANGE_LSB                     = (int)0x0,
   SYSTEM_BUS_RANGE_MSB                     = (int)0x4,
   MAX_SYSTEM_BUS                           = (int)0x5
};
...
enum scan_config_enum
{
   ...
   ATPG_NUM_COMPRESSOR_CHANNEL              = (int)0xF,
   ATPG_NUM_DECOMPRESSOR_CHANNEL            = (int)0x578,
   ATPG_NUM_STUCKATONLY_CHANNEL             = (int)0x0,
   MAX_SCAN_CONFIG                          = (int)0x578
};
...
enum bitserial0_config2_debug_sel_enum
{
   ...
   MAX_BITSERIAL0_CONFIG2_DEBUG_SEL         = (int)0x2
};
#define NUM_BITSERIAL0_CONFIG2_DEBUG_SEL (0x3)
typedef enum bitserial0_config2_debug_sel_enum bitserial0_config2_debug_sel;
...
enum bitserial0_config3_posn_enum
{
   ...
   BITSERIAL0_WAIT_FOR_TBUS_READ_RESP_POSN            = (int)5,
   BITSERIAL0_CONFIG3_BITSERIAL0_WAIT_FOR_TBUS_READ_RESP_LSB_POSN = (int)5,
   BITSERIAL0_CONFIG3_BITSERIAL0_WAIT_FOR_TBUS_READ_RESP_MSB_POSN = (int)5,
   BITSERIAL0_REMOVE_EXTRA_TBUS_READ_POSN             = (int)6,
   BITSERIAL0_CONFIG3_BITSERIAL0_REMOVE_EXTRA_TBUS_READ_LSB_POSN = (int)6,
   BITSERIAL0_CONFIG3_BITSERIAL0_REMOVE_EXTRA_TBUS_READ_MSB_POSN = (int)6
};
...
#define BITSERIAL0_WAIT_FOR_TBUS_READ_RESP_MASK  (0x00000020u)
#define BITSERIAL0_REMOVE_EXTRA_TBUS_READ_MASK   (0x00000040u)

enum bitserial0_config3_act_on_nak_enum
{
   ...
   MAX_BITSERIAL0_CONFIG3_ACT_ON_NAK        = (int)0x2
};
#define NUM_BITSERIAL0_CONFIG3_ACT_ON_NAK (0x3)
typedef enum bitserial0_config3_act_on_nak_enum bitserial0_config3_act_on_nak;
...
#if defined(IO_DEFS_MODULE_BITSERIAL2) 

#ifndef __IO_DEFS_H__IO_DEFS_MODULE_BITSERIAL2
#define __IO_DEFS_H__IO_DEFS_MODULE_BITSERIAL2

/* -- bitserial2 -- Bitserializer regs -- */

enum bitserial2_buffer_enum_posn_enum
{
   BITSERIAL2_BUFF_HANDLE_LSB_POSN                    = (int)0,
   BITSERIAL2_BUFFER_ENUM_BITSERIAL2_BUFF_HANDLE_LSB_POSN = (int)0,
   BITSERIAL2_BUFF_HANDLE_MSB_POSN                    = (int)7,
   BITSERIAL2_BUFFER_ENUM_BITSERIAL2_BUFF_HANDLE_MSB_POSN = (int)7,
   BITSERIAL2_REMOTE_SSID_LSB_POSN                    = (int)8,
   BITSERIAL2_BUFFER_ENUM_BITSERIAL2_REMOTE_SSID_LSB_POSN = (int)8,
   BITSERIAL2_REMOTE_SSID_MSB_POSN                    = (int)11,
   BITSERIAL2_BUFFER_ENUM_BITSERIAL2_REMOTE_SSID_MSB_POSN = (int)11
};
typedef enum bitserial2_buffer_enum_posn_enum bitserial2_buffer_enum_posn;

#define BITSERIAL2_BUFF_HANDLE_LSB_MASK          (0x00000001u)
#define BITSERIAL2_BUFF_HANDLE_MSB_MASK          (0x00000080u)
#define BITSERIAL2_REMOTE_SSID_LSB_MASK          (0x00000100u)
#define BITSERIAL2_REMOTE_SSID_MSB_MASK          (0x00000800u)

enum bitserial2_event_types_enum
{
   BITSERIAL2_EVENT_TX_SUCCESS              = (int)0x0,
   BITSERIAL2_EVENT_RX_SUCCESS              = (int)0x1,
   BITSERIAL2_EVENT_ERROR_IN_BUFFER         = (int)0x2,
   BITSERIAL2_EVENT_ERROR_IN_READ           = (int)0x3,
   BITSERIAL2_EVENT_SLAVE_START_STOP_BITS_ERROR = (int)0x4,
   BITSERIAL2_EVENT_FIFO_UNDERFLOW          = (int)0x5,
   BITSERIAL2_EVENT_FIFO_OVERFLOW           = (int)0x6,
   BITSERIAL2_EVENT_I2C_ACK_ERROR           = (int)0x7,
   BITSERIAL2_EVENT_I2C_LOST_ARB            = (int)0x8,
   BITSERIAL2_EVENT_I2C_NAK_STOP            = (int)0x9,
   BITSERIAL2_EVENT_I2C_NAK_RESTART         = (int)0xA,
   BITSERIAL2_EVENT_TX_NOT_CONFIGURED       = (int)0xB,
   BITSERIAL2_EVENT_RX_CMD_DETECTED         = (int)0xC,
   BITSERIAL2_EVENT_TX_STREAMING_SUCCESS    = (int)0xD,
   BITSERIAL2_EVENT_WIDTH                   = (int)0xE,
   MAX_BITSERIAL2_EVENT_TYPES               = (int)0xE
};
#define NUM_BITSERIAL2_EVENT_TYPES (0xF)
typedef enum bitserial2_event_types_enum bitserial2_event_types;


enum bitserial2_clk_control_posn_enum
{
   BITSERIAL2_MASTER_SLAVE_CLK_REQ_EN_POSN            = (int)0,
   BITSERIAL2_CLK_CONTROL_BITSERIAL2_MASTER_SLAVE_CLK_REQ_EN_LSB_POSN = (int)0,
   BITSERIAL2_CLK_CONTROL_BITSERIAL2_MASTER_SLAVE_CLK_REQ_EN_MSB_POSN = (int)0,
   BITSERIAL2_MAIN_CLK_REQ_EN_POSN                    = (int)1,
   BITSERIAL2_CLK_CONTROL_BITSERIAL2_MAIN_CLK_REQ_EN_LSB_POSN = (int)1,
   BITSERIAL2_CLK_CONTROL_BITSERIAL2_MAIN_CLK_REQ_EN_MSB_POSN = (int)1,
   BITSERIAL2_CLK_DIVIDE_LSB_POSN                     = (int)2,
   BITSERIAL2_CLK_CONTROL_BITSERIAL2_CLK_DIVIDE_LSB_POSN = (int)2,
   BITSERIAL2_CLK_DIVIDE_MSB_POSN                     = (int)9,
   BITSERIAL2_CLK_CONTROL_BITSERIAL2_CLK_DIVIDE_MSB_POSN = (int)9
};
typedef enum bitserial2_clk_control_posn_enum bitserial2_clk_control_posn;

#define BITSERIAL2_MASTER_SLAVE_CLK_REQ_EN_MASK  (0x00000001u)
#define BITSERIAL2_MAIN_CLK_REQ_EN_MASK          (0x00000002u)
#define BITSERIAL2_CLK_DIVIDE_LSB_MASK           (0x00000004u)
#define BITSERIAL2_CLK_DIVIDE_MSB_MASK           (0x00000200u)

enum bitserial2_config_posn_enum
{
   BITSERIAL2_CONFIG_CLK_INVERT_POSN                  = (int)0,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_CLK_INVERT_LSB_POSN = (int)0,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_CLK_INVERT_MSB_POSN = (int)0,
   BITSERIAL2_CONFIG_DIN_INVERT_POSN                  = (int)1,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_DIN_INVERT_LSB_POSN = (int)1,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_DIN_INVERT_MSB_POSN = (int)1,
   BITSERIAL2_CONFIG_DOUT_INVERT_POSN                 = (int)2,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_DOUT_INVERT_LSB_POSN = (int)2,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_DOUT_INVERT_MSB_POSN = (int)2,
   BITSERIAL2_CONFIG_BYTESWAP_EN_POSN                 = (int)3,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_BYTESWAP_EN_LSB_POSN = (int)3,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_BYTESWAP_EN_MSB_POSN = (int)3,
   BITSERIAL2_CONFIG_INT_EVENT_SUBSYSTEM_EN_POSN      = (int)4,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_INT_EVENT_SUBSYSTEM_EN_LSB_POSN = (int)4,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_INT_EVENT_SUBSYSTEM_EN_MSB_POSN = (int)4,
   BITSERIAL2_CONFIG_INT_EVENT_CURATOR_EN_POSN        = (int)5,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_INT_EVENT_CURATOR_EN_LSB_POSN = (int)5,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_INT_EVENT_CURATOR_EN_MSB_POSN = (int)5,
   BITSERIAL2_CONFIG_BITREVERSE_EN_POSN               = (int)6,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_BITREVERSE_EN_LSB_POSN = (int)6,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_BITREVERSE_EN_MSB_POSN = (int)6,
   BITSERIAL2_CONFIG_CLEAR_STICKY_ACK_POSN            = (int)7,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_CLEAR_STICKY_ACK_LSB_POSN = (int)7,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_CLEAR_STICKY_ACK_MSB_POSN = (int)7,
   BITSERIAL2_CONFIG_CLK_OFFSET_EN_POSN               = (int)8,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_CLK_OFFSET_EN_LSB_POSN = (int)8,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_CLK_OFFSET_EN_MSB_POSN = (int)8,
   BITSERIAL2_CONFIG_NEG_EDGE_SAMP_EN_POSN            = (int)9,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_NEG_EDGE_SAMP_EN_LSB_POSN = (int)9,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_NEG_EDGE_SAMP_EN_MSB_POSN = (int)9,
   BITSERIAL2_CONFIG_I2C_MODE_EN_POSN                 = (int)10,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_I2C_MODE_EN_LSB_POSN = (int)10,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_I2C_MODE_EN_MSB_POSN = (int)10,
   BITSERIAL2_CONFIG_POSEDGE_LAUNCH_MODE_EN_POSN      = (int)11,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_POSEDGE_LAUNCH_MODE_EN_LSB_POSN = (int)11,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_POSEDGE_LAUNCH_MODE_EN_MSB_POSN = (int)11,
   BITSERIAL2_CONFIG_STOP_TOKEN_DISABLE_POSN          = (int)12,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_STOP_TOKEN_DISABLE_LSB_POSN = (int)12,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_STOP_TOKEN_DISABLE_MSB_POSN = (int)12,
   BITSERIAL2_CONFIG_SEL_INVERT_POSN                  = (int)13,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_SEL_INVERT_LSB_POSN = (int)13,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_SEL_INVERT_MSB_POSN = (int)13,
   BITSERIAL2_CONFIG_SEL_EN_POSN                      = (int)14,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_SEL_EN_LSB_POSN = (int)14,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_SEL_EN_MSB_POSN = (int)14,
   BITSERIAL2_CONFIG_SEL_TIME_EN_POSN                 = (int)15,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_SEL_TIME_EN_LSB_POSN = (int)15,
   BITSERIAL2_CONFIG_BITSERIAL2_CONFIG_SEL_TIME_EN_MSB_POSN = (int)15
};
typedef enum bitserial2_config_posn_enum bitserial2_config_posn;

#define BITSERIAL2_CONFIG_CLK_INVERT_MASK        (0x00000001u)
#define BITSERIAL2_CONFIG_DIN_INVERT_MASK        (0x00000002u)
#define BITSERIAL2_CONFIG_DOUT_INVERT_MASK       (0x00000004u)
#define BITSERIAL2_CONFIG_BYTESWAP_EN_MASK       (0x00000008u)
#define BITSERIAL2_CONFIG_INT_EVENT_SUBSYSTEM_EN_MASK (0x00000010u)
#define BITSERIAL2_CONFIG_INT_EVENT_CURATOR_EN_MASK (0x00000020u)
#define BITSERIAL2_CONFIG_BITREVERSE_EN_MASK     (0x00000040u)
#define BITSERIAL2_CONFIG_CLEAR_STICKY_ACK_MASK  (0x00000080u)
#define BITSERIAL2_CONFIG_CLK_OFFSET_EN_MASK     (0x00000100u)
#define BITSERIAL2_CONFIG_NEG_EDGE_SAMP_EN_MASK  (0x00000200u)
#define BITSERIAL2_CONFIG_I2C_MODE_EN_MASK       (0x00000400u)
#define BITSERIAL2_CONFIG_POSEDGE_LAUNCH_MODE_EN_MASK (0x00000800u)
#define BITSERIAL2_CONFIG_STOP_TOKEN_DISABLE_MASK (0x00001000u)
#define BITSERIAL2_CONFIG_SEL_INVERT_MASK        (0x00002000u)
#define BITSERIAL2_CONFIG_SEL_EN_MASK            (0x00004000u)
#define BITSERIAL2_CONFIG_SEL_TIME_EN_MASK       (0x00008000u)

enum bitserial2_config2_posn_enum
{
   BITSERIAL2_CONFIG2_COMBO_MODE_POSN                 = (int)0,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_COMBO_MODE_LSB_POSN = (int)0,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_COMBO_MODE_MSB_POSN = (int)0,
   BITSERIAL2_CONFIG2_STOP_TOKEN_DISABLE2_POSN        = (int)1,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_STOP_TOKEN_DISABLE2_LSB_POSN = (int)1,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_STOP_TOKEN_DISABLE2_MSB_POSN = (int)1,
   BITSERIAL2_CONFIG2_SEL_EN2_POSN                    = (int)2,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_SEL_EN2_LSB_POSN = (int)2,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_SEL_EN2_MSB_POSN = (int)2,
   BITSERIAL2_CONFIG2_DOUT_IDLE_SEL_LSB_POSN          = (int)3,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_DOUT_IDLE_SEL_LSB_POSN = (int)3,
   BITSERIAL2_CONFIG2_DOUT_IDLE_SEL_MSB_POSN          = (int)4,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_DOUT_IDLE_SEL_MSB_POSN = (int)4,
   BITSERIAL2_CONFIG2_SLAVE_MODE_POSN                 = (int)5,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_SLAVE_MODE_LSB_POSN = (int)5,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_SLAVE_MODE_MSB_POSN = (int)5,
   BITSERIAL2_CONFIG2_SLAVE_10BIT_ADDR_MODE_POSN      = (int)6,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_SLAVE_10BIT_ADDR_MODE_LSB_POSN = (int)6,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_SLAVE_10BIT_ADDR_MODE_MSB_POSN = (int)6,
   BITSERIAL2_CONFIG2_I2C_SL_CLK_STRETCH_DISABLE_POSN = (int)7,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_I2C_SL_CLK_STRETCH_DISABLE_LSB_POSN = (int)7,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_I2C_SL_CLK_STRETCH_DISABLE_MSB_POSN = (int)7,
   BITSERIAL2_CONFIG2_DATA_READY_WORD_DISABLE_POSN    = (int)8,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_DATA_READY_WORD_DISABLE_LSB_POSN = (int)8,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_DATA_READY_WORD_DISABLE_MSB_POSN = (int)8,
   BITSERIAL2_CONFIG2_SLAVE_READ_MODE_SWITCH_POSN     = (int)9,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_SLAVE_READ_MODE_SWITCH_LSB_POSN = (int)9,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_SLAVE_READ_MODE_SWITCH_MSB_POSN = (int)9,
   BITSERIAL2_CONFIG2_SLAVE_ANY_CMD_BYTE_EN_POSN      = (int)10,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_SLAVE_ANY_CMD_BYTE_EN_LSB_POSN = (int)10,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_SLAVE_ANY_CMD_BYTE_EN_MSB_POSN = (int)10,
   BITSERIAL2_CONFIG2_DISABLE_UNDERFLOW_INT_POSN      = (int)11,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_DISABLE_UNDERFLOW_INT_LSB_POSN = (int)11,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_DISABLE_UNDERFLOW_INT_MSB_POSN = (int)11,
   BITSERIAL2_CONFIG2_DEBUG_SEL_LSB_POSN              = (int)12,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_DEBUG_SEL_LSB_POSN = (int)12,
   BITSERIAL2_CONFIG2_DEBUG_SEL_MSB_POSN              = (int)13,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_DEBUG_SEL_MSB_POSN = (int)13,
   BITSERIAL2_CONFIG2_FORCE_SEL_ACTIVE_POSN           = (int)14,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_FORCE_SEL_ACTIVE_LSB_POSN = (int)14,
   BITSERIAL2_CONFIG2_BITSERIAL2_CONFIG2_FORCE_SEL_ACTIVE_MSB_POSN = (int)14
};
typedef enum bitserial2_config2_posn_enum bitserial2_config2_posn;

#define BITSERIAL2_CONFIG2_COMBO_MODE_MASK       (0x00000001u)
#define BITSERIAL2_CONFIG2_STOP_TOKEN_DISABLE2_MASK (0x00000002u)
#define BITSERIAL2_CONFIG2_SEL_EN2_MASK          (0x00000004u)
#define BITSERIAL2_CONFIG2_DOUT_IDLE_SEL_LSB_MASK (0x00000008u)
#define BITSERIAL2_CONFIG2_DOUT_IDLE_SEL_MSB_MASK (0x00000010u)
#define BITSERIAL2_CONFIG2_SLAVE_MODE_MASK       (0x00000020u)
#define BITSERIAL2_CONFIG2_SLAVE_10BIT_ADDR_MODE_MASK (0x00000040u)
#define BITSERIAL2_CONFIG2_I2C_SL_CLK_STRETCH_DISABLE_MASK (0x00000080u)
#define BITSERIAL2_CONFIG2_DATA_READY_WORD_DISABLE_MASK (0x00000100u)
#define BITSERIAL2_CONFIG2_SLAVE_READ_MODE_SWITCH_MASK (0x00000200u)
#define BITSERIAL2_CONFIG2_SLAVE_ANY_CMD_BYTE_EN_MASK (0x00000400u)
#define BITSERIAL2_CONFIG2_DISABLE_UNDERFLOW_INT_MASK (0x00000800u)
#define BITSERIAL2_CONFIG2_DEBUG_SEL_LSB_MASK    (0x00001000u)
#define BITSERIAL2_CONFIG2_DEBUG_SEL_MSB_MASK    (0x00002000u)
#define BITSERIAL2_CONFIG2_FORCE_SEL_ACTIVE_MASK (0x00004000u)

enum bitserial2_config2_dout_idle_sel_enum
{
   BITSERIAL2_CONFIG2_DOUT_IDLE_SEL_LOW     = (int)0x0,
   BITSERIAL2_CONFIG2_DOUT_IDLE_SEL_HIGH    = (int)0x1,
   BITSERIAL2_CONFIG2_DOUT_IDLE_SEL_LAST    = (int)0x2,
   MAX_BITSERIAL2_CONFIG2_DOUT_IDLE_SEL     = (int)0x2
};
#define NUM_BITSERIAL2_CONFIG2_DOUT_IDLE_SEL (0x3)
typedef enum bitserial2_config2_dout_idle_sel_enum bitserial2_config2_dout_idle_sel;


enum bitserial2_config2_slave_read_mode_switch_enum
{
   BITSERIAL2_CONFIG2_SLAVE_READ_MODE_SWITCH_AUTO = (int)0x0,
   BITSERIAL2_CONFIG2_SLAVE_READ_MODE_SWITCH_MANUAL = (int)0x1,
   MAX_BITSERIAL2_CONFIG2_SLAVE_READ_MODE_SWITCH = (int)0x1
};
#define NUM_BITSERIAL2_CONFIG2_SLAVE_READ_MODE_SWITCH (0x2)
typedef enum bitserial2_config2_slave_read_mode_switch_enum bitserial2_config2_slave_read_mode_switch;


enum bitserial2_config2_debug_sel_enum
{
   BITSERIAL2_CONFIG2_DEBUG_SEL_MASTER      = (int)0x0,
   BITSERIAL2_CONFIG2_DEBUG_SEL_SLAVE       = (int)0x1,
   BITSERIAL2_CONFIG2_DEBUG_SEL_VML_REQUEST = (int)0x2,
   MAX_BITSERIAL2_CONFIG2_DEBUG_SEL         = (int)0x2
};
#define NUM_BITSERIAL2_CONFIG2_DEBUG_SEL (0x3)
typedef enum bitserial2_config2_debug_sel_enum bitserial2_config2_debug_sel;


enum bitserial2_config3_posn_enum
{
   BITSERIAL2_CONFIG3_ACT_ON_NAK_LSB_POSN             = (int)0,
   BITSERIAL2_CONFIG3_BITSERIAL2_CONFIG3_ACT_ON_NAK_LSB_POSN = (int)0,
   BITSERIAL2_CONFIG3_ACT_ON_NAK_MSB_POSN             = (int)1,
   BITSERIAL2_CONFIG3_BITSERIAL2_CONFIG3_ACT_ON_NAK_MSB_POSN = (int)1,
   BITSERIAL2_CLR_SLAVE_READ_FIFO_POSN                = (int)2,
   BITSERIAL2_CONFIG3_BITSERIAL2_CLR_SLAVE_READ_FIFO_LSB_POSN = (int)2,
   BITSERIAL2_CONFIG3_BITSERIAL2_CLR_SLAVE_READ_FIFO_MSB_POSN = (int)2,
   BITSERIAL2_CLR_SLAVE_WRITE_FIFO_POSN               = (int)3,
   BITSERIAL2_CONFIG3_BITSERIAL2_CLR_SLAVE_WRITE_FIFO_LSB_POSN = (int)3,
   BITSERIAL2_CONFIG3_BITSERIAL2_CLR_SLAVE_WRITE_FIFO_MSB_POSN = (int)3,
   BITSERIAL2_STREAMING_EN_POSN                       = (int)4,
   BITSERIAL2_CONFIG3_BITSERIAL2_STREAMING_EN_LSB_POSN = (int)4,
   BITSERIAL2_CONFIG3_BITSERIAL2_STREAMING_EN_MSB_POSN = (int)4,
   BITSERIAL2_WAIT_FOR_TBUS_READ_RESP_POSN            = (int)5,
   BITSERIAL2_CONFIG3_BITSERIAL2_WAIT_FOR_TBUS_READ_RESP_LSB_POSN = (int)5,
   BITSERIAL2_CONFIG3_BITSERIAL2_WAIT_FOR_TBUS_READ_RESP_MSB_POSN = (int)5,
   BITSERIAL2_REMOVE_EXTRA_TBUS_READ_POSN             = (int)6,
   BITSERIAL2_CONFIG3_BITSERIAL2_REMOVE_EXTRA_TBUS_READ_LSB_POSN = (int)6,
   BITSERIAL2_CONFIG3_BITSERIAL2_REMOVE_EXTRA_TBUS_READ_MSB_POSN = (int)6
};
typedef enum bitserial2_config3_posn_enum bitserial2_config3_posn;

#define BITSERIAL2_CONFIG3_ACT_ON_NAK_LSB_MASK   (0x00000001u)
#define BITSERIAL2_CONFIG3_ACT_ON_NAK_MSB_MASK   (0x00000002u)
#define BITSERIAL2_CLR_SLAVE_READ_FIFO_MASK      (0x00000004u)
#define BITSERIAL2_CLR_SLAVE_WRITE_FIFO_MASK     (0x00000008u)
#define BITSERIAL2_STREAMING_EN_MASK             (0x00000010u)
#define BITSERIAL2_WAIT_FOR_TBUS_READ_RESP_MASK  (0x00000020u)
#define BITSERIAL2_REMOVE_EXTRA_TBUS_READ_MASK   (0x00000040u)

enum bitserial2_config3_act_on_nak_enum
{
   BITSERIAL2_CONFIG3_ACT_ON_NAK_LEGACY     = (int)0x0,
   BITSERIAL2_CONFIG3_ACT_ON_NAK_STOP       = (int)0x1,
   BITSERIAL2_CONFIG3_ACT_ON_NAK_RESTART    = (int)0x2,
   MAX_BITSERIAL2_CONFIG3_ACT_ON_NAK        = (int)0x2
};
#define NUM_BITSERIAL2_CONFIG3_ACT_ON_NAK (0x3)
typedef enum bitserial2_config3_act_on_nak_enum bitserial2_config3_act_on_nak;


enum bitserial2_debug_sel_posn_enum
{
   BITSERIAL2_DEBUG_SEL_SLAVE_MEM_CORE_POSN           = (int)0,
   BITSERIAL2_DEBUG_SEL_BITSERIAL2_DEBUG_SEL_SLAVE_MEM_CORE_LSB_POSN = (int)0,
   BITSERIAL2_DEBUG_SEL_BITSERIAL2_DEBUG_SEL_SLAVE_MEM_CORE_MSB_POSN = (int)0,
   BITSERIAL2_DEBUG_SEL_SLAVE_CORE_SEL_LSB_POSN       = (int)1,
   BITSERIAL2_DEBUG_SEL_BITSERIAL2_DEBUG_SEL_SLAVE_CORE_SEL_LSB_POSN = (int)1,
   BITSERIAL2_DEBUG_SEL_SLAVE_CORE_SEL_MSB_POSN       = (int)4,
   BITSERIAL2_DEBUG_SEL_BITSERIAL2_DEBUG_SEL_SLAVE_CORE_SEL_MSB_POSN = (int)4,
   BITSERIAL2_DEBUG_SEL_SLAVE_MEM_SEL_LSB_POSN        = (int)5,
   BITSERIAL2_DEBUG_SEL_BITSERIAL2_DEBUG_SEL_SLAVE_MEM_SEL_LSB_POSN = (int)5,
   BITSERIAL2_DEBUG_SEL_SLAVE_MEM_SEL_MSB_POSN        = (int)8,
   BITSERIAL2_DEBUG_SEL_BITSERIAL2_DEBUG_SEL_SLAVE_MEM_SEL_MSB_POSN = (int)8
};
typedef enum bitserial2_debug_sel_posn_enum bitserial2_debug_sel_posn;

#define BITSERIAL2_DEBUG_SEL_SLAVE_MEM_CORE_MASK (0x00000001u)
#define BITSERIAL2_DEBUG_SEL_SLAVE_CORE_SEL_LSB_MASK (0x00000002u)
#define BITSERIAL2_DEBUG_SEL_SLAVE_CORE_SEL_MSB_MASK (0x00000010u)
#define BITSERIAL2_DEBUG_SEL_SLAVE_MEM_SEL_LSB_MASK (0x00000020u)
#define BITSERIAL2_DEBUG_SEL_SLAVE_MEM_SEL_MSB_MASK (0x00000100u)

enum bitserial2_deglitch_en_posn_enum
{
   BITSERIAL2_DEGLITCH_EN_CLOCK_POSN                  = (int)0,
   BITSERIAL2_DEGLITCH_EN_BITSERIAL2_DEGLITCH_EN_CLOCK_LSB_POSN = (int)0,
   BITSERIAL2_DEGLITCH_EN_BITSERIAL2_DEGLITCH_EN_CLOCK_MSB_POSN = (int)0,
   BITSERIAL2_DEGLITCH_EN_DATA_POSN                   = (int)1,
   BITSERIAL2_DEGLITCH_EN_BITSERIAL2_DEGLITCH_EN_DATA_LSB_POSN = (int)1,
   BITSERIAL2_DEGLITCH_EN_BITSERIAL2_DEGLITCH_EN_DATA_MSB_POSN = (int)1
};
typedef enum bitserial2_deglitch_en_posn_enum bitserial2_deglitch_en_posn;

#define BITSERIAL2_DEGLITCH_EN_CLOCK_MASK        (0x00000001u)
#define BITSERIAL2_DEGLITCH_EN_DATA_MASK         (0x00000002u)

enum bitserial2_error_status_posn_enum
{
   BITSERIAL2_VML_RESP_STATUS_LSB_POSN                = (int)0,
   BITSERIAL2_ERROR_STATUS_BITSERIAL2_VML_RESP_STATUS_LSB_POSN = (int)0,
   BITSERIAL2_VML_RESP_STATUS_MSB_POSN                = (int)3,
   BITSERIAL2_ERROR_STATUS_BITSERIAL2_VML_RESP_STATUS_MSB_POSN = (int)3,
   BITSERIAL2_READ_RESP_STATUS_LSB_POSN               = (int)4,
   BITSERIAL2_ERROR_STATUS_BITSERIAL2_READ_RESP_STATUS_LSB_POSN = (int)4,
   BITSERIAL2_READ_RESP_STATUS_MSB_POSN               = (int)7,
   BITSERIAL2_ERROR_STATUS_BITSERIAL2_READ_RESP_STATUS_MSB_POSN = (int)7,
   BITSERIAL2_TRANSACTION_PART2_POSN                  = (int)8,
   BITSERIAL2_ERROR_STATUS_BITSERIAL2_TRANSACTION_PART2_LSB_POSN = (int)8,
   BITSERIAL2_ERROR_STATUS_BITSERIAL2_TRANSACTION_PART2_MSB_POSN = (int)8
};
typedef enum bitserial2_error_status_posn_enum bitserial2_error_status_posn;

#define BITSERIAL2_VML_RESP_STATUS_LSB_MASK      (0x00000001u)
#define BITSERIAL2_VML_RESP_STATUS_MSB_MASK      (0x00000008u)
#define BITSERIAL2_READ_RESP_STATUS_LSB_MASK     (0x00000010u)
#define BITSERIAL2_READ_RESP_STATUS_MSB_MASK     (0x00000080u)
#define BITSERIAL2_TRANSACTION_PART2_MASK        (0x00000100u)

enum bitserial2_i2c_acks_posn_enum
{
   BITSERIAL2_I2C_ACKS_HISTORY_LSB_POSN               = (int)0,
   BITSERIAL2_I2C_ACKS_BITSERIAL2_I2C_ACKS_HISTORY_LSB_POSN = (int)0,
   BITSERIAL2_I2C_ACKS_HISTORY_MSB_POSN               = (int)14,
   BITSERIAL2_I2C_ACKS_BITSERIAL2_I2C_ACKS_HISTORY_MSB_POSN = (int)14,
   BITSERIAL2_I2C_ACKS_STICKY_POSN                    = (int)15,
   BITSERIAL2_I2C_ACKS_BITSERIAL2_I2C_ACKS_STICKY_LSB_POSN = (int)15,
   BITSERIAL2_I2C_ACKS_BITSERIAL2_I2C_ACKS_STICKY_MSB_POSN = (int)15
};
typedef enum bitserial2_i2c_acks_posn_enum bitserial2_i2c_acks_posn;

#define BITSERIAL2_I2C_ACKS_HISTORY_LSB_MASK     (0x00000001u)
#define BITSERIAL2_I2C_ACKS_HISTORY_MSB_MASK     (0x00004000u)
#define BITSERIAL2_I2C_ACKS_STICKY_MASK          (0x00008000u)

enum bitserial2_interbyte_spacing_posn_enum
{
   BITSERIAL2_INTERBYTE_SPACING_CYCLES_LSB_POSN       = (int)0,
   BITSERIAL2_INTERBYTE_SPACING_BITSERIAL2_INTERBYTE_SPACING_CYCLES_LSB_POSN = (int)0,
   BITSERIAL2_INTERBYTE_SPACING_CYCLES_MSB_POSN       = (int)14,
   BITSERIAL2_INTERBYTE_SPACING_BITSERIAL2_INTERBYTE_SPACING_CYCLES_MSB_POSN = (int)14,
   BITSERIAL2_INTERBYTE_SPACING_EN_POSN               = (int)15,
   BITSERIAL2_INTERBYTE_SPACING_BITSERIAL2_INTERBYTE_SPACING_EN_LSB_POSN = (int)15,
   BITSERIAL2_INTERBYTE_SPACING_BITSERIAL2_INTERBYTE_SPACING_EN_MSB_POSN = (int)15
};
typedef enum bitserial2_interbyte_spacing_posn_enum bitserial2_interbyte_spacing_posn;

#define BITSERIAL2_INTERBYTE_SPACING_CYCLES_LSB_MASK (0x00000001u)
#define BITSERIAL2_INTERBYTE_SPACING_CYCLES_MSB_MASK (0x00004000u)
#define BITSERIAL2_INTERBYTE_SPACING_EN_MASK     (0x00008000u)

enum bitserial2_status_posn_enum
{
   BITSERIAL2_BUSY_POSN                               = (int)0,
   BITSERIAL2_STATUS_BITSERIAL2_BUSY_LSB_POSN         = (int)0,
   BITSERIAL2_STATUS_BITSERIAL2_BUSY_MSB_POSN         = (int)0,
   BITSERIAL2_RWB_POSN                                = (int)1,
   BITSERIAL2_STATUS_BITSERIAL2_RWB_LSB_POSN          = (int)1,
   BITSERIAL2_STATUS_BITSERIAL2_RWB_MSB_POSN          = (int)1,
   BITSERIAL2_EVENT_POSN                              = (int)2,
   BITSERIAL2_STATUS_BITSERIAL2_EVENT_LSB_POSN        = (int)2,
   BITSERIAL2_STATUS_BITSERIAL2_EVENT_MSB_POSN        = (int)2,
   BITSERIAL2_FAILED_POSN                             = (int)3,
   BITSERIAL2_STATUS_BITSERIAL2_FAILED_LSB_POSN       = (int)3,
   BITSERIAL2_STATUS_BITSERIAL2_FAILED_MSB_POSN       = (int)3,
   BITSERIAL2_I2C_LOST_ARBITRATION_POSN               = (int)4,
   BITSERIAL2_STATUS_BITSERIAL2_I2C_LOST_ARBITRATION_LSB_POSN = (int)4,
   BITSERIAL2_STATUS_BITSERIAL2_I2C_LOST_ARBITRATION_MSB_POSN = (int)4,
   BITSERIAL2_I2C_BUS_BUSY_POSN                       = (int)5,
   BITSERIAL2_STATUS_BITSERIAL2_I2C_BUS_BUSY_LSB_POSN = (int)5,
   BITSERIAL2_STATUS_BITSERIAL2_I2C_BUS_BUSY_MSB_POSN = (int)5,
   BITSERIAL2_PART_2_POSN                             = (int)6,
   BITSERIAL2_STATUS_BITSERIAL2_PART_2_LSB_POSN       = (int)6,
   BITSERIAL2_STATUS_BITSERIAL2_PART_2_MSB_POSN       = (int)6,
   BITSERIAL2_FIFO_OVERFLOW_POSN                      = (int)7,
   BITSERIAL2_STATUS_BITSERIAL2_FIFO_OVERFLOW_LSB_POSN = (int)7,
   BITSERIAL2_STATUS_BITSERIAL2_FIFO_OVERFLOW_MSB_POSN = (int)7,
   BITSERIAL2_FIFO_UNDERFLOW_POSN                     = (int)8,
   BITSERIAL2_STATUS_BITSERIAL2_FIFO_UNDERFLOW_LSB_POSN = (int)8,
   BITSERIAL2_STATUS_BITSERIAL2_FIFO_UNDERFLOW_MSB_POSN = (int)8,
   BITSERIAL2_SLAVE_START_STOP_BITS_ERROR_POSN        = (int)9,
   BITSERIAL2_STATUS_BITSERIAL2_SLAVE_START_STOP_BITS_ERROR_LSB_POSN = (int)9,
   BITSERIAL2_STATUS_BITSERIAL2_SLAVE_START_STOP_BITS_ERROR_MSB_POSN = (int)9,
   BITSERIAL2_I2C_NACK_POSN                           = (int)10,
   BITSERIAL2_STATUS_BITSERIAL2_I2C_NACK_LSB_POSN     = (int)10,
   BITSERIAL2_STATUS_BITSERIAL2_I2C_NACK_MSB_POSN     = (int)10,
   BITSERIAL2_DEEP_SLEEP_CDC_BUSY_POSN                = (int)11,
   BITSERIAL2_STATUS_BITSERIAL2_DEEP_SLEEP_CDC_BUSY_LSB_POSN = (int)11,
   BITSERIAL2_STATUS_BITSERIAL2_DEEP_SLEEP_CDC_BUSY_MSB_POSN = (int)11,
   BITSERIAL2_TX_NOT_CONFIGURED_POSN                  = (int)12,
   BITSERIAL2_STATUS_BITSERIAL2_TX_NOT_CONFIGURED_LSB_POSN = (int)12,
   BITSERIAL2_STATUS_BITSERIAL2_TX_NOT_CONFIGURED_MSB_POSN = (int)12
};
typedef enum bitserial2_status_posn_enum bitserial2_status_posn;

#define BITSERIAL2_BUSY_MASK                     (0x00000001u)
#define BITSERIAL2_RWB_MASK                      (0x00000002u)
#define BITSERIAL2_EVENT_MASK                    (0x00000004u)
#define BITSERIAL2_FAILED_MASK                   (0x00000008u)
#define BITSERIAL2_I2C_LOST_ARBITRATION_MASK     (0x00000010u)
#define BITSERIAL2_I2C_BUS_BUSY_MASK             (0x00000020u)
#define BITSERIAL2_PART_2_MASK                   (0x00000040u)
#define BITSERIAL2_FIFO_OVERFLOW_MASK            (0x00000080u)
#define BITSERIAL2_FIFO_UNDERFLOW_MASK           (0x00000100u)
#define BITSERIAL2_SLAVE_START_STOP_BITS_ERROR_MASK (0x00000200u)
#define BITSERIAL2_I2C_NACK_MASK                 (0x00000400u)
#define BITSERIAL2_DEEP_SLEEP_CDC_BUSY_MASK      (0x00000800u)
#define BITSERIAL2_TX_NOT_CONFIGURED_MASK        (0x00001000u)

enum bitserial2_word_config_posn_enum
{
   BITSERIAL2_WORD_CONFIG_NUM_BYTES_LSB_POSN          = (int)0,
   BITSERIAL2_WORD_CONFIG_BITSERIAL2_WORD_CONFIG_NUM_BYTES_LSB_POSN = (int)0,
   BITSERIAL2_WORD_CONFIG_NUM_BYTES_MSB_POSN          = (int)1,
   BITSERIAL2_WORD_CONFIG_BITSERIAL2_WORD_CONFIG_NUM_BYTES_MSB_POSN = (int)1,
   BITSERIAL2_WORD_CONFIG_NUM_STOP_LSB_POSN           = (int)2,
   BITSERIAL2_WORD_CONFIG_BITSERIAL2_WORD_CONFIG_NUM_STOP_LSB_POSN = (int)2,
   BITSERIAL2_WORD_CONFIG_NUM_STOP_MSB_POSN           = (int)3,
   BITSERIAL2_WORD_CONFIG_BITSERIAL2_WORD_CONFIG_NUM_STOP_MSB_POSN = (int)3,
   BITSERIAL2_WORD_CONFIG_NUM_START_LSB_POSN          = (int)4,
   BITSERIAL2_WORD_CONFIG_BITSERIAL2_WORD_CONFIG_NUM_START_LSB_POSN = (int)4,
   BITSERIAL2_WORD_CONFIG_NUM_START_MSB_POSN          = (int)5,
   BITSERIAL2_WORD_CONFIG_BITSERIAL2_WORD_CONFIG_NUM_START_MSB_POSN = (int)5,
   BITSERIAL2_WORD_CONFIG_START_BITS_LSB_POSN         = (int)6,
   BITSERIAL2_WORD_CONFIG_BITSERIAL2_WORD_CONFIG_START_BITS_LSB_POSN = (int)6,
   BITSERIAL2_WORD_CONFIG_START_BITS_MSB_POSN         = (int)8,
   BITSERIAL2_WORD_CONFIG_BITSERIAL2_WORD_CONFIG_START_BITS_MSB_POSN = (int)8,
   BITSERIAL2_WORD_CONFIG_STOP_BITS_LSB_POSN          = (int)9,
   BITSERIAL2_WORD_CONFIG_BITSERIAL2_WORD_CONFIG_STOP_BITS_LSB_POSN = (int)9,
   BITSERIAL2_WORD_CONFIG_STOP_BITS_MSB_POSN          = (int)11,
   BITSERIAL2_WORD_CONFIG_BITSERIAL2_WORD_CONFIG_STOP_BITS_MSB_POSN = (int)11
};
typedef enum bitserial2_word_config_posn_enum bitserial2_word_config_posn;

#define BITSERIAL2_WORD_CONFIG_NUM_BYTES_LSB_MASK (0x00000001u)
#define BITSERIAL2_WORD_CONFIG_NUM_BYTES_MSB_MASK (0x00000002u)
#define BITSERIAL2_WORD_CONFIG_NUM_STOP_LSB_MASK (0x00000004u)
#define BITSERIAL2_WORD_CONFIG_NUM_STOP_MSB_MASK (0x00000008u)
#define BITSERIAL2_WORD_CONFIG_NUM_START_LSB_MASK (0x00000010u)
#define BITSERIAL2_WORD_CONFIG_NUM_START_MSB_MASK (0x00000020u)
#define BITSERIAL2_WORD_CONFIG_START_BITS_LSB_MASK (0x00000040u)
#define BITSERIAL2_WORD_CONFIG_START_BITS_MSB_MASK (0x00000100u)
#define BITSERIAL2_WORD_CONFIG_STOP_BITS_LSB_MASK (0x00000200u)
#define BITSERIAL2_WORD_CONFIG_STOP_BITS_MSB_MASK (0x00000800u)

enum bitserial2_word_config_enum
{
   BITSERIAL2_WORD_CONFIG_NUM_BYTES_ONE     = (int)0x0,
   BITSERIAL2_WORD_CONFIG_NUM_BYTES_TWO     = (int)0x1,
   BITSERIAL2_WORD_CONFIG_NUM_BYTES_THREE   = (int)0x2,
   BITSERIAL2_WORD_CONFIG_NUM_BYTES_FOUR    = (int)0x3,
   MAX_BITSERIAL2_WORD_CONFIG               = (int)0x3
};
#define NUM_BITSERIAL2_WORD_CONFIG (0x4)
typedef enum bitserial2_word_config_enum bitserial2_word_config;


enum bitserial2_clk_rate_hi_posn_enum
{
   BITSERIAL2_CLK_RATE_HI_LSB_POSN                    = (int)0,
   BITSERIAL2_CLK_RATE_HI_BITSERIAL2_CLK_RATE_HI_LSB_POSN = (int)0,
   BITSERIAL2_CLK_RATE_HI_MSB_POSN                    = (int)15,
   BITSERIAL2_CLK_RATE_HI_BITSERIAL2_CLK_RATE_HI_MSB_POSN = (int)15
};
typedef enum bitserial2_clk_rate_hi_posn_enum bitserial2_clk_rate_hi_posn;

#define BITSERIAL2_CLK_RATE_HI_LSB_MASK          (0x00000001u)
#define BITSERIAL2_CLK_RATE_HI_MSB_MASK          (0x00008000u)

enum bitserial2_clk_rate_lo_posn_enum
{
   BITSERIAL2_CLK_RATE_LO_LSB_POSN                    = (int)0,
   BITSERIAL2_CLK_RATE_LO_BITSERIAL2_CLK_RATE_LO_LSB_POSN = (int)0,
   BITSERIAL2_CLK_RATE_LO_MSB_POSN                    = (int)15,
   BITSERIAL2_CLK_RATE_LO_BITSERIAL2_CLK_RATE_LO_MSB_POSN = (int)15
};
typedef enum bitserial2_clk_rate_lo_posn_enum bitserial2_clk_rate_lo_posn;

#define BITSERIAL2_CLK_RATE_LO_LSB_MASK          (0x00000001u)
#define BITSERIAL2_CLK_RATE_LO_MSB_MASK          (0x00008000u)

enum bitserial2_clk_samp_offset_posn_enum
{
   BITSERIAL2_CLK_SAMP_OFFSET_LSB_POSN                = (int)0,
   BITSERIAL2_CLK_SAMP_OFFSET_BITSERIAL2_CLK_SAMP_OFFSET_LSB_POSN = (int)0,
   BITSERIAL2_CLK_SAMP_OFFSET_MSB_POSN                = (int)15,
   BITSERIAL2_CLK_SAMP_OFFSET_BITSERIAL2_CLK_SAMP_OFFSET_MSB_POSN = (int)15
};
typedef enum bitserial2_clk_samp_offset_posn_enum bitserial2_clk_samp_offset_posn;

#define BITSERIAL2_CLK_SAMP_OFFSET_LSB_MASK      (0x00000001u)
#define BITSERIAL2_CLK_SAMP_OFFSET_MSB_MASK      (0x00008000u)

enum bitserial2_config_sel_time_posn_enum
{
   BITSERIAL2_CONFIG_SEL_TIME_LSB_POSN                = (int)0,
   BITSERIAL2_CONFIG_SEL_TIME_BITSERIAL2_CONFIG_SEL_TIME_LSB_POSN = (int)0,
   BITSERIAL2_CONFIG_SEL_TIME_MSB_POSN                = (int)15,
   BITSERIAL2_CONFIG_SEL_TIME_BITSERIAL2_CONFIG_SEL_TIME_MSB_POSN = (int)15
};
typedef enum bitserial2_config_sel_time_posn_enum bitserial2_config_sel_time_posn;

#define BITSERIAL2_CONFIG_SEL_TIME_LSB_MASK      (0x00000001u)
#define BITSERIAL2_CONFIG_SEL_TIME_MSB_MASK      (0x00008000u)

enum bitserial2_config_sel_time2_posn_enum
{
   BITSERIAL2_CONFIG_SEL_TIME2_LSB_POSN               = (int)0,
   BITSERIAL2_CONFIG_SEL_TIME2_BITSERIAL2_CONFIG_SEL_TIME2_LSB_POSN = (int)0,
   BITSERIAL2_CONFIG_SEL_TIME2_MSB_POSN               = (int)3,
   BITSERIAL2_CONFIG_SEL_TIME2_BITSERIAL2_CONFIG_SEL_TIME2_MSB_POSN = (int)3
};
typedef enum bitserial2_config_sel_time2_posn_enum bitserial2_config_sel_time2_posn;

#define BITSERIAL2_CONFIG_SEL_TIME2_LSB_MASK     (0x00000001u)
#define BITSERIAL2_CONFIG_SEL_TIME2_MSB_MASK     (0x00000008u)

enum bitserial2_curator_ssid_posn_enum
{
   BITSERIAL2_CURATOR_SSID_LSB_POSN                   = (int)0,
   BITSERIAL2_CURATOR_SSID_BITSERIAL2_CURATOR_SSID_LSB_POSN = (int)0,
   BITSERIAL2_CURATOR_SSID_MSB_POSN                   = (int)3,
   BITSERIAL2_CURATOR_SSID_BITSERIAL2_CURATOR_SSID_MSB_POSN = (int)3
};
typedef enum bitserial2_curator_ssid_posn_enum bitserial2_curator_ssid_posn;

#define BITSERIAL2_CURATOR_SSID_LSB_MASK         (0x00000001u)
#define BITSERIAL2_CURATOR_SSID_MSB_MASK         (0x00000008u)

enum bitserial2_deep_sleep_active_posn_enum
{
   BITSERIAL2_DEEP_SLEEP_ACTIVE_POSN                  = (int)0,
   BITSERIAL2_DEEP_SLEEP_ACTIVE_BITSERIAL2_DEEP_SLEEP_ACTIVE_LSB_POSN = (int)0,
   BITSERIAL2_DEEP_SLEEP_ACTIVE_BITSERIAL2_DEEP_SLEEP_ACTIVE_MSB_POSN = (int)0
};
typedef enum bitserial2_deep_sleep_active_posn_enum bitserial2_deep_sleep_active_posn;

#define BITSERIAL2_DEEP_SLEEP_ACTIVE_MASK        (0x00000001u)

enum bitserial2_i2c_address_posn_enum
{
   BITSERIAL2_I2C_ADDRESS_LSB_POSN                    = (int)0,
   BITSERIAL2_I2C_ADDRESS_BITSERIAL2_I2C_ADDRESS_LSB_POSN = (int)0,
   BITSERIAL2_I2C_ADDRESS_MSB_POSN                    = (int)9,
   BITSERIAL2_I2C_ADDRESS_BITSERIAL2_I2C_ADDRESS_MSB_POSN = (int)9
};
typedef enum bitserial2_i2c_address_posn_enum bitserial2_i2c_address_posn;

#define BITSERIAL2_I2C_ADDRESS_LSB_MASK          (0x00000001u)
#define BITSERIAL2_I2C_ADDRESS_MSB_MASK          (0x00000200u)

enum bitserial2_interrupt_clear_posn_enum
{
   BITSERIAL2_INTERRUPT_CLEAR_LSB_POSN                = (int)0,
   BITSERIAL2_INTERRUPT_CLEAR_BITSERIAL2_INTERRUPT_CLEAR_LSB_POSN = (int)0,
   BITSERIAL2_INTERRUPT_CLEAR_MSB_POSN                = (int)13,
   BITSERIAL2_INTERRUPT_CLEAR_BITSERIAL2_INTERRUPT_CLEAR_MSB_POSN = (int)13
};
typedef enum bitserial2_interrupt_clear_posn_enum bitserial2_interrupt_clear_posn;

#define BITSERIAL2_INTERRUPT_CLEAR_LSB_MASK      (0x00000001u)
#define BITSERIAL2_INTERRUPT_CLEAR_MSB_MASK      (0x00002000u)

enum bitserial2_interrupt_en_posn_enum
{
   BITSERIAL2_INTERRUPT_EN_LSB_POSN                   = (int)0,
   BITSERIAL2_INTERRUPT_EN_BITSERIAL2_INTERRUPT_EN_LSB_POSN = (int)0,
   BITSERIAL2_INTERRUPT_EN_MSB_POSN                   = (int)13,
   BITSERIAL2_INTERRUPT_EN_BITSERIAL2_INTERRUPT_EN_MSB_POSN = (int)13
};
typedef enum bitserial2_interrupt_en_posn_enum bitserial2_interrupt_en_posn;

#define BITSERIAL2_INTERRUPT_EN_LSB_MASK         (0x00000001u)
#define BITSERIAL2_INTERRUPT_EN_MSB_MASK         (0x00002000u)

enum bitserial2_interrupt_source_posn_enum
{
   BITSERIAL2_INTERRUPT_SOURCE_LSB_POSN               = (int)0,
   BITSERIAL2_INTERRUPT_SOURCE_BITSERIAL2_INTERRUPT_SOURCE_LSB_POSN = (int)0,
   BITSERIAL2_INTERRUPT_SOURCE_MSB_POSN               = (int)13,
   BITSERIAL2_INTERRUPT_SOURCE_BITSERIAL2_INTERRUPT_SOURCE_MSB_POSN = (int)13
};
typedef enum bitserial2_interrupt_source_posn_enum bitserial2_interrupt_source_posn;

#define BITSERIAL2_INTERRUPT_SOURCE_LSB_MASK     (0x00000001u)
#define BITSERIAL2_INTERRUPT_SOURCE_MSB_MASK     (0x00002000u)

enum bitserial2_interrupt_source_clear_posn_enum
{
   BITSERIAL2_INTERRUPT_SOURCE_CLEAR_LSB_POSN         = (int)0,
   BITSERIAL2_INTERRUPT_SOURCE_CLEAR_BITSERIAL2_INTERRUPT_SOURCE_CLEAR_LSB_POSN = (int)0,
   BITSERIAL2_INTERRUPT_SOURCE_CLEAR_MSB_POSN         = (int)13,
   BITSERIAL2_INTERRUPT_SOURCE_CLEAR_BITSERIAL2_INTERRUPT_SOURCE_CLEAR_MSB_POSN = (int)13
};
typedef enum bitserial2_interrupt_source_clear_posn_enum bitserial2_interrupt_source_clear_posn;

#define BITSERIAL2_INTERRUPT_SOURCE_CLEAR_LSB_MASK (0x00000001u)
#define BITSERIAL2_INTERRUPT_SOURCE_CLEAR_MSB_MASK (0x00002000u)

enum bitserial2_interrupt_status_posn_enum
{
   BITSERIAL2_INTERRUPT_STATUS_LSB_POSN               = (int)0,
   BITSERIAL2_INTERRUPT_STATUS_BITSERIAL2_INTERRUPT_STATUS_LSB_POSN = (int)0,
   BITSERIAL2_INTERRUPT_STATUS_MSB_POSN               = (int)13,
   BITSERIAL2_INTERRUPT_STATUS_BITSERIAL2_INTERRUPT_STATUS_MSB_POSN = (int)13
};
typedef enum bitserial2_interrupt_status_posn_enum bitserial2_interrupt_status_posn;

#define BITSERIAL2_INTERRUPT_STATUS_LSB_MASK     (0x00000001u)
#define BITSERIAL2_INTERRUPT_STATUS_MSB_MASK     (0x00002000u)

enum bitserial2_remote_subsystem_ssid_posn_enum
{
   BITSERIAL2_REMOTE_SUBSYSTEM_SSID_LSB_POSN          = (int)0,
   BITSERIAL2_REMOTE_SUBSYSTEM_SSID_BITSERIAL2_REMOTE_SUBSYSTEM_SSID_LSB_POSN = (int)0,
   BITSERIAL2_REMOTE_SUBSYSTEM_SSID_MSB_POSN          = (int)3,
   BITSERIAL2_REMOTE_SUBSYSTEM_SSID_BITSERIAL2_REMOTE_SUBSYSTEM_SSID_MSB_POSN = (int)3
};
typedef enum bitserial2_remote_subsystem_ssid_posn_enum bitserial2_remote_subsystem_ssid_posn;

#define BITSERIAL2_REMOTE_SUBSYSTEM_SSID_LSB_MASK (0x00000001u)
#define BITSERIAL2_REMOTE_SUBSYSTEM_SSID_MSB_MASK (0x00000008u)

enum bitserial2_set_sel_inactive_posn_enum
{
   BITSERIAL2_SET_SEL_INACTIVE_POSN                   = (int)0,
   BITSERIAL2_SET_SEL_INACTIVE_BITSERIAL2_SET_SEL_INACTIVE_LSB_POSN = (int)0,
   BITSERIAL2_SET_SEL_INACTIVE_BITSERIAL2_SET_SEL_INACTIVE_MSB_POSN = (int)0
};
typedef enum bitserial2_set_sel_inactive_posn_enum bitserial2_set_sel_inactive_posn;

#define BITSERIAL2_SET_SEL_INACTIVE_MASK         (0x00000001u)

enum bitserial2_slave_data_ready_byte_posn_enum
{
   BITSERIAL2_SLAVE_DATA_READY_BYTE_LSB_POSN          = (int)0,
   BITSERIAL2_SLAVE_DATA_READY_BYTE_BITSERIAL2_SLAVE_DATA_READY_BYTE_LSB_POSN = (int)0,
   BITSERIAL2_SLAVE_DATA_READY_BYTE_MSB_POSN          = (int)7,
   BITSERIAL2_SLAVE_DATA_READY_BYTE_BITSERIAL2_SLAVE_DATA_READY_BYTE_MSB_POSN = (int)7
};
typedef enum bitserial2_slave_data_ready_byte_posn_enum bitserial2_slave_data_ready_byte_posn;

#define BITSERIAL2_SLAVE_DATA_READY_BYTE_LSB_MASK (0x00000001u)
#define BITSERIAL2_SLAVE_DATA_READY_BYTE_MSB_MASK (0x00000080u)

enum bitserial2_slave_num_protocol_words_posn_enum
{
   BITSERIAL2_SLAVE_NUM_PROTOCOL_WORDS_LSB_POSN       = (int)0,
   BITSERIAL2_SLAVE_NUM_PROTOCOL_WORDS_BITSERIAL2_SLAVE_NUM_PROTOCOL_WORDS_LSB_POSN = (int)0,
   BITSERIAL2_SLAVE_NUM_PROTOCOL_WORDS_MSB_POSN       = (int)15,
   BITSERIAL2_SLAVE_NUM_PROTOCOL_WORDS_BITSERIAL2_SLAVE_NUM_PROTOCOL_WORDS_MSB_POSN = (int)15
};
typedef enum bitserial2_slave_num_protocol_words_posn_enum bitserial2_slave_num_protocol_words_posn;

#define BITSERIAL2_SLAVE_NUM_PROTOCOL_WORDS_LSB_MASK (0x00000001u)
#define BITSERIAL2_SLAVE_NUM_PROTOCOL_WORDS_MSB_MASK (0x00008000u)

enum bitserial2_slave_read_command_byte_posn_enum
{
   BITSERIAL2_SLAVE_READ_COMMAND_BYTE_LSB_POSN        = (int)0,
   BITSERIAL2_SLAVE_READ_COMMAND_BYTE_BITSERIAL2_SLAVE_READ_COMMAND_BYTE_LSB_POSN = (int)0,
   BITSERIAL2_SLAVE_READ_COMMAND_BYTE_MSB_POSN        = (int)7,
   BITSERIAL2_SLAVE_READ_COMMAND_BYTE_BITSERIAL2_SLAVE_READ_COMMAND_BYTE_MSB_POSN = (int)7
};
typedef enum bitserial2_slave_read_command_byte_posn_enum bitserial2_slave_read_command_byte_posn;

#define BITSERIAL2_SLAVE_READ_COMMAND_BYTE_LSB_MASK (0x00000001u)
#define BITSERIAL2_SLAVE_READ_COMMAND_BYTE_MSB_MASK (0x00000080u)

enum bitserial2_slave_read_count_posn_enum
{
   BITSERIAL2_SLAVE_READ_COUNT_LSB_POSN               = (int)0,
   BITSERIAL2_SLAVE_READ_COUNT_BITSERIAL2_SLAVE_READ_COUNT_LSB_POSN = (int)0,
   BITSERIAL2_SLAVE_READ_COUNT_MSB_POSN               = (int)15,
   BITSERIAL2_SLAVE_READ_COUNT_BITSERIAL2_SLAVE_READ_COUNT_MSB_POSN = (int)15
};
typedef enum bitserial2_slave_read_count_posn_enum bitserial2_slave_read_count_posn;

#define BITSERIAL2_SLAVE_READ_COUNT_LSB_MASK     (0x00000001u)
#define BITSERIAL2_SLAVE_READ_COUNT_MSB_MASK     (0x00008000u)

enum bitserial2_slave_underflow_byte_posn_enum
{
   BITSERIAL2_SLAVE_UNDERFLOW_BYTE_LSB_POSN           = (int)0,
   BITSERIAL2_SLAVE_UNDERFLOW_BYTE_BITSERIAL2_SLAVE_UNDERFLOW_BYTE_LSB_POSN = (int)0,
   BITSERIAL2_SLAVE_UNDERFLOW_BYTE_MSB_POSN           = (int)7,
   BITSERIAL2_SLAVE_UNDERFLOW_BYTE_BITSERIAL2_SLAVE_UNDERFLOW_BYTE_MSB_POSN = (int)7
};
typedef enum bitserial2_slave_underflow_byte_posn_enum bitserial2_slave_underflow_byte_posn;

#define BITSERIAL2_SLAVE_UNDERFLOW_BYTE_LSB_MASK (0x00000001u)
#define BITSERIAL2_SLAVE_UNDERFLOW_BYTE_MSB_MASK (0x00000080u)

enum bitserial2_slave_write_count_posn_enum
{
   BITSERIAL2_SLAVE_WRITE_COUNT_LSB_POSN              = (int)0,
   BITSERIAL2_SLAVE_WRITE_COUNT_BITSERIAL2_SLAVE_WRITE_COUNT_LSB_POSN = (int)0,
   BITSERIAL2_SLAVE_WRITE_COUNT_MSB_POSN              = (int)15,
   BITSERIAL2_SLAVE_WRITE_COUNT_BITSERIAL2_SLAVE_WRITE_COUNT_MSB_POSN = (int)15
};
typedef enum bitserial2_slave_write_count_posn_enum bitserial2_slave_write_count_posn;

#define BITSERIAL2_SLAVE_WRITE_COUNT_LSB_MASK    (0x00000001u)
#define BITSERIAL2_SLAVE_WRITE_COUNT_MSB_MASK    (0x00008000u)

enum bitserial2_streaming_threshold_posn_enum
{
   BITSERIAL2_STREAMING_THRESHOLD_LSB_POSN            = (int)0,
   BITSERIAL2_STREAMING_THRESHOLD_BITSERIAL2_STREAMING_THRESHOLD_LSB_POSN = (int)0,
   BITSERIAL2_STREAMING_THRESHOLD_MSB_POSN            = (int)15,
   BITSERIAL2_STREAMING_THRESHOLD_BITSERIAL2_STREAMING_THRESHOLD_MSB_POSN = (int)15
};
typedef enum bitserial2_streaming_threshold_posn_enum bitserial2_streaming_threshold_posn;

#define BITSERIAL2_STREAMING_THRESHOLD_LSB_MASK  (0x00000001u)
#define BITSERIAL2_STREAMING_THRESHOLD_MSB_MASK  (0x00008000u)

enum bitserial2_txrx_length_posn_enum
{
   BITSERIAL2_TXRX_LENGTH_LSB_POSN                    = (int)0,
   BITSERIAL2_TXRX_LENGTH_BITSERIAL2_TXRX_LENGTH_LSB_POSN = (int)0,
   BITSERIAL2_TXRX_LENGTH_MSB_POSN                    = (int)15,
   BITSERIAL2_TXRX_LENGTH_BITSERIAL2_TXRX_LENGTH_MSB_POSN = (int)15
};
typedef enum bitserial2_txrx_length_posn_enum bitserial2_txrx_length_posn;

#define BITSERIAL2_TXRX_LENGTH_LSB_MASK          (0x00000001u)
#define BITSERIAL2_TXRX_LENGTH_MSB_MASK          (0x00008000u)

enum bitserial2_txrx_length2_posn_enum
{
   BITSERIAL2_TXRX_LENGTH2_LSB_POSN                   = (int)0,
   BITSERIAL2_TXRX_LENGTH2_BITSERIAL2_TXRX_LENGTH2_LSB_POSN = (int)0,
   BITSERIAL2_TXRX_LENGTH2_MSB_POSN                   = (int)15,
   BITSERIAL2_TXRX_LENGTH2_BITSERIAL2_TXRX_LENGTH2_MSB_POSN = (int)15
};
typedef enum bitserial2_txrx_length2_posn_enum bitserial2_txrx_length2_posn;

#define BITSERIAL2_TXRX_LENGTH2_LSB_MASK         (0x00000001u)
#define BITSERIAL2_TXRX_LENGTH2_MSB_MASK         (0x00008000u)

enum bitserial2_words_sent_posn_enum
{
   BITSERIAL2_WORDS_SENT_LSB_POSN                     = (int)0,
   BITSERIAL2_WORDS_SENT_BITSERIAL2_WORDS_SENT_LSB_POSN = (int)0,
   BITSERIAL2_WORDS_SENT_MSB_POSN                     = (int)15,
   BITSERIAL2_WORDS_SENT_BITSERIAL2_WORDS_SENT_MSB_POSN = (int)15
};
typedef enum bitserial2_words_sent_posn_enum bitserial2_words_sent_posn;

#define BITSERIAL2_WORDS_SENT_LSB_MASK           (0x00000001u)
#define BITSERIAL2_WORDS_SENT_MSB_MASK           (0x00008000u)

enum bitserial2_rx_buffer_posn_enum
{
   BITSERIAL2_RX_BUFFER_BITSERIAL2_BUFF_HANDLE_LSB_POSN = (int)0,
   BITSERIAL2_RX_BUFFER_BITSERIAL2_BUFF_HANDLE_MSB_POSN = (int)7,
   BITSERIAL2_RX_BUFFER_BITSERIAL2_REMOTE_SSID_LSB_POSN = (int)8,
   BITSERIAL2_RX_BUFFER_BITSERIAL2_REMOTE_SSID_MSB_POSN = (int)11
};
typedef enum bitserial2_rx_buffer_posn_enum bitserial2_rx_buffer_posn;


enum bitserial2_rx_buffer2_posn_enum
{
   BITSERIAL2_RX_BUFFER2_BITSERIAL2_BUFF_HANDLE_LSB_POSN = (int)0,
   BITSERIAL2_RX_BUFFER2_BITSERIAL2_BUFF_HANDLE_MSB_POSN = (int)7,
   BITSERIAL2_RX_BUFFER2_BITSERIAL2_REMOTE_SSID_LSB_POSN = (int)8,
   BITSERIAL2_RX_BUFFER2_BITSERIAL2_REMOTE_SSID_MSB_POSN = (int)11
};
typedef enum bitserial2_rx_buffer2_posn_enum bitserial2_rx_buffer2_posn;


enum bitserial2_tx_buffer_posn_enum
{
   BITSERIAL2_TX_BUFFER_BITSERIAL2_BUFF_HANDLE_LSB_POSN = (int)0,
   BITSERIAL2_TX_BUFFER_BITSERIAL2_BUFF_HANDLE_MSB_POSN = (int)7,
   BITSERIAL2_TX_BUFFER_BITSERIAL2_REMOTE_SSID_LSB_POSN = (int)8,
   BITSERIAL2_TX_BUFFER_BITSERIAL2_REMOTE_SSID_MSB_POSN = (int)11
};
typedef enum bitserial2_tx_buffer_posn_enum bitserial2_tx_buffer_posn;


enum bitserial2_tx_buffer2_posn_enum
{
   BITSERIAL2_TX_BUFFER2_BITSERIAL2_BUFF_HANDLE_LSB_POSN = (int)0,
   BITSERIAL2_TX_BUFFER2_BITSERIAL2_BUFF_HANDLE_MSB_POSN = (int)7,
   BITSERIAL2_TX_BUFFER2_BITSERIAL2_REMOTE_SSID_LSB_POSN = (int)8,
   BITSERIAL2_TX_BUFFER2_BITSERIAL2_REMOTE_SSID_MSB_POSN = (int)11
};
typedef enum bitserial2_tx_buffer2_posn_enum bitserial2_tx_buffer2_posn;


#endif /* IO_DEFS_MODULE_BITSERIAL2 */
#endif /* __IO_DEFS_H__IO_DEFS_MODULE_BITSERIAL2 */
...
enum host_sys_block_ids_enum
{
   ...
   HOST_SYS_BITSERIAL_2_BLOCK_ID            = (int)0x5,
...
enum host_sys_config_force_clk_enables_posn_enum
{
   ...
   HOST_SYS_BITSERIAL_2_CLK_FORCE_ENABLE_POSN         = (int)4,
   HOST_SYS_CONFIG_FORCE_CLK_ENABLES_HOST_SYS_BITSERIAL_2_CLK_FORCE_ENABLE_LSB_POSN = (int)4,
   HOST_SYS_CONFIG_FORCE_CLK_ENABLES_HOST_SYS_BITSERIAL_2_CLK_FORCE_ENABLE_MSB_POSN = (int)4,
   HOST_SYS_SDIO_CLK_FORCE_ENABLE_POSN                = (int)5,
   HOST_SYS_CONFIG_FORCE_CLK_ENABLES_HOST_SYS_SDIO_CLK_FORCE_ENABLE_LSB_POSN = (int)5,
   HOST_SYS_CONFIG_FORCE_CLK_ENABLES_HOST_SYS_SDIO_CLK_FORCE_ENABLE_MSB_POSN = (int)5,
   HOST_SYS_REG_IF_CLK_FORCE_ENABLE_POSN              = (int)6,
   HOST_SYS_CONFIG_FORCE_CLK_ENABLES_HOST_SYS_REG_IF_CLK_FORCE_ENABLE_LSB_POSN = (int)6,
   HOST_SYS_CONFIG_FORCE_CLK_ENABLES_HOST_SYS_REG_IF_CLK_FORCE_ENABLE_MSB_POSN = (int)6,
   HOST_SYS_CONFIG_CLK_FORCE_ENABLE_POSN              = (int)7,
   HOST_SYS_CONFIG_FORCE_CLK_ENABLES_HOST_SYS_CONFIG_CLK_FORCE_ENABLE_LSB_POSN = (int)7,
   HOST_SYS_CONFIG_FORCE_CLK_ENABLES_HOST_SYS_CONFIG_CLK_FORCE_ENABLE_MSB_POSN = (int)7
};
...
#define HOST_SYS_BITSERIAL_2_CLK_FORCE_ENABLE_MASK (0x00000010u)
#define HOST_SYS_SDIO_CLK_FORCE_ENABLE_MASK      (0x00000020u)
#define HOST_SYS_REG_IF_CLK_FORCE_ENABLE_MASK    (0x00000040u)
#define HOST_SYS_CONFIG_CLK_FORCE_ENABLE_MASK    (0x00000080u)
...
enum usb_tx_prefetch_ram_0_to_3_emas_posn_enum
{
   USB_TX_PREFETCH_RAM0_EMAS_POSN                     = (int)0,
   USB_TX_PREFETCH_RAM_0_TO_3_EMAS_USB_TX_PREFETCH_RAM0_EMAS_LSB_POSN = (int)0,
   USB_TX_PREFETCH_RAM_0_TO_3_EMAS_USB_TX_PREFETCH_RAM0_EMAS_MSB_POSN = (int)0,
   USB_TX_PREFETCH_RAM1_EMAS_POSN                     = (int)1,
   USB_TX_PREFETCH_RAM_0_TO_3_EMAS_USB_TX_PREFETCH_RAM1_EMAS_LSB_POSN = (int)1,
   USB_TX_PREFETCH_RAM_0_TO_3_EMAS_USB_TX_PREFETCH_RAM1_EMAS_MSB_POSN = (int)1,
   USB_TX_PREFETCH_RAM2_EMAS_POSN                     = (int)2,
   USB_TX_PREFETCH_RAM_0_TO_3_EMAS_USB_TX_PREFETCH_RAM2_EMAS_LSB_POSN = (int)2,
   USB_TX_PREFETCH_RAM_0_TO_3_EMAS_USB_TX_PREFETCH_RAM2_EMAS_MSB_POSN = (int)2,
   USB_TX_PREFETCH_RAM3_EMAS_POSN                     = (int)3,
   USB_TX_PREFETCH_RAM_0_TO_3_EMAS_USB_TX_PREFETCH_RAM3_EMAS_LSB_POSN = (int)3,
   USB_TX_PREFETCH_RAM_0_TO_3_EMAS_USB_TX_PREFETCH_RAM3_EMAS_MSB_POSN = (int)3
};
typedef enum usb_tx_prefetch_ram_0_to_3_emas_posn_enum usb_tx_prefetch_ram_0_to_3_emas_posn;

#define USB_TX_PREFETCH_RAM0_EMAS_MASK           (0x00000001u)
#define USB_TX_PREFETCH_RAM1_EMAS_MASK           (0x00000002u)
#define USB_TX_PREFETCH_RAM2_EMAS_MASK           (0x00000004u)
#define USB_TX_PREFETCH_RAM3_EMAS_MASK           (0x00000008u)
...
enum usb_tx_prefetch_ram_rdt_posn_enum
{
   USB_TX_PREFETCH_COMMON_RDT_POSN                    = (int)0,
   USB_TX_PREFETCH_RAM_RDT_USB_TX_PREFETCH_COMMON_RDT_LSB_POSN = (int)0,
   USB_TX_PREFETCH_RAM_RDT_USB_TX_PREFETCH_COMMON_RDT_MSB_POSN = (int)0
};
typedef enum usb_tx_prefetch_ram_rdt_posn_enum usb_tx_prefetch_ram_rdt_posn;

#define USB_TX_PREFETCH_COMMON_RDT_MASK          (0x00000001u)
...
enum host_sys_bitserial_2_clk_input_pio_ctrl_posn_enum
{
   HOST_SYS_BITSERIAL_2_CLK_INPUT_PIO_CTRL_LSB_POSN   = (int)0,
   HOST_SYS_BITSERIAL_2_CLK_INPUT_PIO_CTRL_HOST_SYS_BITSERIAL_2_CLK_INPUT_PIO_CTRL_LSB_POSN = (int)0,
   HOST_SYS_BITSERIAL_2_CLK_INPUT_PIO_CTRL_MSB_POSN   = (int)6,
   HOST_SYS_BITSERIAL_2_CLK_INPUT_PIO_CTRL_HOST_SYS_BITSERIAL_2_CLK_INPUT_PIO_CTRL_MSB_POSN = (int)6
};
typedef enum host_sys_bitserial_2_clk_input_pio_ctrl_posn_enum host_sys_bitserial_2_clk_input_pio_ctrl_posn;

#define HOST_SYS_BITSERIAL_2_CLK_INPUT_PIO_CTRL_LSB_MASK (0x00000001u)
#define HOST_SYS_BITSERIAL_2_CLK_INPUT_PIO_CTRL_MSB_MASK (0x00000040u)

enum host_sys_bitserial_2_clk_output_pio_ctrl_posn_enum
{
   HOST_SYS_BITSERIAL_2_CLK_OUTPUT_PIO_CTRL_LSB_POSN  = (int)0,
   HOST_SYS_BITSERIAL_2_CLK_OUTPUT_PIO_CTRL_HOST_SYS_BITSERIAL_2_CLK_OUTPUT_PIO_CTRL_LSB_POSN = (int)0,
   HOST_SYS_BITSERIAL_2_CLK_OUTPUT_PIO_CTRL_MSB_POSN  = (int)6,
   HOST_SYS_BITSERIAL_2_CLK_OUTPUT_PIO_CTRL_HOST_SYS_BITSERIAL_2_CLK_OUTPUT_PIO_CTRL_MSB_POSN = (int)6
};
typedef enum host_sys_bitserial_2_clk_output_pio_ctrl_posn_enum host_sys_bitserial_2_clk_output_pio_ctrl_posn;

#define HOST_SYS_BITSERIAL_2_CLK_OUTPUT_PIO_CTRL_LSB_MASK (0x00000001u)
#define HOST_SYS_BITSERIAL_2_CLK_OUTPUT_PIO_CTRL_MSB_MASK (0x00000040u)

enum host_sys_bitserial_2_data_input_pio_ctrl_posn_enum
{
   HOST_SYS_BITSERIAL_2_DATA_INPUT_PIO_CTRL_LSB_POSN  = (int)0,
   HOST_SYS_BITSERIAL_2_DATA_INPUT_PIO_CTRL_HOST_SYS_BITSERIAL_2_DATA_INPUT_PIO_CTRL_LSB_POSN = (int)0,
   HOST_SYS_BITSERIAL_2_DATA_INPUT_PIO_CTRL_MSB_POSN  = (int)6,
   HOST_SYS_BITSERIAL_2_DATA_INPUT_PIO_CTRL_HOST_SYS_BITSERIAL_2_DATA_INPUT_PIO_CTRL_MSB_POSN = (int)6
};
typedef enum host_sys_bitserial_2_data_input_pio_ctrl_posn_enum host_sys_bitserial_2_data_input_pio_ctrl_posn;

#define HOST_SYS_BITSERIAL_2_DATA_INPUT_PIO_CTRL_LSB_MASK (0x00000001u)
#define HOST_SYS_BITSERIAL_2_DATA_INPUT_PIO_CTRL_MSB_MASK (0x00000040u)

enum host_sys_bitserial_2_data_output_pio_ctrl_posn_enum
{
   HOST_SYS_BITSERIAL_2_DATA_OUTPUT_PIO_CTRL_LSB_POSN = (int)0,
   HOST_SYS_BITSERIAL_2_DATA_OUTPUT_PIO_CTRL_HOST_SYS_BITSERIAL_2_DATA_OUTPUT_PIO_CTRL_LSB_POSN = (int)0,
   HOST_SYS_BITSERIAL_2_DATA_OUTPUT_PIO_CTRL_MSB_POSN = (int)6,
   HOST_SYS_BITSERIAL_2_DATA_OUTPUT_PIO_CTRL_HOST_SYS_BITSERIAL_2_DATA_OUTPUT_PIO_CTRL_MSB_POSN = (int)6
};
typedef enum host_sys_bitserial_2_data_output_pio_ctrl_posn_enum host_sys_bitserial_2_data_output_pio_ctrl_posn;

#define HOST_SYS_BITSERIAL_2_DATA_OUTPUT_PIO_CTRL_LSB_MASK (0x00000001u)
#define HOST_SYS_BITSERIAL_2_DATA_OUTPUT_PIO_CTRL_MSB_MASK (0x00000040u)

enum host_sys_bitserial_2_sel_input_pio_ctrl_posn_enum
{
   HOST_SYS_BITSERIAL_2_SEL_INPUT_PIO_CTRL_LSB_POSN   = (int)0,
   HOST_SYS_BITSERIAL_2_SEL_INPUT_PIO_CTRL_HOST_SYS_BITSERIAL_2_SEL_INPUT_PIO_CTRL_LSB_POSN = (int)0,
   HOST_SYS_BITSERIAL_2_SEL_INPUT_PIO_CTRL_MSB_POSN   = (int)6,
   HOST_SYS_BITSERIAL_2_SEL_INPUT_PIO_CTRL_HOST_SYS_BITSERIAL_2_SEL_INPUT_PIO_CTRL_MSB_POSN = (int)6
};
typedef enum host_sys_bitserial_2_sel_input_pio_ctrl_posn_enum host_sys_bitserial_2_sel_input_pio_ctrl_posn;

#define HOST_SYS_BITSERIAL_2_SEL_INPUT_PIO_CTRL_LSB_MASK (0x00000001u)
#define HOST_SYS_BITSERIAL_2_SEL_INPUT_PIO_CTRL_MSB_MASK (0x00000040u)

enum host_sys_bitserial_2_sel_output_pio_ctrl_posn_enum
{
   HOST_SYS_BITSERIAL_2_SEL_OUTPUT_PIO_CTRL_LSB_POSN  = (int)0,
   HOST_SYS_BITSERIAL_2_SEL_OUTPUT_PIO_CTRL_HOST_SYS_BITSERIAL_2_SEL_OUTPUT_PIO_CTRL_LSB_POSN = (int)0,
   HOST_SYS_BITSERIAL_2_SEL_OUTPUT_PIO_CTRL_MSB_POSN  = (int)6,
   HOST_SYS_BITSERIAL_2_SEL_OUTPUT_PIO_CTRL_HOST_SYS_BITSERIAL_2_SEL_OUTPUT_PIO_CTRL_MSB_POSN = (int)6
};
typedef enum host_sys_bitserial_2_sel_output_pio_ctrl_posn_enum host_sys_bitserial_2_sel_output_pio_ctrl_posn;

#define HOST_SYS_BITSERIAL_2_SEL_OUTPUT_PIO_CTRL_LSB_MASK (0x00000001u)
#define HOST_SYS_BITSERIAL_2_SEL_OUTPUT_PIO_CTRL_MSB_MASK (0x00000040u)
...
enum host_sys_uart_single_wire_enable_posn_enum
{
   HOST_SYS_UART_SINGLE_WIRE_ENABLE_POSN              = (int)0,
   HOST_SYS_UART_SINGLE_WIRE_ENABLE_HOST_SYS_UART_SINGLE_WIRE_ENABLE_LSB_POSN = (int)0,
   HOST_SYS_UART_SINGLE_WIRE_ENABLE_HOST_SYS_UART_SINGLE_WIRE_ENABLE_MSB_POSN = (int)0
};
typedef enum host_sys_uart_single_wire_enable_posn_enum host_sys_uart_single_wire_enable_posn;

#define HOST_SYS_UART_SINGLE_WIRE_ENABLE_MASK    (0x00000001u)

enum host_sys_uart_single_wire_tx_not_rx_posn_enum
{
   HOST_SYS_UART_SINGLE_WIRE_TX_NOT_RX_POSN           = (int)0,
   HOST_SYS_UART_SINGLE_WIRE_TX_NOT_RX_HOST_SYS_UART_SINGLE_WIRE_TX_NOT_RX_LSB_POSN = (int)0,
   HOST_SYS_UART_SINGLE_WIRE_TX_NOT_RX_HOST_SYS_UART_SINGLE_WIRE_TX_NOT_RX_MSB_POSN = (int)0
};
typedef enum host_sys_uart_single_wire_tx_not_rx_posn_enum host_sys_uart_single_wire_tx_not_rx_posn;

#define HOST_SYS_UART_SINGLE_WIRE_TX_NOT_RX_MASK (0x00000001u)

enum host_sys_usb_phy_power_en_posn_enum
{
   HOST_SYS_USB_PHY_POWER_EN_POSN                     = (int)0,
   HOST_SYS_USB_PHY_POWER_EN_HOST_SYS_USB_PHY_POWER_EN_LSB_POSN = (int)0,
   HOST_SYS_USB_PHY_POWER_EN_HOST_SYS_USB_PHY_POWER_EN_MSB_POSN = (int)0
};
typedef enum host_sys_usb_phy_power_en_posn_enum host_sys_usb_phy_power_en_posn;

#define HOST_SYS_USB_PHY_POWER_EN_MASK           (0x00000001u)
...
enum mac_operand_mode_types_posn_enum
{
   MAC_OPERAND_MODE_TYPES_LSB_POSN                    = (int)0,
   MAC_OPERAND_MODE_TYPES_MAC_OPERAND_MODE_TYPES_LSB_POSN = (int)0,
   MAC_OPERAND_MODE_TYPES_MSB_POSN                    = (int)2,
   MAC_OPERAND_MODE_TYPES_MAC_OPERAND_MODE_TYPES_MSB_POSN = (int)2,
   MAC_OPERAND_MODE_FRACT_POSN                        = (int)3,
   MAC_OPERAND_MODE_TYPES_MAC_OPERAND_MODE_FRACT_LSB_POSN = (int)3,
   MAC_OPERAND_MODE_TYPES_MAC_OPERAND_MODE_FRACT_MSB_POSN = (int)3
};
typedef enum mac_operand_mode_types_posn_enum mac_operand_mode_types_posn;

#define MAC_OPERAND_MODE_TYPES_LSB_MASK          (0x00000001u)
#define MAC_OPERAND_MODE_TYPES_MSB_MASK          (0x00000004u)
#define MAC_OPERAND_MODE_FRACT_MASK              (0x00000008u)

enum mac_operand_mode_types_enum
{
   MAC_DEFAULT                              = (int)0x0,
   MAC_16_16                                = (int)0x1,
   MAC_32_16                                = (int)0x2,
   ...
   MAC_16_8                                 = (int)0x4,
   MAC2_8_8                                 = (int)0x5,
   MAX_MAC_OPERAND_MODE_TYPES               = (int)0x5
};
#define NUM_MAC_OPERAND_MODE_TYPES (0x6)
typedef enum mac_operand_mode_types_enum mac_operand_mode_types;
...
enum mac_operand_mode_posn_enum
{
   MAC_OPERAND_MODE_MAC_OPERAND_MODE_TYPES_LSB_POSN   = (int)0,
   MAC_OPERAND_MODE_MAC_OPERAND_MODE_TYPES_MSB_POSN   = (int)2,
   MAC_OPERAND_MODE_MAC_OPERAND_MODE_FRACT_LSB_POSN   = (int)3,
   MAC_OPERAND_MODE_MAC_OPERAND_MODE_FRACT_MSB_POSN   = (int)3
};
typedef enum mac_operand_mode_posn_enum mac_operand_mode_posn;
...
enum apps_sys_debug_source_enum
{
   ...
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU0_DM_5  = (int)0x4F,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_CACHE_RAM0_0 = (int)0x50,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_CACHE_RAM0_1 = (int)0x51,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_CACHE_RAM1_0 = (int)0x52,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_CACHE_RAM1_1 = (int)0x53,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_CACHE_TAG = (int)0x54,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_DM_0  = (int)0x55,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_DM_1  = (int)0x56,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_DM_2  = (int)0x57,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_DM_3  = (int)0x58,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_CPU1_DM_4  = (int)0x59,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_TCM1_0     = (int)0x5A,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_TCM1_1     = (int)0x5B,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_TCM1_2     = (int)0x5C,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_TCM1_3     = (int)0x5D,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_TCM0_LOWER = (int)0x5E,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_TCM0_UPPER = (int)0x5F,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_SHARED_MEM_0 = (int)0x60,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_SHARED_MEM_1 = (int)0x61,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_SHARED_MEM_2 = (int)0x62,
   APPS_SYS_DEBUG_SOURCE_RAM_SEQ_SHARED_MEM_3 = (int)0x63,
   APPS_SYS_DEBUG_SOURCE_LAST               = (int)0x66,
   MAX_APPS_SYS_DEBUG_SOURCE                = (int)0x66
};
...
{
   TCM_REMAP_ENABLE_POSN                              = (int)0,
   TCM_REMAP_CONTROLS_TCM_REMAP_ENABLE_LSB_POSN       = (int)0,
   TCM_REMAP_CONTROLS_TCM_REMAP_ENABLE_MSB_POSN       = (int)0
};
typedef enum tcm_remap_controls_posn_enum tcm_remap_controls_posn;

#define TCM_REMAP_ENABLE_MASK                    (0x00000001u)
...
enum ram_sequencer_active_status_posn_enum
{
   ...
   RAM_SEQUENCER_ACTIVE_STATUS_MSB_POSN               = (int)9,
   RAM_SEQUENCER_ACTIVE_STATUS_RAM_SEQUENCER_ACTIVE_STATUS_MSB_POSN = (int)9
};
...
#define RAM_SEQUENCER_ACTIVE_STATUS_MSB_MASK     (0x00000200u)
...
{
   APPS_SYS_CPU0_TCM_REMAP_CONTROLS_TCM_REMAP_ENABLE_LSB_POSN = (int)0,
   APPS_SYS_CPU0_TCM_REMAP_CONTROLS_TCM_REMAP_ENABLE_MSB_POSN = (int)0
};
...
{
   APPS_SYS_CPU1_TCM_REMAP_CONTROLS_TCM_REMAP_ENABLE_LSB_POSN = (int)0,
   APPS_SYS_CPU1_TCM_REMAP_CONTROLS_TCM_REMAP_ENABLE_MSB_POSN = (int)0
};
...
#if defined(IO_DEFS_MODULE_K32_DEBUG_REGFILE) 

#ifndef __IO_DEFS_H__IO_DEFS_MODULE_K32_DEBUG_REGFILE
#define __IO_DEFS_H__IO_DEFS_MODULE_K32_DEBUG_REGFILE

/* -- k32_debug_regfile -- Kalimba 32-bit Register File Debug Control registers.  Note: All these registers are only accessable from SPI and T-Bus, not from Kalimba core itself. -- */

enum regfile_rflags_posn_enum
{
   N_FLAG_POSN                                        = (int)0,
   REGFILE_RFLAGS_N_FLAG_LSB_POSN                     = (int)0,
   REGFILE_RFLAGS_N_FLAG_MSB_POSN                     = (int)0,
   Z_FLAG_POSN                                        = (int)1,
   REGFILE_RFLAGS_Z_FLAG_LSB_POSN                     = (int)1,
   REGFILE_RFLAGS_Z_FLAG_MSB_POSN                     = (int)1,
   C_FLAG_POSN                                        = (int)2,
   REGFILE_RFLAGS_C_FLAG_LSB_POSN                     = (int)2,
   REGFILE_RFLAGS_C_FLAG_MSB_POSN                     = (int)2,
   V_FLAG_POSN                                        = (int)3,
   REGFILE_RFLAGS_V_FLAG_LSB_POSN                     = (int)3,
   REGFILE_RFLAGS_V_FLAG_MSB_POSN                     = (int)3,
   UD_FLAG_POSN                                       = (int)4,
   REGFILE_RFLAGS_UD_FLAG_LSB_POSN                    = (int)4,
   REGFILE_RFLAGS_UD_FLAG_MSB_POSN                    = (int)4,
   SV_FLAG_POSN                                       = (int)5,
   REGFILE_RFLAGS_SV_FLAG_LSB_POSN                    = (int)5,
   REGFILE_RFLAGS_SV_FLAG_MSB_POSN                    = (int)5,
   BR_FLAG_POSN                                       = (int)6,
   REGFILE_RFLAGS_BR_FLAG_LSB_POSN                    = (int)6,
   REGFILE_RFLAGS_BR_FLAG_MSB_POSN                    = (int)6,
   UM_FLAG_POSN                                       = (int)7,
   REGFILE_RFLAGS_UM_FLAG_LSB_POSN                    = (int)7,
   REGFILE_RFLAGS_UM_FLAG_MSB_POSN                    = (int)7,
   INT_N_FLAG_POSN                                    = (int)8,
   REGFILE_RFLAGS_INT_N_FLAG_LSB_POSN                 = (int)8,
   REGFILE_RFLAGS_INT_N_FLAG_MSB_POSN                 = (int)8,
   INT_Z_FLAG_POSN                                    = (int)9,
   REGFILE_RFLAGS_INT_Z_FLAG_LSB_POSN                 = (int)9,
   REGFILE_RFLAGS_INT_Z_FLAG_MSB_POSN                 = (int)9,
   INT_C_FLAG_POSN                                    = (int)10,
   REGFILE_RFLAGS_INT_C_FLAG_LSB_POSN                 = (int)10,
   REGFILE_RFLAGS_INT_C_FLAG_MSB_POSN                 = (int)10,
   INT_V_FLAG_POSN                                    = (int)11,
   REGFILE_RFLAGS_INT_V_FLAG_LSB_POSN                 = (int)11,
   REGFILE_RFLAGS_INT_V_FLAG_MSB_POSN                 = (int)11,
   INT_UD_FLAG_POSN                                   = (int)12,
   REGFILE_RFLAGS_INT_UD_FLAG_LSB_POSN                = (int)12,
   REGFILE_RFLAGS_INT_UD_FLAG_MSB_POSN                = (int)12,
   INT_SV_FLAG_POSN                                   = (int)13,
   REGFILE_RFLAGS_INT_SV_FLAG_LSB_POSN                = (int)13,
   REGFILE_RFLAGS_INT_SV_FLAG_MSB_POSN                = (int)13,
   INT_BR_FLAG_POSN                                   = (int)14,
   REGFILE_RFLAGS_INT_BR_FLAG_LSB_POSN                = (int)14,
   REGFILE_RFLAGS_INT_BR_FLAG_MSB_POSN                = (int)14,
   INT_UM_FLAG_POSN                                   = (int)15,
   REGFILE_RFLAGS_INT_UM_FLAG_LSB_POSN                = (int)15,
   REGFILE_RFLAGS_INT_UM_FLAG_MSB_POSN                = (int)15,
   UNUSED_LSB_POSN                                    = (int)16,
   REGFILE_RFLAGS_UNUSED_LSB_POSN                     = (int)16,
   UNUSED_MSB_POSN                                    = (int)31,
   REGFILE_RFLAGS_UNUSED_MSB_POSN                     = (int)31
};
typedef enum regfile_rflags_posn_enum regfile_rflags_posn;

#define N_FLAG_MASK                              (0x00000001u)
#define Z_FLAG_MASK                              (0x00000002u)
#define C_FLAG_MASK                              (0x00000004u)
#define V_FLAG_MASK                              (0x00000008u)
#define UD_FLAG_MASK                             (0x00000010u)
#define SV_FLAG_MASK                             (0x00000020u)
#define BR_FLAG_MASK                             (0x00000040u)
#define UM_FLAG_MASK                             (0x00000080u)
#define INT_N_FLAG_MASK                          (0x00000100u)
#define INT_Z_FLAG_MASK                          (0x00000200u)
#define INT_C_FLAG_MASK                          (0x00000400u)
#define INT_V_FLAG_MASK                          (0x00000800u)
#define INT_UD_FLAG_MASK                         (0x00001000u)
#define INT_SV_FLAG_MASK                         (0x00002000u)
#define INT_BR_FLAG_MASK                         (0x00004000u)
#define INT_UM_FLAG_MASK                         (0x00008000u)
#define UNUSED_LSB_MASK                          (0x00010000u)
#define UNUSED_MSB_MASK                          (0x80000000u)

enum regfile_b0_posn_enum
{
   REGFILE_B0_LSB_POSN                                = (int)0,
   REGFILE_B0_REGFILE_B0_LSB_POSN                     = (int)0,
   REGFILE_B0_MSB_POSN                                = (int)31,
   REGFILE_B0_REGFILE_B0_MSB_POSN                     = (int)31
};
typedef enum regfile_b0_posn_enum regfile_b0_posn;

#define REGFILE_B0_LSB_MASK                      (0x00000001u)
#define REGFILE_B0_MSB_MASK                      (0x80000000u)

enum regfile_b1_posn_enum
{
   REGFILE_B1_LSB_POSN                                = (int)0,
   REGFILE_B1_REGFILE_B1_LSB_POSN                     = (int)0,
   REGFILE_B1_MSB_POSN                                = (int)31,
   REGFILE_B1_REGFILE_B1_MSB_POSN                     = (int)31
};
typedef enum regfile_b1_posn_enum regfile_b1_posn;

#define REGFILE_B1_LSB_MASK                      (0x00000001u)
#define REGFILE_B1_MSB_MASK                      (0x80000000u)

enum regfile_b4_posn_enum
{
   REGFILE_B4_LSB_POSN                                = (int)0,
   REGFILE_B4_REGFILE_B4_LSB_POSN                     = (int)0,
   REGFILE_B4_MSB_POSN                                = (int)31,
   REGFILE_B4_REGFILE_B4_MSB_POSN                     = (int)31
};
typedef enum regfile_b4_posn_enum regfile_b4_posn;

#define REGFILE_B4_LSB_MASK                      (0x00000001u)
#define REGFILE_B4_MSB_MASK                      (0x80000000u)

enum regfile_b5_posn_enum
{
   REGFILE_B5_LSB_POSN                                = (int)0,
   REGFILE_B5_REGFILE_B5_LSB_POSN                     = (int)0,
   REGFILE_B5_MSB_POSN                                = (int)31,
   REGFILE_B5_REGFILE_B5_MSB_POSN                     = (int)31
};
typedef enum regfile_b5_posn_enum regfile_b5_posn;

#define REGFILE_B5_LSB_MASK                      (0x00000001u)
#define REGFILE_B5_MSB_MASK                      (0x80000000u)

enum regfile_fp_posn_enum
{
   REGFILE_FP_LSB_POSN                                = (int)0,
   REGFILE_FP_REGFILE_FP_LSB_POSN                     = (int)0,
   REGFILE_FP_MSB_POSN                                = (int)31,
   REGFILE_FP_REGFILE_FP_MSB_POSN                     = (int)31
};
typedef enum regfile_fp_posn_enum regfile_fp_posn;

#define REGFILE_FP_LSB_MASK                      (0x00000001u)
#define REGFILE_FP_MSB_MASK                      (0x80000000u)

enum regfile_i0_posn_enum
{
   REGFILE_I0_LSB_POSN                                = (int)0,
   REGFILE_I0_REGFILE_I0_LSB_POSN                     = (int)0,
   REGFILE_I0_MSB_POSN                                = (int)31,
   REGFILE_I0_REGFILE_I0_MSB_POSN                     = (int)31
};
typedef enum regfile_i0_posn_enum regfile_i0_posn;

#define REGFILE_I0_LSB_MASK                      (0x00000001u)
#define REGFILE_I0_MSB_MASK                      (0x80000000u)

enum regfile_i1_posn_enum
{
   REGFILE_I1_LSB_POSN                                = (int)0,
   REGFILE_I1_REGFILE_I1_LSB_POSN                     = (int)0,
   REGFILE_I1_MSB_POSN                                = (int)31,
   REGFILE_I1_REGFILE_I1_MSB_POSN                     = (int)31
};
typedef enum regfile_i1_posn_enum regfile_i1_posn;

#define REGFILE_I1_LSB_MASK                      (0x00000001u)
#define REGFILE_I1_MSB_MASK                      (0x80000000u)

enum regfile_i2_posn_enum
{
   REGFILE_I2_LSB_POSN                                = (int)0,
   REGFILE_I2_REGFILE_I2_LSB_POSN                     = (int)0,
   REGFILE_I2_MSB_POSN                                = (int)31,
   REGFILE_I2_REGFILE_I2_MSB_POSN                     = (int)31
};
typedef enum regfile_i2_posn_enum regfile_i2_posn;

#define REGFILE_I2_LSB_MASK                      (0x00000001u)
#define REGFILE_I2_MSB_MASK                      (0x80000000u)

enum regfile_i3_posn_enum
{
   REGFILE_I3_LSB_POSN                                = (int)0,
   REGFILE_I3_REGFILE_I3_LSB_POSN                     = (int)0,
   REGFILE_I3_MSB_POSN                                = (int)31,
   REGFILE_I3_REGFILE_I3_MSB_POSN                     = (int)31
};
typedef enum regfile_i3_posn_enum regfile_i3_posn;

#define REGFILE_I3_LSB_MASK                      (0x00000001u)
#define REGFILE_I3_MSB_MASK                      (0x80000000u)

enum regfile_i4_posn_enum
{
   REGFILE_I4_LSB_POSN                                = (int)0,
   REGFILE_I4_REGFILE_I4_LSB_POSN                     = (int)0,
   REGFILE_I4_MSB_POSN                                = (int)31,
   REGFILE_I4_REGFILE_I4_MSB_POSN                     = (int)31
};
typedef enum regfile_i4_posn_enum regfile_i4_posn;

#define REGFILE_I4_LSB_MASK                      (0x00000001u)
#define REGFILE_I4_MSB_MASK                      (0x80000000u)

enum regfile_i5_posn_enum
{
   REGFILE_I5_LSB_POSN                                = (int)0,
   REGFILE_I5_REGFILE_I5_LSB_POSN                     = (int)0,
   REGFILE_I5_MSB_POSN                                = (int)31,
   REGFILE_I5_REGFILE_I5_MSB_POSN                     = (int)31
};
typedef enum regfile_i5_posn_enum regfile_i5_posn;

#define REGFILE_I5_LSB_MASK                      (0x00000001u)
#define REGFILE_I5_MSB_MASK                      (0x80000000u)

enum regfile_i6_posn_enum
{
   REGFILE_I6_LSB_POSN                                = (int)0,
   REGFILE_I6_REGFILE_I6_LSB_POSN                     = (int)0,
   REGFILE_I6_MSB_POSN                                = (int)31,
   REGFILE_I6_REGFILE_I6_MSB_POSN                     = (int)31
};
typedef enum regfile_i6_posn_enum regfile_i6_posn;

#define REGFILE_I6_LSB_MASK                      (0x00000001u)
#define REGFILE_I6_MSB_MASK                      (0x80000000u)

enum regfile_i7_posn_enum
{
   REGFILE_I7_LSB_POSN                                = (int)0,
   REGFILE_I7_REGFILE_I7_LSB_POSN                     = (int)0,
   REGFILE_I7_MSB_POSN                                = (int)31,
   REGFILE_I7_REGFILE_I7_MSB_POSN                     = (int)31
};
typedef enum regfile_i7_posn_enum regfile_i7_posn;

#define REGFILE_I7_LSB_MASK                      (0x00000001u)
#define REGFILE_I7_MSB_MASK                      (0x80000000u)

enum regfile_l0_posn_enum
{
   REGFILE_L0_LSB_POSN                                = (int)0,
   REGFILE_L0_REGFILE_L0_LSB_POSN                     = (int)0,
   REGFILE_L0_MSB_POSN                                = (int)31,
   REGFILE_L0_REGFILE_L0_MSB_POSN                     = (int)31
};
typedef enum regfile_l0_posn_enum regfile_l0_posn;

#define REGFILE_L0_LSB_MASK                      (0x00000001u)
#define REGFILE_L0_MSB_MASK                      (0x80000000u)

enum regfile_l1_posn_enum
{
   REGFILE_L1_LSB_POSN                                = (int)0,
   REGFILE_L1_REGFILE_L1_LSB_POSN                     = (int)0,
   REGFILE_L1_MSB_POSN                                = (int)31,
   REGFILE_L1_REGFILE_L1_MSB_POSN                     = (int)31
};
typedef enum regfile_l1_posn_enum regfile_l1_posn;

#define REGFILE_L1_LSB_MASK                      (0x00000001u)
#define REGFILE_L1_MSB_MASK                      (0x80000000u)

enum regfile_l4_posn_enum
{
   REGFILE_L4_LSB_POSN                                = (int)0,
   REGFILE_L4_REGFILE_L4_LSB_POSN                     = (int)0,
   REGFILE_L4_MSB_POSN                                = (int)31,
   REGFILE_L4_REGFILE_L4_MSB_POSN                     = (int)31
};
typedef enum regfile_l4_posn_enum regfile_l4_posn;

#define REGFILE_L4_LSB_MASK                      (0x00000001u)
#define REGFILE_L4_MSB_MASK                      (0x80000000u)

enum regfile_l5_posn_enum
{
   REGFILE_L5_LSB_POSN                                = (int)0,
   REGFILE_L5_REGFILE_L5_LSB_POSN                     = (int)0,
   REGFILE_L5_MSB_POSN                                = (int)31,
   REGFILE_L5_REGFILE_L5_MSB_POSN                     = (int)31
};
typedef enum regfile_l5_posn_enum regfile_l5_posn;

#define REGFILE_L5_LSB_MASK                      (0x00000001u)
#define REGFILE_L5_MSB_MASK                      (0x80000000u)

enum regfile_m0_posn_enum
{
   REGFILE_M0_LSB_POSN                                = (int)0,
   REGFILE_M0_REGFILE_M0_LSB_POSN                     = (int)0,
   REGFILE_M0_MSB_POSN                                = (int)31,
   REGFILE_M0_REGFILE_M0_MSB_POSN                     = (int)31
};
typedef enum regfile_m0_posn_enum regfile_m0_posn;

#define REGFILE_M0_LSB_MASK                      (0x00000001u)
#define REGFILE_M0_MSB_MASK                      (0x80000000u)

enum regfile_m1_posn_enum
{
   REGFILE_M1_LSB_POSN                                = (int)0,
   REGFILE_M1_REGFILE_M1_LSB_POSN                     = (int)0,
   REGFILE_M1_MSB_POSN                                = (int)31,
   REGFILE_M1_REGFILE_M1_MSB_POSN                     = (int)31
};
typedef enum regfile_m1_posn_enum regfile_m1_posn;

#define REGFILE_M1_LSB_MASK                      (0x00000001u)
#define REGFILE_M1_MSB_MASK                      (0x80000000u)

enum regfile_m2_posn_enum
{
   REGFILE_M2_LSB_POSN                                = (int)0,
   REGFILE_M2_REGFILE_M2_LSB_POSN                     = (int)0,
   REGFILE_M2_MSB_POSN                                = (int)31,
   REGFILE_M2_REGFILE_M2_MSB_POSN                     = (int)31
};
typedef enum regfile_m2_posn_enum regfile_m2_posn;

#define REGFILE_M2_LSB_MASK                      (0x00000001u)
#define REGFILE_M2_MSB_MASK                      (0x80000000u)

enum regfile_m3_posn_enum
{
   REGFILE_M3_LSB_POSN                                = (int)0,
   REGFILE_M3_REGFILE_M3_LSB_POSN                     = (int)0,
   REGFILE_M3_MSB_POSN                                = (int)31,
   REGFILE_M3_REGFILE_M3_MSB_POSN                     = (int)31
};
typedef enum regfile_m3_posn_enum regfile_m3_posn;

#define REGFILE_M3_LSB_MASK                      (0x00000001u)
#define REGFILE_M3_MSB_MASK                      (0x80000000u)

enum regfile_num_core_stalls_posn_enum
{
   REGFILE_NUM_CORE_STALLS_LSB_POSN                   = (int)0,
   REGFILE_NUM_CORE_STALLS_REGFILE_NUM_CORE_STALLS_LSB_POSN = (int)0,
   REGFILE_NUM_CORE_STALLS_MSB_POSN                   = (int)31,
   REGFILE_NUM_CORE_STALLS_REGFILE_NUM_CORE_STALLS_MSB_POSN = (int)31
};
typedef enum regfile_num_core_stalls_posn_enum regfile_num_core_stalls_posn;

#define REGFILE_NUM_CORE_STALLS_LSB_MASK         (0x00000001u)
#define REGFILE_NUM_CORE_STALLS_MSB_MASK         (0x80000000u)

enum regfile_num_instrs_posn_enum
{
   REGFILE_NUM_INSTRS_LSB_POSN                        = (int)0,
   REGFILE_NUM_INSTRS_REGFILE_NUM_INSTRS_LSB_POSN     = (int)0,
   REGFILE_NUM_INSTRS_MSB_POSN                        = (int)31,
   REGFILE_NUM_INSTRS_REGFILE_NUM_INSTRS_MSB_POSN     = (int)31
};
typedef enum regfile_num_instrs_posn_enum regfile_num_instrs_posn;

#define REGFILE_NUM_INSTRS_LSB_MASK              (0x00000001u)
#define REGFILE_NUM_INSTRS_MSB_MASK              (0x80000000u)

enum regfile_num_runclks_posn_enum
{
   REGFILE_NUM_RUNCLKS_LSB_POSN                       = (int)0,
   REGFILE_NUM_RUNCLKS_REGFILE_NUM_RUNCLKS_LSB_POSN   = (int)0,
   REGFILE_NUM_RUNCLKS_MSB_POSN                       = (int)31,
   REGFILE_NUM_RUNCLKS_REGFILE_NUM_RUNCLKS_MSB_POSN   = (int)31
};
typedef enum regfile_num_runclks_posn_enum regfile_num_runclks_posn;

#define REGFILE_NUM_RUNCLKS_LSB_MASK             (0x00000001u)
#define REGFILE_NUM_RUNCLKS_MSB_MASK             (0x80000000u)

enum regfile_r0_posn_enum
{
   REGFILE_R0_LSB_POSN                                = (int)0,
   REGFILE_R0_REGFILE_R0_LSB_POSN                     = (int)0,
   REGFILE_R0_MSB_POSN                                = (int)31,
   REGFILE_R0_REGFILE_R0_MSB_POSN                     = (int)31
};
typedef enum regfile_r0_posn_enum regfile_r0_posn;

#define REGFILE_R0_LSB_MASK                      (0x00000001u)
#define REGFILE_R0_MSB_MASK                      (0x80000000u)

enum regfile_r1_posn_enum
{
   REGFILE_R1_LSB_POSN                                = (int)0,
   REGFILE_R1_REGFILE_R1_LSB_POSN                     = (int)0,
   REGFILE_R1_MSB_POSN                                = (int)31,
   REGFILE_R1_REGFILE_R1_MSB_POSN                     = (int)31
};
typedef enum regfile_r1_posn_enum regfile_r1_posn;

#define REGFILE_R1_LSB_MASK                      (0x00000001u)
#define REGFILE_R1_MSB_MASK                      (0x80000000u)

enum regfile_r10_posn_enum
{
   REGFILE_R10_LSB_POSN                               = (int)0,
   REGFILE_R10_REGFILE_R10_LSB_POSN                   = (int)0,
   REGFILE_R10_MSB_POSN                               = (int)31,
   REGFILE_R10_REGFILE_R10_MSB_POSN                   = (int)31
};
typedef enum regfile_r10_posn_enum regfile_r10_posn;

#define REGFILE_R10_LSB_MASK                     (0x00000001u)
#define REGFILE_R10_MSB_MASK                     (0x80000000u)

enum regfile_r2_posn_enum
{
   REGFILE_R2_LSB_POSN                                = (int)0,
   REGFILE_R2_REGFILE_R2_LSB_POSN                     = (int)0,
   REGFILE_R2_MSB_POSN                                = (int)31,
   REGFILE_R2_REGFILE_R2_MSB_POSN                     = (int)31
};
typedef enum regfile_r2_posn_enum regfile_r2_posn;

#define REGFILE_R2_LSB_MASK                      (0x00000001u)
#define REGFILE_R2_MSB_MASK                      (0x80000000u)

enum regfile_r3_posn_enum
{
   REGFILE_R3_LSB_POSN                                = (int)0,
   REGFILE_R3_REGFILE_R3_LSB_POSN                     = (int)0,
   REGFILE_R3_MSB_POSN                                = (int)31,
   REGFILE_R3_REGFILE_R3_MSB_POSN                     = (int)31
};
typedef enum regfile_r3_posn_enum regfile_r3_posn;

#define REGFILE_R3_LSB_MASK                      (0x00000001u)
#define REGFILE_R3_MSB_MASK                      (0x80000000u)

enum regfile_r4_posn_enum
{
   REGFILE_R4_LSB_POSN                                = (int)0,
   REGFILE_R4_REGFILE_R4_LSB_POSN                     = (int)0,
   REGFILE_R4_MSB_POSN                                = (int)31,
   REGFILE_R4_REGFILE_R4_MSB_POSN                     = (int)31
};
typedef enum regfile_r4_posn_enum regfile_r4_posn;

#define REGFILE_R4_LSB_MASK                      (0x00000001u)
#define REGFILE_R4_MSB_MASK                      (0x80000000u)

enum regfile_r5_posn_enum
{
   REGFILE_R5_LSB_POSN                                = (int)0,
   REGFILE_R5_REGFILE_R5_LSB_POSN                     = (int)0,
   REGFILE_R5_MSB_POSN                                = (int)31,
   REGFILE_R5_REGFILE_R5_MSB_POSN                     = (int)31
};
typedef enum regfile_r5_posn_enum regfile_r5_posn;

#define REGFILE_R5_LSB_MASK                      (0x00000001u)
#define REGFILE_R5_MSB_MASK                      (0x80000000u)

enum regfile_r6_posn_enum
{
   REGFILE_R6_LSB_POSN                                = (int)0,
   REGFILE_R6_REGFILE_R6_LSB_POSN                     = (int)0,
   REGFILE_R6_MSB_POSN                                = (int)31,
   REGFILE_R6_REGFILE_R6_MSB_POSN                     = (int)31
};
typedef enum regfile_r6_posn_enum regfile_r6_posn;

#define REGFILE_R6_LSB_MASK                      (0x00000001u)
#define REGFILE_R6_MSB_MASK                      (0x80000000u)

enum regfile_r7_posn_enum
{
   REGFILE_R7_LSB_POSN                                = (int)0,
   REGFILE_R7_REGFILE_R7_LSB_POSN                     = (int)0,
   REGFILE_R7_MSB_POSN                                = (int)31,
   REGFILE_R7_REGFILE_R7_MSB_POSN                     = (int)31
};
typedef enum regfile_r7_posn_enum regfile_r7_posn;

#define REGFILE_R7_LSB_MASK                      (0x00000001u)
#define REGFILE_R7_MSB_MASK                      (0x80000000u)

enum regfile_r8_posn_enum
{
   REGFILE_R8_LSB_POSN                                = (int)0,
   REGFILE_R8_REGFILE_R8_LSB_POSN                     = (int)0,
   REGFILE_R8_MSB_POSN                                = (int)31,
   REGFILE_R8_REGFILE_R8_MSB_POSN                     = (int)31
};
typedef enum regfile_r8_posn_enum regfile_r8_posn;

#define REGFILE_R8_LSB_MASK                      (0x00000001u)
#define REGFILE_R8_MSB_MASK                      (0x80000000u)

enum regfile_r9_posn_enum
{
   REGFILE_R9_LSB_POSN                                = (int)0,
   REGFILE_R9_REGFILE_R9_LSB_POSN                     = (int)0,
   REGFILE_R9_MSB_POSN                                = (int)31,
   REGFILE_R9_REGFILE_R9_MSB_POSN                     = (int)31
};
typedef enum regfile_r9_posn_enum regfile_r9_posn;

#define REGFILE_R9_LSB_MASK                      (0x00000001u)
#define REGFILE_R9_MSB_MASK                      (0x80000000u)

enum regfile_rlink_posn_enum
{
   REGFILE_RLINK_LSB_POSN                             = (int)0,
   REGFILE_RLINK_REGFILE_RLINK_LSB_POSN               = (int)0,
   REGFILE_RLINK_MSB_POSN                             = (int)31,
   REGFILE_RLINK_REGFILE_RLINK_MSB_POSN               = (int)31
};
typedef enum regfile_rlink_posn_enum regfile_rlink_posn;

#define REGFILE_RLINK_LSB_MASK                   (0x00000001u)
#define REGFILE_RLINK_MSB_MASK                   (0x80000000u)

enum regfile_rmac0_posn_enum
{
   REGFILE_RMAC0_LSB_POSN                             = (int)0,
   REGFILE_RMAC0_REGFILE_RMAC0_LSB_POSN               = (int)0,
   REGFILE_RMAC0_MSB_POSN                             = (int)31,
   REGFILE_RMAC0_REGFILE_RMAC0_MSB_POSN               = (int)31
};
typedef enum regfile_rmac0_posn_enum regfile_rmac0_posn;

#define REGFILE_RMAC0_LSB_MASK                   (0x00000001u)
#define REGFILE_RMAC0_MSB_MASK                   (0x80000000u)

enum regfile_rmac1_posn_enum
{
   REGFILE_RMAC1_LSB_POSN                             = (int)0,
   REGFILE_RMAC1_REGFILE_RMAC1_LSB_POSN               = (int)0,
   REGFILE_RMAC1_MSB_POSN                             = (int)31,
   REGFILE_RMAC1_REGFILE_RMAC1_MSB_POSN               = (int)31
};
typedef enum regfile_rmac1_posn_enum regfile_rmac1_posn;

#define REGFILE_RMAC1_LSB_MASK                   (0x00000001u)
#define REGFILE_RMAC1_MSB_MASK                   (0x80000000u)

enum regfile_rmac2_posn_enum
{
   REGFILE_RMAC2_LSB_POSN                             = (int)0,
   REGFILE_RMAC2_REGFILE_RMAC2_LSB_POSN               = (int)0,
   REGFILE_RMAC2_MSB_POSN                             = (int)31,
   REGFILE_RMAC2_REGFILE_RMAC2_MSB_POSN               = (int)31
};
typedef enum regfile_rmac2_posn_enum regfile_rmac2_posn;

#define REGFILE_RMAC2_LSB_MASK                   (0x00000001u)
#define REGFILE_RMAC2_MSB_MASK                   (0x80000000u)

enum regfile_rmac24_posn_enum
{
   REGFILE_RMAC24_LSB_POSN                            = (int)0,
   REGFILE_RMAC24_REGFILE_RMAC24_LSB_POSN             = (int)0,
   REGFILE_RMAC24_MSB_POSN                            = (int)31,
   REGFILE_RMAC24_REGFILE_RMAC24_MSB_POSN             = (int)31
};
typedef enum regfile_rmac24_posn_enum regfile_rmac24_posn;

#define REGFILE_RMAC24_LSB_MASK                  (0x00000001u)
#define REGFILE_RMAC24_MSB_MASK                  (0x80000000u)

enum regfile_rmacb0_posn_enum
{
   REGFILE_RMACB0_LSB_POSN                            = (int)0,
   REGFILE_RMACB0_REGFILE_RMACB0_LSB_POSN             = (int)0,
   REGFILE_RMACB0_MSB_POSN                            = (int)31,
   REGFILE_RMACB0_REGFILE_RMACB0_MSB_POSN             = (int)31
};
typedef enum regfile_rmacb0_posn_enum regfile_rmacb0_posn;

#define REGFILE_RMACB0_LSB_MASK                  (0x00000001u)
#define REGFILE_RMACB0_MSB_MASK                  (0x80000000u)

enum regfile_rmacb1_posn_enum
{
   REGFILE_RMACB1_LSB_POSN                            = (int)0,
   REGFILE_RMACB1_REGFILE_RMACB1_LSB_POSN             = (int)0,
   REGFILE_RMACB1_MSB_POSN                            = (int)31,
   REGFILE_RMACB1_REGFILE_RMACB1_MSB_POSN             = (int)31
};
typedef enum regfile_rmacb1_posn_enum regfile_rmacb1_posn;

#define REGFILE_RMACB1_LSB_MASK                  (0x00000001u)
#define REGFILE_RMACB1_MSB_MASK                  (0x80000000u)

enum regfile_rmacb2_posn_enum
{
   REGFILE_RMACB2_LSB_POSN                            = (int)0,
   REGFILE_RMACB2_REGFILE_RMACB2_LSB_POSN             = (int)0,
   REGFILE_RMACB2_MSB_POSN                            = (int)31,
   REGFILE_RMACB2_REGFILE_RMACB2_MSB_POSN             = (int)31
};
typedef enum regfile_rmacb2_posn_enum regfile_rmacb2_posn;

#define REGFILE_RMACB2_LSB_MASK                  (0x00000001u)
#define REGFILE_RMACB2_MSB_MASK                  (0x80000000u)

enum regfile_rmacb24_posn_enum
{
   REGFILE_RMACB24_LSB_POSN                           = (int)0,
   REGFILE_RMACB24_REGFILE_RMACB24_LSB_POSN           = (int)0,
   REGFILE_RMACB24_MSB_POSN                           = (int)31,
   REGFILE_RMACB24_REGFILE_RMACB24_MSB_POSN           = (int)31
};
typedef enum regfile_rmacb24_posn_enum regfile_rmacb24_posn;

#define REGFILE_RMACB24_LSB_MASK                 (0x00000001u)
#define REGFILE_RMACB24_MSB_MASK                 (0x80000000u)

enum regfile_sp_posn_enum
{
   REGFILE_SP_LSB_POSN                                = (int)0,
   REGFILE_SP_REGFILE_SP_LSB_POSN                     = (int)0,
   REGFILE_SP_MSB_POSN                                = (int)31,
   REGFILE_SP_REGFILE_SP_MSB_POSN                     = (int)31
};
typedef enum regfile_sp_posn_enum regfile_sp_posn;

#define REGFILE_SP_LSB_MASK                      (0x00000001u)
#define REGFILE_SP_MSB_MASK                      (0x80000000u)

#endif /* IO_DEFS_MODULE_K32_DEBUG_REGFILE */
#endif /* __IO_DEFS_H__IO_DEFS_MODULE_K32_DEBUG_REGFILE */
...
enum bitserial1_config2_debug_sel_enum
{
   ...
   MAX_BITSERIAL1_CONFIG2_DEBUG_SEL         = (int)0x2
};
#define NUM_BITSERIAL1_CONFIG2_DEBUG_SEL (0x3)
typedef enum bitserial1_config2_debug_sel_enum bitserial1_config2_debug_sel;
...
enum bitserial1_config3_posn_enum
{
   ...
   BITSERIAL1_WAIT_FOR_TBUS_READ_RESP_POSN            = (int)5,
   BITSERIAL1_CONFIG3_BITSERIAL1_WAIT_FOR_TBUS_READ_RESP_LSB_POSN = (int)5,
   BITSERIAL1_CONFIG3_BITSERIAL1_WAIT_FOR_TBUS_READ_RESP_MSB_POSN = (int)5,
   BITSERIAL1_REMOVE_EXTRA_TBUS_READ_POSN             = (int)6,
   BITSERIAL1_CONFIG3_BITSERIAL1_REMOVE_EXTRA_TBUS_READ_LSB_POSN = (int)6,
   BITSERIAL1_CONFIG3_BITSERIAL1_REMOVE_EXTRA_TBUS_READ_MSB_POSN = (int)6
};
...
#define BITSERIAL1_WAIT_FOR_TBUS_READ_RESP_MASK  (0x00000020u)
#define BITSERIAL1_REMOVE_EXTRA_TBUS_READ_MASK   (0x00000040u)

enum bitserial1_config3_act_on_nak_enum
{
   ...
   MAX_BITSERIAL1_CONFIG3_ACT_ON_NAK        = (int)0x2
};
#define NUM_BITSERIAL1_CONFIG3_ACT_ON_NAK (0x3)
typedef enum bitserial1_config3_act_on_nak_enum bitserial1_config3_act_on_nak;
...
enum bus_proc_stream_status_enum_posn_enum
{
   BUS_PROC_STREAM_STATUS_ACTIVE_POSN                 = (int)0,
   BUS_PROC_STREAM_STATUS_ENUM_BUS_PROC_STREAM_STATUS_ACTIVE_LSB_POSN = (int)0,
   BUS_PROC_STREAM_STATUS_ENUM_BUS_PROC_STREAM_STATUS_ACTIVE_MSB_POSN = (int)0
};
typedef enum bus_proc_stream_status_enum_posn_enum bus_proc_stream_status_enum_posn;

#define BUS_PROC_STREAM_STATUS_ACTIVE_MASK       (0x00000001u)
...
enum bus_proc_stream_status_posn_enum
{
   BUS_PROC_STREAM_STATUS_BUS_PROC_STREAM_STATUS_ACTIVE_LSB_POSN = (int)0,
   BUS_PROC_STREAM_STATUS_BUS_PROC_STREAM_STATUS_ACTIVE_MSB_POSN = (int)0
};
typedef enum bus_proc_stream_status_posn_enum bus_proc_stream_status_posn;
...
enum support_ras_posn_enum
{
   SUPPORT_RAS_POSN                                   = (int)0,
   SUPPORT_RAS_SUPPORT_RAS_LSB_POSN                   = (int)0,
   SUPPORT_RAS_SUPPORT_RAS_MSB_POSN                   = (int)0
};
typedef enum support_ras_posn_enum support_ras_posn;

#define SUPPORT_RAS_MASK                         (0x00000001u)
