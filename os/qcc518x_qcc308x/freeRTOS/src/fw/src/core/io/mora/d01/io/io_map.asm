...
// File name  : /home/jl56/chips__jl56_auraplus/mora/d01/results/apps_sys/regs/asm/io_map.asm
...
.CONST $BITSERIAL0_CONFIG3                   0x60043008; // RW   7 bits
.CONST $_BITSERIAL0_CONFIG3                  $BITSERIAL0_CONFIG3; // RW   7 bits
...
.CONST $BITSERIAL1_CONFIG3                   0x60044008; // RW   7 bits
.CONST $_BITSERIAL1_CONFIG3                  $BITSERIAL1_CONFIG3; // RW   7 bits
...
.CONST $BITSERIAL2_CONFIG                    0x60045000; // RW  16 bits
.CONST $_BITSERIAL2_CONFIG                   $BITSERIAL2_CONFIG; // RW  16 bits
.CONST $BITSERIAL2_CONFIG2                   0x60045004; // RW  15 bits
.CONST $_BITSERIAL2_CONFIG2                  $BITSERIAL2_CONFIG2; // RW  15 bits
.CONST $BITSERIAL2_CONFIG3                   0x60045008; // RW   7 bits
.CONST $_BITSERIAL2_CONFIG3                  $BITSERIAL2_CONFIG3; // RW   7 bits
.CONST $BITSERIAL2_WORD_CONFIG               0x6004500C; // RW  12 bits
.CONST $_BITSERIAL2_WORD_CONFIG              $BITSERIAL2_WORD_CONFIG; // RW  12 bits
.CONST $BITSERIAL2_CONFIG_SEL_TIME           0x60045010; // RW  16 bits
.CONST $_BITSERIAL2_CONFIG_SEL_TIME          $BITSERIAL2_CONFIG_SEL_TIME; // RW  16 bits
.CONST $BITSERIAL2_CONFIG_SEL_TIME2          0x60045014; // RW   4 bits
.CONST $_BITSERIAL2_CONFIG_SEL_TIME2         $BITSERIAL2_CONFIG_SEL_TIME2; // RW   4 bits
.CONST $BITSERIAL2_REMOTE_SUBSYSTEM_SSID     0x60045018; // RW   4 bits
.CONST $_BITSERIAL2_REMOTE_SUBSYSTEM_SSID    $BITSERIAL2_REMOTE_SUBSYSTEM_SSID; // RW   4 bits
.CONST $BITSERIAL2_CURATOR_SSID              0x6004501C; // RW   4 bits
.CONST $_BITSERIAL2_CURATOR_SSID             $BITSERIAL2_CURATOR_SSID; // RW   4 bits
.CONST $BITSERIAL2_SLAVE_WRITE_COUNT         0x60045020; //  R  16 bits
.CONST $_BITSERIAL2_SLAVE_WRITE_COUNT        $BITSERIAL2_SLAVE_WRITE_COUNT; //  R  16 bits
.CONST $BITSERIAL2_SLAVE_READ_COUNT          0x60045024; //  R  16 bits
.CONST $_BITSERIAL2_SLAVE_READ_COUNT         $BITSERIAL2_SLAVE_READ_COUNT; //  R  16 bits
.CONST $BITSERIAL2_SLAVE_UNDERFLOW_BYTE      0x60045028; // RW   8 bits
.CONST $_BITSERIAL2_SLAVE_UNDERFLOW_BYTE     $BITSERIAL2_SLAVE_UNDERFLOW_BYTE; // RW   8 bits
.CONST $BITSERIAL2_SLAVE_DATA_READY_BYTE     0x6004502C; // RW   8 bits
.CONST $_BITSERIAL2_SLAVE_DATA_READY_BYTE    $BITSERIAL2_SLAVE_DATA_READY_BYTE; // RW   8 bits
.CONST $BITSERIAL2_SLAVE_NUM_PROTOCOL_WORDS  0x60045030; // RW  16 bits
.CONST $_BITSERIAL2_SLAVE_NUM_PROTOCOL_WORDS $BITSERIAL2_SLAVE_NUM_PROTOCOL_WORDS; // RW  16 bits
.CONST $BITSERIAL2_SLAVE_READ_COMMAND_BYTE   0x60045034; // RW   8 bits
.CONST $_BITSERIAL2_SLAVE_READ_COMMAND_BYTE  $BITSERIAL2_SLAVE_READ_COMMAND_BYTE; // RW   8 bits
.CONST $BITSERIAL2_RX_BUFFER                 0x60045038; // RW  12 bits
.CONST $_BITSERIAL2_RX_BUFFER                $BITSERIAL2_RX_BUFFER; // RW  12 bits
.CONST $BITSERIAL2_RX_BUFFER2                0x6004503C; // RW  12 bits
.CONST $_BITSERIAL2_RX_BUFFER2               $BITSERIAL2_RX_BUFFER2; // RW  12 bits
.CONST $BITSERIAL2_TX_BUFFER                 0x60045040; // RW  12 bits
.CONST $_BITSERIAL2_TX_BUFFER                $BITSERIAL2_TX_BUFFER; // RW  12 bits
.CONST $BITSERIAL2_TX_BUFFER2                0x60045044; // RW  12 bits
.CONST $_BITSERIAL2_TX_BUFFER2               $BITSERIAL2_TX_BUFFER2; // RW  12 bits
.CONST $BITSERIAL2_TXRX_LENGTH               0x60045048; // RW  16 bits
.CONST $_BITSERIAL2_TXRX_LENGTH              $BITSERIAL2_TXRX_LENGTH; // RW  16 bits
.CONST $BITSERIAL2_TXRX_LENGTH2              0x6004504C; // RW  16 bits
.CONST $_BITSERIAL2_TXRX_LENGTH2             $BITSERIAL2_TXRX_LENGTH2; // RW  16 bits
.CONST $BITSERIAL2_STREAMING_THRESHOLD       0x60045050; // RW  16 bits
.CONST $_BITSERIAL2_STREAMING_THRESHOLD      $BITSERIAL2_STREAMING_THRESHOLD; // RW  16 bits
.CONST $BITSERIAL2_RWB                       0x60045054; // RW   2 bits
.CONST $_BITSERIAL2_RWB                      $BITSERIAL2_RWB; // RW   2 bits
.CONST $BITSERIAL2_SET_SEL_INACTIVE          0x60045058; // RW   1 bits
.CONST $_BITSERIAL2_SET_SEL_INACTIVE         $BITSERIAL2_SET_SEL_INACTIVE; // RW   1 bits
.CONST $BITSERIAL2_CLK_RATE_HI               0x6004505C; // RW  16 bits
.CONST $_BITSERIAL2_CLK_RATE_HI              $BITSERIAL2_CLK_RATE_HI; // RW  16 bits
.CONST $BITSERIAL2_I2C_ADDRESS               0x60045060; // RW  10 bits
.CONST $_BITSERIAL2_I2C_ADDRESS              $BITSERIAL2_I2C_ADDRESS; // RW  10 bits
.CONST $BITSERIAL2_CLK_RATE_LO               0x60045064; // RW  16 bits
.CONST $_BITSERIAL2_CLK_RATE_LO              $BITSERIAL2_CLK_RATE_LO; // RW  16 bits
.CONST $BITSERIAL2_CLK_SAMP_OFFSET           0x60045068; // RW  16 bits
.CONST $_BITSERIAL2_CLK_SAMP_OFFSET          $BITSERIAL2_CLK_SAMP_OFFSET; // RW  16 bits
.CONST $BITSERIAL2_I2C_ACKS                  0x6004506C; //  R  16 bits
.CONST $_BITSERIAL2_I2C_ACKS                 $BITSERIAL2_I2C_ACKS; //  R  16 bits
.CONST $BITSERIAL2_WORDS_SENT                0x60045070; //  R  16 bits
.CONST $_BITSERIAL2_WORDS_SENT               $BITSERIAL2_WORDS_SENT; //  R  16 bits
.CONST $BITSERIAL2_DEEP_SLEEP_ACTIVE         0x60045074; // RW   1 bits
.CONST $_BITSERIAL2_DEEP_SLEEP_ACTIVE        $BITSERIAL2_DEEP_SLEEP_ACTIVE; // RW   1 bits
.CONST $BITSERIAL2_DEGLITCH_EN               0x60045078; // RW   2 bits
.CONST $_BITSERIAL2_DEGLITCH_EN              $BITSERIAL2_DEGLITCH_EN; // RW   2 bits
.CONST $BITSERIAL2_CLK_CONTROL               0x6004507C; // RW  10 bits
.CONST $_BITSERIAL2_CLK_CONTROL              $BITSERIAL2_CLK_CONTROL; // RW  10 bits
.CONST $BITSERIAL2_INTERBYTE_SPACING         0x60045080; // RW  16 bits
.CONST $_BITSERIAL2_INTERBYTE_SPACING        $BITSERIAL2_INTERBYTE_SPACING; // RW  16 bits
.CONST $BITSERIAL2_ERROR_STATUS              0x60045084; //  R   9 bits
.CONST $_BITSERIAL2_ERROR_STATUS             $BITSERIAL2_ERROR_STATUS; //  R   9 bits
.CONST $BITSERIAL2_STATUS                    0x60045088; //  R  13 bits
.CONST $_BITSERIAL2_STATUS                   $BITSERIAL2_STATUS; //  R  13 bits
.CONST $BITSERIAL2_INTERRUPT_STATUS          0x6004508C; //  R  14 bits
.CONST $_BITSERIAL2_INTERRUPT_STATUS         $BITSERIAL2_INTERRUPT_STATUS; //  R  14 bits
.CONST $BITSERIAL2_INTERRUPT_EN              0x60045090; // RW  14 bits
.CONST $_BITSERIAL2_INTERRUPT_EN             $BITSERIAL2_INTERRUPT_EN; // RW  14 bits
.CONST $BITSERIAL2_INTERRUPT_CLEAR           0x60045094; // RW  14 bits
.CONST $_BITSERIAL2_INTERRUPT_CLEAR          $BITSERIAL2_INTERRUPT_CLEAR; // RW  14 bits
.CONST $BITSERIAL2_INTERRUPT_SOURCE          0x60045098; //  R  14 bits
.CONST $_BITSERIAL2_INTERRUPT_SOURCE         $BITSERIAL2_INTERRUPT_SOURCE; //  R  14 bits
.CONST $BITSERIAL2_INTERRUPT_SOURCE_CLEAR    0x6004509C; // RW  14 bits
.CONST $_BITSERIAL2_INTERRUPT_SOURCE_CLEAR   $BITSERIAL2_INTERRUPT_SOURCE_CLEAR; // RW  14 bits
.CONST $BITSERIAL2_DEBUG_SEL                 0x600450A0; // RW   9 bits
.CONST $_BITSERIAL2_DEBUG_SEL                $BITSERIAL2_DEBUG_SEL; // RW   9 bits
.CONST $HOST_SYS_CONFIG_ENABLES              0x6004D000; // RW   6 bits
.CONST $_HOST_SYS_CONFIG_ENABLES             $HOST_SYS_CONFIG_ENABLES; // RW   6 bits
.CONST $HOST_SYS_CONFIG_FORCE_CLK_ENABLES    0x6004D004; // RW   8 bits
.CONST $_HOST_SYS_CONFIG_FORCE_CLK_ENABLES   $HOST_SYS_CONFIG_FORCE_CLK_ENABLES; // RW   8 bits
.CONST $HOST_SYS_CONFIG_MASK_HW_CLK_REQS     0x6004D008; // RW   6 bits
...
.CONST $HOST_SYS_POWER_ENABLES               0x6004D050; // RW   6 bits
.CONST $_HOST_SYS_POWER_ENABLES              $HOST_SYS_POWER_ENABLES; // RW   6 bits
.CONST $HOST_SYS_POWER_STATUS                0x6004D054; //  R   6 bits
.CONST $_HOST_SYS_POWER_STATUS               $HOST_SYS_POWER_STATUS; //  R   6 bits
.CONST $HOST_SYS_HIFS_BUILT                  0x6004D058; //  R   6 bits
...
.CONST $HOST_SYS_UART_SINGLE_WIRE_TX_NOT_RX  0x6004D070; // RW   1 bits
.CONST $_HOST_SYS_UART_SINGLE_WIRE_TX_NOT_RX $HOST_SYS_UART_SINGLE_WIRE_TX_NOT_RX; // RW   1 bits
.CONST $HOST_SYS_UART_SINGLE_WIRE_ENABLE     0x6004D074; // RW   1 bits
.CONST $_HOST_SYS_UART_SINGLE_WIRE_ENABLE    $HOST_SYS_UART_SINGLE_WIRE_ENABLE; // RW   1 bits
.CONST $HOST_SYS_USB_PHY_POWER_EN            0x6004D078; // RW   1 bits
.CONST $_HOST_SYS_USB_PHY_POWER_EN           $HOST_SYS_USB_PHY_POWER_EN; // RW   1 bits
.CONST $HOST_SYS_MMU_RAM_SEQ_TIMING_REG0     0x6004D07C; // RW  16 bits
.CONST $_HOST_SYS_MMU_RAM_SEQ_TIMING_REG0    $HOST_SYS_MMU_RAM_SEQ_TIMING_REG0; // RW  16 bits
.CONST $HOST_SYS_MMU_RAM_SEQ_TIMING_REG1     0x6004D080; // RW  16 bits
.CONST $_HOST_SYS_MMU_RAM_SEQ_TIMING_REG1    $HOST_SYS_MMU_RAM_SEQ_TIMING_REG1; // RW  16 bits
.CONST $HOST_SYS_MMU_RAM_SEQ_TIMING_REG2     0x6004D084; // RW  12 bits
.CONST $_HOST_SYS_MMU_RAM_SEQ_TIMING_REG2    $HOST_SYS_MMU_RAM_SEQ_TIMING_REG2; // RW  12 bits
.CONST $HOST_SYS_SCALED_CLK_VETO_EN          0x6004D08C; // RW   6 bits
.CONST $_HOST_SYS_SCALED_CLK_VETO_EN         $HOST_SYS_SCALED_CLK_VETO_EN; // RW   6 bits
.CONST $HOST_SYS_SPI_ENABLES                 0x6004D090; // RW   2 bits
.CONST $_HOST_SYS_SPI_ENABLES                $HOST_SYS_SPI_ENABLES; // RW   2 bits
.CONST $USB_TX_PREFETCH_RAM_16EPS_RAM0_EMA   0x6004D094; // RW   5 bits
.CONST $_USB_TX_PREFETCH_RAM_16EPS_RAM0_EMA  $USB_TX_PREFETCH_RAM_16EPS_RAM0_EMA; // RW   5 bits
.CONST $USB_TX_PREFETCH_RAM_16EPS_RAM1_EMA   0x6004D098; // RW   5 bits
.CONST $_USB_TX_PREFETCH_RAM_16EPS_RAM1_EMA  $USB_TX_PREFETCH_RAM_16EPS_RAM1_EMA; // RW   5 bits
.CONST $USB_TX_PREFETCH_RAM_16EPS_RAM2_EMA   0x6004D09C; // RW   5 bits
.CONST $_USB_TX_PREFETCH_RAM_16EPS_RAM2_EMA  $USB_TX_PREFETCH_RAM_16EPS_RAM2_EMA; // RW   5 bits
.CONST $USB_TX_PREFETCH_RAM_16EPS_RAM3_EMA   0x6004D0A0; // RW   5 bits
.CONST $_USB_TX_PREFETCH_RAM_16EPS_RAM3_EMA  $USB_TX_PREFETCH_RAM_16EPS_RAM3_EMA; // RW   5 bits
.CONST $USB_TX_PREFETCH_RAM_0_TO_3_WABL      0x6004D0A4; // RW  12 bits
.CONST $_USB_TX_PREFETCH_RAM_0_TO_3_WABL     $USB_TX_PREFETCH_RAM_0_TO_3_WABL; // RW  12 bits
.CONST $USB_TX_PREFETCH_RAM_READ_ASSIST      0x6004D0A8; // RW   3 bits
.CONST $_USB_TX_PREFETCH_RAM_READ_ASSIST     $USB_TX_PREFETCH_RAM_READ_ASSIST; // RW   3 bits
.CONST $USB_TX_PREFETCH_RAM_0_TO_3_EMAS      0x6004D0AC; // RW   4 bits
.CONST $_USB_TX_PREFETCH_RAM_0_TO_3_EMAS     $USB_TX_PREFETCH_RAM_0_TO_3_EMAS; // RW   4 bits
.CONST $USB_TX_PREFETCH_RAM_RDT              0x6004D0B0; // RW   1 bits
.CONST $_USB_TX_PREFETCH_RAM_RDT             $USB_TX_PREFETCH_RAM_RDT; // RW   1 bits
.CONST $HOST_SYS_BITSERIAL_2_DATA_OUTPUT_PIO_CTRL 0x6004D0B4; // RW   7 bits
.CONST $_HOST_SYS_BITSERIAL_2_DATA_OUTPUT_PIO_CTRL $HOST_SYS_BITSERIAL_2_DATA_OUTPUT_PIO_CTRL; // RW   7 bits
.CONST $HOST_SYS_BITSERIAL_2_CLK_OUTPUT_PIO_CTRL 0x6004D0B8; // RW   7 bits
.CONST $_HOST_SYS_BITSERIAL_2_CLK_OUTPUT_PIO_CTRL $HOST_SYS_BITSERIAL_2_CLK_OUTPUT_PIO_CTRL; // RW   7 bits
.CONST $HOST_SYS_BITSERIAL_2_SEL_OUTPUT_PIO_CTRL 0x6004D0BC; // RW   7 bits
.CONST $_HOST_SYS_BITSERIAL_2_SEL_OUTPUT_PIO_CTRL $HOST_SYS_BITSERIAL_2_SEL_OUTPUT_PIO_CTRL; // RW   7 bits
.CONST $HOST_SYS_BITSERIAL_2_DATA_INPUT_PIO_CTRL 0x6004D0C0; // RW   7 bits
.CONST $_HOST_SYS_BITSERIAL_2_DATA_INPUT_PIO_CTRL $HOST_SYS_BITSERIAL_2_DATA_INPUT_PIO_CTRL; // RW   7 bits
.CONST $HOST_SYS_BITSERIAL_2_CLK_INPUT_PIO_CTRL 0x6004D0C4; // RW   7 bits
.CONST $_HOST_SYS_BITSERIAL_2_CLK_INPUT_PIO_CTRL $HOST_SYS_BITSERIAL_2_CLK_INPUT_PIO_CTRL; // RW   7 bits
.CONST $HOST_SYS_BITSERIAL_2_SEL_INPUT_PIO_CTRL 0x6004D0C8; // RW   7 bits
.CONST $_HOST_SYS_BITSERIAL_2_SEL_INPUT_PIO_CTRL $HOST_SYS_BITSERIAL_2_SEL_INPUT_PIO_CTRL; // RW   7 bits
...
.CONST $MAC_OPERAND_MODE                     0xFFFF8068; // RW   4 bits
.CONST $_MAC_OPERAND_MODE                    $MAC_OPERAND_MODE; // RW   4 bits
...
.CONST $SUPPORT_RAS                          0xFFFF80AC; // RW   1 bits
.CONST $_SUPPORT_RAS                         $SUPPORT_RAS; // RW   1 bits
...
.CONST $RAM_SEQUENCER_ACTIVE_STATUS          0xFFFF9164; //  R  10 bits
.CONST $_RAM_SEQUENCER_ACTIVE_STATUS         $RAM_SEQUENCER_ACTIVE_STATUS; //  R  10 bits
...
.CONST $APPS_SYS_CPU0_TCM_REMAP_CONTROLS     0xFFFF9190; // RW   1 bits
.CONST $_APPS_SYS_CPU0_TCM_REMAP_CONTROLS    $APPS_SYS_CPU0_TCM_REMAP_CONTROLS; // RW   1 bits
.CONST $APPS_SYS_CPU1_TCM_REMAP_CONTROLS     0xFFFF9194; // RW   1 bits
.CONST $_APPS_SYS_CPU1_TCM_REMAP_CONTROLS    $APPS_SYS_CPU1_TCM_REMAP_CONTROLS; // RW   1 bits
...
.CONST $APPS_SYS_PIO_DRIVE                   0xFFFF93CC; // RW  64 bits
.CONST $_APPS_SYS_PIO_DRIVE                  $APPS_SYS_PIO_DRIVE; // RW  64 bits
...
.CONST $APPS_SYS_PIO_DRIVE_ENABLE            0xFFFF93D8; // RW  64 bits
.CONST $_APPS_SYS_PIO_DRIVE_ENABLE           $APPS_SYS_PIO_DRIVE_ENABLE; // RW  64 bits
...
.CONST $APPS_SYS_PIO_STATUS                  0xFFFF93E4; //  R  64 bits
.CONST $_APPS_SYS_PIO_STATUS                 $APPS_SYS_PIO_STATUS; //  R  64 bits
...
.CONST $APPS_SYS_PIO_MUX                     0xFFFF93F0; // RW  64 bits
.CONST $_APPS_SYS_PIO_MUX                    $APPS_SYS_PIO_MUX; // RW  64 bits
...
.CONST $BUS_PROC_STREAM_STATUS               0xFFFF975C; //  R   1 bits
.CONST $_BUS_PROC_STREAM_STATUS              $BUS_PROC_STREAM_STATUS; //  R   1 bits
...
.CONST $KALIMBA_PIO_INT_PIO1_EVENT_RISING_ENABLE 0xFFFF9C00; // RW  64 bits
.CONST $_KALIMBA_PIO_INT_PIO1_EVENT_RISING_ENABLE $KALIMBA_PIO_INT_PIO1_EVENT_RISING_ENABLE; // RW  64 bits
...
.CONST $KALIMBA_PIO_INT_PIO1_EVENT_FALLING_ENABLE 0xFFFF9C18; // RW  64 bits
.CONST $_KALIMBA_PIO_INT_PIO1_EVENT_FALLING_ENABLE $KALIMBA_PIO_INT_PIO1_EVENT_FALLING_ENABLE; // RW  64 bits
...
.CONST $KALIMBA_PIO_INT_PIO2_EVENT_RISING_ENABLE 0xFFFF9C30; // RW  64 bits
.CONST $_KALIMBA_PIO_INT_PIO2_EVENT_RISING_ENABLE $KALIMBA_PIO_INT_PIO2_EVENT_RISING_ENABLE; // RW  64 bits
...
.CONST $KALIMBA_PIO_INT_PIO2_EVENT_FALLING_ENABLE 0xFFFF9C48; // RW  64 bits
.CONST $_KALIMBA_PIO_INT_PIO2_EVENT_FALLING_ENABLE $KALIMBA_PIO_INT_PIO2_EVENT_FALLING_ENABLE; // RW  64 bits
...
.CONST $KALIMBA_PIO_INT_PIO1_EVENT_CAUSE     0xFFFF9C60; //  R  64 bits
.CONST $_KALIMBA_PIO_INT_PIO1_EVENT_CAUSE    $KALIMBA_PIO_INT_PIO1_EVENT_CAUSE; //  R  64 bits
...
.CONST $KALIMBA_PIO_INT_PIO2_EVENT_CAUSE     0xFFFF9C78; //  R  64 bits
.CONST $_KALIMBA_PIO_INT_PIO2_EVENT_CAUSE    $KALIMBA_PIO_INT_PIO2_EVENT_CAUSE; //  R  64 bits
...
.CONST $KALIMBA_PIO_INT_PIO1_EVENT_CAUSE_CLEAR_DATA 0xFFFF9C90; // RW  64 bits
.CONST $_KALIMBA_PIO_INT_PIO1_EVENT_CAUSE_CLEAR_DATA $KALIMBA_PIO_INT_PIO1_EVENT_CAUSE_CLEAR_DATA; // RW  64 bits
...
.CONST $KALIMBA_PIO_INT_PIO2_EVENT_CAUSE_CLEAR_DATA 0xFFFF9CA4; // RW  64 bits
.CONST $_KALIMBA_PIO_INT_PIO2_EVENT_CAUSE_CLEAR_DATA $KALIMBA_PIO_INT_PIO2_EVENT_CAUSE_CLEAR_DATA; // RW  64 bits
...
.CONST $KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_MASK 0xFFFF9D40; // RW  64 bits
.CONST $_KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_MASK $KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_MASK; // RW  64 bits
...
.CONST $KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_INVERT 0xFFFF9D58; // RW  64 bits
.CONST $_KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_INVERT $KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_INVERT; // RW  64 bits
...
.CONST $KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_STATUS 0xFFFF9D70; //  R  64 bits
.CONST $_KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_STATUS $KALIMBA_PIO_INT_TIMER_SW3_EVENT_PIO_STATUS; //  R  64 bits
