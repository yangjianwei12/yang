...
/**
 *  \brief  Create a Stream HCI TAP object and return the source.
 *         
 *  Create a Stream HCI TAP object and return the associated
 *             source. This is used for HCI TAP Logging from P0.
 *         
 *  \return The source handle for the HCI TAP stream.
 * 
 * \ingroup trapset_bluestack
 */
Source StreamHciTapSource(void );
...
/**
 *  \brief  Return the source containing marshal data for ACL link with given remote device
 *         
 *          
