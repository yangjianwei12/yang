...
/**
 *  \brief           Get true random data of requested length and place them into data[].
 *         
 *  \param data Pointer to the memory where the random data will be written.
 *  \param length The length, in bytes, of the requested random data.
 *  \return Return 0 on success or an error code.
 * 
 * \ingroup trapset_core
 */
util_raw_entropy_result UtilRawEntropy(uint8 * data, uint16 length);
#endif /* TRAPSET_CORE */
#endif
