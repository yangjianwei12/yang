...
/*----------------------------------------------------------------------------*
 *  NAME
 *      dm_isoc_iso_receive_req
 *
 *  DESCRIPTION
 *      Build and send a DM_ISOC_ISO_RECEIVE_TEST_REQ primitive.
...
{
    DM_ISOC_ISO_RECEIVE_TEST_REQ_T *p_prim;


    p_prim = zpnew(DM_ISOC_ISO_RECEIVE_TEST_REQ_T);
    p_prim->type = DM_ISOC_ISO_RECEIVE_TEST_REQ;
