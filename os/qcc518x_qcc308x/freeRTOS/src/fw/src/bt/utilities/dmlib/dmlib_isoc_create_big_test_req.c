 ...
 *
 *  DESCRIPTION
 *      Build and send a DM_ISOC_CREATE_BIG_TEST_REQ primitive.
...
void dm_isoc_create_big_test_req(phandle_t   phandle,
                            ...
                            DM_UPRIM_T  **pp_prim)
{
    DM_ISOC_CREATE_BIG_TEST_REQ_T *p_prim;
    uint8_t i;
    ...
    p_prim = zpnew(DM_ISOC_CREATE_BIG_TEST_REQ_T);
    p_prim->type = DM_ISOC_CREATE_BIG_TEST_REQ;
