...
typedef enum apps_slt_id
{
    ...
    /*! Pmalloc pools length
     *  This is the address to the uint32 pmalloc pools length variable.
     */
    APPS_SLT_PMALLOC_LENGTH = 15,

    /*! Pointer to the pmalloc pools array
     * This SLT entry point to another pointer which is the address
     * of the start of the pmalloc pools array
     */
    APPS_SLT_PMALLOC_ARRAY_PTR = 16,

    /*! Size of the pmalloc pool struct
     * The entry contains the size, in bytes, of the pmalloc struct
     */
    APPS_SLT_PMALLOC_STRUCT_SIZE = 17
