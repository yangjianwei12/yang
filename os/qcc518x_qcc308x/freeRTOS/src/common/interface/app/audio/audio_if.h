...
typedef enum {
    ...
    AUDIO_HARDWARE_MON_OUT /*!< The Audio internal "Monitor" decimation chain.
                        "instance" and "channel" together select the decimation chain. See Audio Documentation for details .*/
} audio_hardware;
...
typedef enum {
    ...
    AUDIO_INSTANCE_4  /*!< The audio hardware instance 4*/
} audio_instance;
...
typedef struct audio_get_mem_usage
{
    uint32       heap_size;    /*!< The heap size in words. */
    uint32       heap_current; /*!< Current heap usage in words. */
    uint32       heap_min;     /*!< Minimum available heap in words. */
    uint32       pool_size;    /*!< The pool memory size in words. */
    uint32       pool_current; /*!< Current pool memory usage in words. */
    uint32       pool_min;     /*!< Minimum available pool memory in words. */
}audio_get_mem_usage;
