...
On QCC305x and QCC515x and earlier devices, the maximum possible trickle 
current is 50mA.
On QCC307x and QCC517x and later devices, the maximum possible trickle 
current is 30mA.
...
The values are chip dependent.
On QCC305x and QCC515x and earlier devices, the possible values are:
10%, 20%, 30% and 40%.
On QCC307x and QCC517x and later devices, the possible values are:
13%, 24% and 35%.
Attempting to set a value outside the supported range will clip to the limit. 
Values between these will round to next highest value from the list.
     */
...
* The hardware can only accept a discrete subset of values, 
* see the device Datasheet for details. 
*/
typedef enum
{
   CHARGER_ITERM_CTRL_PERCENT_10 = 10,
   CHARGER_ITERM_CTRL_PERCENT_13 = 13,
   CHARGER_ITERM_CTRL_PERCENT_20 = 20,
   CHARGER_ITERM_CTRL_PERCENT_24 = 24,
   CHARGER_ITERM_CTRL_PERCENT_30 = 30,
   CHARGER_ITERM_CTRL_PERCENT_35 = 35,
