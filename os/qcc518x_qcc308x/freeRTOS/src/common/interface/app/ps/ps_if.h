...
/* Block of READONLY Keys reserved for the application's use */ 
#define PSKEY_APPLICATION_READONLY0 (PSKAPPSMIB_START+10)
#define PSKEY_APPLICATION_READONLY1 (PSKAPPSMIB_START+11)
#define PSKEY_APPLICATION_READONLY2 (PSKAPPSMIB_START+12)
#define PSKEY_APPLICATION_READONLY3 (PSKAPPSMIB_START+13)
#define PSKEY_APPLICATION_READONLY4 (PSKAPPSMIB_START+14)
#define PSKEY_APPLICATION_READONLY5 (PSKAPPSMIB_START+15)
#define PSKEY_APPLICATION_READONLY6 (PSKAPPSMIB_START+16)
#define PSKEY_APPLICATION_READONLY7 (PSKAPPSMIB_START+17)
#define PSKEY_APPLICATION_READONLY8 (PSKAPPSMIB_START+18)
#define PSKEY_APPLICATION_READONLY9 (PSKAPPSMIB_START+19)

#define PSKAPPLICATIONREADONLYMIB_START (PSKEY_APPLICATION_READONLY0)
#define PSKAPPLICATIONREADONLYMIB_END (PSKEY_APPLICATION_READONLY9)
