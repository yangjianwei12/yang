...
typedef enum
{
    TEST_TUNNEL_QACT_COMMAND_OBPM_RESET = 0,
    TEST_TUNNEL_QACT_COMMAND_OBPM_TIMEOUT = 1,
    TEST_TUNNEL_QACT_COMMAND_OBPM_POLL_INTERVAL = 2,
    TEST_TUNNEL_QACT_COMMAND_OBPM_COMMAND_REQ = 3,
    TEST_TUNNEL_QACT_COMMAND_OBPM_COMMAND_RSP = 4
} TEST_TUNNEL_QACT_COMMAND;
/*******************************************************************************
...
/*******************************************************************************
  ...
  NAME
    TEST_TUNNEL_QACT_OBPM_COMMAND_REQ
...
/* The following macros take TEST_TUNNEL_QACT_OBPM_COMMAND_REQ *test_tunnel_qact_obpm_command_req_ptr */
#define TEST_TUNNEL_QACT_OBPM_COMMAND_REQ_COMMAND_WORD_OFFSET (0)
#define TEST_TUNNEL_QACT_OBPM_COMMAND_REQ_COMMAND_GET(test_tunnel_qact_obpm_command_req_ptr) ((((test_tunnel_qact_obpm_command_req_ptr)->_data[0] & 0xffff)))
#define TEST_TUNNEL_QACT_OBPM_COMMAND_REQ_COMMAND_SET(test_tunnel_qact_obpm_command_req_ptr, command) ((test_tunnel_qact_obpm_command_req_ptr)->_data[0] =  \
                                                                                                           (uint32)(((test_tunnel_qact_obpm_command_req_ptr)->_data[0] & ~0xffff) | (((command)) & 0xffff)))
#define TEST_TUNNEL_QACT_OBPM_COMMAND_REQ_PAYLOAD_GET(test_tunnel_qact_obpm_command_req_ptr) ((((test_tunnel_qact_obpm_command_req_ptr)->_data[0] & 0xff0000) >> 16))
#define TEST_TUNNEL_QACT_OBPM_COMMAND_REQ_PAYLOAD_SET(test_tunnel_qact_obpm_command_req_ptr, payload) ((test_tunnel_qact_obpm_command_req_ptr)->_data[0] =  \
                                                                                                           (uint32)(((test_tunnel_qact_obpm_command_req_ptr)->_data[0] & ~0xff0000) | (((payload) << 16) & 0xff0000)))
#define TEST_TUNNEL_QACT_OBPM_COMMAND_REQ_WORD_SIZE (1)
/*lint -e(773) allow unparenthesized*/
#define TEST_TUNNEL_QACT_OBPM_COMMAND_REQ_CREATE(command, payload) \
    (uint32)(((command)) & 0xffff) | \
    (uint32)(((payload) << 16) & 0xff0000)
#define TEST_TUNNEL_QACT_OBPM_COMMAND_REQ_PACK(test_tunnel_qact_obpm_command_req_ptr, command, payload) \
    do { \
        (test_tunnel_qact_obpm_command_req_ptr)->_data[0] = (uint32)((uint32)(((command)) & 0xffff) | \
                                                                     (uint32)(((payload) << 16) & 0xff0000)); \
    } while (0)
...
/*******************************************************************************
  ...
  NAME
    TEST_TUNNEL_QACT_OBPM_COMMAND_RSP
...
/* The following macros take TEST_TUNNEL_QACT_OBPM_COMMAND_RSP *test_tunnel_qact_obpm_command_rsp_ptr */
#define TEST_TUNNEL_QACT_OBPM_COMMAND_RSP_COMMAND_WORD_OFFSET (0)
#define TEST_TUNNEL_QACT_OBPM_COMMAND_RSP_COMMAND_GET(test_tunnel_qact_obpm_command_rsp_ptr) ((test_tunnel_qact_obpm_command_rsp_ptr)->_data[0])
#define TEST_TUNNEL_QACT_OBPM_COMMAND_RSP_COMMAND_SET(test_tunnel_qact_obpm_command_rsp_ptr, command) ((test_tunnel_qact_obpm_command_rsp_ptr)->_data[0] = (uint32)(command))
#define TEST_TUNNEL_QACT_OBPM_COMMAND_RSP_PAYLOAD_WORD_OFFSET (1)
#define TEST_TUNNEL_QACT_OBPM_COMMAND_RSP_PAYLOAD_GET(test_tunnel_qact_obpm_command_rsp_ptr) ((((test_tunnel_qact_obpm_command_rsp_ptr)->_data[1] & 0xff)))
#define TEST_TUNNEL_QACT_OBPM_COMMAND_RSP_PAYLOAD_SET(test_tunnel_qact_obpm_command_rsp_ptr, payload) ((test_tunnel_qact_obpm_command_rsp_ptr)->_data[1] =  \
                                                                                                           (uint32)(((test_tunnel_qact_obpm_command_rsp_ptr)->_data[1] & ~0xff) | (((payload)) & 0xff)))
#define TEST_TUNNEL_QACT_OBPM_COMMAND_RSP_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define TEST_TUNNEL_QACT_OBPM_COMMAND_RSP_CREATE(command, payload) \
    (uint32)(command), \
    (uint32)(((payload)) & 0xff)
#define TEST_TUNNEL_QACT_OBPM_COMMAND_RSP_PACK(test_tunnel_qact_obpm_command_rsp_ptr, command, payload) \
    do { \
        (test_tunnel_qact_obpm_command_rsp_ptr)->_data[0] = (uint32)((uint32)(command)); \
        (test_tunnel_qact_obpm_command_rsp_ptr)->_data[1] = (uint32)((uint32)(((payload)) & 0xff)); \
    } while (0)
...
/*******************************************************************************
  ...
  NAME
    TEST_TUNNEL_QACT_OBPM_POLL_INTERVAL
...
/* The following macros take TEST_TUNNEL_QACT_OBPM_POLL_INTERVAL *test_tunnel_qact_obpm_poll_interval_ptr */
#define TEST_TUNNEL_QACT_OBPM_POLL_INTERVAL_POLL_INTERVAL_WORD_OFFSET (0)
#define TEST_TUNNEL_QACT_OBPM_POLL_INTERVAL_POLL_INTERVAL_GET(test_tunnel_qact_obpm_poll_interval_ptr) ((((test_tunnel_qact_obpm_poll_interval_ptr)->_data[0] & 0xffff)))
#define TEST_TUNNEL_QACT_OBPM_POLL_INTERVAL_POLL_INTERVAL_SET(test_tunnel_qact_obpm_poll_interval_ptr, poll_interval) ((test_tunnel_qact_obpm_poll_interval_ptr)->_data[0] =  \
                                                                                                                           (uint32)(((test_tunnel_qact_obpm_poll_interval_ptr)->_data[0] & ~0xffff) | (((poll_interval)) & 0xffff)))
#define TEST_TUNNEL_QACT_OBPM_POLL_INTERVAL_WORD_SIZE (1)
/*lint -e(773) allow unparenthesized*/
#define TEST_TUNNEL_QACT_OBPM_POLL_INTERVAL_CREATE(poll_interval) \
    (uint32)(((poll_interval)) & 0xffff)
#define TEST_TUNNEL_QACT_OBPM_POLL_INTERVAL_PACK(test_tunnel_qact_obpm_poll_interval_ptr, poll_interval) \
    do { \
        (test_tunnel_qact_obpm_poll_interval_ptr)->_data[0] = (uint32)((uint32)(((poll_interval)) & 0xffff)); \
    } while (0)
...
/* The following macros take TEST_TUNNEL_QACT_OBPM_RESET *test_tunnel_qact_obpm_reset_ptr */
#define TEST_TUNNEL_QACT_OBPM_RESET_DUMMY_WORD_OFFSET (0)
#define TEST_TUNNEL_QACT_OBPM_RESET_DUMMY_GET(test_tunnel_qact_obpm_reset_ptr) ((((test_tunnel_qact_obpm_reset_ptr)->_data[0] & 0xff)))
#define TEST_TUNNEL_QACT_OBPM_RESET_DUMMY_SET(test_tunnel_qact_obpm_reset_ptr, dummy) ((test_tunnel_qact_obpm_reset_ptr)->_data[0] =  \
                                                                                           (uint32)(((test_tunnel_qact_obpm_reset_ptr)->_data[0] & ~0xff) | (((dummy)) & 0xff)))
#define TEST_TUNNEL_QACT_OBPM_RESET_WORD_SIZE (1)
/*lint -e(773) allow unparenthesized*/
#define TEST_TUNNEL_QACT_OBPM_RESET_CREATE(dummy) \
    (uint32)(((dummy)) & 0xff)
#define TEST_TUNNEL_QACT_OBPM_RESET_PACK(test_tunnel_qact_obpm_reset_ptr, dummy) \
    do { \
        (test_tunnel_qact_obpm_reset_ptr)->_data[0] = (uint32)((uint32)(((dummy)) & 0xff)); \
    } while (0)
...
/* The following macros take TEST_TUNNEL_QACT_OBPM_TIMEOUT *test_tunnel_qact_obpm_timeout_ptr */
#define TEST_TUNNEL_QACT_OBPM_TIMEOUT_TIMEOUT_WORD_OFFSET (0)
#define TEST_TUNNEL_QACT_OBPM_TIMEOUT_TIMEOUT_GET(test_tunnel_qact_obpm_timeout_ptr) ((((test_tunnel_qact_obpm_timeout_ptr)->_data[0] & 0xffff)))
#define TEST_TUNNEL_QACT_OBPM_TIMEOUT_TIMEOUT_SET(test_tunnel_qact_obpm_timeout_ptr, timeout) ((test_tunnel_qact_obpm_timeout_ptr)->_data[0] =  \
                                                                                                   (uint32)(((test_tunnel_qact_obpm_timeout_ptr)->_data[0] & ~0xffff) | (((timeout)) & 0xffff)))
#define TEST_TUNNEL_QACT_OBPM_TIMEOUT_WORD_SIZE (1)
/*lint -e(773) allow unparenthesized*/
#define TEST_TUNNEL_QACT_OBPM_TIMEOUT_CREATE(timeout) \
    (uint32)(((timeout)) & 0xffff)
#define TEST_TUNNEL_QACT_OBPM_TIMEOUT_PACK(test_tunnel_qact_obpm_timeout_ptr, timeout) \
    do { \
        (test_tunnel_qact_obpm_timeout_ptr)->_data[0] = (uint32)((uint32)(((timeout)) & 0xffff)); \
    } while (0)
...
/* The following macros take TEST_TUNNEL_QACT *test_tunnel_qact_ptr */
#define TEST_TUNNEL_QACT_COMMAND_WORD_OFFSET (0)
#define TEST_TUNNEL_QACT_COMMAND_GET(test_tunnel_qact_ptr) ((TEST_TUNNEL_QACT_COMMAND)(((test_tunnel_qact_ptr)->_data[0] & 0xff)))
#define TEST_TUNNEL_QACT_COMMAND_SET(test_tunnel_qact_ptr, command) ((test_tunnel_qact_ptr)->_data[0] =  \
                                                                         (uint32)(((test_tunnel_qact_ptr)->_data[0] & ~0xff) | (((command)) & 0xff)))
#define TEST_TUNNEL_QACT_PAYLOAD_GET(test_tunnel_qact_ptr, payload_ptr) do {  \
        (payload_ptr)->_data[0] = (test_tunnel_qact_ptr)->_data[0]; \
        (payload_ptr)->_data[1] = (test_tunnel_qact_ptr)->_data[1]; } while (0)
#define TEST_TUNNEL_QACT_PAYLOAD_SET(test_tunnel_qact_ptr, payload_ptr) do {  \
        (test_tunnel_qact_ptr)->_data[0] = (payload_ptr)->_data[0]; \
        (test_tunnel_qact_ptr)->_data[1] = (payload_ptr)->_data[1]; } while (0)
#define TEST_TUNNEL_QACT_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define TEST_TUNNEL_QACT_CREATE(command, payload) \
    (uint32)(((command)) & 0xff) | \
    (uint32)
#define TEST_TUNNEL_QACT_PACK(test_tunnel_qact_ptr, command, payload_ptr) \
    do { \
        (test_tunnel_qact_ptr)->_data[0] = (uint32)((uint32)(((command)) & 0xff) | \
                                                    (payload_ptr)->_data[0]); \
        (test_tunnel_qact_ptr)->_data[1] = (uint32)((payload_ptr)->_data[1]); \
    } while (0)
