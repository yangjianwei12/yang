...
.CONST $M.VOL_CTRL_VOL_VERSION_MAJOR       	2;
...
.CONST $M.VOL_CTRL.PARAMETERS.OFFSET_DOWNSTREAM_LATENCY_EST_MS 		72*ADDR_PER_WORD;
.CONST $M.VOL_CTRL.PARAMETERS.STRUCT_SIZE                     		73;
