...
.CONST $M.AEC_REFERENCE_AECREF_VERSION_MAJOR       	3;
...
.CONST $M.AEC_REFERENCE.CONSTANT.CONN_SPKR_1_OUTPUT_ONLY		0x00008000;
...
.CONST $M.AEC_REFERENCE.STATUS.TTP_LATENCY_STATS 		21*ADDR_PER_WORD;
.CONST $M.AEC_REFERENCE.STATUS.BLOCK_SIZE             	22;
...
.CONST $M.AEC_REFERENCE.PARAMETERS.OFFSET_LOW_LATENCY_FW_SECONDARY_MIC		46*ADDR_PER_WORD;
.CONST $M.AEC_REFERENCE.PARAMETERS.OFFSET_RSV_PARAM_0                 		47*ADDR_PER_WORD;
.CONST $M.AEC_REFERENCE.PARAMETERS.OFFSET_RSV_PARAM_1                 		48*ADDR_PER_WORD;
.CONST $M.AEC_REFERENCE.PARAMETERS.OFFSET_RSV_PARAM_2                 		49*ADDR_PER_WORD;
.CONST $M.AEC_REFERENCE.PARAMETERS.OFFSET_RSV_PARAM_3                 		50*ADDR_PER_WORD;
.CONST $M.AEC_REFERENCE.PARAMETERS.OFFSET_RSV_PARAM_4                 		51*ADDR_PER_WORD;
.CONST $M.AEC_REFERENCE.PARAMETERS.OFFSET_ENABLE_LATENCY_CHANGE       		52*ADDR_PER_WORD;
.CONST $M.AEC_REFERENCE.PARAMETERS.OFFSET_TTP_LATENCY                 		53*ADDR_PER_WORD;
.CONST $M.AEC_REFERENCE.PARAMETERS.STRUCT_SIZE                       		54;
