...
static unsigned defaults_aec_referenceAECREF[] = {
   ...
   0x00000000u,			// STF_GAIN_RAMP_EXP
   0x00000000u,			// STF_GAIN_RAMP_LIN
   0x00000000u,			// SIDETONE_MICS_MAP0
   0x00000000u,			// LOW_LATENCY_FW_SECONDARY_MIC
   0x7FFFFFFFu,			// RSV_PARAM_0
   0x00000000u,			// RSV_PARAM_1
   0x00000000u,			// RSV_PARAM_2
   0x00000000u,			// RSV_PARAM_3
   0x00000000u,			// RSV_PARAM_4
   0x00000000u,			// ENABLE_LATENCY_CHANGE
   0x00001388u			// TTP_LATENCY
};
