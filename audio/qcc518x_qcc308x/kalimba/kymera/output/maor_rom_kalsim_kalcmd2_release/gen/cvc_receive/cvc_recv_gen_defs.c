...
#if defined(INSTALL_OPERATOR_CVC_RECEIVE) || defined(INSTALL_OPERATOR_CVC_32K)
#ifndef __GNUC__ 
_Pragma("datasection CONST")
#endif /* __GNUC__ */
...
#if defined(INSTALL_OPERATOR_CVC_24K) || defined(INSTALL_OPERATOR_CVC_48K)
#ifndef __GNUC__ 
_Pragma("datasection CONST")
#endif /* __GNUC__ */
...
#if defined(INSTALL_OPERATOR_CVC_FE)
#ifndef __GNUC__ 
_Pragma("datasection CONST")
#endif /* __GNUC__ */
...
unsigned *CVC_RECV_GetDefaults(unsigned capid){
	switch(capid){
		...
		case 0x0054: return defaults_cvc_recvWB;
		case 0x400C: return defaults_cvc_recvWB;
#endif
#if defined (INSTALL_OPERATOR_CVC_48K)
		case 0x0055: return defaults_cvc_recvUWB;
		case 0x400D: return defaults_cvc_recvUWB;
#endif
#if defined (INSTALL_OPERATOR_CVC_FE)
