...
/* Backward compatibility for operator to operator messages. */
#define OPMGR_ADAPTOR_OBPM 0x1F
 ...
 *
 * \param op_data       The data structure of the operator to kick
 * \param source_kicks  Mask of sources to kick
 * \param sink_kicks    Mask of sinks to kick
 */
extern void opmgr_kick_from_operator(OPERATOR_DATA *op_data,
                                     unsigned source_kicks,
                                     unsigned sink_kicks);

extern OPERATOR_DATA* get_op_data_from_id(INT_OP_ID id);
 ...
 *
 * \param  ep_hdl Endpoint handle.
 * \param  enable Enable ratematch when true.
 *
 * \return True on success.
 */
 ...
 * \note This function may only be called when timing_trace_is_enabled()
 *       returns TRUE.
 */
...
extern void opmgr_record_timing_trace_op_term_event(
        ...
        unsigned arg1,
        unsigned arg2);
#else /* INSTALL_TIMING_TRACE */
static inline void opmgr_record_timing_trace_op_term_event(
        unsigned opep_id,
        TIMING_TRACE_OP_EVENT_TYPE event_type,
        unsigned arg1,
        unsigned arg2)
...
{
#ifdef INSTALL_TIMING_TRACE
    opmgr_record_timing_trace_op_term_event((unsigned)op_id, event_type, arg1, arg2);
#endif /* INSTALL_TIMING_TRACE */
}
