...
/**
 * A signed time interval with a range of +/- 1 second
 */
typedef int RATE_SECOND_INTERVAL;
...
enum
{
    ...
    /** Integer bits without sign bit in RATE_SECOND_INTERVAL */
    RATE_SECOND_INTERVAL_INT_BITS            = 20,

    /* Fractional bits in RATE_SECOND_INTERVAL */
    RATE_SECOND_INTERVAL_EXTRA_RESOLUTION    = (DAWTH - RATE_SECOND_INTERVAL_INT_BITS - 1),
    ...
    /** Left shift to convert from RATE_SECOND_INTERVAL to RATE_TIME */
    RATE_SECOND_INTERVAL_TO_TIME_SHIFT      = (RATE_TIME_EXTRA_RESOLUTION
                                              - RATE_SECOND_INTERVAL_EXTRA_RESOLUTION)
};
...
#define RATE_SECOND_INTERVAL_SECOND \
    ((RATE_SECOND_INTERVAL)RATE_MICROSECONDS_PER_SECOND << RATE_SECOND_INTERVAL_EXTRA_RESOLUTION)

#define RATE_SECOND_INTERVAL_MICROSECOND \
    ((RATE_SECOND_INTERVAL)1 << RATE_SECOND_INTERVAL_EXTRA_RESOLUTION)
