...
enum patch_index {
    ...
    patch_fn_boot_shared_patchpoint_index,
...
#endif
    patch_fn_hal_hwsemaphore_shared_patchpoint_index,
    ...
    patch_fn_aec_reference_timer1_index,
    patch_fn_aec_reference_timer2_index,
    patch_fn_aec_reference_timer3_index,
#endif
    ...
    patch_fn_cbops_support_shared_patchpoint_index,
    ...
    patch_fn_pl_hwlock_shared_patchpoint_index,
    ...
    patch_fn_cap_download_mgr_kip_shared_patchpoint_index,
    ...
    patch_fn_opus_celt_encode_quant_bands_shared_patchpoint_index,
    patch_fn_opus_celt_encode_mathops_shared_patchpoint_index,
    patch_fn_opus_celt_encode_vq_shared_patchpoint_index,
    ...
    patch_fn_opus_celt_encode_align_index,
#endif
#if defined(INSTALL_OPERATOR_LC3_ENCODE)          || \
    defined(INSTALL_OPERATOR_LC3_ENCODE_SCO_ISO)  || \
    defined(INSTALL_OPERATOR_LC3Q_ENCODE_SCO_ISO) || \
    defined(INSTALL_OPERATOR_LC3_DECODE)          || \
    defined(INSTALL_OPERATOR_LC3_DECODE_SCO_ISO)  || \
    defined(INSTALL_OPERATOR_LC3Q_DECODE_SCO_ISO)
    patch_fn_lc3_internal_shared_patchpoint_index,
    patch_fn_lc3_common_shared_patchpoint_index,
    patch_fn_lc3_sns_common_shared_patchpoint_index,
    patch_fn_lc3_decode_fft_shared_patchpoint_index,
    patch_fn_lc3_decode_fp_math_shared_patchpoint_index,
    patch_fn_lc3_decode_mdct_synthesis_shared_patchpoint_index,
    patch_fn_lc3_encode_shared_patchpoint_index,
    patch_fn_lc3_bandwidth_detector_shared_patchpoint_index,
    patch_fn_lc3_bitstream_encoder_shared_patchpoint_index,
    patch_fn_lc3_bitstream_enc_functions_shared_patchpoint_index,
    patch_fn_lc3_write_side_info_shared_patchpoint_index,
    patch_fn_lc3_arithm_encode_shared_patchpoint_index,
    patch_fn_lc3_write_residual_shared_patchpoint_index,
    patch_fn_lc3_mdct_analysis_shared_patchpoint_index,
    patch_fn_lc3_noise_lvl_estim_shared_patchpoint_index,
    patch_fn_lc3_residual_coding_index,
    patch_fn_lc3_sns_analysis_shared_patchpoint_index,
    patch_fn_lc3_sns_analysis_scale_factors_shared_patchpoint_index,
    patch_fn_lc3_sns_analysis_pvq_shared_patchpoint_index,
    patch_fn_lc3_spec_quant_shared_patchpoint_index,
    patch_fn_lc3_tns_encode_shared_patchpoint_index,
    patch_fn_lc3_transient_detector_shared_patchpoint_index,
    patch_fn_lc3_ltpf_analysis_shared_patchpoint_index,
    patch_fn_lc3_ltpf_resampling_shared_patchpoint_index,
    patch_fn_lc3_ltpf_bitstream_index,
    patch_fn_lc3_ltpf_pitch_detection_shared_patchpoint_index,
    patch_fn_lc3_ltpf_normcorr_index,
    patch_fn_lc3_ltpf_pitch_lag_shared_patchpoint_index,
    patch_fn_lc3_ltpf_activation_shared_patchpoint_index,
    patch_fn_lc3_to_lc3q_encode_int_shared_patchpoint_index,
    patch_fn_lc3_decode_tns_decode_shared_patchpoint_index,
    patch_fn_lc3_decode_bitstream_decode_shared_patchpoint_index,
    patch_fn_lc3_decode_sns_decode_shared_patchpoint_index,
    patch_fn_lc3_decode_plc_shared_patchpoint_index,
    patch_fn_lc3_decode_noise_filling_shared_patchpoint_index,
    patch_fn_lc3_decode_ltpf_decode_shared_patchpoint_index,
    patch_fn_lc3_decode_wrapper_shared_patchpoint_index,
    patch_fn_lc3_decode_sco_iso_shared_patchpoint_index,
    patch_fn_lc3_decode_processing_shared_patchpoint_index,
    patch_fn_lc3_decode_create_destroy_shared_patchpoint_index,
    patch_fn_lc3_decode_common_shared_patchpoint_index,
    patch_fn_lc3_decode_residual_decoding_index,
    patch_fn_lc3_to_lc3q_decode_int_shared_patchpoint_index,
#endif
#if defined(INSTALL_OPERATOR_LC3Q_ENCODE_SCO_ISO) || \
    defined(INSTALL_OPERATOR_LC3Q_DECODE_SCO_ISO)
    patch_fn_lc3q_error_res_common_shared_patchpoint_index,
    patch_fn_lc3q_encode_shared_patchpoint_index,
    patch_fn_lc3q_encode_debug_shared_patchpoint_index,
    patch_fn_lc3q_error_res_encode_quant_shared_patchpoint_index,
    patch_fn_lc3q_error_res_spec_quant_shared_patchpoint_index,
    patch_fn_lc3q_decode_shared_patchpoint_index,
    patch_fn_lc3q_decode_debug_shared_patchpoint_index,
    patch_fn_lc3q_error_res_decode_shared_patchpoint_index,
#endif
#if defined(INSTALL_OPERATOR_LC3Q_DECODE_SCO_ISO)
    patch_fn_lc3q_decode_sco_iso_shared_patchpoint_index,
    patch_fn_lc3q_decode_processing_shared_patchpoint_index,
    patch_fn_lc3q_decode_create_destroy_shared_patchpoint_index,
#endif
#if defined(INSTALL_OPERATOR_LC3Q_ENCODE_SCO_ISO)
    patch_fn_lc3q_encode_sco_iso_shared_patchpoint_index,
#endif
    patch_fn_lc3_encode_sco_iso_process_data_shared_patchpoint_index,
    patch_fn_lc3_encode_create_destroy_shared_patchpoint_index,
    ...
    patch_fn_base_multi_channel_metadata_transfer_shared_patchpoint_index,
    ...
    patch_fn_wbs_dec_shared_patchpoint_index,
#endif
...
#endif
    patch_fn_sco_dec_read_metadata_shared_patchpoint_index,
    patch_fn_sco_enc_metadata_shared_patchpoint_index,
    patch_fn_read_packet_metadata_index,
    patch_fn_analyse_sco_metadata_shared_patchpoint_index,
    patch_fn_sco_fw_write_output_metadata_index,
    patch_fn_sco_fw_update_expected_timestamp_index,
    patch_fn_sco_fw_check_bad_kick_threshold_index,
    patch_fn_sco_src_drv_processing_shared_patchpoint_index,
    patch_fn_sco_src_drv_transfer_data_index,
    patch_fn_sco_sink_drv_processing_shared_patchpoint_index,
    patch_fn_sco_sink_drv_ttp_shared_patchpoint_index,
#ifdef INSTALL_ISO_CHANNELS
    patch_fn_sco_src_drv_proc_framed_shared_patchpoint_index,
#endif
    patch_fn_sco_common_connect_index,
    patch_fn_sco_common_disconnect_index,
    patch_fn_sco_common_rcv_initialise_index,
    patch_fn_sco_common_rcv_destroy_index,
...
#endif
#if defined (INSTALL_OPERATOR_APTX_ADAPTIVE_R3_DECODE)
    patch_fn_aptx_adaptive_r3_decode_process_data_index,
    patch_fn_aptx_adaptive_r3_decode_shared_patchpoint_index,
#endif
    ...
    patch_fn_src_sync_cfg_shared_patchpoint_index,
    ...
    patch_fn_aov_resource_mgr_shared_patchpoint_index,
    ...
    patch_fn_hal_clock_chip_audio_shared_patchpoint_index,
    patch_fn_clk_mgr_chip_audio_shared_patchpoint_index,
#endif /* INSTALL_CLK_MGR */

#ifdef INSTALL_CLK_MGR_FSM
    patch_fn_clk_mgr_fsm_shared_patchpoint_index,
#endif /* INSTALL_CLK_MGR_FSM */
    ...
    patch_fn_taskq_shared_patchpoint_index,

#if defined(DM_BANKS_CAN_BE_POWERED_OFF)
    patch_fn_hal_dm_bank_shared_patchpoint_index,
#endif

#if defined(PM_BANKS_CAN_BE_POWERED_OFF)
    patch_fn_hal_pm_bank_shared_patchpoint_index,
#endif
    ...
    patch_fn_svad_capability_shared_patchpoint_index,
    patch_fn_svad_process_data_index,
#endif /* INSTALL_OPERATOR_SVAD */

#ifdef CHIP_HAS_ROM_PWR_CONTROL
    patch_fn_rom_pwr_ctrl_shared_patchpoint_index,
#endif /* CHIP_HAS_ROM_PWR_CONTROL */

#ifdef RUN_CAPABILITIES_FROM_SQIF
    patch_fn_pl_nvmem_shared_patchpoint_index,
