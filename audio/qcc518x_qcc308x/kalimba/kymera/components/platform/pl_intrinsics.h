 ...
 *    * They do not call interrupt_block or interrupt_unblock().
 ...
 * The argument int48 is known to be synonymous with int64 on 32 bits platforms
...
/**
 * The argument and result int48 is known to be synonymous with int64 on 32 bits platforms
 * i.e. does not mean the values are restricted to 48 significant bits.
