 ...
 * \param pending    In case of success, indicates whether the endpoint
 *                   creation is yet to complete.
 *
 * \return the created end point, NULL otherwise.
 */
