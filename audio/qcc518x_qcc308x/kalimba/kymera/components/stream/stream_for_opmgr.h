...
****************************************************************************/
/**
 * \file stream_for_opmgr.h
 * \ingroup stream
 *
 * This file contains prototypes for stream functions that are only publicly
 * available to opmgr.
 */
...
/**
 * \brief Control the audio loopback.
 *
...
/**
 * \brief Control the audio loopback routing.
 *
 ...
 *
 */
extern void stream_enable_operator_endpoints(EXT_OP_ID opid);
 ...
 *
 */
extern void stream_disable_operator_endpoints(EXT_OP_ID opid);
 ...
 */
extern bool stream_destroy_all_operators_endpoints(EXT_OP_ID opid,
                                                   unsigned num_sinks,
