...
typedef enum{
    ...
    RESAMPLER_SHARED_FILTER_COEFFS_FIR_12p5,
    RESAMPLER_SHARED_FILTER_COEFFS_FIR_11p5,
    RESAMPLER_SHARED_FILTER_COEFFS_FIR_8p3,
    /*
    ...
    ****************************************************************************/
    ...
    /* ANC HW Manager */
    ANC_HW_MANAGER_SHARED_MEMORY,

    /* CVC filter_bank high resolution */
    FILTER_BANK_COS256_SPLIT,
    FILTER_BANK_FRM120_P480_FFT512,
    FILTER_BANK_FRM240_P960_FFT1024,
    FILTER_BANK_FRM120_P480_FFT512_PROTO,
    FILTER_BANK_FRM240_P960_FFT1024_PROTO
}shared_memory_id;
