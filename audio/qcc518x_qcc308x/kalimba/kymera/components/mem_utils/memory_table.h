...
/**
 * \brief Reserve the scratch memory requested in the table.
 *
 * If all the memory can't be reserved it is all released.
 *
 * \param scratch_alloc_table Table of scratch memory reservations to make.
 * \param length              The length of the table.
 * \param preference          Memory allocation preference.
 *
 ...
 *        malloc table.
 *
 * \param scratch_alloc_table Table of memory allocations that were made.
 * \param length              The length of the table.
 * \param preference          Memory allocation preference.
 */
 ...
 * \param scratch_alloc_table  Table of memory commits to make.
 * \param length               The length of the table.
 * \param preference           Memory allocation preference.
 *
 */
extern void mem_table_scratch_commit(void* struc,
                                     const scratch_malloc_t_entry* scratch_alloc_table,
                                     unsigned length,
									 unsigned preference);
