 ...
 * firmware.  These events are executed from the scheduler's main loop, 
 * and in the Audio subsystem they're strictly background-only; they can 
 * only run when no task is active.
 *
