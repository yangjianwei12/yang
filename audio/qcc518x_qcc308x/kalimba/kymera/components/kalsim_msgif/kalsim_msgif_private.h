...
#define SCO_PROCESSING_SERV_REQ_PAYLOAD_LEN  10
#define SCO_PROCESSING_SERV_REQ_PAYLOAD_MIN_LEN  6
...
void set_iso_parameters(uint16 in_pdu_len, uint16 *in_pdu, SUBSERV_TAG sstag);
