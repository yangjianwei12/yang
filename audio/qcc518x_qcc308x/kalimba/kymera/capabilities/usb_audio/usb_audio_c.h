...
#define MAX_NUM_GIP_HEADER_LEN_BYTES 3
...
typedef struct
{
    ...
    unsigned char gip_tx_sequence_id;

    bool gip_rx_header_processed;

    unsigned gip_rx_packet_num_audio_samples;

    unsigned gip_enabled;
...
extern bool usb_audio_opmsg_enable_gip_handling(OPERATOR_DATA *op_data, void *message_data,
                                          unsigned *resp_length, OP_OPMSG_RSP_PAYLOAD **resp_data);											 
