...
#define VOL_CTRL_AUX0_TTP_FIELD(x) \
        ($volume_control_cap.vol_ctrl_data_struct.AUX0_TTP_FIELD + \
...
vol_ctrl_update_aux_state_next:
    ...
    r1 = r5 + $volume_control_cap.vol_ctrl_data_struct.AUX_CHANNEL_FIELD;
    NULL = r1 - r0;
    ...
    NULL = M[r5 + $volume_control_cap.vol_ctrl_data_struct.CURRENT_TIMESTAMP_VALID_FIELD];
    if Z jump aux_ttp_gate_control_done;
    ...
    // r3 = ttp gate time
    r1 = M[r5 + $volume_control_cap.vol_ctrl_data_struct.CURRENT_TIMESTAMP_FIELD];
...
aux_ttp_gate_control_done:
    ...
    update_aux_state_sufficient_data:
        ...
        update_aux_state_in_AUX_START:
            ...
            r2 = M[r5 + $volume_control_cap.vol_ctrl_data_struct.CURRENT_TIMESTAMP_FIELD];
            r1 = r1 - r2;
            ...
            r2 = M[r5 + $volume_control_cap.vol_ctrl_data_struct.SAMPLE_RATE_FIELD];
            r2 = r2 * (1/500.0)(frac);
            r2 = r2 * r1 (int)(sat);
            ...
            rMAC = r5 + $volume_control_cap.vol_ctrl_data_struct.TC_FIELD;
...
aux_ttp_start_done:
            ...
            r1 = 1;
            M[r5 + $volume_control_cap.vol_ctrl_data_struct.DBG_AUX_MIXING_STARTED_FIELD] = r1;
#endif // VOLUME_CONTROL_AUX_TTP_SUPPORT
