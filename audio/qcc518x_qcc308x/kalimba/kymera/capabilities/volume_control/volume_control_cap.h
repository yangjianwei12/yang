...
#define VOL_CTRL_MAIN_INPUT_TERM_MASK (0x5555u)

/** Bit mask for aux input terminals: 8 least significant odd bits */
#define VOL_CTRL_AUX_INPUT_TERM_MASK (0xaaaau)

/** Bit mask for main output terminals: 8 least significant bits */
#define VOL_CTRL_MAIN_OUTPUT_TERM_MASK (0xffu)
...
#define VOL_CTRL_DOWNSTREAM_LATENCY_EST(op_extra_data)\
   op_extra_data->parameters.OFFSET_DOWNSTREAM_LATENCY_EST_MS
#endif /* VOLUME_CONTROL_AUX_TTP_SUPPORT */
