...
$cbops.aec_ref_latency_mic.main:
   ...
   r0 = M[r7];
   r1 = M[r8 + CBOPS_AEC_REFERENCE_LATENCY_FIELD($aec_reference_latency.latency_op_struct.AVAILABLE_FIELD)];
   ...
   if LE jump drop_check_done;
      ...
      r1 = M[r8 + CBOPS_AEC_REFERENCE_LATENCY_FIELD($aec_reference_latency.latency_op_struct.TRANSFER_DROPS_FIELD)];
      r1 = r1 + r2;
      M[r8 + CBOPS_AEC_REFERENCE_LATENCY_FIELD($aec_reference_latency.latency_op_struct.TRANSFER_DROPS_FIELD)] = r1;
   drop_check_done:
   M[r7] = r0;
