...
.CONST $cvc_send.cap.TMM_OBJ_FIELD                       66*ADDR_PER_WORD;
.CONST $cvc_send.cap.DEBUG_RESERVE_FIELD                 67*ADDR_PER_WORD;
.CONST $cvc_send.cap.SECURITY.KEY_FIELD                  68*ADDR_PER_WORD;
.CONST $cvc_send.cap.PARMS_DEF_FIELD                     70*ADDR_PER_WORD;//Secure Data is 2 words
.CONST $cvc_send.cap.PTR_MAP_RATIO                       75*ADDR_PER_WORD;//PARMS_DEF is 5 words
.CONST $cvc_send.cap.MIPS_ARRAY_FIELD                    76*ADDR_PER_WORD;
.CONST $cvc_send.cap.MLFE_OBJ_FIELD                      77*ADDR_PER_WORD;
.CONST $cvc_send.cap.HR_FILTERBANK_CONFIG                78*ADDR_PER_WORD;
.CONST $cvc_send.cap.REF_DOWNSAMPLER_FIELD               79*ADDR_PER_WORD;
.CONST $cvc_send.cap.IM_DOWNSAMPLER_FIELD                80*ADDR_PER_WORD;
.CONST $cvc_send.cap.IM_UPSAMPLER_FIELD                  81*ADDR_PER_WORD;
.CONST $cvc_send.cap.MBDRC_OBJECT_FIELD                  82*ADDR_PER_WORD;
