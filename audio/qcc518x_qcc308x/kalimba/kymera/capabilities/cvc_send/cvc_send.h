...
/* Capability structure references */
   ...
   extern const CAPABILITY_DATA cvc_send_1mic_wb_hs_va_cap_data;
#endif
...
#ifdef INSTALL_OPERATOR_CVC_24K
   extern const CAPABILITY_DATA cvc_send_earbud_3mic_mono_ie_uwb_cap_data;
#endif
#ifdef INSTALL_OPERATOR_CVC_32K
   extern const CAPABILITY_DATA cvc_send_earbud_3mic_mono_ie_swb_cap_data;
#endif
#ifdef INSTALL_OPERATOR_CVC_48K
   extern const CAPABILITY_DATA cvc_send_earbud_3mic_mono_ie_fb_cap_data;
#endif
#endif

#ifdef INSTALL_OPERATOR_CVC_EARBUD_3MIC_HYBRID
   extern const CAPABILITY_DATA cvc_send_earbud_3mic_hybrid_wb_cap_data;
#ifdef INSTALL_OPERATOR_CVC_32K
   extern const CAPABILITY_DATA cvc_send_earbud_3mic_hybrid_swb_cap_data;
#endif
#endif

#ifdef INSTALL_OPERATOR_CVC_HEADSET_2MIC_MONO_HYBRID
   extern const CAPABILITY_DATA cvc_send_2mic_hs_mono_hybrid_wb_cap_data;
#ifdef INSTALL_OPERATOR_CVC_32K
   extern const CAPABILITY_DATA cvc_send_2mic_hs_mono_hybrid_swb_cap_data;
#endif
#endif

#ifdef INSTALL_OPERATOR_CVC_HEADSET_1MIC_HYBRID
   extern const CAPABILITY_DATA cvc_send_1mic_hs_hybrid_wb_cap_data;
#ifdef INSTALL_OPERATOR_CVC_32K
   extern const CAPABILITY_DATA cvc_send_1mic_hs_hybrid_swb_cap_data;
#endif
#endif
