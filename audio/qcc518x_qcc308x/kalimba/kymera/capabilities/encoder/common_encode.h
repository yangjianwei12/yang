...
****************************************************************************/
/**
*    \file common_encode.h
*
*    Encoder common header file. Contains common function headers.
*/
...
#define COMMON_ENCODE_OUTPUT_BUFFER_SIZE    768
/** Minimum input buffer size */
#define COMMON_ENCODE_INPUT_BUFFER_SIZE   256
...
/* 
 * encoder_get_sched_info no longer exists because it didn't do anything 
 * different from the base_op version. Provide an alias just in case any 
 * old code still references it.
 */
#define encoder_get_sched_info base_op_get_sched_info
