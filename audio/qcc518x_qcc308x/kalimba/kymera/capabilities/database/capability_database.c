...
#endif
#if defined(INSTALL_OPERATOR_APTX_LITE_DECODE_SCO_ISO)
#include "aptx_lite_decode/aptx_lite_decode_sco_iso.h"
#endif
...
#endif
#ifdef INSTALL_OPERATOR_APTX_ADAPTIVE_ENCODE_SCO_ISO
#include "aptx_adaptive_r3_encode/aptx_adaptive_encode_sco_iso.h"
#endif
...
#include "aac_decode/aac_decode.h"
    ...
    defined(INSTALL_OPERATOR_CVC_HEADSET_1MIC_VA)     || \
    ...
    defined(INSTALL_OPERATOR_CVC_EARBUD_3MIC_HYBRID) || \
    defined(INSTALL_OPERATOR_CVC_HEADSET_2MIC_MONO_HYBRID) || \
    defined(INSTALL_OPERATOR_CVC_HEADSET_1MIC_HYBRID)
...
/* Private pointer to manage the list of downloaded caps */
...
#if defined(INSTALL_OPERATOR_AANC2_16K)
#include "aanc2/aanc2.h"
#endif
...
#ifdef INSTALL_OPERATOR_LC3_DECODE
#include "lc3_decode/lc3_decode.h"
#endif

#ifdef INSTALL_OPERATOR_LC3_DECODE_SCO_ISO
#include "lc3_decode/lc3_decode_sco_iso.h"
#endif

#ifdef INSTALL_OPERATOR_LC3_ENCODE_SCO_ISO
#include "lc3_encode/lc3_encode_sco_iso.h"
#endif

#ifdef INSTALL_OPERATOR_LC3Q_ENCODE_SCO_ISO
#include "lc3q_encode/lc3q_encode_sco_iso.h"
#endif

#ifdef INSTALL_OPERATOR_LC3QER_ENCODE_SCO_ISO
#include "lc3qer_encode/lc3q_encode_sco_iso.h"
#endif
...
#ifdef INSTALL_OPERATOR_LC3Q_DECODE_SCO_ISO
#include "lc3q_decode/lc3q_decode_sco_iso.h"
#endif
#ifdef INSTALL_OPERATOR_SILENCE_DETECT
#include "silence_detect/silence_detect.h"
#endif

#ifdef INSTALL_OPERATOR_ML_BASE
#include "ml_base/ml_base.h"
#endif

#ifdef INSTALL_OPERATOR_ML_ENGINE
#include "ml_engine/ml_engine_cap.h"
#endif

#ifdef INSTALL_OPERATOR_ML_EXAMPLE_SVAD
#include "ml_example_svad/ml_example_svad.h"
#endif

#ifdef INSTALL_OPERATOR_ML_NNOPS
#include "ml_nnops/ml_nnops_cap.h"
#endif

#ifdef INSTALL_OPERATOR_LC3QER_DECODE_SCO_ISO
#include "lc3qer_decode/lc3q_decode_sco_iso.h"
#endif

#if defined(INSTALL_OPERATOR_ANC_HW_MANAGER)
#include "anc_hw_manager/anc_hw_manager.h"
#endif

#if defined(INSTALL_OPERATOR_HCGR_16K)
#include "hcgr/hcgr.h"
#endif

#if defined(INSTALL_OPERATOR_ANC_COMPANDER)
#include "anc_compander/anc_compander.h"
#endif

#if defined(INSTALL_OPERATOR_WIND_NOISE_DETECT)
#include "wind_noise_detect/wind_noise_detect.h"
#endif

#if defined(INSTALL_OPERATOR_ATR_VAD)
#include "atr_vad/atr_vad.h"
#endif

#if defined(INSTALL_OPERATOR_AAH)
#include "aah/aah.h"
#endif

#if defined(INSTALL_OPERATOR_NOISE_ID)
#include "noise_id/noise_id.h"
#endif

#ifdef INSTALL_OPERATOR_APTX_LITE_ENCODE_SCO_ISO
#include "aptx_lite_encode/aptx_lite_encode_sco_iso.h"
#endif

#if defined(INSTALL_OPERATOR_GEQ)
#include "geq/geq_cap.h"
#endif
...
#ifdef INSTALL_OPERATOR_APTX_LITE_DECODE_SCO_ISO
    &aptx_lite_decode_sco_iso_cap_data,
#endif
...
#endif
#ifdef INSTALL_OPERATOR_XOVER_3BAND
   &xover_3band_cap_data,
#endif
#ifdef INSTALL_OPERATOR_CVC_RECEIVE
    &cvc_receive_nb_cap_data,
    &cvc_receive_wb_cap_data,
#ifdef INSTALL_OPERATOR_CVC_FE
    ...
    &cvc_send_1mic_wb_hs_va_cap_data,
#endif
...
#ifdef INSTALL_OPERATOR_CVC_32K
    &cvc_send_earbud_3mic_mono_ie_swb_cap_data,
#endif
#endif

#ifdef INSTALL_OPERATOR_CVC_EARBUD_3MIC_HYBRID
    &cvc_send_earbud_3mic_hybrid_wb_cap_data,
#ifdef INSTALL_OPERATOR_CVC_32K
    &cvc_send_earbud_3mic_hybrid_swb_cap_data,
#endif
#endif

#ifdef INSTALL_OPERATOR_CVC_HEADSET_2MIC_MONO_HYBRID
    &cvc_send_2mic_hs_mono_hybrid_wb_cap_data,
#ifdef INSTALL_OPERATOR_CVC_32K
    &cvc_send_2mic_hs_mono_hybrid_swb_cap_data,
#endif
#endif

#ifdef INSTALL_OPERATOR_CVC_HEADSET_1MIC_HYBRID
    &cvc_send_1mic_hs_hybrid_wb_cap_data,
#ifdef INSTALL_OPERATOR_CVC_32K
    &cvc_send_1mic_hs_hybrid_swb_cap_data,
#endif
#endif
...
#ifdef INSTALL_OPERATOR_LC3_DECODE_SCO_ISO
    &lc3_decode_sco_iso_cap_data,
#endif

#ifdef INSTALL_OPERATOR_AANC_MONO_16K
    &aanc_mono_16k_cap_data,
#endif
#ifdef INSTALL_OPERATOR_AANC2_16K
    &aanc2_16k_cap_data,
#endif
...
#ifdef INSTALL_OPERATOR_LC3_ENCODE_SCO_ISO
    &lc3_encode_sco_iso_cap_data,
#endif

#ifdef INSTALL_OPERATOR_LC3Q_ENCODE_SCO_ISO
    &lc3q_encode_sco_iso_cap_data,
#endif
...
#endif
#ifdef INSTALL_OPERATOR_LC3Q_DECODE_SCO_ISO
    &lc3q_decode_sco_iso_cap_data,
#endif
#ifdef INSTALL_OPERATOR_SILENCE_DETECT
    &silence_detect_cap_data,
#endif


#ifdef INSTALL_OPERATOR_ANC_HW_MANAGER
    &anc_hw_manager_cap_data,
#endif

#ifdef INSTALL_OPERATOR_HCGR_16K
    &hcgr_16k_cap_data,
#endif
...
#ifdef INSTALL_OPERATOR_ANC_COMPANDER
    &anc_compander_cap_data,
#endif

#ifdef INSTALL_OPERATOR_WIND_NOISE_DETECT
    &wind_noise_detect_cap_data,
#endif

#ifdef INSTALL_OPERATOR_ATR_VAD
    &atr_vad_cap_data,
#endif

#ifdef INSTALL_OPERATOR_AAH
    &aah_cap_data,
#endif

#ifdef INSTALL_OPERATOR_NOISE_ID
    &noise_id_cap_data,
#endif
#ifdef INSTALL_OPERATOR_APTX_LITE_ENCODE_SCO_ISO
    &aptx_lite_encode_sco_iso_cap_data,
#endif

#ifdef INSTALL_OPERATOR_GEQ
    &geq_cap_data,
#endif
#ifdef INSTALL_OPERATOR_APTX_ADAPTIVE_ENCODE_SCO_ISO
    &aptx_adaptive_encode_sco_iso_cap_data,
#endif
...
void capability_database_init_download_list(void)
{
    ...
    {
        /* Initialise list to null, but only on P0 */
