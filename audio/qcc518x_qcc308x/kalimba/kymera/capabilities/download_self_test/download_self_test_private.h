...
extern unsigned int download_self_test_call_from_maxim_to_minim_test_maxim_dm_as_pm(void);
extern unsigned int download_self_test_call_from_maxim_to_maxim_test_maxim_dm_as_pm(void);
extern unsigned int download_self_test_call_from_maxim_to_maxim_test_maxim(void);
extern unsigned int download_self_test_call_from_minim_to_maxim_test_minim(void);
extern unsigned int download_self_test_call_from_minim_to_maxim_test_minim_dm_as_pm(void);
extern unsigned int download_self_test_call_from_minim_to_minim_test_minim_dm_as_pm(void);
extern unsigned int download_self_test_variable_size_vars_test_maxim_asm_dm_as_pm(void);
extern unsigned int download_self_test_variable_size_vars_test_minim_asm_dm_as_pm(void);
extern unsigned int download_self_test_branch_test_dm_as_pm(void);
extern unsigned int download_self_test_var_ref_test_minim_dm_as_pm(void);
extern unsigned int download_self_test_var_ref_test_maxim_dm_as_pm(void);
...
extern DOWNLOAD_HELPER_STRUCT* func_return_struct_ptr(void);
...
#if defined(CHIP_HAS_NVRAM_ACCESS_TO_DM)
extern unsigned int download_self_test_array_offset_access_dm_as_pm(void);
extern unsigned int download_self_test_array_offset_access_check_dm_as_pm(void);
extern void func_decrease_one_dm_as_pm(void);
extern unsigned int download_self_test_sqrt_test_dm_as_pm(void);
#endif /* CHIP_HAS_NVRAM_ACCESS_TO_DM */

#if defined(DM_BANKS_CAN_BE_POWERED_OFF)
extern unsigned int download_self_test_extra_memory(void);
#else
#define download_self_test_extra_memory(x) 0x600D
#endif
