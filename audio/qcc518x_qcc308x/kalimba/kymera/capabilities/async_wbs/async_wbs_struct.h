...
typedef struct ASYNC_WBS_DEC_OP_DATA
{
    ...
    /** Sco Drv data structure.
     * This is here because ASYNC_WBS calls sco_src_drv_processing to process
     * the record headers. This processing would normally happen in the SCO/ISO
     * source EP.
     */
    SCO_SRC_DRV_DATA *sco_drv_data;
