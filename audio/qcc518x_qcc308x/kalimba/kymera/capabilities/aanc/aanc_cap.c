...
const AANC_GAIN_OVERRIDE gain_override_table[] = {
    ...
    {0, FALSE},
#ifdef AANC_MAOR_V20
    {offsetof(AANC_OP_DATA, rx_ffa_mix_gain), FALSE},
    {offsetof(AANC_OP_DATA, rx_ffa_mix_gain), TRUE},
    {offsetof(AANC_OP_DATA, rx_ffb_mix_gain), FALSE},
    {offsetof(AANC_OP_DATA, rx_ffb_mix_gain), TRUE}
#endif
    };
...
static bool aanc_update_gain(OPERATOR_DATA *op_data, AANC_OP_DATA *p_ext_data)
{
    ...
    OPMSG_CREATION_FIELD_SET(trigger_message, OPMSG_UNSOLICITED_AANC_INFO,
                             FF_COARSE_GAIN, p_ext_data->ff_gain.coarse);
...
#ifdef AANC_MAOR_V20
    p_ext_data->rx_ffa_mix_gain_prev = p_ext_data->rx_ffa_mix_gain;
    OPMSG_CREATION_FIELD_SET(trigger_message,
                             OPMSG_UNSOLICITED_AANC_INFO,
                             RX_FFA_MIX_COARSE_GAIN,
                             p_ext_data->rx_ffa_mix_gain.coarse);
    OPMSG_CREATION_FIELD_SET(trigger_message,
                             OPMSG_UNSOLICITED_AANC_INFO,
                             RX_FFA_MIX_FINE_GAIN,
                             p_ext_data->rx_ffa_mix_gain.fine);
    p_ext_data->rx_ffb_mix_gain_prev = p_ext_data->rx_ffb_mix_gain;
    OPMSG_CREATION_FIELD_SET(trigger_message,
                             OPMSG_UNSOLICITED_AANC_INFO,
                             RX_FFB_MIX_COARSE_GAIN,
                             p_ext_data->rx_ffb_mix_gain.coarse);
    OPMSG_CREATION_FIELD_SET(trigger_message,
                             OPMSG_UNSOLICITED_AANC_INFO,
                             RX_FFB_MIX_FINE_GAIN,
                             p_ext_data->rx_ffb_mix_gain.fine);
#endif
...
/**
 * \brief  Update coarse gain in the ANC HW
 *
 * \param  gain  Gain value to write
 * \param  path  ANC path to update the gain on
 * \param  channel  ANC channel to update the gain on
...
#ifdef AANC_MAOR_V20
/**
 * \brief  Update fine rx mix gain in the ANC HW
 *
 * \param  gain  Gain value to write
 * \param  path  ANC path to update the gain on
 * \param  channel  ANC channel to update the gain on
...
/**
 * \brief  Update coarse rx mix gain in the ANC HW
 *
 * \param  gain  Gain value to write
 * \param  path  ANC path to update the gain on
 * \param  channel  ANC channel to update the gain on
