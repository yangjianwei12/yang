...
#if defined(INSTALL_DOWNLOADABLE_SPLITTER)
...
typedef struct
{
    ...
    /**
     * The fame size has different meaning depending on the mode.
     * Buffer data mode:
     ...
     * Clone mode:
     *   frame_size != 0 indicates that the operator will only consume whole tags
     *   from the input.
     */
    unsigned frame_size;
