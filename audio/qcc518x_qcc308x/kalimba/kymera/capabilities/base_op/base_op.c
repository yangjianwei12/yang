...
bool base_op_create_lite(OPERATOR_DATA *op_data, void **response_data)
{
    return base_op_create(op_data, NULL, NULL, response_data);
}
...
bool base_op_destroy_lite(OPERATOR_DATA *op_data, void **response_data)
{
    return base_op_destroy(op_data, NULL, NULL, response_data);
}
...
bool base_op_buffer_details_lite(OPERATOR_DATA *op_data, void **response_data)
{
    return base_op_buffer_details(op_data, NULL, NULL, response_data);
}

bool base_op_get_sched_info(OPERATOR_DATA *op_data, void *message_data, unsigned *response_id, void **response_data)
{
    OP_SCHED_INFO_RSP* resp = base_op_get_sched_info_ex(op_data, message_data, response_id);
