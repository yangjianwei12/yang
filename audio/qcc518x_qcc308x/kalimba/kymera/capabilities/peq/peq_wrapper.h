...
/* PEQ extended operator data with additional field*/
typedef struct peq_exop_ext
{
    PEQ_OP_DATA peq_op_data;
    unsigned num_stages_per_frame;
} PEQ_OP_DATA_EXT;
...
extern bool peq_wrapper_opmsg_set_stages_per_frame(OPERATOR_DATA *op_data, void *message_data, unsigned *resp_length, OP_OPMSG_RSP_PAYLOAD **resp_data);
