...
/*******************************************************************************
 ...
 VALUES
    ...
    PS_REGISTER_REQ                    -
    CAP_DOWNLOAD_REQ_DATA_REQ          -
    CAP_DOWNLOAD_START_DOWNLOAD_REQ    -
    CAP_DOWNLOAD_KCS_CALLBACK_REQ      -
    CAP_DOWNLOAD_REMOVE_KCS_REQ        -
    CAP_DOWNLOAD_ADD_ELF_REQ           -
    CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ -
    CAP_DOWNLOAD_REMOVE_ELF_REQ        -
    GET_MIPS_USAGE_REQ                 -
    CREATE_OPERATOR_RES                -
    ...
    CAP_DOWNLOAD_REQ_DATA_RES          -
    CAP_DOWNLOAD_REMOVE_KCS_RES        -
    CAP_DOWNLOAD_REMOVE_ELF_RES        -
    GET_MIPS_USAGE_RES                 -
...
typedef enum
{
    ...
    KIP_MSG_ID_PS_REGISTER_REQ = 0x101C,
    KIP_MSG_ID_CAP_DOWNLOAD_REQ_DATA_REQ = 0x101D,
    KIP_MSG_ID_CAP_DOWNLOAD_START_DOWNLOAD_REQ = 0x101E,
    KIP_MSG_ID_CAP_DOWNLOAD_KCS_CALLBACK_REQ = 0x101F,
    KIP_MSG_ID_CAP_DOWNLOAD_REMOVE_KCS_REQ = 0x1021,
    KIP_MSG_ID_CAP_DOWNLOAD_ADD_ELF_REQ = 0x1022,
    KIP_MSG_ID_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ = 0x1023,
    KIP_MSG_ID_CAP_DOWNLOAD_REMOVE_ELF_REQ = 0x1024,
    KIP_MSG_ID_GET_MIPS_USAGE_REQ = 0x1025,
    ...
    KIP_MSG_ID_CAP_DOWNLOAD_REQ_DATA_RES = 0x501D,
    KIP_MSG_ID_CAP_DOWNLOAD_REMOVE_KCS_RES = 0x5021,
    KIP_MSG_ID_CAP_DOWNLOAD_REMOVE_ELF_RES = 0x5024,
    KIP_MSG_ID_GET_MIPS_USAGE_RES = 0x5025
} KIP_MSG_ID;
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ
...
/* The following macros take KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ *kip_msg_cap_download_add_elf_req_ptr */
#define KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ_CON_ID_GET(kip_msg_cap_download_add_elf_req_ptr) ((kip_msg_cap_download_add_elf_req_ptr)->_data[0])
#define KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ_CON_ID_SET(kip_msg_cap_download_add_elf_req_ptr, con_id) ((kip_msg_cap_download_add_elf_req_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ_NUM_RECORDS_WORD_OFFSET (1)
#define KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ_NUM_RECORDS_GET(kip_msg_cap_download_add_elf_req_ptr)  \
    (((uint32)((kip_msg_cap_download_add_elf_req_ptr)->_data[1]) | \
      ((uint32)((kip_msg_cap_download_add_elf_req_ptr)->_data[2]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ_NUM_RECORDS_SET(kip_msg_cap_download_add_elf_req_ptr, num_records) do { \
        (kip_msg_cap_download_add_elf_req_ptr)->_data[1] = (uint16)((num_records) & 0xffff); \
        (kip_msg_cap_download_add_elf_req_ptr)->_data[2] = (uint16)((num_records) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ_FILE_ID_WORD_OFFSET (3)
#define KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ_FILE_ID_GET(kip_msg_cap_download_add_elf_req_ptr)  \
    (((uint32)((kip_msg_cap_download_add_elf_req_ptr)->_data[3]) | \
      ((uint32)((kip_msg_cap_download_add_elf_req_ptr)->_data[4]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ_FILE_ID_SET(kip_msg_cap_download_add_elf_req_ptr, file_id) do { \
        (kip_msg_cap_download_add_elf_req_ptr)->_data[3] = (uint16)((file_id) & 0xffff); \
        (kip_msg_cap_download_add_elf_req_ptr)->_data[4] = (uint16)((file_id) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ_WORD_SIZE (5)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ_CREATE(con_id, num_records, file_id) \
    (uint16)(con_id), \
    (uint16)((num_records) & 0xffff), \
    (uint16)((num_records) >> 16), \
    (uint16)((file_id) & 0xffff), \
    (uint16)((file_id) >> 16)
#define KIP_MSG_CAP_DOWNLOAD_ADD_ELF_REQ_PACK(kip_msg_cap_download_add_elf_req_ptr, con_id, num_records, file_id) \
    do { \
        (kip_msg_cap_download_add_elf_req_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_cap_download_add_elf_req_ptr)->_data[1] = (uint16)((uint16)((num_records) & 0xffff)); \
        (kip_msg_cap_download_add_elf_req_ptr)->_data[2] = (uint16)(((num_records) >> 16)); \
        (kip_msg_cap_download_add_elf_req_ptr)->_data[3] = (uint16)((uint16)((file_id) & 0xffff)); \
        (kip_msg_cap_download_add_elf_req_ptr)->_data[4] = (uint16)(((file_id) >> 16)); \
    } while (0)
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ
  ...
  MEMBERS
    con_id    - Connection ID.
    file_id   - File ID.
    dev_addr  - The address on the device.
    file_addr - The address in the file.
...
/* The following macros take KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ *kip_msg_cap_download_add_mapped_record_req_ptr */
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_CON_ID_GET(kip_msg_cap_download_add_mapped_record_req_ptr) ((kip_msg_cap_download_add_mapped_record_req_ptr)->_data[0])
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_CON_ID_SET(kip_msg_cap_download_add_mapped_record_req_ptr, con_id) ((kip_msg_cap_download_add_mapped_record_req_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_FILE_ID_WORD_OFFSET (1)
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_FILE_ID_GET(kip_msg_cap_download_add_mapped_record_req_ptr)  \
    (((uint32)((kip_msg_cap_download_add_mapped_record_req_ptr)->_data[1]) | \
      ((uint32)((kip_msg_cap_download_add_mapped_record_req_ptr)->_data[2]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_FILE_ID_SET(kip_msg_cap_download_add_mapped_record_req_ptr, file_id) do { \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[1] = (uint16)((file_id) & 0xffff); \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[2] = (uint16)((file_id) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_DEV_ADDR_WORD_OFFSET (3)
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_DEV_ADDR_GET(kip_msg_cap_download_add_mapped_record_req_ptr)  \
    (((uint32)((kip_msg_cap_download_add_mapped_record_req_ptr)->_data[3]) | \
      ((uint32)((kip_msg_cap_download_add_mapped_record_req_ptr)->_data[4]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_DEV_ADDR_SET(kip_msg_cap_download_add_mapped_record_req_ptr, dev_addr) do { \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[3] = (uint16)((dev_addr) & 0xffff); \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[4] = (uint16)((dev_addr) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_FILE_ADDR_WORD_OFFSET (5)
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_FILE_ADDR_GET(kip_msg_cap_download_add_mapped_record_req_ptr)  \
    (((uint32)((kip_msg_cap_download_add_mapped_record_req_ptr)->_data[5]) | \
      ((uint32)((kip_msg_cap_download_add_mapped_record_req_ptr)->_data[6]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_FILE_ADDR_SET(kip_msg_cap_download_add_mapped_record_req_ptr, file_addr) do { \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[5] = (uint16)((file_addr) & 0xffff); \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[6] = (uint16)((file_addr) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_LENGTH_WORD_OFFSET (7)
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_LENGTH_GET(kip_msg_cap_download_add_mapped_record_req_ptr)  \
    (((uint32)((kip_msg_cap_download_add_mapped_record_req_ptr)->_data[7]) | \
      ((uint32)((kip_msg_cap_download_add_mapped_record_req_ptr)->_data[7 + 1]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_LENGTH_SET(kip_msg_cap_download_add_mapped_record_req_ptr, length) do { \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[7] = (uint16)((length) & 0xffff); \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[7 + 1] = (uint16)((length) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_WORD_SIZE (9)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_CREATE(con_id, file_id, dev_addr, file_addr, length) \
    (uint16)(con_id), \
    (uint16)((file_id) & 0xffff), \
    (uint16)((file_id) >> 16), \
    (uint16)((dev_addr) & 0xffff), \
    (uint16)((dev_addr) >> 16), \
    (uint16)((file_addr) & 0xffff), \
    (uint16)((file_addr) >> 16), \
    (uint16)((length) & 0xffff), \
    (uint16)((length) >> 16)
#define KIP_MSG_CAP_DOWNLOAD_ADD_MAPPED_RECORD_REQ_PACK(kip_msg_cap_download_add_mapped_record_req_ptr, con_id, file_id, dev_addr, file_addr, length) \
    do { \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[1] = (uint16)((uint16)((file_id) & 0xffff)); \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[2] = (uint16)(((file_id) >> 16)); \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[3] = (uint16)((uint16)((dev_addr) & 0xffff)); \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[4] = (uint16)(((dev_addr) >> 16)); \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[5] = (uint16)((uint16)((file_addr) & 0xffff)); \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[6] = (uint16)(((file_addr) >> 16)); \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[7] = (uint16)((uint16)((length) & 0xffff)); \
        (kip_msg_cap_download_add_mapped_record_req_ptr)->_data[7 + 1] = (uint16)(((length) >> 16)); \
    } while (0)
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ
...
/* The following macros take KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ *kip_msg_cap_download_kcs_callback_req_ptr */
#define KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ_CON_ID_GET(kip_msg_cap_download_kcs_callback_req_ptr) ((kip_msg_cap_download_kcs_callback_req_ptr)->_data[0])
#define KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ_CON_ID_SET(kip_msg_cap_download_kcs_callback_req_ptr, con_id) ((kip_msg_cap_download_kcs_callback_req_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ_STATUS_WORD_OFFSET (1)
#define KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ_STATUS_GET(kip_msg_cap_download_kcs_callback_req_ptr) ((kip_msg_cap_download_kcs_callback_req_ptr)->_data[1])
#define KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ_STATUS_SET(kip_msg_cap_download_kcs_callback_req_ptr, status) ((kip_msg_cap_download_kcs_callback_req_ptr)->_data[1] = (uint16)(status))
#define KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ_KCS_ID_WORD_OFFSET (2)
#define KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ_KCS_ID_GET(kip_msg_cap_download_kcs_callback_req_ptr) ((kip_msg_cap_download_kcs_callback_req_ptr)->_data[2])
#define KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ_KCS_ID_SET(kip_msg_cap_download_kcs_callback_req_ptr, kcs_id) ((kip_msg_cap_download_kcs_callback_req_ptr)->_data[2] = (uint16)(kcs_id))
#define KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ_WORD_SIZE (3)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ_CREATE(con_id, status, kcs_id) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(kcs_id)
#define KIP_MSG_CAP_DOWNLOAD_KCS_CALLBACK_REQ_PACK(kip_msg_cap_download_kcs_callback_req_ptr, con_id, status, kcs_id) \
    do { \
        (kip_msg_cap_download_kcs_callback_req_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_cap_download_kcs_callback_req_ptr)->_data[1] = (uint16)((uint16)(status)); \
        (kip_msg_cap_download_kcs_callback_req_ptr)->_data[2] = (uint16)((uint16)(kcs_id)); \
    } while (0)
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ
  ...
  MEMBERS
    ...
    kcs_id_addr - For DRAM, address where the KCS file starts (32 bits) - For
                  Kalimba DM, DM address. - For FastPipe and Hydra streams,
                  kcs_id.
...
/* The following macros take KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ *kip_msg_cap_download_remove_elf_req_ptr */
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ_CON_ID_GET(kip_msg_cap_download_remove_elf_req_ptr) ((kip_msg_cap_download_remove_elf_req_ptr)->_data[0])
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ_CON_ID_SET(kip_msg_cap_download_remove_elf_req_ptr, con_id) ((kip_msg_cap_download_remove_elf_req_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ_IFACE_TYPE_WORD_OFFSET (1)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ_IFACE_TYPE_GET(kip_msg_cap_download_remove_elf_req_ptr) ((kip_msg_cap_download_remove_elf_req_ptr)->_data[1])
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ_IFACE_TYPE_SET(kip_msg_cap_download_remove_elf_req_ptr, iface_type) ((kip_msg_cap_download_remove_elf_req_ptr)->_data[1] = (uint16)(iface_type))
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ_KCS_ID_ADDR_WORD_OFFSET (2)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ_KCS_ID_ADDR_GET(kip_msg_cap_download_remove_elf_req_ptr)  \
    (((uint32)((kip_msg_cap_download_remove_elf_req_ptr)->_data[2]) | \
      ((uint32)((kip_msg_cap_download_remove_elf_req_ptr)->_data[3]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ_KCS_ID_ADDR_SET(kip_msg_cap_download_remove_elf_req_ptr, kcs_id_addr) do { \
        (kip_msg_cap_download_remove_elf_req_ptr)->_data[2] = (uint16)((kcs_id_addr) & 0xffff); \
        (kip_msg_cap_download_remove_elf_req_ptr)->_data[3] = (uint16)((kcs_id_addr) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ_WORD_SIZE (4)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ_CREATE(con_id, iface_type, kcs_id_addr) \
    (uint16)(con_id), \
    (uint16)(iface_type), \
    (uint16)((kcs_id_addr) & 0xffff), \
    (uint16)((kcs_id_addr) >> 16)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_REQ_PACK(kip_msg_cap_download_remove_elf_req_ptr, con_id, iface_type, kcs_id_addr) \
    do { \
        (kip_msg_cap_download_remove_elf_req_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_cap_download_remove_elf_req_ptr)->_data[1] = (uint16)((uint16)(iface_type)); \
        (kip_msg_cap_download_remove_elf_req_ptr)->_data[2] = (uint16)((uint16)((kcs_id_addr) & 0xffff)); \
        (kip_msg_cap_download_remove_elf_req_ptr)->_data[3] = (uint16)(((kcs_id_addr) >> 16)); \
    } while (0)
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES
...
/* The following macros take KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES *kip_msg_cap_download_remove_elf_res_ptr */
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES_CON_ID_GET(kip_msg_cap_download_remove_elf_res_ptr) ((kip_msg_cap_download_remove_elf_res_ptr)->_data[0])
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES_CON_ID_SET(kip_msg_cap_download_remove_elf_res_ptr, con_id) ((kip_msg_cap_download_remove_elf_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES_IFACE_TYPE_WORD_OFFSET (1)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES_IFACE_TYPE_GET(kip_msg_cap_download_remove_elf_res_ptr) ((kip_msg_cap_download_remove_elf_res_ptr)->_data[1])
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES_IFACE_TYPE_SET(kip_msg_cap_download_remove_elf_res_ptr, iface_type) ((kip_msg_cap_download_remove_elf_res_ptr)->_data[1] = (uint16)(iface_type))
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES_KCS_ID_ADDR_WORD_OFFSET (2)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES_KCS_ID_ADDR_GET(kip_msg_cap_download_remove_elf_res_ptr)  \
    (((uint32)((kip_msg_cap_download_remove_elf_res_ptr)->_data[2]) | \
      ((uint32)((kip_msg_cap_download_remove_elf_res_ptr)->_data[3]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES_KCS_ID_ADDR_SET(kip_msg_cap_download_remove_elf_res_ptr, kcs_id_addr) do { \
        (kip_msg_cap_download_remove_elf_res_ptr)->_data[2] = (uint16)((kcs_id_addr) & 0xffff); \
        (kip_msg_cap_download_remove_elf_res_ptr)->_data[3] = (uint16)((kcs_id_addr) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES_WORD_SIZE (4)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES_CREATE(con_id, iface_type, kcs_id_addr) \
    (uint16)(con_id), \
    (uint16)(iface_type), \
    (uint16)((kcs_id_addr) & 0xffff), \
    (uint16)((kcs_id_addr) >> 16)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_ELF_RES_PACK(kip_msg_cap_download_remove_elf_res_ptr, con_id, iface_type, kcs_id_addr) \
    do { \
        (kip_msg_cap_download_remove_elf_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_cap_download_remove_elf_res_ptr)->_data[1] = (uint16)((uint16)(iface_type)); \
        (kip_msg_cap_download_remove_elf_res_ptr)->_data[2] = (uint16)((uint16)((kcs_id_addr) & 0xffff)); \
        (kip_msg_cap_download_remove_elf_res_ptr)->_data[3] = (uint16)(((kcs_id_addr) >> 16)); \
    } while (0)
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ
...
/* The following macros take KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ *kip_msg_cap_download_remove_kcs_req_ptr */
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ_CON_ID_GET(kip_msg_cap_download_remove_kcs_req_ptr) ((kip_msg_cap_download_remove_kcs_req_ptr)->_data[0])
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ_CON_ID_SET(kip_msg_cap_download_remove_kcs_req_ptr, con_id) ((kip_msg_cap_download_remove_kcs_req_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ_IFACE_TYPE_WORD_OFFSET (1)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ_IFACE_TYPE_GET(kip_msg_cap_download_remove_kcs_req_ptr) ((kip_msg_cap_download_remove_kcs_req_ptr)->_data[1])
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ_IFACE_TYPE_SET(kip_msg_cap_download_remove_kcs_req_ptr, iface_type) ((kip_msg_cap_download_remove_kcs_req_ptr)->_data[1] = (uint16)(iface_type))
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ_KCS_ID_ADDR_WORD_OFFSET (2)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ_KCS_ID_ADDR_GET(kip_msg_cap_download_remove_kcs_req_ptr)  \
    (((uint32)((kip_msg_cap_download_remove_kcs_req_ptr)->_data[2]) | \
      ((uint32)((kip_msg_cap_download_remove_kcs_req_ptr)->_data[3]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ_KCS_ID_ADDR_SET(kip_msg_cap_download_remove_kcs_req_ptr, kcs_id_addr) do { \
        (kip_msg_cap_download_remove_kcs_req_ptr)->_data[2] = (uint16)((kcs_id_addr) & 0xffff); \
        (kip_msg_cap_download_remove_kcs_req_ptr)->_data[3] = (uint16)((kcs_id_addr) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ_WORD_SIZE (4)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ_CREATE(con_id, iface_type, kcs_id_addr) \
    (uint16)(con_id), \
    (uint16)(iface_type), \
    (uint16)((kcs_id_addr) & 0xffff), \
    (uint16)((kcs_id_addr) >> 16)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_REQ_PACK(kip_msg_cap_download_remove_kcs_req_ptr, con_id, iface_type, kcs_id_addr) \
    do { \
        (kip_msg_cap_download_remove_kcs_req_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_cap_download_remove_kcs_req_ptr)->_data[1] = (uint16)((uint16)(iface_type)); \
        (kip_msg_cap_download_remove_kcs_req_ptr)->_data[2] = (uint16)((uint16)((kcs_id_addr) & 0xffff)); \
        (kip_msg_cap_download_remove_kcs_req_ptr)->_data[3] = (uint16)(((kcs_id_addr) >> 16)); \
    } while (0)
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_RES

  DESCRIPTION

  MEMBERS
    con_id - Connection ID.
    status - The status of the remove KCS request.
...
/* The following macros take KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_RES *kip_msg_cap_download_remove_kcs_res_ptr */
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_RES_CON_ID_GET(kip_msg_cap_download_remove_kcs_res_ptr) ((kip_msg_cap_download_remove_kcs_res_ptr)->_data[0])
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_RES_CON_ID_SET(kip_msg_cap_download_remove_kcs_res_ptr, con_id) ((kip_msg_cap_download_remove_kcs_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_RES_STATUS_GET(kip_msg_cap_download_remove_kcs_res_ptr) ((kip_msg_cap_download_remove_kcs_res_ptr)->_data[1])
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_RES_STATUS_SET(kip_msg_cap_download_remove_kcs_res_ptr, status) ((kip_msg_cap_download_remove_kcs_res_ptr)->_data[1] = (uint16)(status))
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_RES_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_RES_CREATE(con_id, status) \
    (uint16)(con_id), \
    (uint16)(status)
#define KIP_MSG_CAP_DOWNLOAD_REMOVE_KCS_RES_PACK(kip_msg_cap_download_remove_kcs_res_ptr, con_id, status) \
    do { \
        (kip_msg_cap_download_remove_kcs_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_cap_download_remove_kcs_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
    } while (0)
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ

  DESCRIPTION

  MEMBERS
    con_id - Connection ID.
    offset - Offset from addr to read data from (in 16-bit).
    state  - The state of the download manager on P1.
    addr   - Base address to read data from DRAM (in 32-bit).
...
/* The following macros take KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ *kip_msg_cap_download_req_data_req_ptr */
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_CON_ID_GET(kip_msg_cap_download_req_data_req_ptr) ((kip_msg_cap_download_req_data_req_ptr)->_data[0])
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_CON_ID_SET(kip_msg_cap_download_req_data_req_ptr, con_id) ((kip_msg_cap_download_req_data_req_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_OFFSET_WORD_OFFSET (1)
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_OFFSET_GET(kip_msg_cap_download_req_data_req_ptr) ((kip_msg_cap_download_req_data_req_ptr)->_data[1])
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_OFFSET_SET(kip_msg_cap_download_req_data_req_ptr, offset) ((kip_msg_cap_download_req_data_req_ptr)->_data[1] = (uint16)(offset))
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_STATE_WORD_OFFSET (2)
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_STATE_GET(kip_msg_cap_download_req_data_req_ptr) ((kip_msg_cap_download_req_data_req_ptr)->_data[2])
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_STATE_SET(kip_msg_cap_download_req_data_req_ptr, state) ((kip_msg_cap_download_req_data_req_ptr)->_data[2] = (uint16)(state))
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_ADDR_WORD_OFFSET (3)
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_ADDR_GET(kip_msg_cap_download_req_data_req_ptr)  \
    (((uint32)((kip_msg_cap_download_req_data_req_ptr)->_data[3]) | \
      ((uint32)((kip_msg_cap_download_req_data_req_ptr)->_data[4]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_ADDR_SET(kip_msg_cap_download_req_data_req_ptr, addr) do { \
        (kip_msg_cap_download_req_data_req_ptr)->_data[3] = (uint16)((addr) & 0xffff); \
        (kip_msg_cap_download_req_data_req_ptr)->_data[4] = (uint16)((addr) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_WORD_SIZE (5)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_CREATE(con_id, offset, state, addr) \
    (uint16)(con_id), \
    (uint16)(offset), \
    (uint16)(state), \
    (uint16)((addr) & 0xffff), \
    (uint16)((addr) >> 16)
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_REQ_PACK(kip_msg_cap_download_req_data_req_ptr, con_id, offset, state, addr) \
    do { \
        (kip_msg_cap_download_req_data_req_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_cap_download_req_data_req_ptr)->_data[1] = (uint16)((uint16)(offset)); \
        (kip_msg_cap_download_req_data_req_ptr)->_data[2] = (uint16)((uint16)(state)); \
        (kip_msg_cap_download_req_data_req_ptr)->_data[3] = (uint16)((uint16)((addr) & 0xffff)); \
        (kip_msg_cap_download_req_data_req_ptr)->_data[4] = (uint16)(((addr) >> 16)); \
    } while (0)
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES

  DESCRIPTION

  MEMBERS
    con_id - Connection ID.
    state  - The state of the download manager.
    status - status code
...
/* The following macros take KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES *kip_msg_cap_download_req_data_res_ptr */
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES_CON_ID_GET(kip_msg_cap_download_req_data_res_ptr) ((kip_msg_cap_download_req_data_res_ptr)->_data[0])
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES_CON_ID_SET(kip_msg_cap_download_req_data_res_ptr, con_id) ((kip_msg_cap_download_req_data_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES_STATE_WORD_OFFSET (1)
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES_STATE_GET(kip_msg_cap_download_req_data_res_ptr) ((kip_msg_cap_download_req_data_res_ptr)->_data[1])
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES_STATE_SET(kip_msg_cap_download_req_data_res_ptr, state) ((kip_msg_cap_download_req_data_res_ptr)->_data[1] = (uint16)(state))
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES_STATUS_WORD_OFFSET (2)
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES_STATUS_GET(kip_msg_cap_download_req_data_res_ptr) ((kip_msg_cap_download_req_data_res_ptr)->_data[2])
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES_STATUS_SET(kip_msg_cap_download_req_data_res_ptr, status) ((kip_msg_cap_download_req_data_res_ptr)->_data[2] = (uint16)(status))
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES_WORD_SIZE (3)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES_CREATE(con_id, state, status) \
    (uint16)(con_id), \
    (uint16)(state), \
    (uint16)(status)
#define KIP_MSG_CAP_DOWNLOAD_REQ_DATA_RES_PACK(kip_msg_cap_download_req_data_res_ptr, con_id, state, status) \
    do { \
        (kip_msg_cap_download_req_data_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_cap_download_req_data_res_ptr)->_data[1] = (uint16)((uint16)(state)); \
        (kip_msg_cap_download_req_data_res_ptr)->_data[2] = (uint16)((uint16)(status)); \
    } while (0)
...
/*******************************************************************************
  ...
  NAME
    KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ

  DESCRIPTION

  MEMBERS
    con_id        - The connection ID.
    iface_type    - Download interface type.
    iface_addr    - Interface address.
    num_download  - Number of capabilities to be downloaded.
    num_override  - Number of capabilities to be overridden.
    download_caps - Capabilities to be downloaded immediately.
    override_caps - Capabilities to be overridden.
    download_type - The type of the download.
...
/* The following macros take KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ *kip_msg_cap_download_start_download_req_ptr */
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_CON_ID_GET(kip_msg_cap_download_start_download_req_ptr) ((kip_msg_cap_download_start_download_req_ptr)->_data[0])
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_CON_ID_SET(kip_msg_cap_download_start_download_req_ptr, con_id) ((kip_msg_cap_download_start_download_req_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_IFACE_TYPE_WORD_OFFSET (1)
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_IFACE_TYPE_GET(kip_msg_cap_download_start_download_req_ptr) ((kip_msg_cap_download_start_download_req_ptr)->_data[1])
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_IFACE_TYPE_SET(kip_msg_cap_download_start_download_req_ptr, iface_type) ((kip_msg_cap_download_start_download_req_ptr)->_data[1] = (uint16)(iface_type))
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_IFACE_ADDR_WORD_OFFSET (2)
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_IFACE_ADDR_GET(kip_msg_cap_download_start_download_req_ptr)  \
    (((uint32)((kip_msg_cap_download_start_download_req_ptr)->_data[2]) | \
      ((uint32)((kip_msg_cap_download_start_download_req_ptr)->_data[3]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_IFACE_ADDR_SET(kip_msg_cap_download_start_download_req_ptr, iface_addr) do { \
        (kip_msg_cap_download_start_download_req_ptr)->_data[2] = (uint16)((iface_addr) & 0xffff); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[3] = (uint16)((iface_addr) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_NUM_DOWNLOAD_WORD_OFFSET (4)
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_NUM_DOWNLOAD_GET(kip_msg_cap_download_start_download_req_ptr) ((kip_msg_cap_download_start_download_req_ptr)->_data[4])
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_NUM_DOWNLOAD_SET(kip_msg_cap_download_start_download_req_ptr, num_download) ((kip_msg_cap_download_start_download_req_ptr)->_data[4] = (uint16)(num_download))
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_NUM_OVERRIDE_WORD_OFFSET (5)
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_NUM_OVERRIDE_GET(kip_msg_cap_download_start_download_req_ptr) ((kip_msg_cap_download_start_download_req_ptr)->_data[5])
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_NUM_OVERRIDE_SET(kip_msg_cap_download_start_download_req_ptr, num_override) ((kip_msg_cap_download_start_download_req_ptr)->_data[5] = (uint16)(num_override))
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_DOWNLOAD_CAPS_WORD_OFFSET (6)
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_DOWNLOAD_CAPS_GET(kip_msg_cap_download_start_download_req_ptr)  \
    (((uint32)((kip_msg_cap_download_start_download_req_ptr)->_data[6]) | \
      ((uint32)((kip_msg_cap_download_start_download_req_ptr)->_data[7]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_DOWNLOAD_CAPS_SET(kip_msg_cap_download_start_download_req_ptr, download_caps) do { \
        (kip_msg_cap_download_start_download_req_ptr)->_data[6] = (uint16)((download_caps) & 0xffff); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[7] = (uint16)((download_caps) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_OVERRIDE_CAPS_WORD_OFFSET (8)
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_OVERRIDE_CAPS_GET(kip_msg_cap_download_start_download_req_ptr)  \
    (((uint32)((kip_msg_cap_download_start_download_req_ptr)->_data[8]) | \
      ((uint32)((kip_msg_cap_download_start_download_req_ptr)->_data[8 + 1]) << 16)))
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_OVERRIDE_CAPS_SET(kip_msg_cap_download_start_download_req_ptr, override_caps) do { \
        (kip_msg_cap_download_start_download_req_ptr)->_data[8] = (uint16)((override_caps) & 0xffff); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[8 + 1] = (uint16)((override_caps) >> 16); } while (0)
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_DOWNLOAD_TYPE_WORD_OFFSET (10)
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_DOWNLOAD_TYPE_GET(kip_msg_cap_download_start_download_req_ptr) ((kip_msg_cap_download_start_download_req_ptr)->_data[10])
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_DOWNLOAD_TYPE_SET(kip_msg_cap_download_start_download_req_ptr, download_type) ((kip_msg_cap_download_start_download_req_ptr)->_data[10] = (uint16)(download_type))
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_WORD_SIZE (11)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_CREATE(con_id, iface_type, iface_addr, num_download, num_override, download_caps, override_caps, download_type) \
    (uint16)(con_id), \
    (uint16)(iface_type), \
    (uint16)((iface_addr) & 0xffff), \
    (uint16)((iface_addr) >> 16), \
    (uint16)(num_download), \
    (uint16)(num_override), \
    (uint16)((download_caps) & 0xffff), \
    (uint16)((download_caps) >> 16), \
    (uint16)((override_caps) & 0xffff), \
    (uint16)((override_caps) >> 16), \
    (uint16)(download_type)
#define KIP_MSG_CAP_DOWNLOAD_START_DOWNLOAD_REQ_PACK(kip_msg_cap_download_start_download_req_ptr, con_id, iface_type, iface_addr, num_download, num_override, download_caps, override_caps, download_type) \
    do { \
        (kip_msg_cap_download_start_download_req_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[1] = (uint16)((uint16)(iface_type)); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[2] = (uint16)((uint16)((iface_addr) & 0xffff)); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[3] = (uint16)(((iface_addr) >> 16)); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[4] = (uint16)((uint16)(num_download)); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[5] = (uint16)((uint16)(num_override)); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[6] = (uint16)((uint16)((download_caps) & 0xffff)); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[7] = (uint16)(((download_caps) >> 16)); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[8] = (uint16)((uint16)((override_caps) & 0xffff)); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[8 + 1] = (uint16)(((override_caps) >> 16)); \
        (kip_msg_cap_download_start_download_req_ptr)->_data[10] = (uint16)((uint16)(download_type)); \
    } while (0)
...
/*******************************************************************************
  ...
  MEMBERS
    ...
    priority      - Number of configuration key-value pairs
...
#define KIP_MSG_CREATE_OPERATOR_REQ_PRIORITY_WORD_OFFSET (3)
#define KIP_MSG_CREATE_OPERATOR_REQ_PRIORITY_GET(kip_msg_create_operator_req_ptr) ((kip_msg_create_operator_req_ptr)->_data[3])
#define KIP_MSG_CREATE_OPERATOR_REQ_PRIORITY_SET(kip_msg_create_operator_req_ptr, priority) ((kip_msg_create_operator_req_ptr)->_data[3] = (uint16)(priority))
#define KIP_MSG_CREATE_OPERATOR_REQ_WORD_SIZE (4)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_CREATE_OPERATOR_REQ_CREATE(con_id, Capability_ID, Op_ID, priority) \
    (uint16)(con_id), \
    (uint16)(Capability_ID), \
    (uint16)(Op_ID), \
    (uint16)(priority)
#define KIP_MSG_CREATE_OPERATOR_REQ_PACK(kip_msg_create_operator_req_ptr, con_id, Capability_ID, Op_ID, priority) \
    do { \
        ...
        (kip_msg_create_operator_req_ptr)->_data[3] = (uint16)((uint16)(priority)); \
    } while (0)
...
/* The following macros take KIP_MSG_PS_REGISTER_REQ *kip_msg_ps_register_req_ptr */
#define KIP_MSG_PS_REGISTER_REQ_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_PS_REGISTER_REQ_CON_ID_GET(kip_msg_ps_register_req_ptr) ((kip_msg_ps_register_req_ptr)->_data[0])
#define KIP_MSG_PS_REGISTER_REQ_CON_ID_SET(kip_msg_ps_register_req_ptr, con_id) ((kip_msg_ps_register_req_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_PS_REGISTER_REQ_WORD_SIZE (1)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_PS_REGISTER_REQ_CREATE(con_id) \
    (uint16)(con_id)
#define KIP_MSG_PS_REGISTER_REQ_PACK(kip_msg_ps_register_req_ptr, con_id) \
    do { \
        (kip_msg_ps_register_req_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
    } while (0)
...
/*******************************************************************************
  ...
  MEMBERS
    ...
    data_format      - The data format of the local endpoint. This value is set
                       to the shadow sink on the remote core. Otherwise, it is
                       ignored. This aims to replicate data format configuration
                       as if it happened on a single core - see
                       stream_resolve_endpoint_data_formats().
    sync_shadow_eps  - Parameter to tell the other side if the shadow endpoints
                       should be synced.
...
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_DATA_FORMAT_WORD_OFFSET (10)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_DATA_FORMAT_GET(kip_msg_stream_create_endpoints_req_ptr)  \
    (((uint32)((kip_msg_stream_create_endpoints_req_ptr)->_data[10]) | \
      ((uint32)((kip_msg_stream_create_endpoints_req_ptr)->_data[11]) << 16)))
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_DATA_FORMAT_SET(kip_msg_stream_create_endpoints_req_ptr, data_format) do { \
        (kip_msg_stream_create_endpoints_req_ptr)->_data[10] = (uint16)((data_format) & 0xffff); \
        (kip_msg_stream_create_endpoints_req_ptr)->_data[11] = (uint16)((data_format) >> 16); } while (0)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_SYNC_SHADOW_EPS_WORD_OFFSET (12)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_SYNC_SHADOW_EPS_GET(kip_msg_stream_create_endpoints_req_ptr) ((kip_msg_stream_create_endpoints_req_ptr)->_data[12])
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_SYNC_SHADOW_EPS_SET(kip_msg_stream_create_endpoints_req_ptr, sync_shadow_eps) ((kip_msg_stream_create_endpoints_req_ptr)->_data[12] = (uint16)(sync_shadow_eps))
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_WORD_SIZE (13)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_CREATE(con_id, Source_ID, Sink_ID, Channel_ID, Buffer_size, tinfo_block_size, tinfo_period, flags, data_format, sync_shadow_eps) \
    (uint16)(con_id), \
    (uint16)(Source_ID), \
    (uint16)(Sink_ID), \
    (uint16)(Channel_ID), \
    ...
    (uint16)(flags), \
    (uint16)((data_format) & 0xffff), \
    (uint16)((data_format) >> 16), \
    (uint16)(sync_shadow_eps)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_REQ_PACK(kip_msg_stream_create_endpoints_req_ptr, con_id, Source_ID, Sink_ID, Channel_ID, Buffer_size, tinfo_block_size, tinfo_period, flags, data_format, sync_shadow_eps) \
    do { \
        ...
        (kip_msg_stream_create_endpoints_req_ptr)->_data[10] = (uint16)((uint16)((data_format) & 0xffff)); \
        (kip_msg_stream_create_endpoints_req_ptr)->_data[11] = (uint16)(((data_format) >> 16)); \
        (kip_msg_stream_create_endpoints_req_ptr)->_data[12] = (uint16)((uint16)(sync_shadow_eps)); \
    } while (0)
...
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_DATA_FORMAT_WORD_OFFSET (9)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_DATA_FORMAT_GET(kip_msg_stream_create_endpoints_res_ptr)  \
    (((uint32)((kip_msg_stream_create_endpoints_res_ptr)->_data[9]) | \
      ((uint32)((kip_msg_stream_create_endpoints_res_ptr)->_data[9 + 1]) << 16)))
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_DATA_FORMAT_SET(kip_msg_stream_create_endpoints_res_ptr, data_format) do { \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[9] = (uint16)((data_format) & 0xffff); \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[9 + 1] = (uint16)((data_format) >> 16); } while (0)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_WORD_SIZE (11)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_CREATE(con_id, status, Channel_ID, Buffer_size, tinfo_block_size, tinfo_period, flags, data_format) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(Channel_ID), \
    (uint16)(Buffer_size), \
    ...
    (uint16)((data_format) & 0xffff), \
    (uint16)((data_format) >> 16)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_PACK(kip_msg_stream_create_endpoints_res_ptr, con_id, status, Channel_ID, Buffer_size, tinfo_block_size, tinfo_period, flags, data_format) \
    do { \
        ...
        (kip_msg_stream_create_endpoints_res_ptr)->_data[9] = (uint16)((uint16)((data_format) & 0xffff)); \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[9 + 1] = (uint16)(((data_format) >> 16)); \
    } while (0)
