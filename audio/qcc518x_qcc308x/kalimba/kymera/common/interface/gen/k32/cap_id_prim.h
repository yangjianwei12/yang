...
/*******************************************************************************
 ...
 VALUES
    ...
    SBC_SHUNT_ENCODER
                   - SBC Encoder for A2DP / Shunt
    MP3_SHUNT_ENCODER
                   - Configurable Mp3 encoder for A2DP / Shunt
    RESAMPLER
                   - Standard-frequency-set Resampler
    MIXER
                   - Stereo/Mono Audio Mixer
    APTX_SHUNT_ENCODER
                   - High-Quality APT-X Audio Encoder for A2DP / Shunt
    FM_ENHANCEMENT
    ...
    CVCHS1MIC_VA_WB
                   - CVC 1 Mic Headset Wideband VA
    CVCEB2MIC_IE_NB
                   - CVC 2 Mic Earbud In-Ear Narrowband
    CVCEB3MIC_MONO_IE_NB
                   - CVC 3 Mic Earbud Mono In-Ear Narrowband
    CVCEB3MIC_MONO_IE_SWB
                   - CVC 3 Mic Earbud Mono In-Ear Super Wideband
    CVCEB3MIC_HYBRID_WB
                   - CVC 3 Mic Earbud In-Ear Hybrid Wideband
    CVCEB3MIC_HYBRID_SWB
                   - CVC 3 Mic Earbud In-Ear Hybrid Super Wideband
    CVCHS2MIC_MONO_SEND_HYBRID_WB
                   - CVC 2 Mic Headset endfire Hybrid Wideband
    CVCHS2MIC_MONO_SEND_HYBRID_SWB
                   - CVC 2 Mic Headset endfire Hybrid Super Wideband
    DBE_FULLBAND
                   - DBE_FULLBAND
    ...
    APTXHD_DECODER
                   - aptxhd raw decoder
    APTXHD_SHUNT_ENCODER
                   - High-Quality APT-X HD Audio Encoder for A2DP / Shunt
    ...
    OPUS_CELT_ENCODE
                   - Opus-CELT encoder
    LC3_DECODE
                   - LC3 Decoder - Plain for use in A2DP chains
    LC3_DECODE_SCO_ISO
                   - LC3 Decoder for SCO and ISO chains
    LC3_ENCODE
                   - LC3 Encoder - Plain for use in A2DP chains
    LC3_ENCODE_SCO_ISO
                   - LC3 Encoder for SCO and ISO chains
    GVA
    ...
    SVAD
                   - Self Voice Activity Detector
    LC3Q_ENCODE_SCO_ISO
                   - LC3Q Encoder for SCO and ISO chains
    LC3Q_DECODE_SCO_ISO
                   - LC3Q Decoder for SCO and ISO chains
    ML_BASE
                   - ML base for ML use cases
    ML_ENGINE
                   - ML engine for ML use cases
    SILENCE_DETECT
                   - Silence Detection Capability
    ANC_TUNING_32K
                   - ANC Tuning 32k Capability
    ANC_COMPANDER
                   - ANC Compander Capability
    ANC_HW_MANAGER
                   - ANC HW Manager Capability
    HCGR_16K
                   - Howling Control and Gain Recovery 16k
    APTX_ADAPTIVE_R3_MONO_DECODE
                   - aptX Adaptive R3 Mono Decoder
    APTX_ADAPTIVE_R3_STEREO_DECODE
                   - aptX Adaptive R3 Stereo Decoder
    APTX_ADAPTIVE_R3_ENCODE
                   - aptX Adaptive R3 Encoder
    APTX_ADAPTIVE_R3_STEREO_ENCODE
                   - aptX Adaptive R3 Stereo Encoder
    WIND_NOISE_DETECT
                   - Wind Noise Detection Capability
    ML_EXAMPLE_SVAD
                   - Example ML based Self VAD Capability
    APTX_ADAPTIVE_DECODE_SCO_ISO
                   - aptX Adaptive Decoder for LE Audio
    ML_NNOPS
                   - Example ML capability to directly access Kalimba NN ops lib
    ATR_VAD
                   - VAD for Auto-Transparency
    AAH
                   - Adverse Acoustic Handler capability
    NOISE_ID
                   - Noise ID capability
    GEQ
                   - Graphical Equalizer capability
    APTX_LITE_ENCODE_SCO_ISO
                   - aptX lite Encoder for SCO/ISO use-cases
    APTX_LITE_DECODE_SCO_ISO
                   - aptX lite Decoder for SCO/ISO use-cases
    CVCHS1MIC_HYBRID_WB
                   - CVC 1 Mic Headset Hybrid Wideband
    CVCHS1MIC_HYBRID_SWB
                   - CVC 1 Mic Headset Hybrid Super Wideband
    APTX_ADAPTIVE_ENCODE_SCO_ISO
                   - aptx_adaptive r3 encode for SCO/ISO use-cases
    ENCODED_PKT_INTERLEAVE
                   - Encoded packet interleave capability
    TEST_VA
    ...
    DOWNLOAD_APTXHD_SHUNT_ENCODER
                   - Downloadable High-Quality APT-X HD Audio Encoder for A2DP /
                     Shunt
    ...
    DOWNLOAD_KSP
                   - Kymera Stream Probe, streaming of connection buffers' data
                     to a host
    DOWNLOAD_MP3_DECODER
                   - Downloadable MP3 Decoder
    DOWNLOAD_MP3_SHUNT_DECODER
                   - Downloadable MP3 Decoder over A2DP/Shunt (i.e. with L2CAP
                     Headers)
    DOWNLOAD_OPUS_CELT_ENCODE
                   - Downloadable Opus-CELT encoder
    DOWNLOAD_LC3_DECODE
                   - Downloadable LC3 Decoder - Plain for use in A2DP chains
    DOWNLOAD_LC3_DECODE_SCO_ISO
                   - Downloadable LC3 Decoder for SCO_ISO chains
    DOWNLOAD_LC3_ENCODE
                   - Downloadable LC3 Encoder - Plain for use in A2DP chains
    DOWNLOAD_LC3_ENCODE_SCO_ISO
                   - Downloadable LC3 Encoder for SCO_ISO chains
    DOWNLOAD_GVA
    ...
    DOWNLOAD_LC3Q_ENCODE_SCO_ISO
                   - Downloadable LC3Q Encoder for SCO_ISO chains
    DOWNLOAD_LC3Q_DECODE_SCO_ISO
                   - Downloadable LC3Q Decoder for SCO_ISO chains
    DOWNLOAD_ML_BASE
                   - Downloadable ML base for ML use cases
    DOWNLOAD_ML_ENGINE
                   - Downloadable ML engine for ML use cases
    DOWNLOAD_ANC_TUNING_32K
                   - Downloadable ANC Tuning 32K capability
    DOWNLOAD_CVCEB3MIC_MONO_IE_SWB
                   - Downloadable CVC 3 Mic Earbud Mono In-Ear Super Wideband
    DOWNLOAD_EXTRA_HEAP_TEST
                   - Downloadable Extra heap testing capability
    DOWNLOAD_SILENCE_DETECT
                   - Downloadable Silence Detection Capability
    DOWNLOAD_ANC_COMPANDER
                   - Downloadable ANC Compander capability
    DOWNLOAD_ANC_HW_MANAGER
                   - Downloadable ANC HW Manager capability
    DOWNLOAD_HCGR_16K
                   - Downloadable Howling Control and Gain Recovery 16k
    DOWNLOAD_APTX_ADAPTIVE_R3_MONO_DECODE
                   - aptX Adaptive R3 Mono Decoder
    DOWNLOAD_APTX_ADAPTIVE_R3_STEREO_DECODE
                   - aptX Adaptive R3 Stereo Decoder
    DOWNLOAD_APTX_ADAPTIVE_R3_ENCODE
                   - aptX Adaptive R3 Encoder
    DOWNLOAD_WIND_NOISE_DETECT
                   - Downloadable Wind Noise Detection Capability
    DOWNLOAD_ML_EXAMPLE_SVAD
                   - Downloadable Example ML based Self VAD Capability
    DOWNLOAD_APTX_ADAPTIVE_DECODE_SCO_ISO
                   - aptX Adaptive Decoder for LE Audio
    DOWNLOAD_ML_NNOPS
                   - Downloadable Example ML capability to directly access
                     Kalimba NN ops lib
    DOWNLOAD_CVCEB3MIC_HYBRID_WB
                   - Downloadable CVC 3 Mic Earbud In-Ear Hybrid Wideband
    DOWNLOAD_CVCEB3MIC_HYBRID_SWB
                   - Downloadable CVC 3 Mic Earbud In-Ear Hybrid Super Wideband
    DOWNLOAD_ATR_VAD
                   - Downloadable VAD for Auto-Transparency
    DOWNLOAD_AAH
                   - Downloadable Adverse Acoustic Handler capability
    DOWNLOAD_NOISE_ID
                   - Downloadable Noise ID capability
    DOWNLOAD_GEQ
                   - Downloadable Graphical Equalizer capability
    DOWNLOAD_APTX_LITE_ENCODE_SCO_ISO
                   - Downloadable aptX lite Encoder for SCO/ISO use-cases
    DOWNLOAD_APTX_LITE_DECODE_SCO_ISO
                   - Downloadable aptX lite Decoder for SCO/ISO use-cases
    DOWNLOAD_CVCHS2MIC_MONO_SEND_HYBRID_WB
                   - Downloadable CVC 2 Mic Headset endfire Hybrid Wideband
    DOWNLOAD_CVCHS2MIC_MONO_SEND_HYBRID_SWB
                   - Downloadable CVC 2 Mic Headset endfire Hybrid Super
                     Wideband
    DOWNLOAD_CVCHS1MIC_HYBRID_WB
                   - Downloadable CVC 1 Mic Headset Hybrid Wideband
    DOWNLOAD_CVCHS1MIC_HYBRID_SWB
                   - Downloadable CVC 1 Mic Headset Hybrid Super Wideband
    DOWNLOAD_APTX_ADAPTIVE_ENCODE_SCO_ISO
                   - Downloadable aptx_adaptive r3 encode for SCO/ISO use-cases
    DOWNLOAD_MIPS_MONITOR
                   - Downloadable MIPS_MONITOR capability
    DOWNLOAD_ENCODED_PKT_INTERLEAVE
                   - Downloadable encoded packet interleave capability
    DUMMY_ID_FORCE_INT
...
typedef enum
{
    ...
    CAP_ID_SBC_SHUNT_ENCODER = 0x0007,
    CAP_ID_MP3_SHUNT_ENCODER = 0x0008,
    CAP_ID_RESAMPLER = 0x0009,
    CAP_ID_MIXER = 0x000A,
    CAP_ID_APTX_SHUNT_ENCODER = 0x000B,
    ...
    CAP_ID_CVCHS1MIC_VA_WB = 0x0084,
    CAP_ID_CVCEB2MIC_IE_NB = 0x0085,
    CAP_ID_CVCEB3MIC_MONO_IE_NB = 0x0086,
    CAP_ID_CVCEB3MIC_MONO_IE_SWB = 0x0087,
    CAP_ID_CVCEB3MIC_HYBRID_WB = 0x008B,
    CAP_ID_CVCEB3MIC_HYBRID_SWB = 0x008C,
    CAP_ID_CVCHS2MIC_MONO_SEND_HYBRID_WB = 0x008D,
    CAP_ID_CVCHS2MIC_MONO_SEND_HYBRID_SWB = 0x008E,
    ...
    CAP_ID_APTXHD_SHUNT_ENCODER = 0x009F,
    ...
    CAP_ID_LC3_DECODE = 0x00C1,
    CAP_ID_LC3_DECODE_SCO_ISO = 0x00C2,
    CAP_ID_LC3_ENCODE = 0x00C3,
    CAP_ID_LC3_ENCODE_SCO_ISO = 0x00C4,
    CAP_ID_GVA = 0x00C5,
    CAP_ID_APVA = 0x00C6,
    CAP_ID_AANC_MONO_16K = 0x00C7,
    CAP_ID_AANC2_16K = 0x00C8,
    CAP_ID_AANC_LITE_16K = 0x00C9,
    CAP_ID_EARBUD_FIT_TEST_16K = 0x00CA,
    CAP_ID_CVC_FBC = 0x00CB,
    CAP_ID_SVAD = 0x00CD,
    CAP_ID_LC3Q_ENCODE_SCO_ISO = 0x00CE,
    CAP_ID_LC3Q_DECODE_SCO_ISO = 0x00CF,
    CAP_ID_ML_BASE = 0x00D0,
    CAP_ID_ML_ENGINE = 0x00D2,
    CAP_ID_SILENCE_DETECT = 0x00D3,
    CAP_ID_ANC_TUNING_32K = 0x00D4,
    CAP_ID_ANC_COMPANDER = 0x00D6,
    CAP_ID_ANC_HW_MANAGER = 0x00D7,
    CAP_ID_HCGR_16K = 0x00D8,
    CAP_ID_APTX_ADAPTIVE_R3_MONO_DECODE = 0x00DA,
    CAP_ID_APTX_ADAPTIVE_R3_STEREO_DECODE = 0x00DB,
    CAP_ID_APTX_ADAPTIVE_R3_ENCODE = 0x00DC,
    CAP_ID_APTX_ADAPTIVE_R3_STEREO_ENCODE = 0x00DD,
    CAP_ID_WIND_NOISE_DETECT = 0x00DF,
    CAP_ID_ML_EXAMPLE_SVAD = 0x00E0,
    CAP_ID_APTX_ADAPTIVE_DECODE_SCO_ISO = 0x00E1,
    CAP_ID_ML_NNOPS = 0x00E2,
    CAP_ID_ATR_VAD = 0x00E3,
    CAP_ID_AAH = 0x00EA,
    CAP_ID_NOISE_ID = 0x00EB,
    CAP_ID_GEQ = 0x00EC,
    CAP_ID_APTX_LITE_ENCODE_SCO_ISO = 0x00EF,
    CAP_ID_APTX_LITE_DECODE_SCO_ISO = 0x00F0,
    CAP_ID_CVCHS1MIC_HYBRID_WB = 0x00F6,
    CAP_ID_CVCHS1MIC_HYBRID_SWB = 0x00F7,
    CAP_ID_APTX_ADAPTIVE_ENCODE_SCO_ISO = 0x00F8,
    CAP_ID_ENCODED_PKT_INTERLEAVE = 0x00FA,
    ...
    CAP_ID_DOWNLOAD_APTXHD_SHUNT_ENCODER = 0x406F,
    ...
    CAP_ID_DOWNLOAD_MP3_DECODER = 0x4094,
    CAP_ID_DOWNLOAD_MP3_SHUNT_DECODER = 0x4095,
    CAP_ID_DOWNLOAD_OPUS_CELT_ENCODE = 0x4096,
    CAP_ID_DOWNLOAD_LC3_DECODE = 0x4097,
    CAP_ID_DOWNLOAD_LC3_DECODE_SCO_ISO = 0x4098,
    CAP_ID_DOWNLOAD_LC3_ENCODE = 0x4099,
    CAP_ID_DOWNLOAD_LC3_ENCODE_SCO_ISO = 0x409A,
    CAP_ID_DOWNLOAD_GVA = 0x409B,
    CAP_ID_DOWNLOAD_APVA = 0x409C,
    CAP_ID_DOWNLOAD_XOVER_3BAND = 0x409D,
    CAP_ID_DOWNLOAD_AANC_MONO_16K = 0x409F,
    CAP_ID_DOWNLOAD_CVC_FBC = 0x409e,
    CAP_ID_DOWNLOAD_AANC2_16K = 0x40A0,
    CAP_ID_DOWNLOAD_AANC_LITE_16K = 0x40A1,
    CAP_ID_DOWNLOAD_EARBUD_FIT_TEST_16K = 0x40A2,
    CAP_ID_DOWNLOAD_CVCHS1MIC_VA_WB = 0x40A3,
    ...
    CAP_ID_DOWNLOAD_LC3Q_ENCODE_SCO_ISO = 0x40AD,
    CAP_ID_DOWNLOAD_LC3Q_DECODE_SCO_ISO = 0x40AE,
    CAP_ID_DOWNLOAD_ML_BASE = 0x40AF,
    CAP_ID_DOWNLOAD_ML_ENGINE = 0x40B1,
    CAP_ID_DOWNLOAD_ANC_TUNING_32K = 0x40B2,
    CAP_ID_DOWNLOAD_CVCEB3MIC_MONO_IE_SWB = 0x40B3,
    CAP_ID_DOWNLOAD_EXTRA_HEAP_TEST = 0x40B4,
    CAP_ID_DOWNLOAD_SILENCE_DETECT = 0x40B5,
    CAP_ID_DOWNLOAD_ANC_COMPANDER = 0x40B7,
    CAP_ID_DOWNLOAD_ANC_HW_MANAGER = 0x40B8,
    CAP_ID_DOWNLOAD_HCGR_16K = 0x40B9,
    CAP_ID_DOWNLOAD_APTX_ADAPTIVE_R3_MONO_DECODE = 0x40BB,
    CAP_ID_DOWNLOAD_APTX_ADAPTIVE_R3_STEREO_DECODE = 0x40BC,
    CAP_ID_DOWNLOAD_APTX_ADAPTIVE_R3_ENCODE = 0x40BD,
    CAP_ID_DOWNLOAD_WIND_NOISE_DETECT = 0x40C0,
    CAP_ID_DOWNLOAD_ML_EXAMPLE_SVAD = 0x40C1,
    CAP_ID_DOWNLOAD_APTX_ADAPTIVE_DECODE_SCO_ISO = 0x40C4,
    CAP_ID_DOWNLOAD_ML_NNOPS = 0x40C5,
    CAP_ID_DOWNLOAD_CVCEB3MIC_HYBRID_WB = 0x40C7,
    CAP_ID_DOWNLOAD_CVCEB3MIC_HYBRID_SWB = 0x40C8,
    CAP_ID_DOWNLOAD_ATR_VAD = 0x40C9,
    CAP_ID_DOWNLOAD_AAH = 0x40D0,
    CAP_ID_DOWNLOAD_NOISE_ID = 0x40D1,
    CAP_ID_DOWNLOAD_GEQ = 0x40D2,
    CAP_ID_DOWNLOAD_APTX_LITE_ENCODE_SCO_ISO = 0x40D5,
    CAP_ID_DOWNLOAD_APTX_LITE_DECODE_SCO_ISO = 0x40D6,
    CAP_ID_DOWNLOAD_CVCHS2MIC_MONO_SEND_HYBRID_WB = 0x40DA,
    CAP_ID_DOWNLOAD_CVCHS2MIC_MONO_SEND_HYBRID_SWB = 0x40DB,
    CAP_ID_DOWNLOAD_CVCHS1MIC_HYBRID_WB = 0x40DC,
    CAP_ID_DOWNLOAD_CVCHS1MIC_HYBRID_SWB = 0x40DD,
    CAP_ID_DOWNLOAD_APTX_ADAPTIVE_ENCODE_SCO_ISO = 0x40DE,
    CAP_ID_DOWNLOAD_MIPS_MONITOR = 0x40DF,
    CAP_ID_DOWNLOAD_ENCODED_PKT_INTERLEAVE = 0x4213,
