...
/**
 * \brief  Initialize a FIT100 one-shot capture.
 *
 * \param  p_asf  Pointer to AANC feature handle.
 * \param  p_fit  Pointer to the FIT100 data object.
 * \param  num_frames  Number of frames to run the capture for.
 *
 * \return  boolean indicating success or failure.
 */
extern bool aanc_fit100_one_shot_initialize(void *p_asf,
                                            FIT100 *p_fit,
                                            unsigned num_frames);

/**
 * \brief  Process a FIT100 one-shot capture.
 *
 * \param  p_asf  Pointer to AANC feature handle.
 * \param  p_fit  Pointer to the FIT100 data object.
 *
 * \return  boolean indicating success or failure.
 */
extern bool aanc_fit100_one_shot_process(void *p_asf, FIT100 *p_fit);


/**
 * \brief  Process a AUTOFIT related FIT100 one-shot capture.
 *
 * \param  p_asf  Pointer to AANC feature handle.
 * \param  p_fit  Pointer to the FIT100 data object.
 *
 * \return  boolean indicating success or failure.
 */
 extern bool aanc_fit100_autofit_one_shot_process(void *p_asf, FIT100 *p_fit);
