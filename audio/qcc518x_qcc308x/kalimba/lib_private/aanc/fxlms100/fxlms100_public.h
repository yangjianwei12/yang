 ...
 */
extern bool aanc_fxlms100_process_data(void *p_asf,
                                       FXLMS100_DMX *p_dmx);
 ...
 * \param  new_gain1  Gain value used to update the FxLMS algorithm gain 
                      for ANC instance 1 in dual mode
 *
 ...
 * \return boolean indicating success or failure.
 */
extern bool aanc_fxlms100_update_gain(FXLMS100_DMX *p_dmx, 
                                      uint16 new_gain, 
                                      uint16 new_gain1);
