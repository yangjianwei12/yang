...
.CONST $dms200.STATE_LENGTH.DL                  ($dms200.DIM * 9 + $dms200.MS_BAND * 2);
...
.CONST $dms200.pbp.STATE_LENGTH.DL              ($dms200.pbp.wide_band.DIM  * 9 + $dms200.MS_BAND * 2);
.CONST $dms200.pbp.STATE_LENGTH_SWB_FB          ($dms200.pbp.swb.DIM * 8 + $dms200.MS_BAND * 2);
.CONST $dms200.pbp.STATE_LENGTH_SWB_FB.DL       ($dms200.pbp.swb.DIM * 9 + $dms200.MS_BAND * 2);
...
.CONST $dms200.BYPASS_NPC_FIELD              ADDR_PER_WORD + $dms200.NSN_AGGRT_FIELD;
.CONST $dms200.G_G2_FIELD                    ADDR_PER_WORD + $dms200.BYPASS_NPC_FIELD;
.CONST $dms200.PTR_G_G_FINAL_FIELD           ADDR_PER_WORD + $dms200.G_G2_FIELD;
#define $M.oms280.PTR_G_G_FINAL_FIELD        $dms200.PTR_G_G_FINAL_FIELD

.CONST $dms200.STRUC_SIZE.DL                 1 + ($dms200.PTR_G_G_FINAL_FIELD >> LOG2_ADDR_PER_WORD);
