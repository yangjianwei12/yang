...
// -----------------------------------------------------------------------------
// DMSS SNR/HIGH NOISE DATA OBJECT
// -----------------------------------------------------------------------------
#define $dmss.snr.Z1_FIELD                   MK1 * 0
#define $dmss.snr.PARAM_FIELD                MK1 * 1
#define $dmss.snr.PTR_VARIANT_FIELD          MK1 * 2
#define $dmss.snr.NPROTO_FRAME_FIELD         MK1 * 3
// Internal fields
#define $dmss.snr.ALFA_FIELD                 MK1 * 4
#define $dmss.snr.ALFA_INITIAL_FIELD         MK1 * 5
#define $dmss.snr.FRAME_INITIAL_FIELD        MK1 * 6
#define $dmss.snr.START_FRAME_FIELD          MK1 * 7
#define $dmss.snr.NOISE_EST_FIELD            MK1 * 8
#define $dmss.snr.NOISE_POWER_FIELD          MK1 * 9
#define $dmss.snr.NOISE_POWER_EXP            MK1 * 10
#define $dmss.snr.NOISE_ON_THRESH_FIELD      MK1 * 11
#define $dmss.snr.NOISE_OFF_THRESH_FIELD     MK1 * 12
#define $dmss.snr.NOISE_FLAG_FIELD           MK1 * 13
#define $dmss.snr.NOISE_HYST_FIELD           MK1 * 14
#define $dmss.snr.STRUC_SIZE                      (14 + $hyst.STRUCT_SIZE)

// DMSS SNR User Paramters
#define $dmss.snr.param.T_HANG_UP            MK1 * 0
#define $dmss.snr.param.T_HANG_DOWN          MK1 * 1
#define $dmss.snr.param.NOISEEST_TC          MK1 * 2
#define $dmss.snr.param.NOISE_ON_THRESH      MK1 * 3
#define $dmss.snr.param.NOISE_OFF_THRESH     MK1 * 4
