...
.CONST $asf100.wnr.RESERVED_FIELD         ADDR_PER_WORD + $asf100.wnr.WIND_FIELD;
.CONST $asf100.wnr.IDX_LB_BASE_FIELD      ADDR_PER_WORD + $asf100.wnr.RESERVED_FIELD;
...
.CONST $asf100.WNR_MAP_OBJ_FIELD             ADDR_PER_WORD + $asf100.BF_END_FIELD;

#ifndef CVC_INEAR_MAOR_ROM_HARDWARE_BUILD
.CONST $asf100.STRUC_SIZE                    1 + ($asf100.WNR_MAP_OBJ_FIELD >> LOG2_ADDR_PER_WORD);
#else
.CONST $asf100.STRUC_SIZE_HW                 1 + ($asf100.WNR_MAP_OBJ_FIELD >> LOG2_ADDR_PER_WORD);
#endif 
...
// -----------------------------------------------------------------------------
// ASF WNR MAP structures
// -----------------------------------------------------------------------------
#define $asf100.wnr_map.HI_WIND_PARAM_FIELD           MK1 * 0
#define $asf100.wnr_map.PTR_VARIANT_FIELD             MK1 * 1
#define $asf100.wnr_map.MEAN_PWR_FIELD                MK1 * 2
#define $asf100.wnr_map.PHASE_COHER_FLAG_FIELD        MK1 * 3
#define $asf100.wnr_map.HI_WIND_POW_TH_FIELD          MK1 * 4
#define $asf100.wnr_map.HI_WIND_FLAG_FIELD            MK1 * 5
#define $asf100.wnr_map.STRUC_SIZE                         (5 + $hyst.STRUCT_SIZE)

// HI_Wind parameters
#define $asf100.wnr_map.param.T_HANG_UP               0 * MK1
#define $asf100.wnr_map.param.T_HANG_DOWN             1 * MK1
#define $asf100.wnr_map.param.HI_THRESH_PHASE         2 * MK1
#define $asf100.wnr_map.param.HI_THRESH_COHERENCE     3 * MK1
#define $asf100.wnr_map.param.HI_WIND_POW_TH          4 * MK1
