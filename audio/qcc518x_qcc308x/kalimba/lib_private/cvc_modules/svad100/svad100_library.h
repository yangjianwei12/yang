...
// %%version
//
// $Change: 3572284 $  $DateTime: 2020/12/11 20:12:21 $
// *****************************************************************************
...
#define _SVAD_LIB_H
   ...
   // Amount of hold time in frames
   // format : integer
   .CONST $svad100.NUM_HOLD_FRAMES                      ADDR_PER_WORD + $svad100.IPD_NUMBANDS_FIELD;
   // SVAD structure size
   // format : integer
   .CONST $svad100.STRUC_SIZE                           1 +  ($svad100.NUM_HOLD_FRAMES >> LOG2_ADDR_PER_WORD);  
