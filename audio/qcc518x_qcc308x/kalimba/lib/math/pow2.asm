...
.MODULE $M.math.pow2_table_q;
   // Potential FAST PM candidate
   .CODESEGMENT MATH_FAST_PM;
   .DATASEGMENT DM;

// This function corresponds to the cvclib_pow2()
// INPUTS:
//    - r0 = x in Q8.16 (KAL_ARCH3) / Q8.24 (KAL_ARCH4)
//    - r1 = q, output q format (0 <= q <= 31) 
// OUTPUTS:
//    - r0 = pow2(x), in Q1.23 (KAL_ARCH3) / Q1.31 (KAL_ARCH4)
...
non_zero_input:
   ...
   r3 = r0 LSHIFT 8;
   //table index
   r3 = r3 LSHIFT -(DAWTH - $POW2_TBL_INDX);
   //integer part

   Words2Addr(r3);      // KAL_ARCH 4 words to address conversion macro

   //base value
   r1 = M[r3 + (&$M.math.pow2_table.tab32_pow2 + 0)];

   // interpolation range
   r3 = M[r3 + (&$M.math.pow2_table.tab32_pow2 + ADDR_PER_WORD)];
   r3 = r3 - r1; // cvclib_tab32_pow2[temp+1] - cvclib_tab32_pow2[temp]
