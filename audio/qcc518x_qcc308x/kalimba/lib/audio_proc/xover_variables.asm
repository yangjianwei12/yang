...
.MODULE $audio_proc.xover;
   ...
   .VAR/DMCONST $butterworth_filter_order_4_Q_values[2]    = Qfmt_(0.541196, 8), Qfmt_(1.306563, 8);
   .VAR/DMCONST $butterworth_filter_order_5_Q_values[3]    = Qfmt_(0.618034, 8), Qfmt_(1.618034, 8), Qfmt_(1.000000, 8);
   .VAR/DMCONST $butterworth_filter_order_6_Q_values[3]    = Qfmt_(0.517638, 8), Qfmt_(0.707107, 8), Qfmt_(1.931852, 8);
   .VAR/DMCONST $butterworth_filter_order_7_Q_values[4]    = Qfmt_(0.554958, 8), Qfmt_(0.801938, 8), Qfmt_(2.246980, 8), Qfmt_(1.000000, 8);
   .VAR/DMCONST $butterworth_filter_order_8_Q_values[4]    = Qfmt_(0.509796, 8), Qfmt_(0.601345, 8), Qfmt_(0.899976, 8), Qfmt_(2.562915, 8);
   .VAR/DMCONST $butterworth_filter_order_9_Q_values[5]    = Qfmt_(0.532089, 8), Qfmt_(0.652704, 8), Qfmt_(1.000000, 8), Qfmt_(2.879385, 8), Qfmt_(1.000000, 8);
   .VAR/DMCONST $butterworth_filter_order_10_Q_values[5]   = Qfmt_(0.506233, 8), Qfmt_(0.561163, 8), Qfmt_(0.707107, 8), Qfmt_(1.101345, 8), Qfmt_(3.196227, 8);
   .VAR/DMCONST $butterworth_filter_order_11_Q_values[6]   = Qfmt_(0.521109, 8), Qfmt_(0.594351, 8), Qfmt_(0.763521, 8), Qfmt_(1.203616, 8), Qfmt_(3.513337, 8), Qfmt_(1.000000, 8);
   .VAR/DMCONST $butterworth_filter_order_12_Q_values[6]   = Qfmt_(0.504314, 8), Qfmt_(0.541196, 8), Qfmt_(0.630236, 8), Qfmt_(0.821340, 8), Qfmt_(1.306563, 8), Qfmt_(3.830649, 8);
   ...
   .VAR/DMCONST $linkwitz_riley_filter_order_6_Q_values[3]    = Qfmt_(0.500000, 8), Qfmt_(1.000000, 8), Qfmt_(1.000000, 8);
   .VAR/DMCONST $linkwitz_riley_filter_order_8_Q_values[4]    = Qfmt_(0.541196, 8), Qfmt_(0.541196, 8), Qfmt_(1.306563, 8), Qfmt_(1.306563, 8);
   .VAR/DMCONST $linkwitz_riley_filter_order_10_Q_values[5]   = Qfmt_(0.500000, 8), Qfmt_(0.618034, 8), Qfmt_(0.618034, 8), Qfmt_(1.618034, 8), Qfmt_(1.618034, 8);
   .VAR/DMCONST $linkwitz_riley_filter_order_12_Q_values[6]   = Qfmt_(0.517638, 8), Qfmt_(0.517638, 8), Qfmt_(0.707107, 8), Qfmt_(0.707107, 8), Qfmt_(1.931852, 8), Qfmt_(1.931852, 8);
