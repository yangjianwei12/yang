...
// decoder
   ...
   .CONST       $sbc.mem.CONVERT_TO_MONO_FIELD                    52*ADDR_PER_WORD;          // Y            Repurposed to indicate size of WIN_COEFS_MX_FIELD
   ...
   .CONST       $sbc.mem.WBS_SBC_FRAME_OK_FIELD                   56*ADDR_PER_WORD;          // Y            Repurposed as a flag to indicate custom SBC for LEA
