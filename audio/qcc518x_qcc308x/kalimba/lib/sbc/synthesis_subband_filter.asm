...
.MODULE $M.sbcdec.synthesis_subband_filter;
   ...
   if Z jump M_equals_4;
#endif
      // set up default length reg for V ring buffer
      L0 = (160*ADDR_PER_WORD);
      // set up alternative length reg if using 64-tap filter
      r1 = (128*ADDR_PER_WORD);
      ...
      block_loop_M8:
         ...
         M2 = -(55*ADDR_PER_WORD);
         // (1 - M*15)
         M3 = -(119*ADDR_PER_WORD);
         call output_code_64;

         continue_matrix_loop:
