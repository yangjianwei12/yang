...
void iir_resampler_process_data(OPERATOR_DATA *op_data, TOUCHED_TERMINALS *touched)
{
    ...
    unsigned produced, active_channels, input_data_avail;
    int consumed;
    ...
    consumed = iir_resampler_amount_to_use(op_extra_data, chan_ptr, &input_data_avail);
