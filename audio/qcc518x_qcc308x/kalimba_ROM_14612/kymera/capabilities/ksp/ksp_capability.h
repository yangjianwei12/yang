...
Constants
*/
#define KSP_KSP_VERSION_MINOR 2
...
#define KSP_MAX_CHANNELS          4      /* max number of channels per stream,
                                                   not more than 8 */
#define KSP_MAX_COPY              512    /* maximum number of words to read from
...
extern unsigned ksp_copy_from_transform_buffers(KSP_STREAM *stream, unsigned max_copy);
