...
$cvc.init.root:
   ...
   // reset high_wind and hysteresis flag
   M[r9 + $cvc_send.cap.HIGH_WIND_FLAG_FIELD] = 0;
   M[r9 + $cvc_send.cap.HYST_FLAG_FIELD] = 0;
...
// NOTE:
// *****************************************************************************
.MODULE $M.CVC_SEND.module_control.dms_im_out;
...
// *****************************************************************************
// MODULE:
//    $cvc.user.aec_map.selfclean_init
//
// DESCRIPTION:
//    aec530_map module configuration when SELFCLEAN is active
//
//if S.SelfClean_EQ
//        G_eq = SELF_CLEAN * ones(1,SND.SYS_c.NUMBINS);    
// end  
// MODIFICATIONS:
//
// INPUTS:
//    - r7 - selfclean_flag
//    - r8 - module object (aec_map_obj)
//    - r9 - cvc data root object
//
// OUTPUTS:
//
...
// NOTE:
// *****************************************************************************
.MODULE $M.CVC_SEND.module_init.aec530_map.selfclean_init;

   .CODESEGMENT PM;

$cvc.user.aec_map.selfclean_init:
   M[r8 + $aec530.map.SELFCLEAN_PTR_FIELD] = r7;
   rts;
...
//
// DESCRIPTION:
//    aec530_map module configuration
//
// MODIFICATIONS:
//
// INPUTS:
...
// NOTE:
// *****************************************************************************
.MODULE $M.CVC_SEND.module_init.aec530_map;
...
$cvc.init.aec530_map:
   ...
   // OMS/DMS AGGR needed for G_eq
   r2 = M[r3 + $M.GEN.CVC_SEND.PARAMETERS.OFFSET_DMS_AGGR];
   M[r8 + $aec530.OFFSET_OMS_AGGRESSIVENESS] = r2;

   // CNG/RER/FDFBC not used
   rts;
...
//
// DESCRIPTION:
//    aec530_map module control (for Occluded mode)
//
// MODIFICATIONS:
//
// INPUTS:
//    - r8 - module object (aec_map_obj / vsm_fdnlp)
//    - r9 - cvc data root object
//
// OUTPUTS:
//    - r0 - ~AEC_ON (bypass flag)
...
// NOTE:
// *****************************************************************************
.MODULE $M.CVC_SEND.module_control.aec530_map;
...
$cvc.mc.blend:
   ...
   // if (HI_Wind_Flag_Hyst_b.hystFlag) do blending
   jump $cvc.mc.hyst_on;
