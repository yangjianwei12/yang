...
$_sco_decoder_wbs_validate:
   ...
   r0 = M[r3 + $sco_common_struct.SCO_TERMINAL_BUFFERS_struct.OP_BUFFER_FIELD];
   // INPUTS:
   ...
   r3 = r0;
   // get the Input buffer
   r0 = M[r3 + $sco_common_struct.SCO_TERMINAL_BUFFERS_struct.IP_BUFFER_FIELD];
   ...
   push r3;
   pop B0;
   r8 = r1; // save the read address offset value.
   ...
   // r8  read offset of the input buffer.
   ...
   // reload the sync word alignment which can be 0 EVEN (word aligned)
   // or 1 ODD aligned.
   r2 = M[r9 + $sbc.mem.WBS_PAYLOAD_ALIGN_FIELD];
   // r8 is still the read offset of the input buffer which 
   // for 16 bit buffer can be 0 (word aligned) or 1.
   // Make sure that the read offset is kept when it mathes with the alignment field.
   // Otherwise the library will notice that there was a shift.
   r2 = r2 AND r8;
   //in r0 cbuffer address
...
//
// INPUTS:
// r0 op data (wbs_dec base address)
// r1 metadata status of the frame
// r2 validate retval
...
// r3 wbs_packet_length
   ...
   //get the op buffer
   r8 = M[r3 + $sco_common_struct.SCO_TERMINAL_BUFFERS_struct.OP_BUFFER_FIELD];
