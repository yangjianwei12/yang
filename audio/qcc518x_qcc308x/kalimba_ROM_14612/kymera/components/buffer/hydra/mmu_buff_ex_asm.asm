...
$mmu.get_read_address_local_buff_ex:
   ...
   // Check for presence of aux read handle
   // If there is one, use that instead of the normal read handle
   ...
   r0 = M[r0 + $cbuffer.AUX_ADDR_FIELD];
...
$mmu.get_write_address_local_buff_ex:
   ...
   // Check for presence of aux write handle
   // If there is one, use that instead of the normal write handle
   r3 = M[r0 + $cbuffer.DESCRIPTOR_FIELD];
   Null = r3 AND $cbuffer.AUX_PTR_PRESENT_MASK;
