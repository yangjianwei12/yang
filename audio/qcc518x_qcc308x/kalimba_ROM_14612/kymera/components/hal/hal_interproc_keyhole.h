...
/**
 * Set the NVMEM_WIN1_CONFIG through inter-proc keyhole of target cpu
 */
#ifdef RUN_CAPABILITIES_FROM_SQIF
#define hal_inter_proc_keyhole_set_nvmem_win1_config( cpu, val ) \
            hal_inter_proc_keyhole_write_dm_register( cpu, NVMEM_WIN1_CONFIG, val)
#endif

/**
 * Set the NVMEM_WIN2_CONFIG through inter-proc keyhole of target cpu
 */ 
#define hal_inter_proc_keyhole_set_nvmem_win2_config( cpu, val ) \
            hal_inter_proc_keyhole_write_dm_register( cpu, NVMEM_WIN2_CONFIG, val)
