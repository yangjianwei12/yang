...
/**
 * \brief DM Profiling: tag all bits of DM memory
 *        of a given ext buffer.
 *
 * \param eb                  - ext buffer pointer
 */
void ext_buffer_tag_external_buffer(EXT_BUFFER * eb, DMPROFILING_OWNER owner);
#else
#define ext_buffer_tag_external_buffer(eb)
#endif
