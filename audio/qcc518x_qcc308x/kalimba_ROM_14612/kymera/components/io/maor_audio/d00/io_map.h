...
/* *************************************************************************  *
   ...
   $Id: //depot/dspsw/maor_rom_v20/kalimba/kymera/components/io/maor_audio/d00/io_map.h#1 $
   $Name$
   $Source$
...
extern volatile uint32  ANC_CONTROL28;                       /* RW  14 bits */
...
extern volatile uint32  ANC_CONTROL40;                       /* RW  14 bits */
...
extern volatile kalimba_debug_select  KALIMBA_DEBUG_SELECT;                /* RW   7 bits */
...
/* Declarations of read/write/mixed registers */
extern volatile uint32  AOV0_CTL;                            /* RW  10 bits */
extern volatile uint32  AOV0_EOD_CTRL;                       /* RW  15 bits */
extern volatile uint32  AOV0_RAMS_EMA;                       /* RW  12 bits */
extern volatile uint32  AOV0_RAM_CFG;                        /* RW  25 bits */
extern volatile uint32  AOV1_CTL;                            /* RW  10 bits */
extern volatile uint32  AOV1_EOD_CTRL;                       /* RW  15 bits */
extern volatile uint32  AOV1_RAMS_EMA;                       /* RW  12 bits */
extern volatile uint32  AOV1_RAM_CFG;                        /* RW  25 bits */
extern volatile uint32  AOV2_CTL;                            /* RW  10 bits */
extern volatile uint32  AOV2_EOD_CTRL;                       /* RW  15 bits */
extern volatile uint32  AOV2_RAMS_EMA;                       /* RW  12 bits */
extern volatile uint32  AOV2_RAM_CFG;                        /* RW  25 bits */
extern volatile uint32  AOV_ACCESS_CTRL;                     /* RW   4 bits */
extern volatile uint32  AOV_DEBUG_SELECT;                    /* RW   7 bits */
extern volatile uint32  AOV_EVENT_CLEAR;                     /* RW  20 bits */
extern volatile uint32  AOV_EVENT_MASK;                      /* RW  20 bits */
extern volatile uint32  AOV_KEYHOLE;                         /* RW  17 bits */
extern volatile aov__mutex_lock_enum  AOV_MUTEX_LOCK;                      /* RW   4 bits */
extern volatile uint32  AOV_RAMS_DS_EN;                      /* RW   6 bits */
extern volatile uint32  AOV_RAMS_LS_EN;                      /* RW   6 bits */
extern volatile uint32  AOV_RAMS_RAWL;                       /* RW  18 bits */
extern volatile uint32  AOV_RAMS_SD_EN;                      /* RW   6 bits */
extern volatile uint32  AOV_RAMS_WABL;                       /* RW  24 bits */
extern volatile uint32  AOV_WAKEUP_MASK;                     /* RW  20 bits */

/* Declarations of read only registers */
extern volatile uint32  AOV0_EOD_STATUS;                     /* R   13 bits */
extern volatile uint32  AOV1_EOD_STATUS;                     /* R   13 bits */
extern volatile uint32  AOV2_EOD_STATUS;                     /* R   13 bits */
extern volatile uint32  AOV_EVENT_STATUS;                    /* R   20 bits */
extern volatile uint32  AOV_KEYHOLE_READ_DATA;               /* R   24 bits */
extern volatile uint32  AOV_RAM_IF_STATUS1;                  /* R    9 bits */
extern volatile uint32  AOV_RAM_IF_STATUS2;                  /* R   27 bits */
extern volatile uint32  AOV_SEQUENCER_ACTIVE;                /* R    6 bits */
...
extern volatile uint32  AUDIO_DMAC_EXTRA_CONFIG_LOGIC;       /* RW   2 bits */
