...
/* *************************************************************************  *
   ...
   $Id: //depot/dspsw/maor_rom_v20/kalimba/kymera/components/io/maor_audio/d00/io_defs.h#1 $
   $Name$
   $Source$
...
#define CHIP_REGISTER_HASH 0x1642
...
enum anc_control13_posn_enum
{
   ...
   CDC_TX_INP_MUX_AMIC_MUX_10_SEL_MSB_POSN            = (int)2,
   ANC_CONTROL13_CDC_TX_INP_MUX_AMIC_MUX_10_SEL_MSB_POSN = (int)2,
...
#define CDC_TX_INP_MUX_AMIC_MUX_10_SEL_MSB_MASK  (0x00000004u)
...
enum anc_control14_posn_enum
{
   ...
   CDC_TX_INP_MUX_AMIC_MUX_11_SEL_MSB_POSN            = (int)2,
   ANC_CONTROL14_CDC_TX_INP_MUX_AMIC_MUX_11_SEL_MSB_POSN = (int)2,
...
#define CDC_TX_INP_MUX_AMIC_MUX_11_SEL_MSB_MASK  (0x00000004u)
...
enum anc_control15_posn_enum
{
   ...
   CDC_TX_INP_MUX_AMIC_MUX_12_SEL_MSB_POSN            = (int)2,
   ANC_CONTROL15_CDC_TX_INP_MUX_AMIC_MUX_12_SEL_MSB_POSN = (int)2,
...
#define CDC_TX_INP_MUX_AMIC_MUX_12_SEL_MSB_MASK  (0x00000004u)
...
enum anc_control16_posn_enum
{
   ...
   CDC_TX_INP_MUX_AMIC_MUX_13_SEL_MSB_POSN            = (int)2,
   ANC_CONTROL16_CDC_TX_INP_MUX_AMIC_MUX_13_SEL_MSB_POSN = (int)2,
...
#define CDC_TX_INP_MUX_AMIC_MUX_13_SEL_MSB_MASK  (0x00000004u)
...
enum anc_control28_posn_enum
{
   ...
   CDC_ANC0_ANC_DMIC_ACTIV_THRESH_B_LSB_POSN          = (int)4,
   ANC_CONTROL28_CDC_ANC0_ANC_DMIC_ACTIV_THRESH_B_LSB_POSN = (int)4,
   CDC_ANC0_ANC_DMIC_ACTIV_THRESH_B_MSB_POSN          = (int)8,
   ANC_CONTROL28_CDC_ANC0_ANC_DMIC_ACTIV_THRESH_B_MSB_POSN = (int)8,
   CDC_ANC0_ANC_DMIC_ACTIV_THRESH_A_LSB_POSN          = (int)9,
   ANC_CONTROL28_CDC_ANC0_ANC_DMIC_ACTIV_THRESH_A_LSB_POSN = (int)9,
   CDC_ANC0_ANC_DMIC_ACTIV_THRESH_A_MSB_POSN          = (int)13,
   ANC_CONTROL28_CDC_ANC0_ANC_DMIC_ACTIV_THRESH_A_MSB_POSN = (int)13
};
...
#define CDC_ANC0_ANC_DMIC_ACTIV_THRESH_B_LSB_MASK (0x00000010u)
#define CDC_ANC0_ANC_DMIC_ACTIV_THRESH_B_MSB_MASK (0x00000100u)
#define CDC_ANC0_ANC_DMIC_ACTIV_THRESH_A_LSB_MASK (0x00000200u)
#define CDC_ANC0_ANC_DMIC_ACTIV_THRESH_A_MSB_MASK (0x00002000u)
...
enum anc_control40_posn_enum
{
   ...
   CDC_ANC1_ANC_DMIC_ACTIV_THRESH_B_LSB_POSN          = (int)4,
   ANC_CONTROL40_CDC_ANC1_ANC_DMIC_ACTIV_THRESH_B_LSB_POSN = (int)4,
   CDC_ANC1_ANC_DMIC_ACTIV_THRESH_B_MSB_POSN          = (int)8,
   ANC_CONTROL40_CDC_ANC1_ANC_DMIC_ACTIV_THRESH_B_MSB_POSN = (int)8,
   CDC_ANC1_ANC_DMIC_ACTIV_THRESH_A_LSB_POSN          = (int)9,
   ANC_CONTROL40_CDC_ANC1_ANC_DMIC_ACTIV_THRESH_A_LSB_POSN = (int)9,
   CDC_ANC1_ANC_DMIC_ACTIV_THRESH_A_MSB_POSN          = (int)13,
   ANC_CONTROL40_CDC_ANC1_ANC_DMIC_ACTIV_THRESH_A_MSB_POSN = (int)13
};
...
#define CDC_ANC1_ANC_DMIC_ACTIV_THRESH_B_LSB_MASK (0x00000010u)
#define CDC_ANC1_ANC_DMIC_ACTIV_THRESH_B_MSB_MASK (0x00000100u)
#define CDC_ANC1_ANC_DMIC_ACTIV_THRESH_A_LSB_MASK (0x00000200u)
#define CDC_ANC1_ANC_DMIC_ACTIV_THRESH_A_MSB_MASK (0x00002000u)
...
enum kalimba_debug_select_enum
{
   ...
   KALIMBA_DEBUG_SEL_PM_SEQ14               = (int)0x12,
   KALIMBA_DEBUG_SEL_PM_SEQ15               = (int)0x13,
   KALIMBA_DEBUG_SEL_PM_SEQ16               = (int)0x14,
   KALIMBA_DEBUG_SEL_PM_SEQ17               = (int)0x15,
   KALIMBA_DEBUG_SEL_PM_SEQ18               = (int)0x16,
   KALIMBA_DEBUG_SEL_PM_SEQ19               = (int)0x17,
   KALIMBA_DEBUG_SEL_PM_SEQ20               = (int)0x18,
   KALIMBA_DEBUG_SEL_PM_SEQ21               = (int)0x19,
   KALIMBA_DEBUG_SEL_PM_SEQ22               = (int)0x1A,
   KALIMBA_DEBUG_SEL_PM_SEQ23               = (int)0x1B,
   KALIMBA_DEBUG_SEL_PM_SEQ24               = (int)0x1C,
   KALIMBA_DEBUG_SEL_PM_SEQ25               = (int)0x1D,
   KALIMBA_DEBUG_SEL_PM_SEQ26               = (int)0x1E,
   KALIMBA_DEBUG_SEL_PM_SEQ27               = (int)0x1F,
   KALIMBA_DEBUG_SEL_PM_SEQ28               = (int)0x20,
   KALIMBA_DEBUG_SEL_PM_SEQ29               = (int)0x21,
   KALIMBA_DEBUG_SEL_PM_SEQ30               = (int)0x22,
   KALIMBA_DEBUG_SEL_PM_SEQ31               = (int)0x23,
   KALIMBA_DEBUG_SEL_PM_SEQ32               = (int)0x24,
   KALIMBA_DEBUG_SEL_PM_SEQ33               = (int)0x25,
   KALIMBA_DEBUG_SEL_PM_SEQ34               = (int)0x26,
   KALIMBA_DEBUG_SEL_PM_SEQ35               = (int)0x27,
   KALIMBA_DEBUG_SEL_PM_SEQ36               = (int)0x28,
   KALIMBA_DEBUG_SEL_PM_SEQ37               = (int)0x29,
   KALIMBA_DEBUG_SEL_PM_SEQ38               = (int)0x2A,
   KALIMBA_DEBUG_SEL_PM_SEQ39               = (int)0x2B,
   KALIMBA_DEBUG_SEL_PM_SEQ40               = (int)0x2C,
   KALIMBA_DEBUG_SEL_PM_SEQ41               = (int)0x2D,
   KALIMBA_DEBUG_SEL_PM_SEQ42               = (int)0x2E,
   KALIMBA_DEBUG_SEL_PM_SEQ43               = (int)0x2F,
   KALIMBA_DEBUG_SEL_PM_SEQ44               = (int)0x30,
   KALIMBA_DEBUG_SEL_PM_SEQ45               = (int)0x31,
   KALIMBA_DEBUG_SEL_PM_SEQ46               = (int)0x32,
   KALIMBA_DEBUG_SEL_PM_SEQ47               = (int)0x33,
   KALIMBA_DEBUG_SEL_DM_SEQ0                = (int)0x34,
   KALIMBA_DEBUG_SEL_DM_SEQ1                = (int)0x35,
   KALIMBA_DEBUG_SEL_DM_SEQ2                = (int)0x36,
   KALIMBA_DEBUG_SEL_DM_SEQ3                = (int)0x37,
   KALIMBA_DEBUG_SEL_DM_SEQ4                = (int)0x38,
   KALIMBA_DEBUG_SEL_DM_SEQ5                = (int)0x39,
   KALIMBA_DEBUG_SEL_DM_SEQ6                = (int)0x3A,
   KALIMBA_DEBUG_SEL_DM_SEQ7                = (int)0x3B,
   KALIMBA_DEBUG_SEL_DM_SEQ8                = (int)0x3C,
   KALIMBA_DEBUG_SEL_DM_SEQ9                = (int)0x3D,
   KALIMBA_DEBUG_SEL_DM_SEQ10               = (int)0x3E,
   KALIMBA_DEBUG_SEL_DM_SEQ11               = (int)0x3F,
   KALIMBA_DEBUG_SEL_DM_SEQ12               = (int)0x40,
   KALIMBA_DEBUG_SEL_DM_SEQ13               = (int)0x41,
   KALIMBA_DEBUG_SEL_DM_SEQ14               = (int)0x42,
   KALIMBA_DEBUG_SEL_DM_SEQ15               = (int)0x43,
   KALIMBA_DEBUG_SEL_DM_SEQ16               = (int)0x44,
   KALIMBA_DEBUG_SEL_DM_SEQ17               = (int)0x45,
   KALIMBA_DEBUG_SEL_DM_SEQ18               = (int)0x46,
   KALIMBA_DEBUG_SEL_DM_SEQ19               = (int)0x47,
   KALIMBA_DEBUG_SEL_DM_SEQ20               = (int)0x48,
   KALIMBA_DEBUG_SEL_DM_SEQ21               = (int)0x49,
   KALIMBA_DEBUG_SEL_DM_SEQ22               = (int)0x4A,
   KALIMBA_DEBUG_SEL_DM_SEQ23               = (int)0x4B,
   KALIMBA_DEBUG_SEL_DM_SEQ24               = (int)0x4C,
   KALIMBA_DEBUG_SEL_DM_SEQ25               = (int)0x4D,
   KALIMBA_DEBUG_SEL_DM_SEQ26               = (int)0x4E,
   KALIMBA_DEBUG_SEL_DM_SEQ27               = (int)0x4F,
   KALIMBA_DEBUG_SEL_DM_SEQ28               = (int)0x50,
   KALIMBA_DEBUG_SEL_DM_SEQ29               = (int)0x51,
   KALIMBA_DEBUG_SEL_DM_SEQ30               = (int)0x52,
   KALIMBA_DEBUG_SEL_DM_SEQ31               = (int)0x53,
   KALIMBA_DEBUG_SEL_DM_SEQ32               = (int)0x54,
   KALIMBA_DEBUG_SEL_DM_SEQ33               = (int)0x55,
   KALIMBA_DEBUG_SEL_DM_SEQ34               = (int)0x56,
   KALIMBA_DEBUG_SEL_DM_SEQ35               = (int)0x57,
   KALIMBA_DEBUG_SEL_DM_SEQ36               = (int)0x58,
   KALIMBA_DEBUG_SEL_DM_SEQ37               = (int)0x59,
   KALIMBA_DEBUG_SEL_DM_SEQ38               = (int)0x5A,
   KALIMBA_DEBUG_SEL_DM_SEQ39               = (int)0x5B,
   KALIMBA_DEBUG_SEL_DM_SEQ40               = (int)0x5C,
   KALIMBA_DEBUG_SEL_DM_SEQ41               = (int)0x5D,
   KALIMBA_DEBUG_SEL_DM_SEQ42               = (int)0x5E,
   KALIMBA_DEBUG_SEL_DM_SEQ43               = (int)0x5F,
   KALIMBA_DEBUG_SEL_MARGIN_PM_0            = (int)0x60,
   KALIMBA_DEBUG_SEL_MARGIN_PM_1            = (int)0x61,
   KALIMBA_DEBUG_SEL_MARGIN_PM_2            = (int)0x62,
   KALIMBA_DEBUG_SEL_MARGIN_PM_3            = (int)0x63,
   KALIMBA_DEBUG_SEL_MARGIN_PM_4            = (int)0x64,
   KALIMBA_DEBUG_SEL_MARGIN_DM_0            = (int)0x65,
   KALIMBA_DEBUG_SEL_MARGIN_DM_1            = (int)0x66,
   KALIMBA_DEBUG_SEL_MARGIN_DM_2            = (int)0x67,
   KALIMBA_DEBUG_SEL_MARGIN_DM_3            = (int)0x68,
   KALIMBA_DEBUG_SEL_MARGIN_DM_4            = (int)0x69,
   MAX_KALIMBA_DEBUG_SELECT                 = (int)0x69
};
#define NUM_KALIMBA_DEBUG_SELECT (0x6A)
...
enum aov_ctrl_enum_posn_enum
{
   AOV_CTL_ENABLE_POSN                                = (int)0,
   AOV_CTRL_ENUM_AOV_CTL_ENABLE_LSB_POSN              = (int)0,
   AOV_CTRL_ENUM_AOV_CTL_ENABLE_MSB_POSN              = (int)0,
   AOV_CTL_VAD_ENABLE_POSN                            = (int)1,
   AOV_CTRL_ENUM_AOV_CTL_VAD_ENABLE_LSB_POSN          = (int)1,
   AOV_CTRL_ENUM_AOV_CTL_VAD_ENABLE_MSB_POSN          = (int)1,
   AOV_CTL_DRAIN_BUFFER_ENABLE_POSN                   = (int)2,
   AOV_CTRL_ENUM_AOV_CTL_DRAIN_BUFFER_ENABLE_LSB_POSN = (int)2,
   AOV_CTRL_ENUM_AOV_CTL_DRAIN_BUFFER_ENABLE_MSB_POSN = (int)2,
   AOV_CTL_FREEZE_ON_ERROR_POSN                       = (int)3,
   AOV_CTRL_ENUM_AOV_CTL_FREEZE_ON_ERROR_LSB_POSN     = (int)3,
   AOV_CTRL_ENUM_AOV_CTL_FREEZE_ON_ERROR_MSB_POSN     = (int)3,
   AOV_CTL_CLR_VAD_FIRED_POSN                         = (int)4,
   AOV_CTRL_ENUM_AOV_CTL_CLR_VAD_FIRED_LSB_POSN       = (int)4,
   AOV_CTRL_ENUM_AOV_CTL_CLR_VAD_FIRED_MSB_POSN       = (int)4,
   AOV_CTL_PAUSE_RAM_FILL_POSN                        = (int)5,
   AOV_CTRL_ENUM_AOV_CTL_PAUSE_RAM_FILL_LSB_POSN      = (int)5,
   AOV_CTRL_ENUM_AOV_CTL_PAUSE_RAM_FILL_MSB_POSN      = (int)5,
   AOV_CTL_KCODEC_SEL_LSB_POSN                        = (int)6,
   AOV_CTRL_ENUM_AOV_CTL_KCODEC_SEL_LSB_POSN          = (int)6,
   AOV_CTL_KCODEC_SEL_MSB_POSN                        = (int)9,
   AOV_CTRL_ENUM_AOV_CTL_KCODEC_SEL_MSB_POSN          = (int)9
};
typedef enum aov_ctrl_enum_posn_enum aov_ctrl_enum_posn;
...
#define AOV_CTL_KCODEC_SEL_MSB_MASK              (0x00000200u)

enum aov_eod_ctrl_enum_posn_enum
{
   AOV_EOD_NUM_WORDS_LSB_POSN                         = (int)0,
   AOV_EOD_CTRL_ENUM_AOV_EOD_NUM_WORDS_LSB_POSN       = (int)0,
   AOV_EOD_NUM_WORDS_MSB_POSN                         = (int)12,
   AOV_EOD_CTRL_ENUM_AOV_EOD_NUM_WORDS_MSB_POSN       = (int)12,
   AOV_EOD_EN_POSN                                    = (int)13,
   AOV_EOD_CTRL_ENUM_AOV_EOD_EN_LSB_POSN              = (int)13,
   AOV_EOD_CTRL_ENUM_AOV_EOD_EN_MSB_POSN              = (int)13,
   AOV_EOD_GO_POSN                                    = (int)14,
   AOV_EOD_CTRL_ENUM_AOV_EOD_GO_LSB_POSN              = (int)14,
   AOV_EOD_CTRL_ENUM_AOV_EOD_GO_MSB_POSN              = (int)14
};
typedef enum aov_eod_ctrl_enum_posn_enum aov_eod_ctrl_enum_posn;

#define AOV_EOD_NUM_WORDS_LSB_MASK               (0x00000001u)
#define AOV_EOD_NUM_WORDS_MSB_MASK               (0x00001000u)
#define AOV_EOD_EN_MASK                          (0x00002000u)
#define AOV_EOD_GO_MASK                          (0x00004000u)

enum aov_eod_status_enum_posn_enum
{
   AOV_EOD_CNT_LSB_POSN                               = (int)0,
   AOV_EOD_STATUS_ENUM_AOV_EOD_CNT_LSB_POSN           = (int)0,
   AOV_EOD_CNT_MSB_POSN                               = (int)12,
   AOV_EOD_STATUS_ENUM_AOV_EOD_CNT_MSB_POSN           = (int)12
};
typedef enum aov_eod_status_enum_posn_enum aov_eod_status_enum_posn;

#define AOV_EOD_CNT_LSB_MASK                     (0x00000001u)
#define AOV_EOD_CNT_MSB_MASK                     (0x00001000u)

enum aov_events_posn_enum
{
   AOV0_EVENT_RAM0_FULL_POSN                          = (int)0,
   AOV_EVENTS_AOV0_EVENT_RAM0_FULL_LSB_POSN           = (int)0,
   AOV_EVENTS_AOV0_EVENT_RAM0_FULL_MSB_POSN           = (int)0,
   AOV0_EVENT_RAM1_FULL_POSN                          = (int)1,
   AOV_EVENTS_AOV0_EVENT_RAM1_FULL_LSB_POSN           = (int)1,
   AOV_EVENTS_AOV0_EVENT_RAM1_FULL_MSB_POSN           = (int)1,
   AOV1_EVENT_RAM0_FULL_POSN                          = (int)2,
   AOV_EVENTS_AOV1_EVENT_RAM0_FULL_LSB_POSN           = (int)2,
   AOV_EVENTS_AOV1_EVENT_RAM0_FULL_MSB_POSN           = (int)2,
   AOV1_EVENT_RAM1_FULL_POSN                          = (int)3,
   AOV_EVENTS_AOV1_EVENT_RAM1_FULL_LSB_POSN           = (int)3,
   AOV_EVENTS_AOV1_EVENT_RAM1_FULL_MSB_POSN           = (int)3,
   AOV2_EVENT_RAM0_FULL_POSN                          = (int)4,
   AOV_EVENTS_AOV2_EVENT_RAM0_FULL_LSB_POSN           = (int)4,
   AOV_EVENTS_AOV2_EVENT_RAM0_FULL_MSB_POSN           = (int)4,
   AOV2_EVENT_RAM1_FULL_POSN                          = (int)5,
   AOV_EVENTS_AOV2_EVENT_RAM1_FULL_LSB_POSN           = (int)5,
   AOV_EVENTS_AOV2_EVENT_RAM1_FULL_MSB_POSN           = (int)5,
   AOV0_EVENT_RAM0_EMPTY_POSN                         = (int)6,
   AOV_EVENTS_AOV0_EVENT_RAM0_EMPTY_LSB_POSN          = (int)6,
   AOV_EVENTS_AOV0_EVENT_RAM0_EMPTY_MSB_POSN          = (int)6,
   AOV0_EVENT_RAM1_EMPTY_POSN                         = (int)7,
   AOV_EVENTS_AOV0_EVENT_RAM1_EMPTY_LSB_POSN          = (int)7,
   AOV_EVENTS_AOV0_EVENT_RAM1_EMPTY_MSB_POSN          = (int)7,
   AOV1_EVENT_RAM0_EMPTY_POSN                         = (int)8,
   AOV_EVENTS_AOV1_EVENT_RAM0_EMPTY_LSB_POSN          = (int)8,
   AOV_EVENTS_AOV1_EVENT_RAM0_EMPTY_MSB_POSN          = (int)8,
   AOV1_EVENT_RAM1_EMPTY_POSN                         = (int)9,
   AOV_EVENTS_AOV1_EVENT_RAM1_EMPTY_LSB_POSN          = (int)9,
   AOV_EVENTS_AOV1_EVENT_RAM1_EMPTY_MSB_POSN          = (int)9,
   AOV2_EVENT_RAM0_EMPTY_POSN                         = (int)10,
   AOV_EVENTS_AOV2_EVENT_RAM0_EMPTY_LSB_POSN          = (int)10,
   AOV_EVENTS_AOV2_EVENT_RAM0_EMPTY_MSB_POSN          = (int)10,
   AOV2_EVENT_RAM1_EMPTY_POSN                         = (int)11,
   AOV_EVENTS_AOV2_EVENT_RAM1_EMPTY_LSB_POSN          = (int)11,
   AOV_EVENTS_AOV2_EVENT_RAM1_EMPTY_MSB_POSN          = (int)11,
   AOV0_EVENT_RAM_OVERRUN_POSN                        = (int)12,
   AOV_EVENTS_AOV0_EVENT_RAM_OVERRUN_LSB_POSN         = (int)12,
   AOV_EVENTS_AOV0_EVENT_RAM_OVERRUN_MSB_POSN         = (int)12,
   AOV1_EVENT_RAM_OVERRUN_POSN                        = (int)13,
   AOV_EVENTS_AOV1_EVENT_RAM_OVERRUN_LSB_POSN         = (int)13,
   AOV_EVENTS_AOV1_EVENT_RAM_OVERRUN_MSB_POSN         = (int)13,
   AOV2_EVENT_RAM_OVERRUN_POSN                        = (int)14,
   AOV_EVENTS_AOV2_EVENT_RAM_OVERRUN_LSB_POSN         = (int)14,
   AOV_EVENTS_AOV2_EVENT_RAM_OVERRUN_MSB_POSN         = (int)14,
   AOV_EVENT_VAD_POS_EVENT_POSN                       = (int)15,
   AOV_EVENTS_AOV_EVENT_VAD_POS_EVENT_LSB_POSN        = (int)15,
   AOV_EVENTS_AOV_EVENT_VAD_POS_EVENT_MSB_POSN        = (int)15,
   AOV_EVENT_VAD_NEG_EVENT_POSN                       = (int)16,
   AOV_EVENTS_AOV_EVENT_VAD_NEG_EVENT_LSB_POSN        = (int)16,
   AOV_EVENTS_AOV_EVENT_VAD_NEG_EVENT_MSB_POSN        = (int)16,
   AOV0_EVENT_EOD_DAT_AVAIL_POSN                      = (int)17,
   AOV_EVENTS_AOV0_EVENT_EOD_DAT_AVAIL_LSB_POSN       = (int)17,
   AOV_EVENTS_AOV0_EVENT_EOD_DAT_AVAIL_MSB_POSN       = (int)17,
   AOV1_EVENT_EOD_DAT_AVAIL_POSN                      = (int)18,
   AOV_EVENTS_AOV1_EVENT_EOD_DAT_AVAIL_LSB_POSN       = (int)18,
   AOV_EVENTS_AOV1_EVENT_EOD_DAT_AVAIL_MSB_POSN       = (int)18,
   AOV2_EVENT_EOD_DAT_AVAIL_POSN                      = (int)19,
   AOV_EVENTS_AOV2_EVENT_EOD_DAT_AVAIL_LSB_POSN       = (int)19,
   AOV_EVENTS_AOV2_EVENT_EOD_DAT_AVAIL_MSB_POSN       = (int)19
};
typedef enum aov_events_posn_enum aov_events_posn;

#define AOV0_EVENT_RAM0_FULL_MASK                (0x00000001u)
#define AOV0_EVENT_RAM1_FULL_MASK                (0x00000002u)
#define AOV1_EVENT_RAM0_FULL_MASK                (0x00000004u)
#define AOV1_EVENT_RAM1_FULL_MASK                (0x00000008u)
#define AOV2_EVENT_RAM0_FULL_MASK                (0x00000010u)
#define AOV2_EVENT_RAM1_FULL_MASK                (0x00000020u)
#define AOV0_EVENT_RAM0_EMPTY_MASK               (0x00000040u)
#define AOV0_EVENT_RAM1_EMPTY_MASK               (0x00000080u)
#define AOV1_EVENT_RAM0_EMPTY_MASK               (0x00000100u)
#define AOV1_EVENT_RAM1_EMPTY_MASK               (0x00000200u)
#define AOV2_EVENT_RAM0_EMPTY_MASK               (0x00000400u)
#define AOV2_EVENT_RAM1_EMPTY_MASK               (0x00000800u)
#define AOV0_EVENT_RAM_OVERRUN_MASK              (0x00001000u)
#define AOV1_EVENT_RAM_OVERRUN_MASK              (0x00002000u)
#define AOV2_EVENT_RAM_OVERRUN_MASK              (0x00004000u)
#define AOV_EVENT_VAD_POS_EVENT_MASK             (0x00008000u)
#define AOV_EVENT_VAD_NEG_EVENT_MASK             (0x00010000u)
#define AOV0_EVENT_EOD_DAT_AVAIL_MASK            (0x00020000u)
#define AOV1_EVENT_EOD_DAT_AVAIL_MASK            (0x00040000u)
#define AOV2_EVENT_EOD_DAT_AVAIL_MASK            (0x00080000u)

enum aov_ram_cfg_enum_posn_enum
{
   AOV_RAM_CFG_MAX_ENTRIES_LSB_POSN                   = (int)0,
   AOV_RAM_CFG_ENUM_AOV_RAM_CFG_MAX_ENTRIES_LSB_POSN  = (int)0,
   AOV_RAM_CFG_MAX_ENTRIES_MSB_POSN                   = (int)12,
   AOV_RAM_CFG_ENUM_AOV_RAM_CFG_MAX_ENTRIES_MSB_POSN  = (int)12,
   AOV_RAM_CFG_THRESHOLD_LSB_POSN                     = (int)13,
   AOV_RAM_CFG_ENUM_AOV_RAM_CFG_THRESHOLD_LSB_POSN    = (int)13,
   AOV_RAM_CFG_THRESHOLD_MSB_POSN                     = (int)16,
   AOV_RAM_CFG_ENUM_AOV_RAM_CFG_THRESHOLD_MSB_POSN    = (int)16,
   AOV_RAM_CFG_READ_LIMIT_LSB_POSN                    = (int)17,
   AOV_RAM_CFG_ENUM_AOV_RAM_CFG_READ_LIMIT_LSB_POSN   = (int)17,
   AOV_RAM_CFG_READ_LIMIT_MSB_POSN                    = (int)20,
   AOV_RAM_CFG_ENUM_AOV_RAM_CFG_READ_LIMIT_MSB_POSN   = (int)20,
   AOV_RAM_CFG_STALL_LIMIT_LSB_POSN                   = (int)21,
   AOV_RAM_CFG_ENUM_AOV_RAM_CFG_STALL_LIMIT_LSB_POSN  = (int)21,
   AOV_RAM_CFG_STALL_LIMIT_MSB_POSN                   = (int)24,
   AOV_RAM_CFG_ENUM_AOV_RAM_CFG_STALL_LIMIT_MSB_POSN  = (int)24
};
typedef enum aov_ram_cfg_enum_posn_enum aov_ram_cfg_enum_posn;

#define AOV_RAM_CFG_MAX_ENTRIES_LSB_MASK         (0x00000001u)
#define AOV_RAM_CFG_MAX_ENTRIES_MSB_MASK         (0x00001000u)
#define AOV_RAM_CFG_THRESHOLD_LSB_MASK           (0x00002000u)
#define AOV_RAM_CFG_THRESHOLD_MSB_MASK           (0x00010000u)
#define AOV_RAM_CFG_READ_LIMIT_LSB_MASK          (0x00020000u)
#define AOV_RAM_CFG_READ_LIMIT_MSB_MASK          (0x00100000u)
#define AOV_RAM_CFG_STALL_LIMIT_LSB_MASK         (0x00200000u)
#define AOV_RAM_CFG_STALL_LIMIT_MSB_MASK         (0x01000000u)

enum aov0_rams_ema_posn_enum
{
   AOV0_RAM0_EMAW_LSB_POSN                            = (int)0,
   AOV0_RAMS_EMA_AOV0_RAM0_EMAW_LSB_POSN              = (int)0,
   AOV0_RAM0_EMAW_MSB_POSN                            = (int)1,
   AOV0_RAMS_EMA_AOV0_RAM0_EMAW_MSB_POSN              = (int)1,
   AOV0_RAM0_EMA_LSB_POSN                             = (int)2,
   AOV0_RAMS_EMA_AOV0_RAM0_EMA_LSB_POSN               = (int)2,
   AOV0_RAM0_EMA_MSB_POSN                             = (int)4,
   AOV0_RAMS_EMA_AOV0_RAM0_EMA_MSB_POSN               = (int)4,
   AOV0_RAM0_EMAS_POSN                                = (int)5,
   AOV0_RAMS_EMA_AOV0_RAM0_EMAS_LSB_POSN              = (int)5,
   AOV0_RAMS_EMA_AOV0_RAM0_EMAS_MSB_POSN              = (int)5,
   AOV0_RAM1_EMAW_LSB_POSN                            = (int)6,
   AOV0_RAMS_EMA_AOV0_RAM1_EMAW_LSB_POSN              = (int)6,
   AOV0_RAM1_EMAW_MSB_POSN                            = (int)7,
   AOV0_RAMS_EMA_AOV0_RAM1_EMAW_MSB_POSN              = (int)7,
   AOV0_RAM1_EMA_LSB_POSN                             = (int)8,
   AOV0_RAMS_EMA_AOV0_RAM1_EMA_LSB_POSN               = (int)8,
   AOV0_RAM1_EMA_MSB_POSN                             = (int)10,
   AOV0_RAMS_EMA_AOV0_RAM1_EMA_MSB_POSN               = (int)10,
   AOV0_RAM1_EMAS_POSN                                = (int)11,
   AOV0_RAMS_EMA_AOV0_RAM1_EMAS_LSB_POSN              = (int)11,
   AOV0_RAMS_EMA_AOV0_RAM1_EMAS_MSB_POSN              = (int)11
};
typedef enum aov0_rams_ema_posn_enum aov0_rams_ema_posn;

#define AOV0_RAM0_EMAW_LSB_MASK                  (0x00000001u)
#define AOV0_RAM0_EMAW_MSB_MASK                  (0x00000002u)
#define AOV0_RAM0_EMA_LSB_MASK                   (0x00000004u)
#define AOV0_RAM0_EMA_MSB_MASK                   (0x00000010u)
#define AOV0_RAM0_EMAS_MASK                      (0x00000020u)
#define AOV0_RAM1_EMAW_LSB_MASK                  (0x00000040u)
#define AOV0_RAM1_EMAW_MSB_MASK                  (0x00000080u)
#define AOV0_RAM1_EMA_LSB_MASK                   (0x00000100u)
#define AOV0_RAM1_EMA_MSB_MASK                   (0x00000400u)
#define AOV0_RAM1_EMAS_MASK                      (0x00000800u)

enum aov1_rams_ema_posn_enum
{
   AOV1_RAM0_EMAW_LSB_POSN                            = (int)0,
   AOV1_RAMS_EMA_AOV1_RAM0_EMAW_LSB_POSN              = (int)0,
   AOV1_RAM0_EMAW_MSB_POSN                            = (int)1,
   AOV1_RAMS_EMA_AOV1_RAM0_EMAW_MSB_POSN              = (int)1,
   AOV1_RAM0_EMA_LSB_POSN                             = (int)2,
   AOV1_RAMS_EMA_AOV1_RAM0_EMA_LSB_POSN               = (int)2,
   AOV1_RAM0_EMA_MSB_POSN                             = (int)4,
   AOV1_RAMS_EMA_AOV1_RAM0_EMA_MSB_POSN               = (int)4,
   AOV1_RAM0_EMAS_POSN                                = (int)5,
   AOV1_RAMS_EMA_AOV1_RAM0_EMAS_LSB_POSN              = (int)5,
   AOV1_RAMS_EMA_AOV1_RAM0_EMAS_MSB_POSN              = (int)5,
   AOV1_RAM1_EMAW_LSB_POSN                            = (int)6,
   AOV1_RAMS_EMA_AOV1_RAM1_EMAW_LSB_POSN              = (int)6,
   AOV1_RAM1_EMAW_MSB_POSN                            = (int)7,
   AOV1_RAMS_EMA_AOV1_RAM1_EMAW_MSB_POSN              = (int)7,
   AOV1_RAM1_EMA_LSB_POSN                             = (int)8,
   AOV1_RAMS_EMA_AOV1_RAM1_EMA_LSB_POSN               = (int)8,
   AOV1_RAM1_EMA_MSB_POSN                             = (int)10,
   AOV1_RAMS_EMA_AOV1_RAM1_EMA_MSB_POSN               = (int)10,
   AOV1_RAM1_EMAS_POSN                                = (int)11,
   AOV1_RAMS_EMA_AOV1_RAM1_EMAS_LSB_POSN              = (int)11,
   AOV1_RAMS_EMA_AOV1_RAM1_EMAS_MSB_POSN              = (int)11
};
typedef enum aov1_rams_ema_posn_enum aov1_rams_ema_posn;

#define AOV1_RAM0_EMAW_LSB_MASK                  (0x00000001u)
#define AOV1_RAM0_EMAW_MSB_MASK                  (0x00000002u)
#define AOV1_RAM0_EMA_LSB_MASK                   (0x00000004u)
#define AOV1_RAM0_EMA_MSB_MASK                   (0x00000010u)
#define AOV1_RAM0_EMAS_MASK                      (0x00000020u)
#define AOV1_RAM1_EMAW_LSB_MASK                  (0x00000040u)
#define AOV1_RAM1_EMAW_MSB_MASK                  (0x00000080u)
#define AOV1_RAM1_EMA_LSB_MASK                   (0x00000100u)
#define AOV1_RAM1_EMA_MSB_MASK                   (0x00000400u)
#define AOV1_RAM1_EMAS_MASK                      (0x00000800u)

enum aov2_rams_ema_posn_enum
{
   AOV2_RAM0_EMAW_LSB_POSN                            = (int)0,
   AOV2_RAMS_EMA_AOV2_RAM0_EMAW_LSB_POSN              = (int)0,
   AOV2_RAM0_EMAW_MSB_POSN                            = (int)1,
   AOV2_RAMS_EMA_AOV2_RAM0_EMAW_MSB_POSN              = (int)1,
   AOV2_RAM0_EMA_LSB_POSN                             = (int)2,
   AOV2_RAMS_EMA_AOV2_RAM0_EMA_LSB_POSN               = (int)2,
   AOV2_RAM0_EMA_MSB_POSN                             = (int)4,
   AOV2_RAMS_EMA_AOV2_RAM0_EMA_MSB_POSN               = (int)4,
   AOV2_RAM0_EMAS_POSN                                = (int)5,
   AOV2_RAMS_EMA_AOV2_RAM0_EMAS_LSB_POSN              = (int)5,
   AOV2_RAMS_EMA_AOV2_RAM0_EMAS_MSB_POSN              = (int)5,
   AOV2_RAM1_EMAW_LSB_POSN                            = (int)6,
   AOV2_RAMS_EMA_AOV2_RAM1_EMAW_LSB_POSN              = (int)6,
   AOV2_RAM1_EMAW_MSB_POSN                            = (int)7,
   AOV2_RAMS_EMA_AOV2_RAM1_EMAW_MSB_POSN              = (int)7,
   AOV2_RAM1_EMA_LSB_POSN                             = (int)8,
   AOV2_RAMS_EMA_AOV2_RAM1_EMA_LSB_POSN               = (int)8,
   AOV2_RAM1_EMA_MSB_POSN                             = (int)10,
   AOV2_RAMS_EMA_AOV2_RAM1_EMA_MSB_POSN               = (int)10,
   AOV2_RAM1_EMAS_POSN                                = (int)11,
   AOV2_RAMS_EMA_AOV2_RAM1_EMAS_LSB_POSN              = (int)11,
   AOV2_RAMS_EMA_AOV2_RAM1_EMAS_MSB_POSN              = (int)11
};
typedef enum aov2_rams_ema_posn_enum aov2_rams_ema_posn;

#define AOV2_RAM0_EMAW_LSB_MASK                  (0x00000001u)
#define AOV2_RAM0_EMAW_MSB_MASK                  (0x00000002u)
#define AOV2_RAM0_EMA_LSB_MASK                   (0x00000004u)
#define AOV2_RAM0_EMA_MSB_MASK                   (0x00000010u)
#define AOV2_RAM0_EMAS_MASK                      (0x00000020u)
#define AOV2_RAM1_EMAW_LSB_MASK                  (0x00000040u)
#define AOV2_RAM1_EMAW_MSB_MASK                  (0x00000080u)
#define AOV2_RAM1_EMA_LSB_MASK                   (0x00000100u)
#define AOV2_RAM1_EMA_MSB_MASK                   (0x00000400u)
#define AOV2_RAM1_EMAS_MASK                      (0x00000800u)

enum aov_debug_select_posn_enum
{
   DBG_RAM_CONTENTS_SEL_LSB_POSN                      = (int)0,
   AOV_DEBUG_SELECT_DBG_RAM_CONTENTS_SEL_LSB_POSN     = (int)0,
   DBG_RAM_CONTENTS_SEL_MSB_POSN                      = (int)4,
   AOV_DEBUG_SELECT_DBG_RAM_CONTENTS_SEL_MSB_POSN     = (int)4,
   DBG_RAM_SEL_LSB_POSN                               = (int)5,
   AOV_DEBUG_SELECT_DBG_RAM_SEL_LSB_POSN              = (int)5,
   DBG_RAM_SEL_MSB_POSN                               = (int)6,
   AOV_DEBUG_SELECT_DBG_RAM_SEL_MSB_POSN              = (int)6
};
typedef enum aov_debug_select_posn_enum aov_debug_select_posn;

#define DBG_RAM_CONTENTS_SEL_LSB_MASK            (0x00000001u)
#define DBG_RAM_CONTENTS_SEL_MSB_MASK            (0x00000010u)
#define DBG_RAM_SEL_LSB_MASK                     (0x00000020u)
#define DBG_RAM_SEL_MSB_MASK                     (0x00000040u)

enum aov_keyhole_posn_enum
{
   AOV_KEYHOLE_ADDR_LSB_POSN                          = (int)0,
   AOV_KEYHOLE_AOV_KEYHOLE_ADDR_LSB_POSN              = (int)0,
   AOV_KEYHOLE_ADDR_MSB_POSN                          = (int)12,
   AOV_KEYHOLE_AOV_KEYHOLE_ADDR_MSB_POSN              = (int)12,
   AOV_KEYHOLE_FORCE_RAM_SEL_POSN                     = (int)13,
   AOV_KEYHOLE_AOV_KEYHOLE_FORCE_RAM_SEL_LSB_POSN     = (int)13,
   AOV_KEYHOLE_AOV_KEYHOLE_FORCE_RAM_SEL_MSB_POSN     = (int)13,
   AOV_KEYHOLE_RAM_SEL_POSN                           = (int)14,
   AOV_KEYHOLE_AOV_KEYHOLE_RAM_SEL_LSB_POSN           = (int)14,
   AOV_KEYHOLE_AOV_KEYHOLE_RAM_SEL_MSB_POSN           = (int)14,
   AOV_KEYHOLE_INST_LSB_POSN                          = (int)15,
   AOV_KEYHOLE_AOV_KEYHOLE_INST_LSB_POSN              = (int)15,
   AOV_KEYHOLE_INST_MSB_POSN                          = (int)16,
   AOV_KEYHOLE_AOV_KEYHOLE_INST_MSB_POSN              = (int)16
};
typedef enum aov_keyhole_posn_enum aov_keyhole_posn;

#define AOV_KEYHOLE_ADDR_LSB_MASK                (0x00000001u)
#define AOV_KEYHOLE_ADDR_MSB_MASK                (0x00001000u)
#define AOV_KEYHOLE_FORCE_RAM_SEL_MASK           (0x00002000u)
#define AOV_KEYHOLE_RAM_SEL_MASK                 (0x00004000u)
#define AOV_KEYHOLE_INST_LSB_MASK                (0x00008000u)
#define AOV_KEYHOLE_INST_MSB_MASK                (0x00010000u)

enum aov_rams_ds_en_posn_enum
{
   AOV0_RAMS_DS_RAM0_POSN                             = (int)0,
   AOV_RAMS_DS_EN_AOV0_RAMS_DS_RAM0_LSB_POSN          = (int)0,
   AOV_RAMS_DS_EN_AOV0_RAMS_DS_RAM0_MSB_POSN          = (int)0,
   AOV0_RAMS_DS_RAM1_POSN                             = (int)1,
   AOV_RAMS_DS_EN_AOV0_RAMS_DS_RAM1_LSB_POSN          = (int)1,
   AOV_RAMS_DS_EN_AOV0_RAMS_DS_RAM1_MSB_POSN          = (int)1,
   AOV1_RAMS_DS_RAM0_POSN                             = (int)2,
   AOV_RAMS_DS_EN_AOV1_RAMS_DS_RAM0_LSB_POSN          = (int)2,
   AOV_RAMS_DS_EN_AOV1_RAMS_DS_RAM0_MSB_POSN          = (int)2,
   AOV1_RAMS_DS_RAM1_POSN                             = (int)3,
   AOV_RAMS_DS_EN_AOV1_RAMS_DS_RAM1_LSB_POSN          = (int)3,
   AOV_RAMS_DS_EN_AOV1_RAMS_DS_RAM1_MSB_POSN          = (int)3,
   AOV2_RAMS_DS_RAM0_POSN                             = (int)4,
   AOV_RAMS_DS_EN_AOV2_RAMS_DS_RAM0_LSB_POSN          = (int)4,
   AOV_RAMS_DS_EN_AOV2_RAMS_DS_RAM0_MSB_POSN          = (int)4,
   AOV2_RAMS_DS_RAM1_POSN                             = (int)5,
   AOV_RAMS_DS_EN_AOV2_RAMS_DS_RAM1_LSB_POSN          = (int)5,
   AOV_RAMS_DS_EN_AOV2_RAMS_DS_RAM1_MSB_POSN          = (int)5
};
typedef enum aov_rams_ds_en_posn_enum aov_rams_ds_en_posn;

#define AOV0_RAMS_DS_RAM0_MASK                   (0x00000001u)
#define AOV0_RAMS_DS_RAM1_MASK                   (0x00000002u)
#define AOV1_RAMS_DS_RAM0_MASK                   (0x00000004u)
#define AOV1_RAMS_DS_RAM1_MASK                   (0x00000008u)
#define AOV2_RAMS_DS_RAM0_MASK                   (0x00000010u)
#define AOV2_RAMS_DS_RAM1_MASK                   (0x00000020u)

enum aov_rams_ls_en_posn_enum
{
   AOV0_RAMS_LS_RAM0_POSN                             = (int)0,
   AOV_RAMS_LS_EN_AOV0_RAMS_LS_RAM0_LSB_POSN          = (int)0,
   AOV_RAMS_LS_EN_AOV0_RAMS_LS_RAM0_MSB_POSN          = (int)0,
   AOV0_RAMS_LS_RAM1_POSN                             = (int)1,
   AOV_RAMS_LS_EN_AOV0_RAMS_LS_RAM1_LSB_POSN          = (int)1,
   AOV_RAMS_LS_EN_AOV0_RAMS_LS_RAM1_MSB_POSN          = (int)1,
   AOV1_RAMS_LS_RAM0_POSN                             = (int)2,
   AOV_RAMS_LS_EN_AOV1_RAMS_LS_RAM0_LSB_POSN          = (int)2,
   AOV_RAMS_LS_EN_AOV1_RAMS_LS_RAM0_MSB_POSN          = (int)2,
   AOV1_RAMS_LS_RAM1_POSN                             = (int)3,
   AOV_RAMS_LS_EN_AOV1_RAMS_LS_RAM1_LSB_POSN          = (int)3,
   AOV_RAMS_LS_EN_AOV1_RAMS_LS_RAM1_MSB_POSN          = (int)3,
   AOV2_RAMS_LS_RAM0_POSN                             = (int)4,
   AOV_RAMS_LS_EN_AOV2_RAMS_LS_RAM0_LSB_POSN          = (int)4,
   AOV_RAMS_LS_EN_AOV2_RAMS_LS_RAM0_MSB_POSN          = (int)4,
   AOV2_RAMS_LS_RAM1_POSN                             = (int)5,
   AOV_RAMS_LS_EN_AOV2_RAMS_LS_RAM1_LSB_POSN          = (int)5,
   AOV_RAMS_LS_EN_AOV2_RAMS_LS_RAM1_MSB_POSN          = (int)5
};
typedef enum aov_rams_ls_en_posn_enum aov_rams_ls_en_posn;

#define AOV0_RAMS_LS_RAM0_MASK                   (0x00000001u)
#define AOV0_RAMS_LS_RAM1_MASK                   (0x00000002u)
#define AOV1_RAMS_LS_RAM0_MASK                   (0x00000004u)
#define AOV1_RAMS_LS_RAM1_MASK                   (0x00000008u)
#define AOV2_RAMS_LS_RAM0_MASK                   (0x00000010u)
#define AOV2_RAMS_LS_RAM1_MASK                   (0x00000020u)

enum aov_rams_rawl_posn_enum
{
   AOV0_RAM0_RAWLM_LSB_POSN                           = (int)0,
   AOV_RAMS_RAWL_AOV0_RAM0_RAWLM_LSB_POSN             = (int)0,
   AOV0_RAM0_RAWLM_MSB_POSN                           = (int)1,
   AOV_RAMS_RAWL_AOV0_RAM0_RAWLM_MSB_POSN             = (int)1,
   AOV0_RAM0_RAWL_POSN                                = (int)2,
   AOV_RAMS_RAWL_AOV0_RAM0_RAWL_LSB_POSN              = (int)2,
   AOV_RAMS_RAWL_AOV0_RAM0_RAWL_MSB_POSN              = (int)2,
   AOV0_RAM1_RAWLM_LSB_POSN                           = (int)3,
   AOV_RAMS_RAWL_AOV0_RAM1_RAWLM_LSB_POSN             = (int)3,
   AOV0_RAM1_RAWLM_MSB_POSN                           = (int)4,
   AOV_RAMS_RAWL_AOV0_RAM1_RAWLM_MSB_POSN             = (int)4,
   AOV0_RAM1_RAWL_POSN                                = (int)5,
   AOV_RAMS_RAWL_AOV0_RAM1_RAWL_LSB_POSN              = (int)5,
   AOV_RAMS_RAWL_AOV0_RAM1_RAWL_MSB_POSN              = (int)5,
   AOV1_RAM0_RAWLM_LSB_POSN                           = (int)6,
   AOV_RAMS_RAWL_AOV1_RAM0_RAWLM_LSB_POSN             = (int)6,
   AOV1_RAM0_RAWLM_MSB_POSN                           = (int)7,
   AOV_RAMS_RAWL_AOV1_RAM0_RAWLM_MSB_POSN             = (int)7,
   AOV1_RAM0_RAWL_POSN                                = (int)8,
   AOV_RAMS_RAWL_AOV1_RAM0_RAWL_LSB_POSN              = (int)8,
   AOV_RAMS_RAWL_AOV1_RAM0_RAWL_MSB_POSN              = (int)8,
   AOV1_RAM1_RAWLM_LSB_POSN                           = (int)9,
   AOV_RAMS_RAWL_AOV1_RAM1_RAWLM_LSB_POSN             = (int)9,
   AOV1_RAM1_RAWLM_MSB_POSN                           = (int)10,
   AOV_RAMS_RAWL_AOV1_RAM1_RAWLM_MSB_POSN             = (int)10,
   AOV1_RAM1_RAWL_POSN                                = (int)11,
   AOV_RAMS_RAWL_AOV1_RAM1_RAWL_LSB_POSN              = (int)11,
   AOV_RAMS_RAWL_AOV1_RAM1_RAWL_MSB_POSN              = (int)11,
   AOV2_RAM0_RAWLM_LSB_POSN                           = (int)12,
   AOV_RAMS_RAWL_AOV2_RAM0_RAWLM_LSB_POSN             = (int)12,
   AOV2_RAM0_RAWLM_MSB_POSN                           = (int)13,
   AOV_RAMS_RAWL_AOV2_RAM0_RAWLM_MSB_POSN             = (int)13,
   AOV2_RAM0_RAWL_POSN                                = (int)14,
   AOV_RAMS_RAWL_AOV2_RAM0_RAWL_LSB_POSN              = (int)14,
   AOV_RAMS_RAWL_AOV2_RAM0_RAWL_MSB_POSN              = (int)14,
   AOV2_RAM1_RAWLM_LSB_POSN                           = (int)15,
   AOV_RAMS_RAWL_AOV2_RAM1_RAWLM_LSB_POSN             = (int)15,
   AOV2_RAM1_RAWLM_MSB_POSN                           = (int)16,
   AOV_RAMS_RAWL_AOV2_RAM1_RAWLM_MSB_POSN             = (int)16,
   AOV2_RAM1_RAWL_POSN                                = (int)17,
   AOV_RAMS_RAWL_AOV2_RAM1_RAWL_LSB_POSN              = (int)17,
   AOV_RAMS_RAWL_AOV2_RAM1_RAWL_MSB_POSN              = (int)17
};
typedef enum aov_rams_rawl_posn_enum aov_rams_rawl_posn;

#define AOV0_RAM0_RAWLM_LSB_MASK                 (0x00000001u)
#define AOV0_RAM0_RAWLM_MSB_MASK                 (0x00000002u)
#define AOV0_RAM0_RAWL_MASK                      (0x00000004u)
#define AOV0_RAM1_RAWLM_LSB_MASK                 (0x00000008u)
#define AOV0_RAM1_RAWLM_MSB_MASK                 (0x00000010u)
#define AOV0_RAM1_RAWL_MASK                      (0x00000020u)
#define AOV1_RAM0_RAWLM_LSB_MASK                 (0x00000040u)
#define AOV1_RAM0_RAWLM_MSB_MASK                 (0x00000080u)
#define AOV1_RAM0_RAWL_MASK                      (0x00000100u)
#define AOV1_RAM1_RAWLM_LSB_MASK                 (0x00000200u)
#define AOV1_RAM1_RAWLM_MSB_MASK                 (0x00000400u)
#define AOV1_RAM1_RAWL_MASK                      (0x00000800u)
#define AOV2_RAM0_RAWLM_LSB_MASK                 (0x00001000u)
#define AOV2_RAM0_RAWLM_MSB_MASK                 (0x00002000u)
#define AOV2_RAM0_RAWL_MASK                      (0x00004000u)
#define AOV2_RAM1_RAWLM_LSB_MASK                 (0x00008000u)
#define AOV2_RAM1_RAWLM_MSB_MASK                 (0x00010000u)
#define AOV2_RAM1_RAWL_MASK                      (0x00020000u)

enum aov_rams_sd_en_posn_enum
{
   AOV0_RAMS_SD_RAM0_POSN                             = (int)0,
   AOV_RAMS_SD_EN_AOV0_RAMS_SD_RAM0_LSB_POSN          = (int)0,
   AOV_RAMS_SD_EN_AOV0_RAMS_SD_RAM0_MSB_POSN          = (int)0,
   AOV0_RAMS_SD_RAM1_POSN                             = (int)1,
   AOV_RAMS_SD_EN_AOV0_RAMS_SD_RAM1_LSB_POSN          = (int)1,
   AOV_RAMS_SD_EN_AOV0_RAMS_SD_RAM1_MSB_POSN          = (int)1,
   AOV1_RAMS_SD_RAM0_POSN                             = (int)2,
   AOV_RAMS_SD_EN_AOV1_RAMS_SD_RAM0_LSB_POSN          = (int)2,
   AOV_RAMS_SD_EN_AOV1_RAMS_SD_RAM0_MSB_POSN          = (int)2,
   AOV1_RAMS_SD_RAM1_POSN                             = (int)3,
   AOV_RAMS_SD_EN_AOV1_RAMS_SD_RAM1_LSB_POSN          = (int)3,
   AOV_RAMS_SD_EN_AOV1_RAMS_SD_RAM1_MSB_POSN          = (int)3,
   AOV2_RAMS_SD_RAM0_POSN                             = (int)4,
   AOV_RAMS_SD_EN_AOV2_RAMS_SD_RAM0_LSB_POSN          = (int)4,
   AOV_RAMS_SD_EN_AOV2_RAMS_SD_RAM0_MSB_POSN          = (int)4,
   AOV2_RAMS_SD_RAM1_POSN                             = (int)5,
   AOV_RAMS_SD_EN_AOV2_RAMS_SD_RAM1_LSB_POSN          = (int)5,
   AOV_RAMS_SD_EN_AOV2_RAMS_SD_RAM1_MSB_POSN          = (int)5
};
typedef enum aov_rams_sd_en_posn_enum aov_rams_sd_en_posn;

#define AOV0_RAMS_SD_RAM0_MASK                   (0x00000001u)
#define AOV0_RAMS_SD_RAM1_MASK                   (0x00000002u)
#define AOV1_RAMS_SD_RAM0_MASK                   (0x00000004u)
#define AOV1_RAMS_SD_RAM1_MASK                   (0x00000008u)
#define AOV2_RAMS_SD_RAM0_MASK                   (0x00000010u)
#define AOV2_RAMS_SD_RAM1_MASK                   (0x00000020u)

enum aov_rams_wabl_posn_enum
{
   AOV0_RAM0_WABLM_LSB_POSN                           = (int)0,
   AOV_RAMS_WABL_AOV0_RAM0_WABLM_LSB_POSN             = (int)0,
   AOV0_RAM0_WABLM_MSB_POSN                           = (int)2,
   AOV_RAMS_WABL_AOV0_RAM0_WABLM_MSB_POSN             = (int)2,
   AOV0_RAM0_WABL_POSN                                = (int)3,
   AOV_RAMS_WABL_AOV0_RAM0_WABL_LSB_POSN              = (int)3,
   AOV_RAMS_WABL_AOV0_RAM0_WABL_MSB_POSN              = (int)3,
   AOV0_RAM1_WABLM_LSB_POSN                           = (int)4,
   AOV_RAMS_WABL_AOV0_RAM1_WABLM_LSB_POSN             = (int)4,
   AOV0_RAM1_WABLM_MSB_POSN                           = (int)6,
   AOV_RAMS_WABL_AOV0_RAM1_WABLM_MSB_POSN             = (int)6,
   AOV0_RAM1_WABL_POSN                                = (int)7,
   AOV_RAMS_WABL_AOV0_RAM1_WABL_LSB_POSN              = (int)7,
   AOV_RAMS_WABL_AOV0_RAM1_WABL_MSB_POSN              = (int)7,
   AOV1_RAM0_WABLM_LSB_POSN                           = (int)8,
   AOV_RAMS_WABL_AOV1_RAM0_WABLM_LSB_POSN             = (int)8,
   AOV1_RAM0_WABLM_MSB_POSN                           = (int)10,
   AOV_RAMS_WABL_AOV1_RAM0_WABLM_MSB_POSN             = (int)10,
   AOV1_RAM0_WABL_POSN                                = (int)11,
   AOV_RAMS_WABL_AOV1_RAM0_WABL_LSB_POSN              = (int)11,
   AOV_RAMS_WABL_AOV1_RAM0_WABL_MSB_POSN              = (int)11,
   AOV1_RAM1_WABLM_LSB_POSN                           = (int)12,
   AOV_RAMS_WABL_AOV1_RAM1_WABLM_LSB_POSN             = (int)12,
   AOV1_RAM1_WABLM_MSB_POSN                           = (int)14,
   AOV_RAMS_WABL_AOV1_RAM1_WABLM_MSB_POSN             = (int)14,
   AOV1_RAM1_WABL_POSN                                = (int)15,
   AOV_RAMS_WABL_AOV1_RAM1_WABL_LSB_POSN              = (int)15,
   AOV_RAMS_WABL_AOV1_RAM1_WABL_MSB_POSN              = (int)15,
   AOV2_RAM0_WABLM_LSB_POSN                           = (int)16,
   AOV_RAMS_WABL_AOV2_RAM0_WABLM_LSB_POSN             = (int)16,
   AOV2_RAM0_WABLM_MSB_POSN                           = (int)18,
   AOV_RAMS_WABL_AOV2_RAM0_WABLM_MSB_POSN             = (int)18,
   AOV2_RAM0_WABL_POSN                                = (int)19,
   AOV_RAMS_WABL_AOV2_RAM0_WABL_LSB_POSN              = (int)19,
   AOV_RAMS_WABL_AOV2_RAM0_WABL_MSB_POSN              = (int)19,
   AOV2_RAM1_WABLM_LSB_POSN                           = (int)20,
   AOV_RAMS_WABL_AOV2_RAM1_WABLM_LSB_POSN             = (int)20,
   AOV2_RAM1_WABLM_MSB_POSN                           = (int)22,
   AOV_RAMS_WABL_AOV2_RAM1_WABLM_MSB_POSN             = (int)22,
   AOV2_RAM1_WABL_POSN                                = (int)23,
   AOV_RAMS_WABL_AOV2_RAM1_WABL_LSB_POSN              = (int)23,
   AOV_RAMS_WABL_AOV2_RAM1_WABL_MSB_POSN              = (int)23
};
typedef enum aov_rams_wabl_posn_enum aov_rams_wabl_posn;

#define AOV0_RAM0_WABLM_LSB_MASK                 (0x00000001u)
#define AOV0_RAM0_WABLM_MSB_MASK                 (0x00000004u)
#define AOV0_RAM0_WABL_MASK                      (0x00000008u)
#define AOV0_RAM1_WABLM_LSB_MASK                 (0x00000010u)
#define AOV0_RAM1_WABLM_MSB_MASK                 (0x00000040u)
#define AOV0_RAM1_WABL_MASK                      (0x00000080u)
#define AOV1_RAM0_WABLM_LSB_MASK                 (0x00000100u)
#define AOV1_RAM0_WABLM_MSB_MASK                 (0x00000400u)
#define AOV1_RAM0_WABL_MASK                      (0x00000800u)
#define AOV1_RAM1_WABLM_LSB_MASK                 (0x00001000u)
#define AOV1_RAM1_WABLM_MSB_MASK                 (0x00004000u)
#define AOV1_RAM1_WABL_MASK                      (0x00008000u)
#define AOV2_RAM0_WABLM_LSB_MASK                 (0x00010000u)
#define AOV2_RAM0_WABLM_MSB_MASK                 (0x00040000u)
#define AOV2_RAM0_WABL_MASK                      (0x00080000u)
#define AOV2_RAM1_WABLM_LSB_MASK                 (0x00100000u)
#define AOV2_RAM1_WABLM_MSB_MASK                 (0x00400000u)
#define AOV2_RAM1_WABL_MASK                      (0x00800000u)
...
enum aov_ram_if_status2_posn_enum
{
   ...
   RAM_WRITE_ADDR_MSB_POSN                            = (int)12,
   AOV_RAM_IF_STATUS2_RAM_WRITE_ADDR_MSB_POSN         = (int)12,
   RAM_WR_SEL_POSN                                    = (int)13,
   AOV_RAM_IF_STATUS2_RAM_WR_SEL_LSB_POSN             = (int)13,
   AOV_RAM_IF_STATUS2_RAM_WR_SEL_MSB_POSN             = (int)13,
   RAM_RD_ADR_LSB_POSN                                = (int)14,
   AOV_RAM_IF_STATUS2_RAM_RD_ADR_LSB_POSN             = (int)14,
   RAM_RD_ADR_MSB_POSN                                = (int)26,
   AOV_RAM_IF_STATUS2_RAM_RD_ADR_MSB_POSN             = (int)26
};
typedef enum aov_ram_if_status2_posn_enum aov_ram_if_status2_posn;

#define RAM_WRITE_ADDR_LSB_MASK                  (0x00000001u)
#define RAM_WRITE_ADDR_MSB_MASK                  (0x00001000u)
#define RAM_WR_SEL_MASK                          (0x00002000u)
#define RAM_RD_ADR_LSB_MASK                      (0x00004000u)
#define RAM_RD_ADR_MSB_MASK                      (0x04000000u)

enum aov_sequencer_active_posn_enum
{
   AOV0_RAM0_SEQ_ACT_POSN                             = (int)0,
   AOV_SEQUENCER_ACTIVE_AOV0_RAM0_SEQ_ACT_LSB_POSN    = (int)0,
   AOV_SEQUENCER_ACTIVE_AOV0_RAM0_SEQ_ACT_MSB_POSN    = (int)0,
   AOV0_RAM1_SEQ_ACT_POSN                             = (int)1,
   AOV_SEQUENCER_ACTIVE_AOV0_RAM1_SEQ_ACT_LSB_POSN    = (int)1,
   AOV_SEQUENCER_ACTIVE_AOV0_RAM1_SEQ_ACT_MSB_POSN    = (int)1,
   AOV1_RAM0_SEQ_ACT_POSN                             = (int)2,
   AOV_SEQUENCER_ACTIVE_AOV1_RAM0_SEQ_ACT_LSB_POSN    = (int)2,
   AOV_SEQUENCER_ACTIVE_AOV1_RAM0_SEQ_ACT_MSB_POSN    = (int)2,
   AOV1_RAM1_SEQ_ACT_POSN                             = (int)3,
   AOV_SEQUENCER_ACTIVE_AOV1_RAM1_SEQ_ACT_LSB_POSN    = (int)3,
   AOV_SEQUENCER_ACTIVE_AOV1_RAM1_SEQ_ACT_MSB_POSN    = (int)3,
   AOV2_RAM0_SEQ_ACT_POSN                             = (int)4,
   AOV_SEQUENCER_ACTIVE_AOV2_RAM0_SEQ_ACT_LSB_POSN    = (int)4,
   AOV_SEQUENCER_ACTIVE_AOV2_RAM0_SEQ_ACT_MSB_POSN    = (int)4,
   AOV2_RAM1_SEQ_ACT_POSN                             = (int)5,
   AOV_SEQUENCER_ACTIVE_AOV2_RAM1_SEQ_ACT_LSB_POSN    = (int)5,
   AOV_SEQUENCER_ACTIVE_AOV2_RAM1_SEQ_ACT_MSB_POSN    = (int)5
};
typedef enum aov_sequencer_active_posn_enum aov_sequencer_active_posn;

#define AOV0_RAM0_SEQ_ACT_MASK                   (0x00000001u)
#define AOV0_RAM1_SEQ_ACT_MASK                   (0x00000002u)
#define AOV1_RAM0_SEQ_ACT_MASK                   (0x00000004u)
#define AOV1_RAM1_SEQ_ACT_MASK                   (0x00000008u)
#define AOV2_RAM0_SEQ_ACT_MASK                   (0x00000010u)
#define AOV2_RAM1_SEQ_ACT_MASK                   (0x00000020u)
...
enum aov0_ctl_posn_enum
{
   AOV0_CTL_AOV_CTL_ENABLE_LSB_POSN                   = (int)0,
   AOV0_CTL_AOV_CTL_ENABLE_MSB_POSN                   = (int)0,
   AOV0_CTL_AOV_CTL_VAD_ENABLE_LSB_POSN               = (int)1,
   AOV0_CTL_AOV_CTL_VAD_ENABLE_MSB_POSN               = (int)1,
   AOV0_CTL_AOV_CTL_DRAIN_BUFFER_ENABLE_LSB_POSN      = (int)2,
   AOV0_CTL_AOV_CTL_DRAIN_BUFFER_ENABLE_MSB_POSN      = (int)2,
   AOV0_CTL_AOV_CTL_FREEZE_ON_ERROR_LSB_POSN          = (int)3,
   AOV0_CTL_AOV_CTL_FREEZE_ON_ERROR_MSB_POSN          = (int)3,
   AOV0_CTL_AOV_CTL_CLR_VAD_FIRED_LSB_POSN            = (int)4,
   AOV0_CTL_AOV_CTL_CLR_VAD_FIRED_MSB_POSN            = (int)4,
   AOV0_CTL_AOV_CTL_PAUSE_RAM_FILL_LSB_POSN           = (int)5,
   AOV0_CTL_AOV_CTL_PAUSE_RAM_FILL_MSB_POSN           = (int)5,
   AOV0_CTL_AOV_CTL_KCODEC_SEL_LSB_POSN               = (int)6,
   AOV0_CTL_AOV_CTL_KCODEC_SEL_MSB_POSN               = (int)9
};
typedef enum aov0_ctl_posn_enum aov0_ctl_posn;


enum aov0_eod_ctrl_posn_enum
{
   AOV0_EOD_CTRL_AOV_EOD_NUM_WORDS_LSB_POSN           = (int)0,
   AOV0_EOD_CTRL_AOV_EOD_NUM_WORDS_MSB_POSN           = (int)12,
   AOV0_EOD_CTRL_AOV_EOD_EN_LSB_POSN                  = (int)13,
   AOV0_EOD_CTRL_AOV_EOD_EN_MSB_POSN                  = (int)13,
   AOV0_EOD_CTRL_AOV_EOD_GO_LSB_POSN                  = (int)14,
   AOV0_EOD_CTRL_AOV_EOD_GO_MSB_POSN                  = (int)14
};
typedef enum aov0_eod_ctrl_posn_enum aov0_eod_ctrl_posn;


enum aov0_eod_status_posn_enum
{
   AOV0_EOD_STATUS_AOV_EOD_CNT_LSB_POSN               = (int)0,
   AOV0_EOD_STATUS_AOV_EOD_CNT_MSB_POSN               = (int)12
};
typedef enum aov0_eod_status_posn_enum aov0_eod_status_posn;


enum aov0_ram_cfg_posn_enum
{
   AOV0_RAM_CFG_AOV_RAM_CFG_MAX_ENTRIES_LSB_POSN      = (int)0,
   AOV0_RAM_CFG_AOV_RAM_CFG_MAX_ENTRIES_MSB_POSN      = (int)12,
   AOV0_RAM_CFG_AOV_RAM_CFG_THRESHOLD_LSB_POSN        = (int)13,
   AOV0_RAM_CFG_AOV_RAM_CFG_THRESHOLD_MSB_POSN        = (int)16,
   AOV0_RAM_CFG_AOV_RAM_CFG_READ_LIMIT_LSB_POSN       = (int)17,
   AOV0_RAM_CFG_AOV_RAM_CFG_READ_LIMIT_MSB_POSN       = (int)20,
   AOV0_RAM_CFG_AOV_RAM_CFG_STALL_LIMIT_LSB_POSN      = (int)21,
   AOV0_RAM_CFG_AOV_RAM_CFG_STALL_LIMIT_MSB_POSN      = (int)24
};
typedef enum aov0_ram_cfg_posn_enum aov0_ram_cfg_posn;


enum aov1_ctl_posn_enum
{
   AOV1_CTL_AOV_CTL_ENABLE_LSB_POSN                   = (int)0,
   AOV1_CTL_AOV_CTL_ENABLE_MSB_POSN                   = (int)0,
   AOV1_CTL_AOV_CTL_VAD_ENABLE_LSB_POSN               = (int)1,
   AOV1_CTL_AOV_CTL_VAD_ENABLE_MSB_POSN               = (int)1,
   AOV1_CTL_AOV_CTL_DRAIN_BUFFER_ENABLE_LSB_POSN      = (int)2,
   AOV1_CTL_AOV_CTL_DRAIN_BUFFER_ENABLE_MSB_POSN      = (int)2,
   AOV1_CTL_AOV_CTL_FREEZE_ON_ERROR_LSB_POSN          = (int)3,
   AOV1_CTL_AOV_CTL_FREEZE_ON_ERROR_MSB_POSN          = (int)3,
   AOV1_CTL_AOV_CTL_CLR_VAD_FIRED_LSB_POSN            = (int)4,
   AOV1_CTL_AOV_CTL_CLR_VAD_FIRED_MSB_POSN            = (int)4,
   AOV1_CTL_AOV_CTL_PAUSE_RAM_FILL_LSB_POSN           = (int)5,
   AOV1_CTL_AOV_CTL_PAUSE_RAM_FILL_MSB_POSN           = (int)5,
   AOV1_CTL_AOV_CTL_KCODEC_SEL_LSB_POSN               = (int)6,
   AOV1_CTL_AOV_CTL_KCODEC_SEL_MSB_POSN               = (int)9
};
typedef enum aov1_ctl_posn_enum aov1_ctl_posn;


enum aov1_eod_ctrl_posn_enum
{
   AOV1_EOD_CTRL_AOV_EOD_NUM_WORDS_LSB_POSN           = (int)0,
   AOV1_EOD_CTRL_AOV_EOD_NUM_WORDS_MSB_POSN           = (int)12,
   AOV1_EOD_CTRL_AOV_EOD_EN_LSB_POSN                  = (int)13,
   AOV1_EOD_CTRL_AOV_EOD_EN_MSB_POSN                  = (int)13,
   AOV1_EOD_CTRL_AOV_EOD_GO_LSB_POSN                  = (int)14,
   AOV1_EOD_CTRL_AOV_EOD_GO_MSB_POSN                  = (int)14
};
typedef enum aov1_eod_ctrl_posn_enum aov1_eod_ctrl_posn;


enum aov1_eod_status_posn_enum
{
   AOV1_EOD_STATUS_AOV_EOD_CNT_LSB_POSN               = (int)0,
   AOV1_EOD_STATUS_AOV_EOD_CNT_MSB_POSN               = (int)12
};
typedef enum aov1_eod_status_posn_enum aov1_eod_status_posn;


enum aov1_ram_cfg_posn_enum
{
   AOV1_RAM_CFG_AOV_RAM_CFG_MAX_ENTRIES_LSB_POSN      = (int)0,
   AOV1_RAM_CFG_AOV_RAM_CFG_MAX_ENTRIES_MSB_POSN      = (int)12,
   AOV1_RAM_CFG_AOV_RAM_CFG_THRESHOLD_LSB_POSN        = (int)13,
   AOV1_RAM_CFG_AOV_RAM_CFG_THRESHOLD_MSB_POSN        = (int)16,
   AOV1_RAM_CFG_AOV_RAM_CFG_READ_LIMIT_LSB_POSN       = (int)17,
   AOV1_RAM_CFG_AOV_RAM_CFG_READ_LIMIT_MSB_POSN       = (int)20,
   AOV1_RAM_CFG_AOV_RAM_CFG_STALL_LIMIT_LSB_POSN      = (int)21,
   AOV1_RAM_CFG_AOV_RAM_CFG_STALL_LIMIT_MSB_POSN      = (int)24
};
typedef enum aov1_ram_cfg_posn_enum aov1_ram_cfg_posn;


enum aov2_ctl_posn_enum
{
   AOV2_CTL_AOV_CTL_ENABLE_LSB_POSN                   = (int)0,
   AOV2_CTL_AOV_CTL_ENABLE_MSB_POSN                   = (int)0,
   AOV2_CTL_AOV_CTL_VAD_ENABLE_LSB_POSN               = (int)1,
   AOV2_CTL_AOV_CTL_VAD_ENABLE_MSB_POSN               = (int)1,
   AOV2_CTL_AOV_CTL_DRAIN_BUFFER_ENABLE_LSB_POSN      = (int)2,
   AOV2_CTL_AOV_CTL_DRAIN_BUFFER_ENABLE_MSB_POSN      = (int)2,
   AOV2_CTL_AOV_CTL_FREEZE_ON_ERROR_LSB_POSN          = (int)3,
   AOV2_CTL_AOV_CTL_FREEZE_ON_ERROR_MSB_POSN          = (int)3,
   AOV2_CTL_AOV_CTL_CLR_VAD_FIRED_LSB_POSN            = (int)4,
   AOV2_CTL_AOV_CTL_CLR_VAD_FIRED_MSB_POSN            = (int)4,
   AOV2_CTL_AOV_CTL_PAUSE_RAM_FILL_LSB_POSN           = (int)5,
   AOV2_CTL_AOV_CTL_PAUSE_RAM_FILL_MSB_POSN           = (int)5,
   AOV2_CTL_AOV_CTL_KCODEC_SEL_LSB_POSN               = (int)6,
   AOV2_CTL_AOV_CTL_KCODEC_SEL_MSB_POSN               = (int)9
};
typedef enum aov2_ctl_posn_enum aov2_ctl_posn;


enum aov2_eod_ctrl_posn_enum
{
   AOV2_EOD_CTRL_AOV_EOD_NUM_WORDS_LSB_POSN           = (int)0,
   AOV2_EOD_CTRL_AOV_EOD_NUM_WORDS_MSB_POSN           = (int)12,
   AOV2_EOD_CTRL_AOV_EOD_EN_LSB_POSN                  = (int)13,
   AOV2_EOD_CTRL_AOV_EOD_EN_MSB_POSN                  = (int)13,
   AOV2_EOD_CTRL_AOV_EOD_GO_LSB_POSN                  = (int)14,
   AOV2_EOD_CTRL_AOV_EOD_GO_MSB_POSN                  = (int)14
};
typedef enum aov2_eod_ctrl_posn_enum aov2_eod_ctrl_posn;


enum aov2_eod_status_posn_enum
{
   AOV2_EOD_STATUS_AOV_EOD_CNT_LSB_POSN               = (int)0,
   AOV2_EOD_STATUS_AOV_EOD_CNT_MSB_POSN               = (int)12
};
typedef enum aov2_eod_status_posn_enum aov2_eod_status_posn;


enum aov2_ram_cfg_posn_enum
{
   AOV2_RAM_CFG_AOV_RAM_CFG_MAX_ENTRIES_LSB_POSN      = (int)0,
   AOV2_RAM_CFG_AOV_RAM_CFG_MAX_ENTRIES_MSB_POSN      = (int)12,
   AOV2_RAM_CFG_AOV_RAM_CFG_THRESHOLD_LSB_POSN        = (int)13,
   AOV2_RAM_CFG_AOV_RAM_CFG_THRESHOLD_MSB_POSN        = (int)16,
   AOV2_RAM_CFG_AOV_RAM_CFG_READ_LIMIT_LSB_POSN       = (int)17,
   AOV2_RAM_CFG_AOV_RAM_CFG_READ_LIMIT_MSB_POSN       = (int)20,
   AOV2_RAM_CFG_AOV_RAM_CFG_STALL_LIMIT_LSB_POSN      = (int)21,
   AOV2_RAM_CFG_AOV_RAM_CFG_STALL_LIMIT_MSB_POSN      = (int)24
};
typedef enum aov2_ram_cfg_posn_enum aov2_ram_cfg_posn;


enum aov_event_clear_posn_enum
{
   AOV_EVENT_CLEAR_AOV0_EVENT_RAM0_FULL_LSB_POSN      = (int)0,
   AOV_EVENT_CLEAR_AOV0_EVENT_RAM0_FULL_MSB_POSN      = (int)0,
   AOV_EVENT_CLEAR_AOV0_EVENT_RAM1_FULL_LSB_POSN      = (int)1,
   AOV_EVENT_CLEAR_AOV0_EVENT_RAM1_FULL_MSB_POSN      = (int)1,
   AOV_EVENT_CLEAR_AOV1_EVENT_RAM0_FULL_LSB_POSN      = (int)2,
   AOV_EVENT_CLEAR_AOV1_EVENT_RAM0_FULL_MSB_POSN      = (int)2,
   AOV_EVENT_CLEAR_AOV1_EVENT_RAM1_FULL_LSB_POSN      = (int)3,
   AOV_EVENT_CLEAR_AOV1_EVENT_RAM1_FULL_MSB_POSN      = (int)3,
   AOV_EVENT_CLEAR_AOV2_EVENT_RAM0_FULL_LSB_POSN      = (int)4,
   AOV_EVENT_CLEAR_AOV2_EVENT_RAM0_FULL_MSB_POSN      = (int)4,
   AOV_EVENT_CLEAR_AOV2_EVENT_RAM1_FULL_LSB_POSN      = (int)5,
   AOV_EVENT_CLEAR_AOV2_EVENT_RAM1_FULL_MSB_POSN      = (int)5,
   AOV_EVENT_CLEAR_AOV0_EVENT_RAM0_EMPTY_LSB_POSN     = (int)6,
   AOV_EVENT_CLEAR_AOV0_EVENT_RAM0_EMPTY_MSB_POSN     = (int)6,
   AOV_EVENT_CLEAR_AOV0_EVENT_RAM1_EMPTY_LSB_POSN     = (int)7,
   AOV_EVENT_CLEAR_AOV0_EVENT_RAM1_EMPTY_MSB_POSN     = (int)7,
   AOV_EVENT_CLEAR_AOV1_EVENT_RAM0_EMPTY_LSB_POSN     = (int)8,
   AOV_EVENT_CLEAR_AOV1_EVENT_RAM0_EMPTY_MSB_POSN     = (int)8,
   AOV_EVENT_CLEAR_AOV1_EVENT_RAM1_EMPTY_LSB_POSN     = (int)9,
   AOV_EVENT_CLEAR_AOV1_EVENT_RAM1_EMPTY_MSB_POSN     = (int)9,
   AOV_EVENT_CLEAR_AOV2_EVENT_RAM0_EMPTY_LSB_POSN     = (int)10,
   AOV_EVENT_CLEAR_AOV2_EVENT_RAM0_EMPTY_MSB_POSN     = (int)10,
   AOV_EVENT_CLEAR_AOV2_EVENT_RAM1_EMPTY_LSB_POSN     = (int)11,
   AOV_EVENT_CLEAR_AOV2_EVENT_RAM1_EMPTY_MSB_POSN     = (int)11,
   AOV_EVENT_CLEAR_AOV0_EVENT_RAM_OVERRUN_LSB_POSN    = (int)12,
   AOV_EVENT_CLEAR_AOV0_EVENT_RAM_OVERRUN_MSB_POSN    = (int)12,
   AOV_EVENT_CLEAR_AOV1_EVENT_RAM_OVERRUN_LSB_POSN    = (int)13,
   AOV_EVENT_CLEAR_AOV1_EVENT_RAM_OVERRUN_MSB_POSN    = (int)13,
   AOV_EVENT_CLEAR_AOV2_EVENT_RAM_OVERRUN_LSB_POSN    = (int)14,
   AOV_EVENT_CLEAR_AOV2_EVENT_RAM_OVERRUN_MSB_POSN    = (int)14,
   AOV_EVENT_CLEAR_AOV_EVENT_VAD_POS_EVENT_LSB_POSN   = (int)15,
   AOV_EVENT_CLEAR_AOV_EVENT_VAD_POS_EVENT_MSB_POSN   = (int)15,
   AOV_EVENT_CLEAR_AOV_EVENT_VAD_NEG_EVENT_LSB_POSN   = (int)16,
   AOV_EVENT_CLEAR_AOV_EVENT_VAD_NEG_EVENT_MSB_POSN   = (int)16,
   AOV_EVENT_CLEAR_AOV0_EVENT_EOD_DAT_AVAIL_LSB_POSN  = (int)17,
   AOV_EVENT_CLEAR_AOV0_EVENT_EOD_DAT_AVAIL_MSB_POSN  = (int)17,
   AOV_EVENT_CLEAR_AOV1_EVENT_EOD_DAT_AVAIL_LSB_POSN  = (int)18,
   AOV_EVENT_CLEAR_AOV1_EVENT_EOD_DAT_AVAIL_MSB_POSN  = (int)18,
   AOV_EVENT_CLEAR_AOV2_EVENT_EOD_DAT_AVAIL_LSB_POSN  = (int)19,
   AOV_EVENT_CLEAR_AOV2_EVENT_EOD_DAT_AVAIL_MSB_POSN  = (int)19
};
...
{
   AOV_EVENT_MASK_AOV0_EVENT_RAM0_FULL_LSB_POSN       = (int)0,
   AOV_EVENT_MASK_AOV0_EVENT_RAM0_FULL_MSB_POSN       = (int)0,
   AOV_EVENT_MASK_AOV0_EVENT_RAM1_FULL_LSB_POSN       = (int)1,
   AOV_EVENT_MASK_AOV0_EVENT_RAM1_FULL_MSB_POSN       = (int)1,
   AOV_EVENT_MASK_AOV1_EVENT_RAM0_FULL_LSB_POSN       = (int)2,
   AOV_EVENT_MASK_AOV1_EVENT_RAM0_FULL_MSB_POSN       = (int)2,
   AOV_EVENT_MASK_AOV1_EVENT_RAM1_FULL_LSB_POSN       = (int)3,
   AOV_EVENT_MASK_AOV1_EVENT_RAM1_FULL_MSB_POSN       = (int)3,
   AOV_EVENT_MASK_AOV2_EVENT_RAM0_FULL_LSB_POSN       = (int)4,
   AOV_EVENT_MASK_AOV2_EVENT_RAM0_FULL_MSB_POSN       = (int)4,
   AOV_EVENT_MASK_AOV2_EVENT_RAM1_FULL_LSB_POSN       = (int)5,
   AOV_EVENT_MASK_AOV2_EVENT_RAM1_FULL_MSB_POSN       = (int)5,
   AOV_EVENT_MASK_AOV0_EVENT_RAM0_EMPTY_LSB_POSN      = (int)6,
   AOV_EVENT_MASK_AOV0_EVENT_RAM0_EMPTY_MSB_POSN      = (int)6,
   AOV_EVENT_MASK_AOV0_EVENT_RAM1_EMPTY_LSB_POSN      = (int)7,
   AOV_EVENT_MASK_AOV0_EVENT_RAM1_EMPTY_MSB_POSN      = (int)7,
   AOV_EVENT_MASK_AOV1_EVENT_RAM0_EMPTY_LSB_POSN      = (int)8,
   AOV_EVENT_MASK_AOV1_EVENT_RAM0_EMPTY_MSB_POSN      = (int)8,
   AOV_EVENT_MASK_AOV1_EVENT_RAM1_EMPTY_LSB_POSN      = (int)9,
   AOV_EVENT_MASK_AOV1_EVENT_RAM1_EMPTY_MSB_POSN      = (int)9,
   AOV_EVENT_MASK_AOV2_EVENT_RAM0_EMPTY_LSB_POSN      = (int)10,
   AOV_EVENT_MASK_AOV2_EVENT_RAM0_EMPTY_MSB_POSN      = (int)10,
   AOV_EVENT_MASK_AOV2_EVENT_RAM1_EMPTY_LSB_POSN      = (int)11,
   AOV_EVENT_MASK_AOV2_EVENT_RAM1_EMPTY_MSB_POSN      = (int)11,
   AOV_EVENT_MASK_AOV0_EVENT_RAM_OVERRUN_LSB_POSN     = (int)12,
   AOV_EVENT_MASK_AOV0_EVENT_RAM_OVERRUN_MSB_POSN     = (int)12,
   AOV_EVENT_MASK_AOV1_EVENT_RAM_OVERRUN_LSB_POSN     = (int)13,
   AOV_EVENT_MASK_AOV1_EVENT_RAM_OVERRUN_MSB_POSN     = (int)13,
   AOV_EVENT_MASK_AOV2_EVENT_RAM_OVERRUN_LSB_POSN     = (int)14,
   AOV_EVENT_MASK_AOV2_EVENT_RAM_OVERRUN_MSB_POSN     = (int)14,
   AOV_EVENT_MASK_AOV_EVENT_VAD_POS_EVENT_LSB_POSN    = (int)15,
   AOV_EVENT_MASK_AOV_EVENT_VAD_POS_EVENT_MSB_POSN    = (int)15,
   AOV_EVENT_MASK_AOV_EVENT_VAD_NEG_EVENT_LSB_POSN    = (int)16,
   AOV_EVENT_MASK_AOV_EVENT_VAD_NEG_EVENT_MSB_POSN    = (int)16,
   AOV_EVENT_MASK_AOV0_EVENT_EOD_DAT_AVAIL_LSB_POSN   = (int)17,
   AOV_EVENT_MASK_AOV0_EVENT_EOD_DAT_AVAIL_MSB_POSN   = (int)17,
   AOV_EVENT_MASK_AOV1_EVENT_EOD_DAT_AVAIL_LSB_POSN   = (int)18,
   AOV_EVENT_MASK_AOV1_EVENT_EOD_DAT_AVAIL_MSB_POSN   = (int)18,
   AOV_EVENT_MASK_AOV2_EVENT_EOD_DAT_AVAIL_LSB_POSN   = (int)19,
   AOV_EVENT_MASK_AOV2_EVENT_EOD_DAT_AVAIL_MSB_POSN   = (int)19
};
...
{
   AOV_EVENT_STATUS_AOV0_EVENT_RAM0_FULL_LSB_POSN     = (int)0,
   AOV_EVENT_STATUS_AOV0_EVENT_RAM0_FULL_MSB_POSN     = (int)0,
   AOV_EVENT_STATUS_AOV0_EVENT_RAM1_FULL_LSB_POSN     = (int)1,
   AOV_EVENT_STATUS_AOV0_EVENT_RAM1_FULL_MSB_POSN     = (int)1,
   AOV_EVENT_STATUS_AOV1_EVENT_RAM0_FULL_LSB_POSN     = (int)2,
   AOV_EVENT_STATUS_AOV1_EVENT_RAM0_FULL_MSB_POSN     = (int)2,
   AOV_EVENT_STATUS_AOV1_EVENT_RAM1_FULL_LSB_POSN     = (int)3,
   AOV_EVENT_STATUS_AOV1_EVENT_RAM1_FULL_MSB_POSN     = (int)3,
   AOV_EVENT_STATUS_AOV2_EVENT_RAM0_FULL_LSB_POSN     = (int)4,
   AOV_EVENT_STATUS_AOV2_EVENT_RAM0_FULL_MSB_POSN     = (int)4,
   AOV_EVENT_STATUS_AOV2_EVENT_RAM1_FULL_LSB_POSN     = (int)5,
   AOV_EVENT_STATUS_AOV2_EVENT_RAM1_FULL_MSB_POSN     = (int)5,
   AOV_EVENT_STATUS_AOV0_EVENT_RAM0_EMPTY_LSB_POSN    = (int)6,
   AOV_EVENT_STATUS_AOV0_EVENT_RAM0_EMPTY_MSB_POSN    = (int)6,
   AOV_EVENT_STATUS_AOV0_EVENT_RAM1_EMPTY_LSB_POSN    = (int)7,
   AOV_EVENT_STATUS_AOV0_EVENT_RAM1_EMPTY_MSB_POSN    = (int)7,
   AOV_EVENT_STATUS_AOV1_EVENT_RAM0_EMPTY_LSB_POSN    = (int)8,
   AOV_EVENT_STATUS_AOV1_EVENT_RAM0_EMPTY_MSB_POSN    = (int)8,
   AOV_EVENT_STATUS_AOV1_EVENT_RAM1_EMPTY_LSB_POSN    = (int)9,
   AOV_EVENT_STATUS_AOV1_EVENT_RAM1_EMPTY_MSB_POSN    = (int)9,
   AOV_EVENT_STATUS_AOV2_EVENT_RAM0_EMPTY_LSB_POSN    = (int)10,
   AOV_EVENT_STATUS_AOV2_EVENT_RAM0_EMPTY_MSB_POSN    = (int)10,
   AOV_EVENT_STATUS_AOV2_EVENT_RAM1_EMPTY_LSB_POSN    = (int)11,
   AOV_EVENT_STATUS_AOV2_EVENT_RAM1_EMPTY_MSB_POSN    = (int)11,
   AOV_EVENT_STATUS_AOV0_EVENT_RAM_OVERRUN_LSB_POSN   = (int)12,
   AOV_EVENT_STATUS_AOV0_EVENT_RAM_OVERRUN_MSB_POSN   = (int)12,
   AOV_EVENT_STATUS_AOV1_EVENT_RAM_OVERRUN_LSB_POSN   = (int)13,
   AOV_EVENT_STATUS_AOV1_EVENT_RAM_OVERRUN_MSB_POSN   = (int)13,
   AOV_EVENT_STATUS_AOV2_EVENT_RAM_OVERRUN_LSB_POSN   = (int)14,
   AOV_EVENT_STATUS_AOV2_EVENT_RAM_OVERRUN_MSB_POSN   = (int)14,
   AOV_EVENT_STATUS_AOV_EVENT_VAD_POS_EVENT_LSB_POSN  = (int)15,
   AOV_EVENT_STATUS_AOV_EVENT_VAD_POS_EVENT_MSB_POSN  = (int)15,
   AOV_EVENT_STATUS_AOV_EVENT_VAD_NEG_EVENT_LSB_POSN  = (int)16,
   AOV_EVENT_STATUS_AOV_EVENT_VAD_NEG_EVENT_MSB_POSN  = (int)16,
   AOV_EVENT_STATUS_AOV0_EVENT_EOD_DAT_AVAIL_LSB_POSN = (int)17,
   AOV_EVENT_STATUS_AOV0_EVENT_EOD_DAT_AVAIL_MSB_POSN = (int)17,
   AOV_EVENT_STATUS_AOV1_EVENT_EOD_DAT_AVAIL_LSB_POSN = (int)18,
   AOV_EVENT_STATUS_AOV1_EVENT_EOD_DAT_AVAIL_MSB_POSN = (int)18,
   AOV_EVENT_STATUS_AOV2_EVENT_EOD_DAT_AVAIL_LSB_POSN = (int)19,
   AOV_EVENT_STATUS_AOV2_EVENT_EOD_DAT_AVAIL_MSB_POSN = (int)19
};
...
{
   AOV_WAKEUP_MASK_AOV0_EVENT_RAM0_FULL_LSB_POSN      = (int)0,
   AOV_WAKEUP_MASK_AOV0_EVENT_RAM0_FULL_MSB_POSN      = (int)0,
   AOV_WAKEUP_MASK_AOV0_EVENT_RAM1_FULL_LSB_POSN      = (int)1,
   AOV_WAKEUP_MASK_AOV0_EVENT_RAM1_FULL_MSB_POSN      = (int)1,
   AOV_WAKEUP_MASK_AOV1_EVENT_RAM0_FULL_LSB_POSN      = (int)2,
   AOV_WAKEUP_MASK_AOV1_EVENT_RAM0_FULL_MSB_POSN      = (int)2,
   AOV_WAKEUP_MASK_AOV1_EVENT_RAM1_FULL_LSB_POSN      = (int)3,
   AOV_WAKEUP_MASK_AOV1_EVENT_RAM1_FULL_MSB_POSN      = (int)3,
   AOV_WAKEUP_MASK_AOV2_EVENT_RAM0_FULL_LSB_POSN      = (int)4,
   AOV_WAKEUP_MASK_AOV2_EVENT_RAM0_FULL_MSB_POSN      = (int)4,
   AOV_WAKEUP_MASK_AOV2_EVENT_RAM1_FULL_LSB_POSN      = (int)5,
   AOV_WAKEUP_MASK_AOV2_EVENT_RAM1_FULL_MSB_POSN      = (int)5,
   AOV_WAKEUP_MASK_AOV0_EVENT_RAM0_EMPTY_LSB_POSN     = (int)6,
   AOV_WAKEUP_MASK_AOV0_EVENT_RAM0_EMPTY_MSB_POSN     = (int)6,
   AOV_WAKEUP_MASK_AOV0_EVENT_RAM1_EMPTY_LSB_POSN     = (int)7,
   AOV_WAKEUP_MASK_AOV0_EVENT_RAM1_EMPTY_MSB_POSN     = (int)7,
   AOV_WAKEUP_MASK_AOV1_EVENT_RAM0_EMPTY_LSB_POSN     = (int)8,
   AOV_WAKEUP_MASK_AOV1_EVENT_RAM0_EMPTY_MSB_POSN     = (int)8,
   AOV_WAKEUP_MASK_AOV1_EVENT_RAM1_EMPTY_LSB_POSN     = (int)9,
   AOV_WAKEUP_MASK_AOV1_EVENT_RAM1_EMPTY_MSB_POSN     = (int)9,
   AOV_WAKEUP_MASK_AOV2_EVENT_RAM0_EMPTY_LSB_POSN     = (int)10,
   AOV_WAKEUP_MASK_AOV2_EVENT_RAM0_EMPTY_MSB_POSN     = (int)10,
   AOV_WAKEUP_MASK_AOV2_EVENT_RAM1_EMPTY_LSB_POSN     = (int)11,
   AOV_WAKEUP_MASK_AOV2_EVENT_RAM1_EMPTY_MSB_POSN     = (int)11,
   AOV_WAKEUP_MASK_AOV0_EVENT_RAM_OVERRUN_LSB_POSN    = (int)12,
   AOV_WAKEUP_MASK_AOV0_EVENT_RAM_OVERRUN_MSB_POSN    = (int)12,
   AOV_WAKEUP_MASK_AOV1_EVENT_RAM_OVERRUN_LSB_POSN    = (int)13,
   AOV_WAKEUP_MASK_AOV1_EVENT_RAM_OVERRUN_MSB_POSN    = (int)13,
   AOV_WAKEUP_MASK_AOV2_EVENT_RAM_OVERRUN_LSB_POSN    = (int)14,
   AOV_WAKEUP_MASK_AOV2_EVENT_RAM_OVERRUN_MSB_POSN    = (int)14,
   AOV_WAKEUP_MASK_AOV_EVENT_VAD_POS_EVENT_LSB_POSN   = (int)15,
   AOV_WAKEUP_MASK_AOV_EVENT_VAD_POS_EVENT_MSB_POSN   = (int)15,
   AOV_WAKEUP_MASK_AOV_EVENT_VAD_NEG_EVENT_LSB_POSN   = (int)16,
   AOV_WAKEUP_MASK_AOV_EVENT_VAD_NEG_EVENT_MSB_POSN   = (int)16,
   AOV_WAKEUP_MASK_AOV0_EVENT_EOD_DAT_AVAIL_LSB_POSN  = (int)17,
   AOV_WAKEUP_MASK_AOV0_EVENT_EOD_DAT_AVAIL_MSB_POSN  = (int)17,
   AOV_WAKEUP_MASK_AOV1_EVENT_EOD_DAT_AVAIL_LSB_POSN  = (int)18,
   AOV_WAKEUP_MASK_AOV1_EVENT_EOD_DAT_AVAIL_MSB_POSN  = (int)18,
   AOV_WAKEUP_MASK_AOV2_EVENT_EOD_DAT_AVAIL_LSB_POSN  = (int)19,
   AOV_WAKEUP_MASK_AOV2_EVENT_EOD_DAT_AVAIL_MSB_POSN  = (int)19
};
...
enum audio_dmac_extra_config_logic_posn_enum
{
   DMA_WAIT_FOR_TBUS_READ_RESP_POSN                   = (int)0,
   AUDIO_DMAC_EXTRA_CONFIG_LOGIC_DMA_WAIT_FOR_TBUS_READ_RESP_LSB_POSN = (int)0,
   AUDIO_DMAC_EXTRA_CONFIG_LOGIC_DMA_WAIT_FOR_TBUS_READ_RESP_MSB_POSN = (int)0,
   DMA_REMOVE_EXTRA_TBUS_READ_POSN                    = (int)1,
   AUDIO_DMAC_EXTRA_CONFIG_LOGIC_DMA_REMOVE_EXTRA_TBUS_READ_LSB_POSN = (int)1,
   AUDIO_DMAC_EXTRA_CONFIG_LOGIC_DMA_REMOVE_EXTRA_TBUS_READ_MSB_POSN = (int)1
};
typedef enum audio_dmac_extra_config_logic_posn_enum audio_dmac_extra_config_logic_posn;

#define DMA_WAIT_FOR_TBUS_READ_RESP_MASK         (0x00000001u)
#define DMA_REMOVE_EXTRA_TBUS_READ_MASK          (0x00000002u)
