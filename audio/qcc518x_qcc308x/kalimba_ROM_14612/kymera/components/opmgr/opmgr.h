 ...
 * \ingroup opmgr
 *
 * Operator Manager public header file.
 * This file contains public opmgr functions and types.
 */
 ...
 * \param  callback - Function pointer to the function to call with the response.
 */
static inline void opmgr_create_operator(CONNECTION_LINK con_id,
                                         CAP_ID cap_id,
                                         EXT_OP_ID op_id,
                                         OP_CREATE_CBACK callback)
{
 ...
 *
 * \param endpoint_id - The operator endpoint to get the scheduling info for.
 * 
 ...
 */
extern bool opmgr_get_capid_from_opid(EXT_OP_ID opid, CAP_ID *capid);
 ...
 */
extern PROC_ID_NUM opmgr_get_processor_id_from_opid(EXT_OP_ID ext_opid);
 ...
 */
extern bool is_op_running(INT_OP_ID op_id);
 ...
 */
extern unsigned int opmgr_create_endpoint_id(EXT_OP_ID opid,
                                             unsigned int idx,
 ...
 *
 */
extern void opmgr_stop_kicks(INT_OP_ID op_id, STOP_KICK side);
 ...
 */
extern unsigned opmgr_get_num_sink_terminals(EXT_OP_ID opid);
 ...
 */
extern unsigned opmgr_get_num_source_terminals(EXT_OP_ID opid);
 ...
 *  \param msg_body message payload
 *  \param length pointer to the length of the message constructed
 */
...
extern ADAPTOR_TARGET opmgr_get_adaptor(CONNECTION_LINK con_id);
#endif /* OPMGR_H */
