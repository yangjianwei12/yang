...
/**
 * The numeric representation of a operator inside of the audio subsystem.
 * Only the 7 lower bits are used. The value 0 is used to indicate errors.
 */
typedef unsigned OPERATOR_INT_ID;
#define INT_OP_ID OPERATOR_INT_ID
