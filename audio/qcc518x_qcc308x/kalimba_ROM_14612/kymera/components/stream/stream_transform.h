...
#define STREAM_TRANSFORM_GET_INT_ID(id) \
    ((TRANSFORM_INT_ID)(((id) != 0)? id ^ TRANSFORM_COOKIE: 0))

#define STREAM_TRANSFORM_GET_EXT_ID(id) \
    ((TRANSFORM_ID)(((id) != 0)? id ^ TRANSFORM_COOKIE: 0))
