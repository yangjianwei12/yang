...
/**
 * The numeric representation of a endpoint inside of the audio subsystem.
 * Only the 16 lower bits are used.
 */
typedef unsigned ENDPOINT_INT_ID;
...
/**
 * The numeric representation of a transform inside of the audio subsystem.
 * Only the 8 lower bits are used. The value 0 is used to indicate errors.
 */
typedef unsigned TRANSFORM_INT_ID;
