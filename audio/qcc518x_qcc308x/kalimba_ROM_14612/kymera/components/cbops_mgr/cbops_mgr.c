 ...
 * \param head        The cbops head structure that contains the cbops chain
 *                    list.
 * \param vals        cbops creation parameters.
 *
 * \return TRUE if the chain is successfully created. FALSE on a failure.
 */
static bool create_in_chain(unsigned int cbops_flags,
                            unsigned nr_chans,
							cbops_graph *head,
							CBOP_VALS *vals)
{
 ...
 * \return TRUE if the chain is successfully created. FALSE on a failure.
 */
static bool create_out_chain(unsigned int cbops_flags,
                             unsigned nr_chans,
							 cbops_graph *head,
							 CBOP_VALS *vals)
{
...
/* cbops_mgr_disconnect */
void cbops_mgr_disconnect(cbops_mgr* cbops_mgr_obj)
{
...
/* cbops_mgr_destroy */
void cbops_mgr_destroy(cbops_mgr* cbops_mgr_obj)
{
...
void cbops_mgr_buffer_reinit(cbops_mgr* cbops_mgr_obj)
{
 ...
 */
bool cbops_mgr_get_buffer_info(cbops_mgr *cbops_mgr_obj,
                               unsigned nr_chans,
							   tCbuffer **in_buffs,
							   tCbuffer **out_buffs)
{
