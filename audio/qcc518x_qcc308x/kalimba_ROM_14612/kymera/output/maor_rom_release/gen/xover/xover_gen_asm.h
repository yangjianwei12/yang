...
.CONST $M.XOVER_XOVER_3BAND_CAP_ID       	0x000034;
.CONST $M.XOVER_XOVER_3BAND_ALT_CAP_ID_0       	0x409D;
.CONST $M.XOVER_XOVER_3BAND_SAMPLE_RATE       	0;
.CONST $M.XOVER_XOVER_3BAND_VERSION_MAJOR       	1;
...
.CONST $M.XOVER.CONSTANT.LP_TYPE_F2_Butterworth            		0x00000001;
.CONST $M.XOVER.CONSTANT.LP_TYPE_F2_Linkwitz_Riley         		0x00000002;
.CONST $M.XOVER.CONSTANT.LP_TYPE_F2_APC                    		0x00000003;
.CONST $M.XOVER.CONSTANT.HP_TYPE_F2_Butterworth            		0x00000001;
.CONST $M.XOVER.CONSTANT.HP_TYPE_F2_Linkwitz_Riley         		0x00000002;
.CONST $M.XOVER.CONSTANT.HP_TYPE_F2_APC                    		0x00000003;
...
.CONST $M.XOVER.CONFIG.INV_BAND3		0x00000008;
...
.CONST $M.XOVER.PARAMETERS.OFFSET_XOVER_FILTER_TYPE		1*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.OFFSET_LP_TYPE          		2*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.OFFSET_LP_FC            		3*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.OFFSET_LP_ORDER         		4*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.OFFSET_HP_TYPE          		5*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.OFFSET_HP_FC            		6*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.OFFSET_HP_ORDER         		7*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.OFFSET_LP_TYPE_F2       		8*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.OFFSET_LP_FC_F2         		9*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.OFFSET_LP_ORDER_F2      		10*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.OFFSET_HP_TYPE_F2       		11*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.OFFSET_HP_FC_F2         		12*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.OFFSET_HP_ORDER_F2      		13*ADDR_PER_WORD;
.CONST $M.XOVER.PARAMETERS.STRUCT_SIZE            		14;
