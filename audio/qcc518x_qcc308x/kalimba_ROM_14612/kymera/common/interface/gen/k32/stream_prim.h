...
/*******************************************************************************
  ...
  DESCRIPTION
    ...
    this information in common/hydra/interface/accmd_types.xml) FM = 0x0004
    on BlueCore FASTPIPE = 0x0008 on BlueCore I2C = 0x000D on BlueCore
...
typedef enum
{
    ...
    STREAM_DEVICE_ISO = 0x0013,
    STREAM_DEVICE_MON_OUT = 0x0014,
