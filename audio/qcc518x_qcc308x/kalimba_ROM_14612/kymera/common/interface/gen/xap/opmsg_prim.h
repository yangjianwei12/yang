...
/*******************************************************************************
 ...
 VALUES
    ...
    SET_FRAME_DURATION - This message is used to set the audio frame duration
                         ...
                         ms frames. Hence the supported values are either 10000
                         or 7500.
    SET_BLOCKS_PER_SDU - This message is used to tell the encoder how many
                         blocks per SDU to be encoded
...
/*******************************************************************************
 ...
 VALUES
    ...
    FADEOUT_DONE                - For more information see section 4.2 in
                                  ...
                                  Note: value is the same as
                                  OPMSG_COMMON_ID_FADEOUT_ENABLE
    DISCARDABLE_MESSAGE         - This is a special ID representing a bitmask
                                  which if set indicates that the message
                                  payload is transient and may be discarded in
