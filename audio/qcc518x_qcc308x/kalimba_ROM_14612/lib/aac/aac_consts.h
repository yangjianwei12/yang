...
#define AAC_CONSTS_HEADER_INCLUDED
   ...
   // Constants used in the Levinson-Durbin step down recursion for B-302799
   .CONST $aacdec.TNS_STABILITY_1                          (1.0 / 8);      //shifted to Q3.28
   .CONST $aacdec.TNS_STABILITY_COEFF_SCALAR               (0.025 / 8);    //shifted to Q3.28
