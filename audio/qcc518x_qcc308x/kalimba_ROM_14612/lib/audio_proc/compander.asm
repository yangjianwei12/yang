...
#define COMPANDER_NUM_FLOOR         0.00000005960464477539063 // 2^-24
// *****************************************************************************
// MODULE:
...
$audio_proc.cmpd.process_channels:
   ...
   r4 = COMPANDER_NUM_FLOOR;                                  // initialize running max/running mean(rms)across channels
...
soft_knee_part:
   ...
   rMAC = r3 * r3 , r0 = M[I0,M1];        // r3 = xG in Q8.24; rMAC = xG^2 in Q15.17; r0 = A in Q14.18
   r5 = SIGNDET rMAC;                     // X1
   rMAC = rMAC ASHIFT r5 (72bit);         // xG^2 in Q(15-X1).(17+X1)
   rMAC = rMAC * r0;                      // A*xG^2 in Q(15-X1+14-1).(17+X1-14+1) = Q(28-X1).(4+X1)
   r6 = SIGNDET rMAC;
   r5 = 19 - r5;                          // shifting needed for A*xG^2
   r6 = r5 - r6, r1 = M[I0,M1];           // headroom shortage for A*xG^2; r1 = B in Q14.18 

   rMACB = r1 * r3;                       // B*xG in  Q(8+14-1).N = Q21.N
   r1 = SIGNDET rMACB, r2 = M[I0,M1];     // r1 = X3, r2 = C in Q14.18 
   r1 = 12 - r1;                          // headroom_shortage for B*xG
   r4 = SIGNDET r2;     
   r4 = 5 - r4;                           // headroom_shortage for C

   // find the max headroom shortage
   r6 = MAX r1;
   r6 = MAX r4;
   r6 = r6 + 1;                           // 1 bit extra headroom for addition

   // shift to match Q format
   r9 = r5 - r6;
   rMAC = rMAC ASHIFT r9 (72bit);         // A*xG^2
   r9 = 12 - r6;
   rMACB = rMACB ASHIFT r9 (72bit);       // B*xG
   rMAC = rMAC + rMACB;                   // A*xG^2 + B*xG
   r9 = 5 - r6;
   r2 = r2 ASHIFT r9;
   rMAC = rMAC + r2;                      // A*xG^2 + B*xG + C
   rMAC = rMAC ASHIFT r6;                 // yG = polyval(p, xG) (arch3:q.15, arch4:q.23)
   jump compute_gain;
