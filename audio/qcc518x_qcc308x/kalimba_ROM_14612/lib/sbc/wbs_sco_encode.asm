...
.MODULE $M.wbsenc.process_frame;
   ...
   r0 = M[$wbs_frame_encode.cbuf_in_ptr];
#else
   r0 = M[r7 + $wbs_struct.WBS_ENC_OP_DATA_struct.SCO_SEND_OP_DATA_FIELD+ 
    $wbs_struct.SCO_COMMON_SEND_OP_DATA_struct.BUFFERS_FIELD + 
    $wbs_struct.SCO_TERMINAL_BUFFERS_struct.IP_BUFFER_FIELD];
#endif
   ...
   r0 = M[r7 + $wbs_struct.WBS_ENC_OP_DATA_struct.SCO_SEND_OP_DATA_FIELD+ 
    $wbs_struct.SCO_COMMON_SEND_OP_DATA_struct.BUFFERS_FIELD + 
    $wbs_struct.SCO_TERMINAL_BUFFERS_struct.OP_BUFFER_FIELD];
