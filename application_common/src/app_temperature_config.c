...
const temperature_lookup_t app_temperature_config_table[] =
{
    {1730, -40},
    {1725, -39},
    {1721, -38},
...
{
    *table_length = ARRAY_DIM(app_temperature_config_table);
    return app_temperature_config_table;
}
