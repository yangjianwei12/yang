...
\file       charger_case_temperature_config.c
...
const temperature_lookup_t charger_case_temperature_config_table[] =
{
    {1730, -40},
    {1725, -39},
    {1721, -38},
...
{
    *table_length = ARRAY_DIM(charger_case_temperature_config_table);
    return charger_case_temperature_config_table;
}
