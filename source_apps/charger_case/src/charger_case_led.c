...
\file       charger_case_led.c
\brief      Source file for the charger case application user interface LED indications.
*/
#include "charger_case_led.h"
#include "charger_case_ui.h"

const led_manager_hw_config_t charger_case_led_config =
...
/*! \cond led_patterns_well_named
    ...
    from public functions such as ChargerCaseUi_Init()
 */
