...
\file       charger_case_soc_config.c
...
const soc_lookup_t charger_case_soc_config_table[] =
{
    {3000, 0},
    {3012, 1},
    {3024, 2},
...
{
    *table_length = ARRAY_DIM(charger_case_soc_config_table);
    return charger_case_soc_config_table;
}
