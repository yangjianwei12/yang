...

{
    ...
    "layout": [
        ...
        ("apps_p0",         {"capacity": 144 * 4 * 1024,  "authenticate": True, "src_file_signed": True}),
        ("apps_p1",         {"capacity": 230 * 4 * 1024,  "authenticate": False}),
        ...
        ("ro_fs",           {"capacity":  64 * 4 * 1024,  "authenticate": False})
    ]
}
