...
const ui_event_indicator_table_t app_ui_tones_table[] =
{
    ...
    {.sys_event=LI_MFB_BUTTON_PRESS_TOUCHPAD_DISABLE_DS,        { .tone.tone = app_tone_error,
                                                                 .tone.queueable = TRUE,
                                                                 .tone.interruptible = FALSE,
                                                                 .tone.button_feedback = TRUE }},
#endif
    ...
    {.sys_event=CAP_SENSE_DOUBLE_PRESS,                        { .tone.tone = app_tone_double_tap,
                                                                 .tone.queueable = TRUE,
                                                                 .tone.interruptible = FALSE,
                                                                 .tone.button_feedback = TRUE }},
#else
...
#endif
#ifdef INCLUDE_ACCESSORY_TRACKING
    {.sys_event=ACCESSORY_TRACKING_PLAY_UT_TONE, { .tone.tone = app_tone_accessory_tracking,
                                          .tone.queueable = TRUE,
                                          .tone.interruptible = FALSE,
                                          .tone.is_loud = TRUE }},
#endif
