...
const led_pattern_t app_led_pattern_4[] =
{
    LED_LOCK,
    LED_SYNC(1000),
    LED_ON(LED_GREEN), LED_WAIT(200), LED_OFF(LED_GREEN), LED_WAIT(200),
...
const led_pattern_t app_led_pattern_idle_production[] =
{
    LED_LOCK,
    LED_SYNC(1000),
    LED_ON(LED_GREEN), LED_WAIT(200), LED_OFF(LED_GREEN), LED_WAIT(200),
...
const led_pattern_t app_led_pattern_sensor_error_2[] =
{
    LED_LOCK,
    LED_SYNC(1000),
    LED_ON(LED_RED), LED_WAIT(200), LED_OFF(LED_RED), LED_WAIT(200),
    LED_ON(LED_RED), LED_WAIT(200), LED_OFF(LED_RED), LED_WAIT(1000),
    LED_UNLOCK,
    LED_REPEAT(0, 0),
};

const led_pattern_t app_led_pattern_sensor_error_3[] =
{
    LED_LOCK,
    LED_SYNC(1000),
    LED_ON(LED_RED), LED_WAIT(200), LED_OFF(LED_RED), LED_WAIT(200),
...
const led_pattern_t app_led_pattern_sensor_error_4[] =
{
    LED_LOCK,
    LED_SYNC(1000),
    LED_ON(LED_RED), LED_WAIT(200), LED_OFF(LED_RED), LED_WAIT(200),
