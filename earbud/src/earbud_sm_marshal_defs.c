...
const marshal_type_descriptor_t marshal_type_descriptor_earbud_sm_req_disable_touchpad_t =
    MAKE_MARSHAL_TYPE_DEFINITION_BASIC(earbud_sm_req_disable_touchpad_t);
