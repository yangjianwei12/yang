...
//!@{ \name LED pattern and ringtone note sequence arrays.app_led_filter_battery_low
...
extern const led_pattern_t app_led_pattern_4[];
extern const led_pattern_t app_led_pattern_idle_production[];
extern const led_pattern_t app_led_pattern_sensor_error_4[];
extern const led_pattern_t app_led_pattern_sensor_error_2[];
extern const led_pattern_t app_led_pattern_sensor_error_3[];
...
#define appUiFCCDH5() \
    LedManager_SetPattern(app_led_pattern_dh5, LED_PRI_HIGH, NULL, 0)

/*! \brief Show LED pattern for FCC 2DH5 */
#define appUiFCC2DH5() \
    LedManager_SetPattern(app_led_pattern_2dh5, LED_PRI_HIGH, NULL, 0)

/*! \brief Show LED pattern for FCC 3DH5*/
#define appUiFCC3DH5() \
    LedManager_SetPattern(app_led_pattern_3dh5, LED_PRI_HIGH, NULL, 0)

/*! \brief Show LED pattern for PTM Step 4*/
#define appUi4Flashes() \
    LedManager_SetPattern(app_led_pattern_4, LED_PRI_HIGH, NULL, 0)

/*! \brief Show LED pattern for PTM Step 5*/
#define appUiIdleFlashes() \
    LedManager_SetPattern(app_led_pattern_idle5, LED_PRI_HIGH, NULL, 0)


/*! \brief Show LED pattern for sensor test error */
#define appUiSensor1Error() \
    LedManager_SetPattern(app_led_pattern_error, LED_PRI_HIGH, NULL, 0)

/*! \brief Show LED pattern for sensor test error */
#define appUiSensor2Error() \
    LedManager_SetPattern(app_led_pattern_sensor_error_2, LED_PRI_HIGH, NULL, 0)

/*! \brief Show LED pattern for sensor test error */
#define appUiSensor3Error() \
    LedManager_SetPattern(app_led_pattern_sensor_error_3, LED_PRI_HIGH, NULL, 0)

/*! \brief Show LED pattern for sensor test error*/
#define appUiSensor4Error() \
    LedManager_SetPattern(app_led_pattern_sensor_error_4, LED_PRI_HIGH, NULL, 0)

/*! \brief Show LED pattern for idle production moder*/
#define appIdleProduction() \
    LedManager_SetPattern(app_led_pattern_idle_production, LED_PRI_HIGH, NULL, 0)
