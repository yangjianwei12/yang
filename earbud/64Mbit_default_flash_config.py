...

{
    ...
    "layout": [
        ...
        ("apps_p0",         {"capacity": 162 * 4 * 1024,  "authenticate": True, "src_file_signed": True}),
        ("apps_p1",         {"capacity": 376 * 4 * 1024,  "authenticate": False}),
        ...
        # The partition can hold: (current model size + headroom) + rafs FAT table = (68Kb + 4Kb) + 4Kb = 76Kb = 19 blocks
        ("ra_partition",    {"capacity":  19 * 4 * 1024,  "id": "VMdl"}),
        ("ro_cfg_fs",       {"capacity":  64 * 4 * 1024,  "authenticate": False}),
        ("ro_fs",           {"capacity": 346 * 4 * 1024,  "authenticate": False})
    ]
}
