...

{
    ...
    "layout": [
        ...
        ("apps_p0",         {"capacity": 146 * 4 * 1024,  "authenticate": True, "src_file_signed": True}),
        ("apps_p1",         {"capacity": 255 * 4 * 1024,  "authenticate": False}),
        ...
        ("ro_fs",           {"capacity":  37 * 4 * 1024,  "authenticate": False})
    ]
}
