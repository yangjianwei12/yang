/*!
\copyright  Copyright (c) 2023-2023 Qualcomm Technologies International, Ltd.\n
            All Rights Reserved.\n
            Qualcomm Technologies International, Ltd. Confidential and Proprietary.
\file
\brief      GPIO for MON build variant.
*/
...
* A1: LOAD_FAULT_N
*/
#define GPIO_LOAD_FAULT_N               (GPIO_A1 | GPIO_ACTIVE_LOW)
...
* A3: IN_CASE_DETECT_R
*/
#define GPIO_SWITCH_R                   (GPIO_A3 | GPIO_ACTIVE_LOW)
...
* A7: IN_CASE_DETECT_L
*/
#define GPIO_SWITCH_L                   (GPIO_A7 | GPIO_ACTIVE_LOW)
...
/*
* B13: IN_CASE_DETECT_EN
*/
#define GPIO_SWITCH_EN                  GPIO_B13
