...
void test_case_lid_open(void)
{
    ...
    */
    case_rx_earbud_status(EARBUD_LEFT, 0, 0, 0, 0x21, 1);
    ...
    */
    case_rx_earbud_status(EARBUD_RIGHT, 0, 0, 0, 0x2B, 1);
...
void test_case_status_fully_charged(void)
{
    ...
    * Response from left earbud received.
    */
    case_rx_earbud_status(EARBUD_LEFT, 0, 0, 0, 0x64, 1);
    ...
    * Response from right earbud received.
    */
    case_rx_earbud_status(EARBUD_RIGHT, 0, 0, 0, 0x64, 1);
