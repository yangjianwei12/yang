...
static const CLI_COMMAND cli_command_atq[] =
{
    ...
    { "LID",       atq_lid,       2 },
    { "NTC",       atq_ntc,       2 },
    { "REGULATOR", atq_regulator, 2 },
#ifdef HAVE_CURRENT_SENSE
    { "SENSE",     atq_sense,     2 },
#endif
    { "IMAGE",  atq_running_image,2 },
    { NULL }
};
