...

{
    ...
    "layout": [
        ...
        ("curator_fs",      {"capacity":  16 * 4 * 1024,  "authenticate": False, "src_file_signed": False, "attribs": "eu"}),
        ("apps_p0",         {"capacity": 192 * 4 * 1024,  "authenticate": True, "src_file_signed": True, "attribs": "eu"}),
        ("apps_p1",         {"capacity": 300 * 4 * 1024,  "authenticate": False, "attribs": "eu"}),
        # Device config filesystem size limited by size of production test buffer,  ( 1024*2)-10.
        ("device_ro_fs",    {"capacity":  16 * 4 * 1024,  "authenticate": False, "inline_auth_hash": True, "attribs": "eu"}),
        ...
        ("ro_cfg_fs",       {"capacity":  64 * 4 * 1024,  "authenticate": False, "attribs": "eu"}),
        ("ro_fs",           {"capacity": 500 * 4 * 1024,  "authenticate": False, "attribs": "eu"})
    ]
}
