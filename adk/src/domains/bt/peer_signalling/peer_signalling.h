/*!
    ...
    \defgroup   peer_signalling Peer Signalling
    @{
    \ingroup    bt_domain
...
/*! \brief Peer signalling state machine states */
typedef enum
{
...
/*! \brief Enumeration of peer signalling status codes. */
typedef enum
{
    /*! Operation success. */
...
/*! \brief Messages that can be sent by peer signalling to client tasks. */
...
/*! \brief Channel IDs for peer signalling. */
typedef enum
{
    ...
    /*! Channel ID for User Account Key Sync messages */
    ...
    /*! Channel ID for LE audio broadcast messages. */
    ...
    /*! Channel ID for LE audio volume messages. */
...
/*! \brief Message sent to clients registered to receive notification of peer signalling
...
/*! \brief messages used by peer signalling. */
typedef enum
{
