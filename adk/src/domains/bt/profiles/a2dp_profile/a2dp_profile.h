...
/*! \brief Is A2DP state 'connected media suspended' */
#define appA2dpIsStateConnectedMediaSuspended(a2dp_state) \
    ((a2dp_state) == A2DP_STATE_CONNECTED_MEDIA_SUSPENDED)
...
/*!
    \brief Send Media connect request for AV instance

    \param[in] av_instance  AV instance to be used for media connection
    \param[in] seid         Required SEID, or 0 if no preference
    \param[in] delay_ms     Delay in milliseconds to connect media channel
    \param[in] send_later   TRUE if need to send after delay_ms miliseconds
*/
