...
/*! \brief Send the media start request

    \param av_instance      The AV instance
*/
void a2dpProfileSync_SendMediaStartRequest(avInstanceTaskData* theInst);

/*! \brief Send the media start response

    \param av_instance      The AV instance
*/
void a2dpProfileSync_SendMediaStartResponse(avInstanceTaskData* av_instance);
