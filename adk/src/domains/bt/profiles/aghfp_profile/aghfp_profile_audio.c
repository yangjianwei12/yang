...
static hfp_codec_mode_t aghfpProfile_GetCodecMode(aghfpInstanceTaskData * instance)
{
    ...
    DEBUG_LOG_VERBOSE("aghfpProfile_GetCodecMode, codec_mode %d", codec_mode);
    return codec_mode;
}
                                              ...
                                              bool using_wbs)
{
    ...
    DEBUG_LOG("AghfpProfile_StoreConnectParams using_wbs %u, wbs_codec %u, wesco %u, tesco %u, qce_codec_mode_id %u",
              using_wbs, codec, wesco, tesco, qce_codec_mode_id);
}
