...
typedef enum
{
    ...
    MIRROR_PROFILE_SUB_STATE_CIS_CONNECTED      = 0x400, /*!< Mirror CIS link connected and routed */
#endif
...
#ifdef ENABLE_LEA_CIS_DELEGATION
        /*! Locally initiated mirror CIS connection in progress. */
        MIRROR_PROFILE_STATE_CIS_CONNECTING         = MIRROR_PROFILE_STATE_DISCONNECTED + 3,

            /* CIS_CONNECTED sub-state */

            /*! Mirror CIS connected. */
            MIRROR_PROFILE_STATE_CIS_CONNECTED      = MIRROR_PROFILE_SUB_STATE_CIS_CONNECTED,

        /*! Locally initiated mirror ACL disconnect in progress. */
        MIRROR_PROFILE_STATE_CIS_DISCONNECTING       = MIRROR_PROFILE_STATE_DISCONNECTED + 4,
#endif
...
#ifdef ENABLE_LEA_CIS_DELEGATION
#define MIRROR_PROFILE_STATE_MASK_CIS_CONNECTED         (MIRROR_PROFILE_STATE_CIS_CONNECTED)
#else
