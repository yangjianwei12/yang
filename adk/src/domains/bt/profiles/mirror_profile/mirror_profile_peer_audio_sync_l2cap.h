...
/*! \brief Handles L2cap connection request from remote device.

    \param ind l2cap connect request indication message.
*/
...
/*! \brief Handle the L2CAP connect confirmation for local requests.
...
*/
void MirrorProfile_HandleCmSdsRegisterCfm(const CsrBtCmSdsRegisterCfm *message);

/*! \brief Cancel any queued SDP search sent by this module.

    If mirror profile has sent an SDP search request and is waiting for the
