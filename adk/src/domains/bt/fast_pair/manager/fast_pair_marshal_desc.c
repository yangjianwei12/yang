...
static const marshal_type_descriptor_t mtd_sass_connection_status_field_t =
        MAKE_MARSHAL_TYPE_DEFINITION_BASIC(sass_connection_status_field_t);
...
static const marshal_member_descriptor_t mmd_fast_pair_data[] =
{
    ...
    MAKE_MARSHAL_MEMBER(fast_pair_marshal_data, uint8, rfcomm_dlci),
    MAKE_MARSHAL_MEMBER(fast_pair_marshal_data, fast_pair_msg_stream_dev_info, dev_info),
    MAKE_MARSHAL_MEMBER_ARRAY(fast_pair_marshal_data, uint8, session_nonce, FASTPAIR_DEV_INFO_SESSION_NONCE_LEN),
    MAKE_MARSHAL_MEMBER(fast_pair_marshal_data, sass_connection_status_field_t, con_status_data),
};
