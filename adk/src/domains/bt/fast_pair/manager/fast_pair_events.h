...
{
#ifdef USE_SYNERGY
    const CsrBtCmLeReadRandomAddressCfm* rpa_cfm;
#else
...
{
#ifdef USE_SYNERGY
    CsrBtCmCryptoHashCfm* crypto_hash_cfm;
#else
...
{
#ifdef USE_SYNERGY
    CsrBtCmCryptoEncryptCfm* crypto_encrypt_cfm;
#else
...
{
#ifdef USE_SYNERGY
    CsrBtCmCryptoDecryptCfm* crypto_decrypt_cfm;
#else
...
{
#ifdef USE_SYNERGY
    CsrBtCmCryptoAesCtrCfm* crypto_aes_ctr_cfm;
#else
...
bool fastPair_CacheRandomAddressCfm(const CsrBtCmLeReadRandomAddressCfm *cfm);
#else
...
#ifdef USE_SYNERGY
bool fastPair_HashCfm(CsrBtCmCryptoHashCfm *cfm);
#else
...
#ifdef USE_SYNERGY
bool fastPair_EncryptCfm(CsrBtCmCryptoEncryptCfm *cfm);
#else
...
/*! \brief Handle Crypto AES Encrypt confirm */
#ifdef USE_SYNERGY
bool fastPair_DecryptCfm(CsrBtCmCryptoDecryptCfm *cfm);
#else
...
#ifdef USE_SYNERGY
bool fastPair_AesCtrCfm(CsrBtCmCryptoAesCtrCfm *cfm);
#else
...
void fastPair_ProviderPasskey(bool isPasskeySame, uint32 provider_passkey, tp_bdaddr handset_tpaddr);
