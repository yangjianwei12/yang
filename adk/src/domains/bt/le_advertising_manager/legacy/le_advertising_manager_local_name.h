...
/*! \brief Reset the flags indicating the usage of local name token
*/
void LeAdvertisingManager_LocalNameReset(void);

/*! \brief Get the data item containting the local name
...
/*! \brief Register the data item containting the local name
