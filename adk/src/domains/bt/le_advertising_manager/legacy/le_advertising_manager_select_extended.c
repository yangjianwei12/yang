...
static void LeAdvertisingManager_HandleExtendedCmPrim(void *msg)
{
    CsrBtCmPrim *prim = (CsrBtCmPrim *) msg;

    DEBUG_LOG_LEVEL_1("LeAdvertisingManager_HandleExtendedCmPrim %d", *prim);
        ...
        case CSR_BT_CM_EXT_ADV_SET_RANDOM_ADDR_CFM:
            {
                ...
                leAdvertisingManager_handleSetRandomAddressCfm(&clMessage);
            }
            break;
        ...
        case CSR_BT_CM_EXT_ADV_SET_PARAMS_CFM:
            {
                ...
                leAdvertisingManager_HandleExtendedSetAdvertisingParamCfm_Locally(&clMessage);
            }
            break;

        default:
            DEBUG_LOG_V_VERBOSE("LeAdvertisingManager_HandleExtendedCmPrim unexpected CM prim %d", *prim);
            break;
    }
...
#ifdef USE_SYNERGY
        case CM_PRIM:
            LeAdvertisingManager_HandleExtendedCmPrim((void *) message);
            break;
#else
