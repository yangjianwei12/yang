/*!
    ...
    \file
    \defgroup   le_advertising_manager_legacy Legacy
    @{
...
#ifndef LE_ADVERTISING_MANAGER_LEGACY_H_
#define LE_ADVERTISING_MANAGER_LEGACY_H_
...
/*! \brief State of the advertising manager (internal) */
...
/*! \brief Type of discoverable advertising to use.
...
/*! \brief Definition for an advert. The structure will contain all needed settings.
...
/*! \brief Message sent when AdvertisingManager_Start() completes */
typedef struct
{
...
/*! \brief Message sent when AdvertisingManager_SetAdvertData() completes */
typedef struct
{
...
/*! \brief Deinitialise LE Advertising Manager
...
typedef le_adv_mgr_register_handle le_adv_item_handle;

#endif /* LE_ADVERTISING_MANAGER_LEGACY_H_ */
/*! @} */