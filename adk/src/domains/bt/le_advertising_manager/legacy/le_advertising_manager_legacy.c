/*!
    ...
    \brief      Management of Bluetooth Low Energy advertising (legacy component)
*/
...
#ifdef USE_SYNERGY
static void LeAdvertisingManager_HandleCmPrim(void *msg);
#endif
...
#ifdef USE_SYNERGY
        case CM_PRIM:
            LeAdvertisingManager_HandleCmPrim((void *) message);
            break;
#else
...
#ifdef USE_SYNERGY
    CmLeSetOwnAddressTypeReqSend(AdvManagerGetTask(), LocalAddr_GetBleType());
#endif
...
/* API function to use as the handler for CSR_BT_CM_LE_ADVERTISE_CFM prim */
static void leAdvertisingManager_HandleCmLeAdvertiseCfm(CsrBtCmLeAdvertiseCfm *cfm)
{
    switch (cfm->context)
    {
        case CM_LE_ADVERTISE_REQ_CONTEXT_DATA:
            leAdvertisingManager_HandleSetLegacyAdvertisingDataCfm(cfm->resultCode);
            break;

        case CM_LE_ADVERTISE_REQ_CONTEXT_PARAM:
            leAdvertisingManager_HandleLegacySetAdvertisingParamCfm(cfm->resultCode);
            break;

        case CM_LE_ADVERTISE_REQ_CONTEXT_ENABLE:
            leAdvertisingManager_HandleLegacySetAdvertisingEnableCfm(cfm->resultCode);
            break;

        case CM_LE_ADVERTISE_REQ_CONTEXT_SCAN_RSP_DATA:
            leAdvertisingManager_HandleLegacySetScanResponseDataCfm(cfm->resultCode);
            break;

        default:
            DEBUG_LOG_V_VERBOSE("leAdvertisingManager_HandleCmLeAdvertiseCfm Unknown context %d",
                                cfm->context);
            Panic();
            break;
    }
...
void LeAdvertisingManager_HandleCmPrim(void *msg)
{
    CsrBtCmPrim *prim = (CsrBtCmPrim *) msg;

    DEBUG_LOG("LeAdvertisingManager_HandleCmPrim 0x%x", *prim);

    switch (*prim)
    {
        case CSR_BT_CM_LE_ADVERTISE_CFM:
            leAdvertisingManager_HandleCmLeAdvertiseCfm((CsrBtCmLeAdvertiseCfm *) msg);
            break;
        ...
        case CSR_BT_CM_EXT_ADV_SET_DATA_CFM:
            {
                ...
                leAdvertisingManager_HandleExtendedSetAdvertisingDataCfm(&clMessage);
            }
            break;
        ...
        case CSR_BT_CM_EXT_ADV_SET_SCAN_RESP_DATA_CFM:
            {
                ...
                clMessage.status = cmMessage->resultCode;
                clMessage.adv_handle = cmMessage->advHandle;
                leAdvertisingManager_HandleExtendedSetScanResponseDataCfm(&clMessage);
            }
            break;
        ...
        case CSR_BT_CM_EXT_ADV_SET_PARAMS_CFM:
            {
                ...
                leAdvertisingManager_HandleExtendedSetAdvertisingParamCfm(&clMessage);
            }
            break;
        ...
        case CSR_BT_CM_EXT_ADV_ENABLE_CFM:
            {
                ...
                clMessage.status = cmMessage->resultCode;
                clMessage.adv_handle = cmMessage->advHandle;
                leAdvertisingManager_HandleExtendedSetAdvertisingEnableCfm(&clMessage);
            }
            break;
        ...
        case CSR_BT_CM_EXT_ADV_REGISTER_APP_ADV_SET_CFM:
            {
                ...
                clMessage.status = cmMessage->resultCode;
                clMessage.adv_handle = cmMessage->advHandle;
                leAdvertisingManager_HandleExtendedAdvertisingRegisterCfm(&clMessage);
            }
            break;
#endif
        ...
        case CSR_BT_CM_GET_ADV_SCAN_CAPABILITIES_CFM:
            {
                CmGetAdvScanCapabilitiesCfm *cmMessage = (CmGetAdvScanCapabilitiesCfm *) msg;
                CL_DM_BLE_GET_ADV_SCAN_CAPABILITIES_CFM_T clMessage;
                clMessage.status = cmMessage->resultCode;
                clMessage.available_api = cmMessage->availableApi;
                leAdvertisingManager_HandleGetAdvScanCapabilitiesCfm(&clMessage);
            }
            break;
        ...
        case CSR_BT_CM_EXT_ADV_TERMINATED_IND:
            {
                ...
                leAdvertisingManager_HandleExtAdvTerminatedIndication(&termInd);
            }
            break;

        default:
            DEBUG_LOG_V_VERBOSE("LeAdvertisingManager_HandleCmPrim unexpected CM prim %d", *prim);
            break;
    }
