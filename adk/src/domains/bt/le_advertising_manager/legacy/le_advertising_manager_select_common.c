...
#ifdef USE_SYNERGY
uint8 leAdvertisingManager_GetAdvertType(le_adv_event_type_t event)
{
    switch(event)
    {
        case le_adv_event_type_connectable_general:
            return CSR_BT_CM_LE_ADVTYPE_CONNECTABLE_UNDIRECTED;

        case le_adv_event_type_connectable_directed:
            return CSR_BT_CM_LE_ADVTYPE_CONNECTABLE_DIRECTED_HIGH_DUTY;

        case le_adv_event_type_nonconnectable_discoverable:
            return CSR_BT_CM_LE_ADVTYPE_SCANNABLE;

        case le_adv_event_type_nonconnectable_nondiscoverable:
            return CSR_BT_CM_LE_ADVTYPE_NONCONNECTABLE;
