...
#ifndef LE_ADVERTISING_MANAGER_LEGACY_PRIVATE_H_
#define LE_ADVERTISING_MANAGER_LEGACY_PRIVATE_H_
...
#ifdef USE_SYNERGY
enum cm_le_advertise_req_context
{
    CM_LE_ADVERTISE_REQ_CONTEXT_PARAM,
    CM_LE_ADVERTISE_REQ_CONTEXT_DATA,
    CM_LE_ADVERTISE_REQ_CONTEXT_ENABLE,
