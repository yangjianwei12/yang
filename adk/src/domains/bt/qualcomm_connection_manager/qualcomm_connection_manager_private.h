/*!
    ...
    \addtogroup qualcomm_connection_manager
...
/*! LE PA Transmitted event bit mask octet and bit position */
#define QLL_PA_TRANSMITTED_EVENT_OCTET  1
#define QLL_PA_TRANSMITTED_BIT_OFFSET   3
