...
typedef enum
{
    ...
    /*! Confirmation Messages to be sent to LE Scan Manager */
    LE_SCAN_MANAGER_EXTENDED_STOP_CFM,
    LE_SCAN_MANAGER_EXTENDED_DISABLE_CFM,
    LE_SCAN_MANAGER_EXTENDED_ENABLE_CFM
#endif
