...
typedef struct
{
    ...
    /*! Service handle UUID type. */
    uint16             service_uuid_type;
    /*! 32 bit service uuid. */
    uint32             service_uuid32;
    /*! 128 bit service uuid. */
    CsrBtUuid128       service_uuid128;
    /*! The attribute list. */
...
#ifdef USE_SYNERGY
    /*! Handle the connect accept request */
    /*! \param[out] config     If the client wants to change some connection
                               parameters, its preferred setting can be provided
                               as a configuration table. */
    void (*handle_connect_accept)(l2cap_manager_l2cap_link_config_t *config);
