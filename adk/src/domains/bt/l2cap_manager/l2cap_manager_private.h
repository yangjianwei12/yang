...
#ifdef USE_SYNERGY
/*! Messages used internally only in l2cap manager.
*/
typedef enum
{
    /*! Message to release resources allocated for SDP search. */
    L2CAP_INTERNAL_CLOSE_SDP,

    L2CAP_INTERNAL_MAX
} l2cap_manager_internal_msg_t;
#endif
...
#ifdef USE_SYNERGY
/*! Message type to close SDP search. */
typedef struct
{
    /*! Pointer to the PSM Instance. */
    l2cap_manager_psm_instance_t *psm_inst;
} L2CAP_INTERNAL_CLOSE_SDP_T;
#endif
