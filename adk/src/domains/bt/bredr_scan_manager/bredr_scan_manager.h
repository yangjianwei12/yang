/*!
    ...
    \version       
    \file
    \defgroup   bredr_scan_manager BR/EDR Scan Manager
    @{
    \ingroup    bt_domain
...
/*! BREDR scan manager external messages. Message ordering between page and
    ...
    should be listed after page messages. */
enum bredr_scan_manager_messages
{
    ...
    /*! Indication that regular page scan has been paused due to other higher priority requests */
    BREDR_SCAN_MANAGER_PAGE_SCAN_PAUSED_IND,
    /*! Indication that truncated page scan has been paused due to other higher priority requests */
    BREDR_SCAN_MANAGER_TRUNCATED_PAGE_SCAN_PAUSED_IND,
    /*! Indication that inquiry scan has been paused due to other higher priority requests */
    BREDR_SCAN_MANAGER_INQUIRY_SCAN_PAUSED_IND,

    /*! Indication that regular page scan has been resumed after other higher priority requests have been released. */
    BREDR_SCAN_MANAGER_PAGE_SCAN_RESUMED_IND,
    /*! Indication that truncated page scan has been resumed after other higher priority requests have been released. */
    BREDR_SCAN_MANAGER_TRUNCATED_PAGE_SCAN_RESUMED_IND,
    /*! Indication that inquiry scan has been resumed after other higher priority requests have been released. */
    ...
    /*! Indication scan activity is throttled - other higher priority features are running */
    BREDR_SCAN_MANAGER_PAGE_SCAN_THROTTLED_IND,

    /*! Indication scan activity is unthrottled - other higher priority features stopped running */
...
typedef struct
{
    /*! TRUE = disabled, FALSE = re-enabled */
    bool disabled;
...
/*! @brief Release truncated page scanning request for a specified client.
