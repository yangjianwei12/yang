...
void BtDevice_GetDeviceData(device_t device, bt_device_pdd_t *device_data)
{
    ...
    Device_GetPropertyU8(device, device_property_google_finder_location_tracking_disabled, &device_data->google_finder_location_tracking_disabled);
...
void BtDevice_SetDeviceData(device_t device, const bt_device_pdd_t *device_data)
{
    ...
    switch(device_data->type)
    {
        ...
        case DEVICE_TYPE_SELF:
            ...
            Device_SetPropertyU8(device, device_property_google_finder_location_tracking_disabled, device_data->google_finder_location_tracking_disabled);
            break;
