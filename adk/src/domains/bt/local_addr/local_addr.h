/*!
    ...
    \file       
    \defgroup   local_addr Local Address
    @{
    \ingroup    bt_domain
...
/*! \brief Messages sent by the Local Addr module. */
typedef enum
{
...
/*! \brief Message payload for LOCAL_ADDR_CONFIGURE_BLE_GENERATION_CFM */
typedef struct
{
    /*! Success or failure */
...
/*! \brief Host address generation options */
typedef enum
{
...
/*! \brief Controller address generation options */
typedef enum
{
