/*!
    ...
    All Rights Reserved.
    Qualcomm Technologies International, Ltd. Confidential and Proprietary. gatt_client_battery GATT Battery Client
    \file
    \defgroup    gatt_battery_domain GATT Battery Client
    @{
