...
/*! \brief Find AV instance using A2DP/AVRCP profile's search id (connection Id/ stream handle)
    ...
    \note This function finds the AV instance from the existing device records by matching
...
*/
avInstanceTaskData *AvInstance_GetInstanceForSearchId(uint8 search_id, bool search_by_conn_id, uint32 profile_to_check);
#endif
