...
#ifdef USE_SYNERGY
    void *sdp_search_data;          /*!< SDP search data */
#endif
...
BRIEF
    Cancel any previous DFU activities such as cancel any pending UPGRADE_PEER_CONNECT_REQ
    or disconnect L2CAP channel which was created from old primary
...
#define DfuPeer_CancelPreviousDFUActivities(void)   ((void)0)
#endif
