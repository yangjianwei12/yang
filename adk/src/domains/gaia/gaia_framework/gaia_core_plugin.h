...
*/
#define GAIA_CORE_PLUGIN_VERSION (5)
...
typedef enum
{
    ...
    /*! Get various System Information parameters */
    get_system_information = 17,
...
/*! \brief System information IDs as passed in the token
*/
typedef enum
{
    /*! Request Application build ID. */
    application_build_id = 0,
    system_information_max, /* Important: this must be the last entry in this list */
} gaia_system_information_id_t;
