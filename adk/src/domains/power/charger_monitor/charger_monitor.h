/*!
    ...
    \file
    \defgroup   charger_monitor Charger Monitor
    @{
...
/*! /brief Check if earbud was booted due to lid open event
*
* Charger status will not be NO_POWER if lid is open and earbud boots from in case
*
* \return TRUE if charger status is not equal to NO_POWER
*/
bool Charger_IsChargerConnectedAtBoot(void);

/*! /brief Clear the charger detected at boot flag.
*/
...
#define Charger_DisableReasonAdd(reason)   (UNUSED(reason))
#define Charger_DisableReasonClear(reason)   (UNUSED(reason))
...
#define Charger_ClientRegister(task) (UNUSED(task),FALSE)
#define Charger_ClientUnregister(task)  (UNUSED(task))
#define Charger_UpdateCurrent(void)
