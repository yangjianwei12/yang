/*!
    ...
    \file
    \defgroup   usb_hid_class   USB HID
    @{
        \ingroup    usb_domain    
...
/*! \brief  HID 1.11 spec, 7.2 Class-Specific Requests */
typedef enum {
    HID_GET_REPORT = 0x01,
    HID_GET_IDLE = 0x02,
...
/*! \brief  HID 1.11 spec, 6.2.2.2 Short Items */
typedef enum {
    HID_REPORT_MAIN = 0,
    HID_REPORT_GLOBAL = 1,
    HID_REPORT_LOCAL = 2,
...
/*! \brief HID 1.11 spec, 6.2.2.4 Main Items */
typedef enum
{
    HID_REPORT_INPUT = 8,
    HID_REPORT_OUTPUT = 9,
...
/*! \brief  HID 1.11 spec, 6.2.2.7 Global Items */
typedef enum
{
...
/*! \brief  HID 1.11 spec, 6.2.2.8 Local Items */
typedef enum
{
    HID_REPORT_USAGE = 0,
...
/*! \brief Class-specific HID interface descriptor */
typedef struct
{
