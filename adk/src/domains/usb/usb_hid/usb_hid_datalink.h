...
/*! \brief Handler for USB HID datalink data coming from the host
 *
...
/*! \brief Register handler for report data coming from the host
 *
...
/*! \brief Send HID report data to the host
 *
