...
typedef struct
{
    ...
    /*! Streaming config index used in last reporting in GetConnectParameters(). */
    uint8                       spkr_streaming_config_index;
    uint8                       mic_streaming_config_index;
    voice_source_t              audio_source;
    Source                      spkr_src;
    Sink                        mic_sink;
    /*! Sample rate used in last reporting in GetConnectParameters(). */
