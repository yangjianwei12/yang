/*!
    ...
    \brief      Private interface file between USB Audio function driver and class 
                driver.
    @{
*/
...
/*! \brief USB Audio message comes from class driver */
typedef enum
{
...
/*! \brief Structure to hold voulme status. */
typedef struct
{
...
/*! \brief Structure to hold information regarding streaming interface. */
...
/*! \brief Opaque USB audio class context data */
