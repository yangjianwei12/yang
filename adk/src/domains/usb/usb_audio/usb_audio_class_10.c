...
static const uint8 *usbAudioClass10_FindEndpointClassDescriptor(const uint8 *intf_desc,
                                               ...
                                               const usb_audio_interface_config_t *intf_config)
{
    ...
    for(uint8 index = 0; index<intf_config->alt_settings_count ; index++)
    {
         ...
         * pointers and sizes. */
        ep_desc = usbAudioClass10_FindEndpointClassDescriptor(intf_desc, intf_desc_size);
        if (ep_desc)
        {
