...
/*! \brief Making globalusbTaskData visible to other domain*/
extern usbTaskData globalusbTaskData;

/*! \brief Get pointer to the Usb Task data structure */
#define UsbGetTaskData()    (&globalusbTaskData)

/*! \brief Get the clients data registered for nitifications */
