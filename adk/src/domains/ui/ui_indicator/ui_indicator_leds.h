...
/*! \brief User interface internal messasges */
...
/*! \brief Refresh the currently active context indication.

    This API can be used in peer-enabled contexts to cause an active context flash (i.e. state indication)
    to be synchronised on the peer device's UI.
*/
