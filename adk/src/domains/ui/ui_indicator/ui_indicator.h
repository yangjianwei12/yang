/*!
    ...
    \file
    \defgroup   ui_indicator UI Indicator
    @{
        \ingroup    ui_domain
...
/*! \brief For all the System Events in the group to which the specified System Event belongs, register
           the client task on the originating module's Task List.

    \param sys_event The system event whose group is to be registered
    \param client_task The task to insert on the module originating the System Events task_list
*/
void UiIndicator_RegisterInterestInSystemEventGroup(
        MessageId sys_event,
        Task client_task);
