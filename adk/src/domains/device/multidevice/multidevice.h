...
/*! \brief Check if device type is stereo or not.

    \returns TRUE if side is multidevice_type_both otherwise FALSE.
*/
bool Multidevice_IsDeviceStereo(void);

/*! \brief Check if device side matches with given side.

    \returns TRUE if side is matches to 'device side' or multidevice_side_both otherwise FALSE.
*/
bool Multidevice_IsSameAsOurSide(multidevice_side_t side);

/*! \brief Check if pair side matches with given side.

    \returns TRUE if side is matches to 'pair device side' or multidevice_side_both otherwise FALSE.
*/
