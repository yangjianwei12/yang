...
typedef enum
{
    ...
    anc_state_manager_event_aah_enable,
    anc_state_manager_event_aah_disable,
    anc_state_manager_event_filter_topology_parallel,
    anc_state_manager_event_filter_topology_dual,
