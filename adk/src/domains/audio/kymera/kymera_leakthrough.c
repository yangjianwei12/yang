...
static mic_user_state_t kymera_LeakthroughGetUserState(void);
static bool kymera_LeakthroughGetAecRefUsage(void);
...
static const mic_callbacks_t kymera_MicLeakthroughCallbacks =
{
    ...
    .MicGetUserState = kymera_LeakthroughGetUserState,
    .MicGetAecRefUsage = kymera_LeakthroughGetAecRefUsage,
};
...
static const mic_registry_per_user_t kymera_MicLeakthroughRegistry =
{
    ...
    .permanent.mandatory_mic_ids = kymera_MandatoryLeakthroughMicIds,
    .permanent.num_of_mandatory_mics = ARRAY_DIM(kymera_MandatoryLeakthroughMicIds),
};
...
void Kymera_LeakthroughSetupSTGain(void)
{
    if(AecLeakthrough_IsLeakthroughEnabled())
    {
        ...
        Kymera_LeakthroughEnableSidetonePath(TRUE);
...
void Kymera_LeakthroughEnableSidetonePath(bool enable)
{
