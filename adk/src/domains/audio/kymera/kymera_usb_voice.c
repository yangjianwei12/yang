...
static mic_user_state_t kymeraUsbVoice_GetUserState(void);
static bool kymeraUsbVoice_GetAecRefUsage(void);
...
static const mic_callbacks_t usb_voice_mic_callbacks =
{
    ...
    .MicGetUserState = kymeraUsbVoice_GetUserState,
    .MicGetAecRefUsage = kymeraUsbVoice_GetAecRefUsage,
};
...
kymera_chain_handle_t KymeraUsbVoice_GetCvcChain(void)
{
    return the_usb_voice_chain;
}
