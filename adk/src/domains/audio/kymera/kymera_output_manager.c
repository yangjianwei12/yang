...
static bool kymera_IsBackgroundConnection(output_connection_t connection)
{
    return (connection == output_connection_background);
}
...
static bool kymera_CanConnectConcurrently(output_connection_t a, output_connection_t b)
{
    ...
    if (kymera_IsBackgroundConnection(a) && kymera_IsBackgroundConnection(b))
        return FALSE;
...
static void kymera_UpdateInputSampleRate(output_users_t user, const kymera_output_chain_config *user_config)
{
    ...
    if (kymera_IsBackgroundConnection(connection))
        KymeraOutput_SetBackgroundSampleRate(user_config->rate);
}
...
static bool kymera_ConnectToOutputChain(output_users_t user, const output_source_t *sources)
{
    ...
    switch(connection)
    {
        ...
        case output_connection_stereo:
            ...
            break;
        case output_connection_background:
            KymeraOutput_ConnectToBackgroundInput(sources->background.left, sources->background.right);
            break;
        default:
            Panic();
            break;
...
static void kymera_DisconnectFromOutputChain(output_users_t user)
{
    ...
    switch(connection)
    {
        ...
        case output_connection_stereo:
            ...
            break;
        case output_connection_background:
            KymeraOutput_DisconnectBackgroundInput();
            break;
        default:
            Panic();
            break;
