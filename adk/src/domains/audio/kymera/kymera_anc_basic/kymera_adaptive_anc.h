...
#else
#define KymeraAdaptiveAnc_GetCurrentAancMode(aanc_mode) (FALSE)
#endif
...
#else
#define KymeraAdaptiveAnc_CreateAdaptiveAncTuningChain(x) ((void)(0))
#endif
...
#else
#define KymeraAdaptiveAnc_DestroyAdaptiveAncTuningChain(x) ((void)(0))
#endif
