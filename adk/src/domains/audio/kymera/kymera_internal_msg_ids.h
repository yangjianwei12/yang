...
enum app_kymera_internal_message_ids
{
    ...
    /*! Internal USB Audio mute message. */
    KYMERA_INTERNAL_USB_AUDIO_MUTE,
    ...
    /*! Internal LEA Mic synchronised message */
    KYMERA_INTERNAL_LEA_MIC_SYNCHRONISED,

    /*! Internal Apply QHS level change message */
    KYMERA_INTERNAL_QHS_LEVEL_CHANGED,

#if defined (INCLUDE_LE_AUDIO_BROADCAST_SOURCE) && defined (ENABLE_SIMPLE_SPEAKER)
    /*! Internal LEA Media Broadcast request(enable/disable) message */
    KYMERA_INTERNAL_LEA_MEDIA_BROADCAST_REQ,
