...
/*! Fast task period for AEC Ref 1msec*/
#define AEC_REF_TASK_PERIOD_1MS             (1000U)
...
typedef enum
{
    ...
    /* aec usecase for all  non-sco aanc scenarios */
    /* Multiple ANC usecases are possible, see list in kymera_anc_common.c */
    aec_usecase_anc,
    aec_usecase_anc2,
    aec_usecase_anc3,
    aec_usecase_anc4,
...
/*! \brief Returns the last configured ttp delay for aec_ref. */
