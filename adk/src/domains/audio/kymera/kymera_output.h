...
/*! \brief Get the sample rate used for the background output
    \return The sample rate
*/
...
/*! \brief Initialise the Kymera output module
 */
void KymeraOutput_Init(void);

#ifdef INCLUDE_KYMERA_COMPANDER
/*! \brief Enables the sound limiter */
void KymeraOutput_EnableSoundLimiter(void);

/*! \brief Disables the sound limiter */
void KymeraOutput_DisableSoundLimiter(void);
#else
#define KymeraOutput_EnableSoundLimiter()   ((void)(0))
#define KymeraOutput_DisableSoundLimiter()  ((void)(0))
#endif
