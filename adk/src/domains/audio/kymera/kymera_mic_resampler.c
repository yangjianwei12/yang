...
#if MAX_NUM_OF_CONCURRENT_MICS > 1
     EPR_MIC_RESAMPLER_IN2,
#endif
#if MAX_NUM_OF_CONCURRENT_MICS > 2
     EPR_MIC_RESAMPLER_IN3,
#endif
#if MAX_NUM_OF_CONCURRENT_MICS > 3
     EPR_MIC_RESAMPLER_IN4,
#endif
#if MAX_NUM_OF_CONCURRENT_MICS > 4
     EPR_MIC_RESAMPLER_IN5,
#endif
#if MAX_NUM_OF_CONCURRENT_MICS > 5
     EPR_MIC_RESAMPLER_IN6,
#endif
#if MAX_NUM_OF_CONCURRENT_MICS > 6
...
#if MAX_NUM_OF_CONCURRENT_MICS > 7
    #error Mic framework supports a maximum of 7 microphones
#endif
};
...
} resamplers[MAX_NUM_OF_CONCURRENT_MIC_USERS * 2] = {0};    /* The first set of resamplers is used for normal splitter connection.
