...
/*! \brief Set the output chains sample rate for the background input.
    \param rate The sample rate to set
 */
...
/*! \brief Connect to background input.
    \param left Source to connect to the left background channel.
    \param right Source to connect to the right background channel.
 */
...
/*! \brief Disconnect background input.
 */
