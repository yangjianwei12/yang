...
/*! \brief Check to determine if a audio sources audio is routed.

    \param source The audio source

    \return TRUE if audio sources audio is routed, else FALSE
 */
...
/*! \brief Get the state of an audio source
 ...
 */
void AudioSources_OnAudioRoutingChange(audio_source_t source, source_routing_change_t change);
