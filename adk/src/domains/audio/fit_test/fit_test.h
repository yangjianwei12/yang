...
/* Compiler error checks for macros that are supported under ANC V2 only */
        ...
        #error ENABLE_EARBUD_FIT_TEST  can be used along with INCLUDE_ANC_V2 only
    #endif
#endif
...
#else
#define FitTest_ContinuousInit(x) (FALSE)
#endif

/*!
    \brief Start continuous earbud fit test
 */
#if defined(ENABLE_CONTINUOUS_EARBUD_FIT_TEST)
void FitTest_ContinuousStart(void);
#else
#define FitTest_ContinuousStart() ((void)0)
#endif

/*!
    \brief Stop continuous earbud fit test
 */
#if defined(ENABLE_CONTINUOUS_EARBUD_FIT_TEST)
void FitTest_ContinuousStop(void);
#else
#define FitTest_ContinuousStop() ((void)0)
#endif

/*!
    \brief Start a single capture in continuous earbud fit test mode
 */
#if defined(ENABLE_CONTINUOUS_EARBUD_FIT_TEST)
void FitTest_ContinuousSingleCapture(void);
#else
#define FitTest_ContinuousSingleCapture() ((void)0)
#endif
