...
#define GenericSource_GetDevice(src)                (GenericSource_IsAudio(src) ? \
                                                    AudioSources_GetAudioSourceDevice(src.u.audio) : \
                                                    VoiceSources_GetDeviceForSource(src.u.voice))
#define GenericSource_SourcesOnSameDevice(src1, src2) (GenericSource_GetDevice(src1) == GenericSource_GetDevice(src2))
