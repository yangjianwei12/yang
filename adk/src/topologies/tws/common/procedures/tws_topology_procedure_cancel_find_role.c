                                        ...
                                        Message goal_data)
{
    ...
    /* Elected roles that are not secondary will result in invalid topology transistions
       Ensure the role is relinquished */
    if(TwsTopology_GetSm()->elected_role != tws_topology_elected_role_secondary)
    {
        TwsTopology_GetSm()->elected_role = tws_topology_elected_role_none;
    }
