...
static void TwsTopology_ProcedureNotifyRoleChangeClientsReset(void)
{
    ...
    MessageCancelFirst(TwsTopProcNotifyRoleChangeClientsGetTask(), TWSTOP_INTERNAL_PROPOSAL_TIMEOUT);
    MessageCancelFirst(TwsTopProcNotifyRoleChangeClientsGetTask(), TWSTOP_INTERNAL_FORCE_TIMEOUT);
    td->complete_fn = NULL;
                                        ...
                                        Message goal_data)
{
    ...
    switch(td->params.notification)
    {
        case tws_notify_role_change_force_notification:    
        {
            ...
            MessageSendLater(TwsTopProcNotifyRoleChangeClientsGetTask(), TWSTOP_INTERNAL_FORCE_TIMEOUT, NULL, TWSTOP_PROC_CLIENT_FORCE_RESPONSE_TIMEOUT_TIMEOUT_MS);                
    }
        break;
        case tws_notify_role_change_proposal_notification:
        {
            ...
            MessageSendLater(TwsTopProcNotifyRoleChangeClientsGetTask(), TWSTOP_INTERNAL_PROPOSAL_TIMEOUT, NULL, TWSTOP_PROC_CLIENT_ACCEPTANCE_TIMEOUT_TIMEOUT_MS);
        }
        break;
...
static void twsTopology_ProcNotifyRoleChangeClientsHandleMessage(Task task, MessageId id, Message message)
{
    ...
    DEBUG_LOG("twsTopology_ProcNotifyRoleChangeClientsHandleMessage "
              "enum:tws_topology_internal_message_t:%d", id);
    ...
    switch (id)
    {
        ...
        case TWSTOP_INTERNAL_PROPOSAL_TIMEOUT:
        {
            Procedures_DelayedCompleteCfmCallback(td->complete_fn,
                                                       tws_topology_procedure_notify_role_change_clients,
                                                       procedure_result_success); 
        ...
        case TWSTOP_INTERNAL_FORCE_TIMEOUT:
        {
            Procedures_DelayedCompleteCfmCallback(td->complete_fn,
                                                       tws_topology_procedure_notify_role_change_clients,
                                                       procedure_result_success);
