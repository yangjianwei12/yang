...
#ifndef STEREO_TOPOLOGY_PROC_ENABLE_CONNECTABLE_PEER_H
#define STEREO_TOPOLOGY_PROC_ENABLE_CONNECTABLE_PEER_H
...
extern const procedure_script_t stereo_primary_connect_peer_script;
