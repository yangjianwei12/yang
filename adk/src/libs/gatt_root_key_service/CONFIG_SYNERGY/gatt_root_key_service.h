...
/*!
    @brief Status code returned following a GattRootKeyServerInit().
*/
typedef enum
{
        /*! Indicates that the GATT Root Key server initialisation has completed successfully */
    gatt_root_key_server_init_success,
        /*! Indicates that the GATT Root Key server initialisation has failed */
    gatt_root_key_server_init_failed,
} gatt_root_key_server_init_status_t;
