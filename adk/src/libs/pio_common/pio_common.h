...
/*!
 * @brief Structure used to contains I2C PIOs with functions
 *
 */
...
/*!
    Switch I2C PIOs from i2c function to IO function and vise versa

    @param[in] i2c_pios : array of i2c pio functions
    @param[in] size: size of the pio array
    @param[in] set_io: set true to switch to IO function
    @param[in] set_fn: set true to switch to I2C function
