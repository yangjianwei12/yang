...
/*!
    @brief Status code returned following a GattRoleSelectionServerInit().
*/
typedef enum
{
        /*! Indicates that the GATT Role Selection server initialisation has completed successfully */
    gatt_role_selection_server_init_success,
        /*! Indicates that the GATT Role Selection server initialisation has failed */
    gatt_role_selection_server_init_failed,
} gatt_role_selection_server_init_status_t;
