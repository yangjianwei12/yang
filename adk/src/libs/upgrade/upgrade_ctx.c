...
void UpgradeCtxClearPSKeys(void)
{
    ...
    UpgradeCtxGetPSKeys()->state_of_partitions = UPGRADE_PARTITIONS_DIRTY;
    ...
    memset(&UpgradeCtxGetPSKeys()->last_closed_partition, 0, sizeof(UpgradeCtxGetPSKeys()->last_closed_partition));
