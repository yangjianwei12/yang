...
void avrcpHandleDeleteTask(AVRCP *avrcp)
{
    ...
    else
    {
        ...
        /* Cleanup any outstanding Source/allocated data */
        ...
        if (avrcp->dataFreeTask.sent_data)
        {
            ...
            avrcp->dataFreeTask.sent_data = NULL;
        }

        /* Flush any pending messages, and also remove the Task
         * from the registered Source handlers */
        MessageFlushTask(&avrcp->dataFreeTask.cleanUpTask);
