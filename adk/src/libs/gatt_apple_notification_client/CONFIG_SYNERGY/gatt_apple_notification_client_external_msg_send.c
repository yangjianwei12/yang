...
static gatt_ancs_status_t getAncsStatusFromGattStatus(uint16 gatt_status)
{
    switch(gatt_status)
    {
...
void gattAncsSendSetNotificationSourceNotificationResponse(GANCS *ancs, uint16 gatt_status)
{
...
void gattAncsSendSetDataSourceNotificationResponse(GANCS *ancs, uint16 gatt_status)
{
...
void gattAncsSendWriteControlPointResponse(GANCS *ancs, uint16 gatt_status)
{
...
void gattAncsSendInitResponse(GANCS *ancs, uint16 gatt_status)
{
