...
static gatt_ams_status_t getAmsStatusFromGattStatus(uint16 gatt_status)
{
    switch(gatt_status)
    {
        case CSR_BT_GATT_ACCESS_RES_SUCCESS:
            return gatt_ams_status_success;
        case CSR_BT_GATT_ACCESS_RES_REQUEST_NOT_SUPPORTED:
...
static void sendWriteRemoteCommandResponse(const GAMS *ams, uint16 gatt_status)
{
...
static void sendWriteEntityUpdateResponse(const GAMS *ams, uint16 gatt_status)
{
...
static void sendWriteEntityAttributeResponse(const GAMS *ams, uint16 gatt_status)
{
...
static void sendReadEntityAttributeResponse(const GAMS *ams, uint16 gatt_status, uint16 value_size, const uint8 *value)
{
