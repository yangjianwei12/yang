...
#define AMS_CLIENT_REMOTE_COMMAND_UUID128    9B,3C,81,D8,57,B1,4A,8A,B8,DF,0E,56,F7,CA,51,C2
#define AMS_CLIENT_ENTITY_UPDATE_UUID128     2F,7C,AB,CE,80,8D,41,1F,9A,0C,BB,92,BA,96,C1,02
#define AMS_CLIENT_ENTITY_ATTRIBUTE_UUID128  C6,B2,F3,8C,23,AB,46,D8,A6,AB,A3,A8,70,BB,D5,D7
