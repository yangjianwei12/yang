...
/******************************************************************************
NAME:
    AudioOutputEnableSilenceDetection

DESCRIPTION:
    This interface enables silence detection in audio output left and right channels.
    Whenever silence is detected then the DAC ultra quiet mode will be enabled automatically.
    <Note> This feature is available only in QCC517x audio firmware and afterwards

RETURNS:
    Whether Silence Detection enabled (TRUE = enabled, FALSE = ignored)
*/
...
DESCRIPTION:
    This interface disables silence detection in audio output left and right channels.
    <Note> This feature is available only in QCC517x audio firmware and afterwards.

RETURNS:
    Whether Silence Detection disabled(TRUE = disabled, FALSE = ignored)
*/
