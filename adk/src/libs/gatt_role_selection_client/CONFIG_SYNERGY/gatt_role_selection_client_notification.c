...
{
    if (    GRSS_SIZE_MIRROR_STATE_PDU_OCTETS == ind->valueLength
        && (ind->valueHandle == instance->handles.handle_state))
    {
    ...
    else if (    GRSS_SIZE_FIGURE_OF_MERIT_PDU_OCTETS == ind->valueLength
             && (ind->valueHandle == instance->handles.handle_figure_of_merit))
    {
