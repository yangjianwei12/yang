...
typedef enum
{
    ...
    gaia_transport_accessory,                           /*!< Accessory / Bluetooth transport */
    gaia_transport_max,
...
typedef enum
{
	...
	GAIA_TRANSPORT_BUSY                     /*!< Transport is busy to take any more data due to the error GAIA_TRANSPORT_INSUFFICENT_BUFFER_SPACE */
