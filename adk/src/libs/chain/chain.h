...
/*! \brief Returns the chain config the chain handle was created with.
 *  \param handle The handle of the corresponding chain.
 *  \return True: chain config the chain handle was created with.
*/
