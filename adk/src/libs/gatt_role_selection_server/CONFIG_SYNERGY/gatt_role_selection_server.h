...
/*! Message sent on Role Selection Service initialisation completion */
typedef struct
{
    const GATT_ROLE_SELECTION_SERVER *instance;
    gatt_role_selection_server_init_status_t  status;
} GATT_ROLE_SELECTION_SERVER_INIT_IND_T;
...
typedef enum
{
    ...
    GATT_ROLE_SELECTION_SERVER_CHANGE_ROLE_IND = GATT_ROLE_SELECTION_SERVER_MESSAGE_BASE,
        ...
        /*! Role Selection Service initialisation has completed */
    GATT_ROLE_SELECTION_SERVER_INIT_IND,
...
/*!
    ...
    @param conn_id      connection identifier for this server
*/
