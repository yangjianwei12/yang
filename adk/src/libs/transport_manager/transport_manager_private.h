...
/****************************************************************************
DESCRIPTION
    Update datablock with BtConnId
...
RETURNS
*/
void transportMgrUpdateBtConnId(uint16 trans_link_id, uint32 btConnId,transport_mgr_type_t trans_type);

/****************************************************************************
DESCRIPTION
    Find a transport link identifier from the list with btConnId as ref. This utility function works only 
    when the transport_mgr_type_t is not  transport_mgr_type_gatt. 
...
*/
uint16 transportMgrFindTranslinkIdFromBtConnId(uint32 ref_btConnId);
#endif
