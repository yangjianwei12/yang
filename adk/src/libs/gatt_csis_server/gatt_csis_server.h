...
typedef gatt_status_t    CsisServerGattStatusType;
...
typedef struct
{
    unsigned    lockValueClientCfg:2;
    unsigned    sirkValueClientCfg:2;
    unsigned    sizeValueClientCfg:2;
    unsigned    unused:10;
...
/*!
    ...
    @param handle The server instance handle returned in GattCsisServerInitReq()
...
/*!
    ...
    @param handle The server instance returned in GattCsisServerInitReq().
...
/*!
    ...
    NOTE: Application need not call this API if init_params are not changed
          and are same as what was passed in GattCsisServerInitReq()
*/
