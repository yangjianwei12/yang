...
void aghfpHandleSendServiceIndicator(AGHFP *aghfp, aghfp_service_availability availability)
{
        ...
        /* check length of 'availability' */
        if(availability>aghfp_service_present)
        {
            AGHFP_DEBUG_PANIC(("AGHFP:aghfpHandleSendServiceIndicator availability invalid"));
            return;
        }
...
void aghfpSendCallIndicator(AGHFP *aghfp, aghfp_call_status status)
{
    ...
    if(status>aghfp_call_active)
    {
        AGHFP_DEBUG_PANIC(("AGHFP:aghfpSendCallIndicator status invalid"));
        return;
    }
...
void aghfpSendCallSetupIndicator(AGHFP *aghfp, aghfp_call_setup_status type)
{
    ...
    if(type>aghfp_call_setup_remote_alert)
    {
        AGHFP_DEBUG_PANIC(("AGHFP:aghfpSendCallSetupIndicator type invalid"));
        return;
    }
...
void aghfpHandleSendCallHeldIndicator(AGHFP *aghfp, aghfp_call_held_status status)
{
    ...
    /* check length of 'status' */
    if(status>aghfp_call_held_remaining)
    {
        AGHFP_DEBUG_PANIC(("AGHFP:aghfpHandleSendCallHeldIndicator status invalid"));
        return;
    }
...
void aghfpHandleSendSignalIndicator(AGHFP *aghfp, uint16 level)
{
        ...
        /* Check the length of level */
        if(level > 99)
        {
            AGHFP_DEBUG_PANIC(("AGHFP:aghfpHandleSendSignalIndicator level invalid"));
            return;
        }
...
void aghfpHandleSendRoamIndicator(AGHFP *aghfp, aghfp_roam_status status)
{
        ...
        /* check length of 'status' */
        if(status>aghfp_roam_active)
        {
            AGHFP_DEBUG_PANIC(("AGHFP:aghfpHandleSendRoamIndicator status invalid"));
            return;
        }
...
void aghfpHandleSendBattChgIndicator(AGHFP *aghfp, uint16 level)
{
        ...
        /* check length of 'level' */
        if(level>99)
        {
            AGHFP_DEBUG_PANIC(("AGHFP:aghfpHandleSendBattChgIndicator level invalid"));
            return;
        }
