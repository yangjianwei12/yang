...
#define MAKE_AGHFP_MESSAGE(TYPE) TYPE##_T *message = PanicUnlessMalloc(sizeof(TYPE##_T));
#define MAKE_AGHFP_MESSAGE_WITH_ARRAY(TYPE, len) \
	TYPE##_T *message = (TYPE##_T*)PanicUnlessMalloc(sizeof(TYPE##_T) + sizeof(uint16) * len);
