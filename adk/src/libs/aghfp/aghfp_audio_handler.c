...
void sendAudioConnectCfmToApp(AGHFP *aghfp, aghfp_audio_connect_status status, hci_status cl_status)
{
    ...
    if ((aghfp->use_wbs) && (aghfp->use_codec > wbs_codec_cvsd))
    {
...
static void startAudioConnectRequest(AGHFP *aghfp)
{
    ...
    if ( (aghfp->audio_packet_type & sync_all_esco) || (aghfp->audio_packet_type & sync_all_edr_esco) != sync_all_edr_esco )
...
const aghfp_audio_params * aghfpGetDefaultAudioParams (sync_pkt_type packet_type)
{
    ...
    if ( (packet_type & sync_all_esco) || (packet_type & sync_all_edr_esco) != sync_all_edr_esco )
    {
