...
#include "csr_types.h"
#include "bluetooth.h"
#if defined(HYDRA) || defined(__llvm__)
#include "hci.h"
#else
#include "hci_prim.h"
#endif
...
#endif
#ifndef CSR_BT_BLUETOOTH_VERSION_5P4
#define CSR_BT_BLUETOOTH_VERSION_5P4                       (0x0D)
#endif
 ...
 * Defines for EATT.
 *----------------------------------------------------------------------------*/
/* Total number of EATT bearers & max number of outgoing EATT Bearer Synergy can establish.
 * Configure these values based on product's requirement and platform's memory availability */
#define NO_OF_EATT_BEARER                                  (0x03)
#define LOCAL_INITIATED_EATT_BEARER                        (0x01)
...
#define CSR_BT_HCI_BUILD_L2CAP_NON_EDR_MAX_FRAME_SIZE           (895)
...
#define CSR_BT_HF_PROFILE_DEFAULT_MTU_SIZE                      (200)
#endif /* CSR_BT_HF_PROFILE_DEFAULT_MTU_SIZE */

#ifndef HF_MAX_BVRA_TEXT_SIZE
#define HF_MAX_BVRA_TEXT_SIZE                                   (32)
#endif /* HF_MAX_BVRA_TEXT_SIZE */
...
#define CSR_BT_MAX_FRIENDLY_NAME_LEN                                   (30)     /* 31 Characters for V&M */
...
/*--------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------------*/
/* MTU size to be used to configure L2CAP connection for SDP in both client & Server roles.
 * Configure its value based on product's requirement and available P0 memory pools. */
#define CSR_BT_SDP_MTU                                                  128
...
#define CSR_BT_HF_DEFAULT_SERVER_HF                        0x0A /* As defined in library.h in VM libs */
#endif

#ifndef CSR_BT_HF_DEFAULT_SERVER_HS
#define CSR_BT_HF_DEFAULT_SERVER_HS                        0x0B /* As defined in library.h in VM libs */
#endif
...
#define CSR_BT_AV_MAX_NUM_STREAMS          2
...
#ifndef PAC_MAX_NUM_INSTANCES
#ifdef INSTALL_PAC_MULTI_INSTANCE_SUPPORT
#define PAC_MAX_NUM_INSTANCES                    (2) /* Max number of concurrent PBAP connections */
#else
#define PAC_MAX_NUM_INSTANCES                    (1)
#endif /* INSTALL_PAC_MULTI_INSTANCE_SUPPORT */
#endif /* PAC_MAX_NUM_INSTANCES */
/*--------------------------------------------------------------------------
