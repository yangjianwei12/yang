...
/* #undef EXCLUDE_CSR_BT_BAP_SERVER_MODULE */
/* #undef EXCLUDE_CSR_BT_ASCS_SERVER_MODULE */
/* #undef EXCLUDE_CSR_BT_PACS_SERVER_MODULE */
/* #undef EXCLUDE_CSR_BT_BASS_SERVER_MODULE */
/* #undef EXCLUDE_CSR_BT_CSIS_SERVER_MODULE */
/* #undef EXCLUDE_CSR_BT_VCS_SERVER_MODULE */
/* #undef EXCLUDE_CSR_BT_MICS_SERVER_MODULE */
/* #undef EXCLUDE_CSR_BT_MCP_MODULE */
/* #undef EXCLUDE_CSR_BT_MCS_CLIENT_MODULE */
/* #undef EXCLUDE_CSR_BT_CCP_MODULE */
/* #undef EXCLUDE_CSR_BT_TBS_CLIENT_MODULE */

#define EXCLUDE_CSR_BT_BAP_MODULE
#define EXCLUDE_CSR_BT_BAP_BROADCAST_ASSISTANT_MODULE
#define EXCLUDE_CSR_BT_ASCS_CLIENT_MODULE
#define EXCLUDE_CSR_BT_PACS_CLIENT_MODULE
#define EXCLUDE_CSR_BT_BASS_CLIENT_MODULE
#define EXCLUDE_CSR_BT_CSIP_MODULE
#define EXCLUDE_CSR_BT_CSIS_CLIENT_MODULE
#define EXCLUDE_CSR_BT_VCP_MODULE
#define EXCLUDE_CSR_BT_VCS_CLIENT_MODULE
#define EXCLUDE_CSR_BT_MICP_MODULE
#define EXCLUDE_CSR_BT_MICS_CLIENT_MODULE
#define EXCLUDE_CSR_BT_MCS_SERVER_MODULE
#define EXCLUDE_CSR_BT_TBS_SERVER_MODULE
...
/* #undef SYNERGY_VM_SOURCE_APP_ENABLED */
#endif
