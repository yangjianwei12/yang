...
/* **************************************************** */
    ...
    */
    ...
    CmnCsrBtLinkedListStruct *CsrBtUtilSdrCreateServiceHandleEntryFromUuid128(CmnCsrBtLinkedListStruct *bll,
                                                                              const CsrBtUuid128 *serviceUuid128,
                                                                              CsrUint16 *newIndex);
...
/* **************************************************** */
    ...
    */
    ...
    CsrUint8 *CsrBtUtilSdrGetInnerAttrData(CmnCsrBtLinkedListStruct *bll_p,
                                           CsrUintFast16 serviceHandleIndex,
                                           CsrUint16 attributeUuid,
                                           CsrUint16 *dataLen);
...
#define CsrBtUtilSdrGetEmptyAttributeSize(_size_p) (*(_size_p) = SDR_ENTRY_INDEX_ATTRIBUTE_DATA)
    ...
    */
    ...
    CsrUint16 CsrBtUtilSdrGetL2capPsm(CmnCsrBtLinkedListStruct *bll_p,
                                      CsrUintFast16 serviceHandleIndex);

    /* Mark the entry in SDP out tag list as succesful for Service Search attribute cfm */
    void CmnSdcUtilMarkEntrySuccessful(CmnCsrBtLinkedListStruct *bll_p,
                                       CsrUint8 serviceHandleIndex);

    /* Check if the entry in SDP out tag list is succesful for the given service handle index */
    CsrBool CmnSdcUtilCheckEntrySuccessful(CmnCsrBtLinkedListStruct *bll_p,
                                           CsrUint8 serviceHandleIndex);
#ifdef __cplusplus
}
#endif
