...
#define RESULT_CODE_HFG_OPERATION_TIMEOUT                       ((CsrBtResultCode) (0x0007))
...
/* QCE codec is not supported */
#define CSR_BT_HFG_QCE_UNSUPPORTED              (0xFFFF)
...
#define CSR_BT_HFG_CONNECTION_ALL              ((CsrBtHfgConnectionId) 0xFFFFFFFFU)
...
#define CSR_BT_HFG_CNF_AUDIO_STATUS                0x00000001 /* Send CSR_BT_HFG_STATUS_AUDIO_IND on audio parameter setups */
#define CSR_BT_HFG_CNF_DISABLE_BIA                 0x00000002 /* Disable AT+BIA support */
#define CSR_BT_HFG_CNF_MANUAL_INDICATORS           0x00000004 /* _NOT_ recommended: Manual CIND handling in AT sequence */
#define CSR_BT_HFG_CNF_DISABLE_COPS                0x00000008 /* Disable support for "AT+COPS=" command. Recommended when no operator name is available */
#define CSR_BT_HFG_CNF_DISABLE_ESCO_TO_OLD_DEVICES 0x00000010 /* Do not try to establish eSCO towards pre-1.05 spec devices */
...
#define CSR_BT_HFG_CONFIG_AUDIO_REQ                    ((CsrBtHfgPrim) (0x000A + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_RING_REQ                            ((CsrBtHfgPrim) (0x000B + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_CALL_WAITING_REQ                    ((CsrBtHfgPrim) (0x000C + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_CALL_HANDLING_REQ                   ((CsrBtHfgPrim) (0x000D + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_CALL_HANDLING_RES                   ((CsrBtHfgPrim) (0x000E + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_DIAL_RES                            ((CsrBtHfgPrim) (0x000F + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_SPEAKER_GAIN_REQ                    ((CsrBtHfgPrim) (0x0010 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_MIC_GAIN_REQ                        ((CsrBtHfgPrim) (0x0011 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_AT_CMD_REQ                          ((CsrBtHfgPrim) (0x0012 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_OPERATOR_RES                        ((CsrBtHfgPrim) (0x0013 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_CALL_LIST_RES                       ((CsrBtHfgPrim) (0x0014 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_SUBSCRIBER_NUMBER_RES               ((CsrBtHfgPrim) (0x0015 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_STATUS_INDICATOR_SET_REQ            ((CsrBtHfgPrim) (0x0016 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_INBAND_RINGING_REQ                  ((CsrBtHfgPrim) (0x0017 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_BT_INPUT_RES                        ((CsrBtHfgPrim) (0x0018 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_VOICE_RECOG_REQ                     ((CsrBtHfgPrim) (0x0019 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_VOICE_RECOG_RES                     ((CsrBtHfgPrim) (0x001A + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_MANUAL_INDICATOR_RES                ((CsrBtHfgPrim) (0x001B + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_CONFIG_SINGLE_ATCMD_REQ             ((CsrBtHfgPrim) (0x001C + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_CONFIG_ATCMD_HANDLING_REQ           ((CsrBtHfgPrim) (0x001D + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_DEREGISTER_TIME_REQ                 ((CsrBtHfgPrim) (0x001E + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_SET_HF_INDICATOR_STATUS_REQ         ((CsrBtHfgPrim) (0x001F + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))

#ifdef CSR_BT_HFG_ENABLE_SWB_SUPPORT
#define CSR_BT_HFG_SWB_RSP                             ((CsrBtHfgPrim) (0x0020 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HFG_PRIM_DOWNSTREAM_HIGHEST                          (0x0020 + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST)
#else
#define CSR_BT_HFG_PRIM_DOWNSTREAM_HIGHEST                          (0x001F + CSR_BT_HFG_PRIM_DOWNSTREAM_LOWEST)
#endif
...
#define CSR_BT_HFG_STATUS_AUDIO_IND                    ((CsrBtHfgPrim) (0x000A + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_RING_CFM                            ((CsrBtHfgPrim) (0x000B + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_ANSWER_IND                          ((CsrBtHfgPrim) (0x000C + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_REJECT_IND                          ((CsrBtHfgPrim) (0x000D + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_CALL_HANDLING_IND                   ((CsrBtHfgPrim) (0x000E + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_DIAL_IND                            ((CsrBtHfgPrim) (0x000F + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_SPEAKER_GAIN_IND                    ((CsrBtHfgPrim) (0x0010 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_MIC_GAIN_IND                        ((CsrBtHfgPrim) (0x0011 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_AT_CMD_IND                          ((CsrBtHfgPrim) (0x0012 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_OPERATOR_IND                        ((CsrBtHfgPrim) (0x0013 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_CALL_LIST_IND                       ((CsrBtHfgPrim) (0x0014 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_SUBSCRIBER_NUMBER_IND               ((CsrBtHfgPrim) (0x0015 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_GENERATE_DTMF_IND                   ((CsrBtHfgPrim) (0x0016 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_NOISE_ECHO_IND                      ((CsrBtHfgPrim) (0x0017 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_BT_INPUT_IND                        ((CsrBtHfgPrim) (0x0018 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_VOICE_RECOG_IND                     ((CsrBtHfgPrim) (0x0019 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_MANUAL_INDICATOR_IND                ((CsrBtHfgPrim) (0x001A + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_CONFIG_SINGLE_ATCMD_CFM             ((CsrBtHfgPrim) (0x001B + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_CONFIG_ATCMD_HANDLING_CFM           ((CsrBtHfgPrim) (0x001C + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_DEREGISTER_TIME_CFM                 ((CsrBtHfgPrim) (0x001D + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_SELECTED_CODEC_IND                  ((CsrBtHfgPrim) (0x001E + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_HF_INDICATOR_VALUE_IND              ((CsrBtHfgPrim) (0x001F + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HFG_ENHANCED_VOICE_RECOG_IND            ((CsrBtHfgPrim) (0x0020 + CSR_BT_HFG_PRIM_UPSTREAM_LOWEST))
...
typedef struct
{
    ...
    CsrUint8                    hfgSupportedCodecs;            /* Supported CODECs bitmask */
} CsrBtHfgActivateReq;
...
typedef struct
{
    ...
    CsrUint16                   qceCodecId;                     /* QCE Codec to use */
...
/* Downstream primitive structure for Voice recognition (AT+BVRA) */
typedef struct
{
    CsrBtHfgPrim                type;                           /* Primitive/message identity */
    CsrBtHfgConnectionId        connectionId;                   /* Connection indentifier */
    CsrUint8                    bvra;                           /* bvra value to enable/disable the feature or enhaned bvra value */
    ...
    CsrCharString               *string;                        /* Pointer to the text string(in UTF-8 format within duble-quotes) converted from voice response by VRE */
...
/* Enhanced Voice recognition activation from headset (AT+BVRA) */
typedef struct
{
    CsrBtHfgPrim                type;                           /* primitive/message identity */
    CsrBtHfgConnectionId        connectionId;                   /* connection index */
    CsrUint8                    bvra;                           /* Value received from HF to enable/disable feature or enhaned bvra value */
} CsrBtHfgEnhancedVoiceRecogInd;
...
typedef struct
{
    CsrBtHfgPrim                 type;
    CsrBtHfgConnectionId         connectionId;
    CsrUint16                    len;                         /* AT Command length */
    CsrCharString               *cmd;                         /* AT Command */
}CsrBtHfgSwbRsp;
