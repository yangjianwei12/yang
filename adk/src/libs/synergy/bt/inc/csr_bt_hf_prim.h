...
#define CSR_BT_RESULT_CODE_HF_AUDIO_CONNECT_NO_SLC                      ((CsrBtResultCode) (0x000C)) /* Not used, to be deprecated in next major release */
#define RESULT_CODE_HF_AUDIO_CONNECT_ATTEMPT_FAILED                     ((CsrBtResultCode) (0x000D)) /* Audio connection request is failed due to HFP profile level errors */
...
#define CSR_BT_HF_CONNECTION_ALL                ((CsrBtHfConnectionId) 0xFFFFFFFFu)
...
/* START: Deprecated definition, shall be removed in next major release.*/
...
#define CSR_BT_HF_CONFIG_AUDIO_REQ                         ((CsrBtHfPrim) (0x0002 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_SERVICE_CONNECT_REQ                      ((CsrBtHfPrim) (0x0003 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_CANCEL_CONNECT_REQ                       ((CsrBtHfPrim) (0x0004 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_DISCONNECT_REQ                           ((CsrBtHfPrim) (0x0005 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_AUDIO_CONNECT_REQ                        ((CsrBtHfPrim) (0x0006 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_AUDIO_ACCEPT_CONNECT_RES                 ((CsrBtHfPrim) (0x0007 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_AUDIO_DISCONNECT_REQ                     ((CsrBtHfPrim) (0x0008 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))

#define CSR_BT_HF_GET_ALL_STATUS_INDICATORS_REQ            ((CsrBtHfPrim) (0x0009 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_GET_CURRENT_OPERATOR_SELECTION_REQ       ((CsrBtHfPrim) (0x000A + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_GET_SUBSCRIBER_NUMBER_INFORMATION_REQ    ((CsrBtHfPrim) (0x000B + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_GET_CURRENT_CALL_LIST_REQ                ((CsrBtHfPrim) (0x000C + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_SET_EXTENDED_AG_ERROR_RESULT_CODE_REQ    ((CsrBtHfPrim) (0x000D + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_SET_CALL_NOTIFICATION_INDICATION_REQ     ((CsrBtHfPrim) (0x000E + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_SET_CALL_WAITING_NOTIFICATION_REQ        ((CsrBtHfPrim) (0x000F + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_SET_STATUS_INDICATOR_UPDATE_REQ          ((CsrBtHfPrim) (0x0010 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_SET_ECHO_AND_NOISE_REQ                   ((CsrBtHfPrim) (0x0011 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_SET_VOICE_RECOGNITION_REQ                ((CsrBtHfPrim) (0x0012 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_BT_INPUT_REQ                             ((CsrBtHfPrim) (0x0013 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_GENERATE_DTMF_REQ                        ((CsrBtHfPrim) (0x0014 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_SPEAKER_GAIN_STATUS_REQ                  ((CsrBtHfPrim) (0x0015 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_MIC_GAIN_STATUS_REQ                      ((CsrBtHfPrim) (0x0016 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))

#define CSR_BT_HF_DIAL_REQ                                 ((CsrBtHfPrim) (0x0017 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_CALL_ANSWER_REQ                          ((CsrBtHfPrim) (0x0018 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_CALL_END_REQ                             ((CsrBtHfPrim) (0x0019 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_CALL_HANDLING_REQ                        ((CsrBtHfPrim) (0x001A + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_AT_CMD_REQ                               ((CsrBtHfPrim) (0x001B + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))

#define CSR_BT_HF_SECURITY_IN_REQ                          ((CsrBtHfPrim) (0x001C + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_SECURITY_OUT_REQ                         ((CsrBtHfPrim) (0x001D + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_DEREGISTER_TIME_REQ                      ((CsrBtHfPrim) (0x001E + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_INDICATOR_ACTIVATION_REQ                 ((CsrBtHfPrim) (0x001F + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_UPDATE_SUPPORTED_CODEC_REQ               ((CsrBtHfPrim) (0x0020 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_SET_HF_INDICATOR_VALUE_REQ               ((CsrBtHfPrim) (0x0021 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_HF_UPDATE_QCE_CODEC_REQ                     ((CsrBtHfPrim) (0x0022 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))
#define HF_UPDATE_OPTIONAL_CODEC_REQ                       ((CsrBtHfPrim) (0x0023 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST))

#define CSR_BT_HF_PRIM_DOWNSTREAM_HIGHEST                              (0x0023 + CSR_BT_HF_PRIM_DOWNSTREAM_LOWEST)
...
#define CSR_BT_HF_CONFIG_AUDIO_CFM                         ((CsrBtHfPrim) (0x0002 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SERVICE_CONNECT_IND                      ((CsrBtHfPrim) (0x0003 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SERVICE_CONNECT_CFM                      ((CsrBtHfPrim) (0x0004 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_DISCONNECT_IND                           ((CsrBtHfPrim) (0x0005 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_DISCONNECT_CFM                           ((CsrBtHfPrim) (0x0006 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_AUDIO_CONNECT_IND                        ((CsrBtHfPrim) (0x0007 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_AUDIO_CONNECT_CFM                        ((CsrBtHfPrim) (0x0008 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_AUDIO_ACCEPT_CONNECT_IND                 ((CsrBtHfPrim) (0x0009 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_AUDIO_DISCONNECT_IND                     ((CsrBtHfPrim) (0x000A + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_AUDIO_DISCONNECT_CFM                     ((CsrBtHfPrim) (0x000B + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_STATUS_INDICATOR_UPDATE_IND              ((CsrBtHfPrim) (0x000C + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))

#define CSR_BT_HF_GET_ALL_STATUS_INDICATORS_CFM            ((CsrBtHfPrim) (0x000D + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_GET_CURRENT_OPERATOR_SELECTION_CFM       ((CsrBtHfPrim) (0x000E + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_GET_SUBSCRIBER_NUMBER_INFORMATION_IND    ((CsrBtHfPrim) (0x000F + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_GET_SUBSCRIBER_NUMBER_INFORMATION_CFM    ((CsrBtHfPrim) (0x0010 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_GET_CURRENT_CALL_LIST_IND                ((CsrBtHfPrim) (0x0011 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_GET_CURRENT_CALL_LIST_CFM                ((CsrBtHfPrim) (0x0012 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SET_EXTENDED_AG_ERROR_RESULT_CODE_CFM    ((CsrBtHfPrim) (0x0013 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SET_CALL_NOTIFICATION_INDICATION_CFM     ((CsrBtHfPrim) (0x0014 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SET_CALL_WAITING_NOTIFICATION_CFM        ((CsrBtHfPrim) (0x0015 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SET_STATUS_INDICATOR_UPDATE_CFM          ((CsrBtHfPrim) (0x0016 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SET_ECHO_AND_NOISE_CFM                   ((CsrBtHfPrim) (0x0017 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SET_VOICE_RECOGNITION_CFM                ((CsrBtHfPrim) (0x0018 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SET_VOICE_RECOGNITION_IND                ((CsrBtHfPrim) (0x0019 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_BT_INPUT_CFM                             ((CsrBtHfPrim) (0x001A + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_INBAND_RING_SETTING_CHANGED_IND          ((CsrBtHfPrim) (0x001B + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_GENERATE_DTMF_CFM                        ((CsrBtHfPrim) (0x001C + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SPEAKER_GAIN_STATUS_CFM                  ((CsrBtHfPrim) (0x001D + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SPEAKER_GAIN_IND                         ((CsrBtHfPrim) (0x001E + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_MIC_GAIN_STATUS_CFM                      ((CsrBtHfPrim) (0x001F + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_MIC_GAIN_IND                             ((CsrBtHfPrim) (0x0020 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))

#define CSR_BT_HF_DIAL_CFM                                 ((CsrBtHfPrim) (0x0021 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_CALL_ANSWER_CFM                          ((CsrBtHfPrim) (0x0022 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_CALL_END_CFM                             ((CsrBtHfPrim) (0x0023 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_CALL_HANDLING_IND                        ((CsrBtHfPrim) (0x0024 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_CALL_HANDLING_CFM                        ((CsrBtHfPrim) (0x0025 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_AT_CMD_IND                               ((CsrBtHfPrim) (0x0026 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_AT_CMD_CFM                               ((CsrBtHfPrim) (0x0027+ CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_CALL_RINGING_IND                         ((CsrBtHfPrim) (0x0028 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_CALL_NOTIFICATION_IND                    ((CsrBtHfPrim) (0x0029 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_CALL_WAITING_NOTIFICATION_IND            ((CsrBtHfPrim) (0x002A + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))

#define CSR_BT_HF_SECURITY_IN_CFM                          ((CsrBtHfPrim) (0x002B + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SECURITY_OUT_CFM                         ((CsrBtHfPrim) (0x002C + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_DEREGISTER_TIME_CFM                      ((CsrBtHfPrim) (0x002D + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_INDICATOR_ACTIVATION_CFM                 ((CsrBtHfPrim) (0x002E + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_UPDATE_SUPPORTED_CODEC_CFM               ((CsrBtHfPrim) (0x002F + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SELECTED_CODEC_IND                       ((CsrBtHfPrim) (0x0030 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_SET_HF_INDICATOR_VALUE_CFM               ((CsrBtHfPrim) (0x0031 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_HF_HF_INDICATOR_STATUS_IND                  ((CsrBtHfPrim) (0x0032 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))
#define HF_UPDATE_OPTIONAL_CODEC_CFM                       ((CsrBtHfPrim) (0x0033 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST))

#define CSR_BT_HF_PRIM_UPSTREAM_HIGHEST                                (0x0033 + CSR_BT_HF_PRIM_UPSTREAM_LOWEST)
...
typedef struct
{
    ...
    CsrUint16                   qceCodecId;                     /* ID of QCE codec if selected otherwise unsupported */
    CsrBtResultCode             resultCode;
    CsrBtSupplier               resultSupplier;
...
typedef struct
{
    CsrBtHfPrim                 type;                           /* Primitive/message identity */
    CsrBtHfConnectionId         connectionId;                   /* Connection indentifier */
    CsrUint8                    value;                          /* Enable/disable VR in AG & also used to perform Enhanced VR operations */
...
/* Voice recognition indication from AG (+BVRA:) */
typedef struct
{
    CsrBtHfPrim                 type;                           /* Primitive/message identity */
    CsrBtHfConnectionId         connectionId;                   /* Connection indentifier */
    CsrBool                     started;                        /* Whether VR feature in AG is started/stoped */
    CsrBtHfpVreState            vreState;                       /* State of AG's VRE - this is represented as bitmask */
    CsrCharString               *textId;                        /* Pointer to unique identifier of the text; valid for current VR session */
    CsrBtHfpVrTxtType           textType;                       /* Type of the text specifiying how to interpret provided text */
    CsrBtHfpVrTxtOp             textOperation;                  /* Operation that HF needs to perform on the stored text for the given Text ID */
    CsrCharString               *string;                        /* Pointer to the text string(in UTF-8 format within duble-quotes); text converted from voice response by AG */
...
{
    CsrBtHfPrim                 type;                           /* primitive/message identity */
    CsrUint8                    codecMask;                      /* Codec to add or remove: see mask definitions in csr_bt_hf.h */
...
{
    CsrBtHfPrim                 type;                           /* primitive/message identity */
    HfCodecId                   *codecIdList;                   /* Pointer to list of optional codecs supported by the device */
    CsrUint8                    codecCount;                     /* Number of optional codecs in '_codecIdList' list. */
}HfUpdateOptionalCodecReq;
...
{
    CsrBtHfPrim                 type;                           /* primitive/message identity */
    CsrBtHfQceCodecMask         codecMask;                      /* Qualcomm Codec Extension Mask to be enabled/disabled, See csr_bt_hf.h */
    CsrBool                     enable;
} CsrBtHfUpdateQceSupportReq;
