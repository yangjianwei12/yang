...
/*!
    @brief Status code returned following a GattDeviceInfoServerInit().
*/
typedef enum
{
        /*! Indicates that the GATT device info server initialisation has completed successfully */
    gatt_device_info_server_init_success,
        /*! Indicates that the GATT device info server initialisation has failed */
    gatt_device_info_server_init_failed,
} gatt_device_info_server_init_status_t;
...
*/
bool GattDeviceInfoServerInit(AppTask appTask,
