...
#define HIDD_CONNECT_REQ                       ((CsrBtHiddPrim) (0x0008 + CSR_BT_HIDD_PRIM_DOWNSTREAM_LOWEST))
#define HIDD_DISCONNECT_REQ                    ((CsrBtHiddPrim) (0x0009 + CSR_BT_HIDD_PRIM_DOWNSTREAM_LOWEST))

#define CSR_BT_HIDD_PRIM_DOWNSTREAM_HIGHEST                    (0x0009 + CSR_BT_HIDD_PRIM_DOWNSTREAM_LOWEST)
...
/* Deprecated definition, shall be removed in next major release.*/
/* Please use API CmSetEventMaskReqSend or CsrBtCmSetEventMaskReqSend with eventMask CSR_BT_CM_EVENT_MASK_SUBSCRIBE_MODE_CHANGE
 * to subscribe to CSR_BT_CM_MODE_CHANGE_IND events.*/
...
typedef struct
{
    CsrBtHiddPrim            type;  /* Identity: HIDD_CONNECT_REQ */
} HiddConnectReq;

typedef struct
{
    CsrBtHiddPrim            type;  /* Identity: HIDD_DISCONNECT_REQ */
} HiddDisconnectReq;
