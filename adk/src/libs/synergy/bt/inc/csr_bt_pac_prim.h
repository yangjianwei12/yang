...
#define PAC_REGISTER_QID_REQ               ((CsrBtPacPrim) (0x000F + CSR_BT_PAC_PRIM_DOWNSTREAM_LOWEST))
#define PAC_GET_INSTANCE_IDS_REQ           ((CsrBtPacPrim) (0x0010 + CSR_BT_PAC_PRIM_DOWNSTREAM_LOWEST))

#define CSR_BT_PAC_PRIM_DOWNSTREAM_HIGHEST (0x0010 + CSR_BT_PAC_PRIM_DOWNSTREAM_LOWEST)
...
#define PAC_GET_INSTANCE_IDS_CFM           ((CsrBtPacPrim) (0x000E + CSR_BT_PAC_PRIM_UPSTREAM_LOWEST))

#define CSR_BT_PAC_PRIM_UPSTREAM_HIGHEST                   (0x000E + CSR_BT_PAC_PRIM_UPSTREAM_LOWEST)
...
/************************************ PAC Internal Qid registration ****************************/
typedef struct
{
    CsrBtPacPrim            type;           /* primitive type */
    CsrSchedQid             pacInstanceId;  /* PAC instance ID to register */
} PacRegisterQidReq;
...
} PacGetInstanceIdsReq;

typedef struct
{
    CsrBtPacPrim            type;           /* primitive type */
    CsrUint8                instanceCount;  /* number of items in instanceIdsList */
    CsrSchedQid            *instanceIdsList;/* list of instances  */
} PacGetInstanceIdsCfm;
...
typedef struct
{
    ...
    CsrSchedQid             instanceId;             /* PAC instance which generated this event */
} CsrBtPacConnectCfm;
