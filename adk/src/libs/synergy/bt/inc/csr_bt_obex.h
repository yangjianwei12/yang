...
#define CSR_BT_MAP_SF_MESSAGE_FORWARDING                      ((CsrBtMapSupportedFeatures) 0x00400000)

#define CSR_BT_MAP_SUPPORTED_FEATURE_ALL                            ((CsrBtMapSupportedFeatures) 0x007FFFFF)
...
typedef CsrUint8 CsrBtMapModifyText;
#define CSR_BT_MAP_MODIFY_TEXT_PREPEND                              ((CsrBtMapModifyText) 0x00)
#define CSR_BT_MAP_MODIFY_TEXT_REPLACE                              ((CsrBtMapModifyText) 0x01)
...
#define CSR_BT_MAP_TAG_ID_MESSAGE_HANDLE                            ((CsrBtMapTagId) 0x2A)
#define CSR_BT_MAP_TAG_ID_MODIFY_TEXT                               ((CsrBtMapTagId) 0x2B)
...
#define CSR_BT_MAP_TAG_ID_LENGTH_MESSAGE_HANDLE                     ((CsrBtMapTagIdLength) 0x00) /* variable */
#define CSR_BT_MAP_TAG_ID_LENGTH_MODIFY_TEXT                        ((CsrBtMapTagIdLength) 0x01)
