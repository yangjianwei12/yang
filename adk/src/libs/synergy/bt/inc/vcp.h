...
#define VCP_CLIENT_PRIM    (SYNERGY_EVENT_BASE + VCP_PRIM)
...
#define VCP_STATUS_SUCCESS              ((VcpStatus)0x0000u)  /*!> Request was a success*/
#define VCP_STATUS_IN_PROGRESS          ((VcpStatus)0x0001u)  /*!> Request in progress*/
#define VCP_STATUS_INVALID_PARAMETER    ((VcpStatus)0x0002u)  /*!> Invalid parameter was supplied*/
#define VCP_STATUS_DISCOVERY_ERR        ((VcpStatus)0x0003u)  /*!> Error in discovery of one of the services*/
#define VCP_STATUS_FAILED               ((VcpStatus)0x0004u)  /*!> Request has failed*/
#define VCP_STATUS_VOL_PERSISTED        ((VcpStatus)0x0005u)  /*!> It was not possible to set an initial value of volume,
...
#define VCP_INIT_CFM                          ((VcpMessageId)VCP_MESSAGE_BASE)
#define VCP_DESTROY_CFM                       ((VcpMessageId)VCP_MESSAGE_BASE + 0x0001u)
#define VCP_VCS_TERMINATE_CFM                 ((VcpMessageId)VCP_MESSAGE_BASE + 0x0002u)
#define VCP_VOCS_TERMINATE_CFM                ((VcpMessageId)VCP_MESSAGE_BASE + 0x0003u)
#define VCP_AICS_TERMINATE_CFM                ((VcpMessageId)VCP_MESSAGE_BASE + 0x0004u)
#define VCP_VOLUME_STATE_SET_NTF_CFM          ((VcpMessageId)VCP_MESSAGE_BASE + 0x0005u)
#define VCP_VOLUME_FLAG_SET_NTF_CFM           ((VcpMessageId)VCP_MESSAGE_BASE + 0x0006u)
#define VCP_READ_VOLUME_STATE_CCC_CFM         ((VcpMessageId)VCP_MESSAGE_BASE + 0x0007u)
#define VCP_READ_VOLUME_FLAG_CCC_CFM          ((VcpMessageId)VCP_MESSAGE_BASE + 0x0008u)
#define VCP_VOLUME_STATE_IND                  ((VcpMessageId)VCP_MESSAGE_BASE + 0x0009u)
#define VCP_VOLUME_FLAG_IND                   ((VcpMessageId)VCP_MESSAGE_BASE + 0x000Au)
#define VCP_READ_VOLUME_STATE_CFM             ((VcpMessageId)VCP_MESSAGE_BASE + 0x000Bu)
#define VCP_READ_VOLUME_FLAG_CFM              ((VcpMessageId)VCP_MESSAGE_BASE + 0x000Cu)
#define VCP_REL_VOL_DOWN_CFM                  ((VcpMessageId)VCP_MESSAGE_BASE + 0x000Du)
#define VCP_REL_VOL_UP_CFM                    ((VcpMessageId)VCP_MESSAGE_BASE + 0x000Eu)
#define VCP_UNMUTE_REL_VOL_DOWN_CFM           ((VcpMessageId)VCP_MESSAGE_BASE + 0x000Fu)
#define VCP_UNMUTE_REL_VOL_UP_CFM             ((VcpMessageId)VCP_MESSAGE_BASE + 0x0010u)
#define VCP_ABS_VOL_CFM                       ((VcpMessageId)VCP_MESSAGE_BASE + 0x0011u)
#define VCP_UNMUTE_CFM                        ((VcpMessageId)VCP_MESSAGE_BASE + 0x0012u)
#define VCP_MUTE_CFM                          ((VcpMessageId)VCP_MESSAGE_BASE + 0x0013u)
#define VCP_OFFSET_STATE_SET_NTF_CFM          ((VcpMessageId)VCP_MESSAGE_BASE + 0x0014u)
#define VCP_AUDIO_LOCATION_SET_NTF_CFM        ((VcpMessageId)VCP_MESSAGE_BASE + 0x0015u)
#define VCP_AUDIO_OUTPUT_DESC_SET_NTF_CFM     ((VcpMessageId)VCP_MESSAGE_BASE + 0x0016u)
#define VCP_READ_OFFSET_STATE_CCC_CFM         ((VcpMessageId)VCP_MESSAGE_BASE + 0x0017u)
#define VCP_READ_AUDIO_LOCATION_CCC_CFM       ((VcpMessageId)VCP_MESSAGE_BASE + 0x0018u)
#define VCP_READ_AUDIO_OUTPUT_DESC_CCC_CFM    ((VcpMessageId)VCP_MESSAGE_BASE + 0x0019u)
#define VCP_READ_OFFSET_STATE_CFM             ((VcpMessageId)VCP_MESSAGE_BASE + 0x001Au)
#define VCP_READ_AUDIO_LOCATION_CFM           ((VcpMessageId)VCP_MESSAGE_BASE + 0x001Bu)
#define VCP_READ_AUDIO_OUTPUT_DESC_CFM        ((VcpMessageId)VCP_MESSAGE_BASE + 0x001Cu)
#define VCP_SET_VOLUME_OFFSET_CFM             ((VcpMessageId)VCP_MESSAGE_BASE + 0x001Du)
#define VCP_SET_AUDIO_LOCATION_CFM            ((VcpMessageId)VCP_MESSAGE_BASE + 0x001Eu)
#define VCP_SET_AUDIO_OUTPUT_DESC_CFM         ((VcpMessageId)VCP_MESSAGE_BASE + 0x001Fu)
#define VCP_OFFSET_STATE_IND                  ((VcpMessageId)VCP_MESSAGE_BASE + 0x0020u)
#define VCP_AUDIO_LOCATION_IND                ((VcpMessageId)VCP_MESSAGE_BASE + 0x0021u)
#define VCP_AUDIO_OUTPUT_DESC_IND             ((VcpMessageId)VCP_MESSAGE_BASE + 0x0022u)
#define VCP_INPUT_STATE_SET_NTF_CFM           ((VcpMessageId)VCP_MESSAGE_BASE + 0x0023u)
#define VCP_INPUT_STATUS_SET_NTF_CFM          ((VcpMessageId)VCP_MESSAGE_BASE + 0x0024u)
#define VCP_AUDIO_INPUT_DESC_SET_NTF_CFM      ((VcpMessageId)VCP_MESSAGE_BASE + 0x0025u)
#define VCP_READ_INPUT_STATE_CCC_CFM          ((VcpMessageId)VCP_MESSAGE_BASE + 0x0026u)
#define VCP_READ_INPUT_STATUS_CCC_CFM         ((VcpMessageId)VCP_MESSAGE_BASE + 0x0027u)
#define VCP_READ_AUDIO_INPUT_DESC_CCC_CFM     ((VcpMessageId)VCP_MESSAGE_BASE + 0x0028u)
#define VCP_READ_INPUT_STATE_CFM              ((VcpMessageId)VCP_MESSAGE_BASE + 0x0029u)
#define VCP_READ_GAIN_SET_PROPERTIES_CFM      ((VcpMessageId)VCP_MESSAGE_BASE + 0x002Au)
#define VCP_READ_INPUT_TYPE_CFM               ((VcpMessageId)VCP_MESSAGE_BASE + 0x002Bu)
#define VCP_READ_INPUT_STATUS_CFM             ((VcpMessageId)VCP_MESSAGE_BASE + 0x002Cu)
#define VCP_READ_AUDIO_INPUT_DESC_CFM         ((VcpMessageId)VCP_MESSAGE_BASE + 0x002Du)
#define VCP_SET_GAIN_SETTING_CFM              ((VcpMessageId)VCP_MESSAGE_BASE + 0x002Eu)
#define VCP_AICS_UNMUTE_CFM                   ((VcpMessageId)VCP_MESSAGE_BASE + 0x002Fu)
#define VCP_AICS_MUTE_CFM                     ((VcpMessageId)VCP_MESSAGE_BASE + 0x0030u)
#define VCP_AICS_SET_MANUAL_GAIN_MODE_CFM     ((VcpMessageId)VCP_MESSAGE_BASE + 0x0031u)
#define VCP_AICS_SET_AUTOMATIC_GAIN_MODE_CFM  ((VcpMessageId)VCP_MESSAGE_BASE + 0x0032u)
#define VCP_SET_AUDIO_INPUT_DESC_CFM          ((VcpMessageId)VCP_MESSAGE_BASE + 0x0033u)
#define VCP_INPUT_STATE_IND                   ((VcpMessageId)VCP_MESSAGE_BASE + 0x0034u)
#define VCP_INPUT_STATUS_IND                  ((VcpMessageId)VCP_MESSAGE_BASE + 0x0035u)
#define VCP_AUDIO_INPUT_DESC_IND              ((VcpMessageId)VCP_MESSAGE_BASE + 0x0036u)
#define VCP_SET_INITIAL_VOL_CFM               ((VcpMessageId)VCP_MESSAGE_BASE + 0x0037u)
#define VCP_MESSAGE_TOP                       ((VcpMessageId)VCP_MESSAGE_BASE + 0x0038u)
...
/*!
    ...
    @param profileHhandle       The Profile handle.
    @param aicsClntHndl       Service handle of the AICS instance to which apply the operation.
...
/*!
    ...
    @param profileHandle       The Profile handle.
    @param aicsClnHndl       Service handle of the AICS instance to which apply the operation.
...
#endif
/*!
    @brief This API is used to retrieve the volume control point characteristic and descriptor handles stored
           by the profile library during discovery procedure.

    @param clntHndl      The service handle for this GATT Client Service.

    @return GattVcsClientDeviceData : The structure containing characteristic and descriptor handles info.
