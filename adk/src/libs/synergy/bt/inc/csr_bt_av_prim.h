...
/* Error Codes 0xDE-0xDF is RFU as per specification */
#define CSR_BT_RESULT_CODE_A2DP_INVALID_CP_TYPE               ((CsrBtAvResult) 0xE0) /* Requested Content Protection Type not supported */
#define CSR_BT_RESULT_CODE_A2DP_INVALID_CP_FORMAT             ((CsrBtAvResult) 0xE1) /* Format of Content Protection Service Capability or Content Potection Scheme Dependent Data is not correct */
#define RESULT_CODE_A2DP_INVALID_CODEC_PARAMETER              ((CsrBtAvResult) 0xE2) 
#define RESULT_CODE_A2DP_NOT_SUPPORTED_CODEC_PARAMETER        ((CsrBtAvResult) 0xE3) 
#define RESULT_CODE_A2DP_INVALID_DRC                          ((CsrBtAvResult) 0xE4) /* Combination of Object type and DRC is invalid */
#define RESULT_CODE_A2DP_NOT_SUPPORTED_DRC                    ((CsrBtAvResult) 0xE5) /* DRC is not supported, used for MPEG-2,4 AAC codec only */
...
#define CSR_BT_RESULT_CODE_AV_ALREADY_CONNECTED      ((CsrBtResultCode) (0x800C))
...
#define CSR_BT_AV_DELAY_REPORT_REQ                      ((CsrBtAvPrim) (0x0020 + CSR_BT_AV_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_AV_GET_ALL_CAPABILITIES_RES              ((CsrBtAvPrim) (0x0021 + CSR_BT_AV_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_AV_GET_CHANNEL_INFO_REQ                  ((CsrBtAvPrim) (0x0022 + CSR_BT_AV_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_AV_GET_STREAM_CHANNEL_INFO_REQ           ((CsrBtAvPrim) (0x0023 + CSR_BT_AV_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_AV_DELAY_REPORT_RES                      ((CsrBtAvPrim) (0x0024 + CSR_BT_AV_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_AV_SET_STREAM_INFO_REQ                   ((CsrBtAvPrim) (0x0025 + CSR_BT_AV_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_AV_GET_MEDIA_CHANNEL_INFO_REQ            ((CsrBtAvPrim) (0x0026 + CSR_BT_AV_PRIM_DOWNSTREAM_LOWEST))
...
#define CSR_BT_AV_GET_MEDIA_CHANNEL_INFO_CFM            ((CsrBtAvPrim) (0x0026 + CSR_BT_AV_PRIM_UPSTREAM_LOWEST))

#define CSR_BT_AV_PRIM_UPSTREAM_HIGHEST                      (0x0026 + CSR_BT_AV_PRIM_UPSTREAM_LOWEST)
...
#define CSR_BT_AV_LP_SUPERVISION_TIMER          ((CsrBtAvPrim) (0x0027 + CSR_BT_AV_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_AV_HOUSE_CLEANING                ((CsrBtAvPrim) (0x0028 + CSR_BT_AV_PRIM_UPSTREAM_LOWEST))
/*******************************************************************************
