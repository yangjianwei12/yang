...
/******************************************************************************
 Copyright (c) 2005-2023 Qualcomm Technologies International, Ltd.
 All Rights Reserved.
...
#define CSR_BT_HF_SUPPORT_ENHANCE_VOICE_RECOG_STATUS             ((CsrBtHfSupportedFeatures) 0x00000400)
#define CSR_BT_HF_SUPPORT_VOICE_RECOG_TEXT                       ((CsrBtHfSupportedFeatures) 0x00000800)
...
#define CSR_BT_HFG_SUPPORT_ENHANCE_VOICE_RECOG_STATUS            ((CsrBtHfgSupportedFeatures) 0x00001000)
#define CSR_BT_HFG_SUPPORT_VOICE_RECOG_TEXT                      ((CsrBtHfgSupportedFeatures) 0x00002000)
...
/* Enhanced voice recognition status bit in the SDP database */
#define CSR_BT_HFP_SDP_ENHANCED_VOICE_RECOG_STATUS               (0x40)

/* Voice recognition text bit in the SDP database */
#define CSR_BT_HFP_SDP_VOICE_RECOG_TEXT                          (0x80)

/* Super Wideband Speech bit in the SDP database */
#define CSR_BT_HFP_SDP_SWBS                                      (0x100)
...
/* defines related to GATHERED_CALL_INDICATORS */
...
typedef CsrUint8 HfCodecId;

/* defines for WBS and SWB */
...
#define CSR_BT_WBS_LC3SWB_CODEC                                  ((CsrUint8) 0x03)

#define CSR_BT_WBS_CVSD_CODEC_MASK                               ((CsrUint8) 0x01)
#define CSR_BT_WBS_MSBC_CODEC_MASK                               ((CsrUint8) 0x02)
#define CSR_BT_WBS_LC3SWB_CODEC_MASK                             ((CsrUint8) 0x04)
...
#if defined(CSR_BT_HF_ENABLE_SWB_SUPPORT) || defined(CSR_BT_HFG_ENABLE_SWB_SUPPORT)
/* QCE feature tokens */
#define CSR_BT_QAC_TOKEN                                         (105)
#define CSR_BT_QCS_TOKEN                                         (106)
...
typedef CsrUint8 CsrBtHfpHfIndicatorId;
...
/* Definition of HF Voice Recognition (BVRA) values */
typedef CsrUint8 CsrBtHfpVrStatus;
#define CSR_BT_HFP_VR_DISABLE                    ((CsrBtHfpVrStatus) 0x00)
#define CSR_BT_HFP_VR_ENABLE                     ((CsrBtHfpVrStatus) 0x01)
#define CSR_BT_HFP_VR_NEW_AUD_INPUT              ((CsrBtHfpVrStatus) 0x02)
#define CSR_BT_HFP_VR_READY_FOR_AUD              ((CsrBtHfpVrStatus) 0x02)

/* Definition of HF Voice Recognition Engine States of AG */
typedef CsrUint8 CsrBtHfpVreState;
#define CSR_BT_HFP_VRE_READY_TO_ACCEPT_AUDIO     ((CsrBtHfpVreState) 0x01)
#define CSR_BT_HFP_VRE_AUDIO_SENDING             ((CsrBtHfpVreState) 0x02)
#define CSR_BT_HFP_VRE_AUDIO_PROCESSING          ((CsrBtHfpVreState) 0x04)

/* Definition of HF Voice Recognition Text Type */
typedef CsrUint8 CsrBtHfpVrTxtType;
#define CSR_BT_HFP_VR_RECOGNIZED_TEXT            ((CsrBtHfpVrTxtType) 0x00)
#define CSR_BT_HFP_VR_OUTPUT_TEXT                ((CsrBtHfpVrTxtType) 0x01)
#define CSR_BT_HFP_VR_OUTPUT_TEXT_QUESTION       ((CsrBtHfpVrTxtType) 0x02)
#define CSR_BT_HFP_VR_OUTPUT_TEXT_ERROR          ((CsrBtHfpVrTxtType) 0x03)

/* Definition of HF Voice Recognition Text Operation */
typedef CsrUint8 CsrBtHfpVrTxtOp;
#define CSR_BT_HFP_VR_NEW_TEXT_OP                ((CsrBtHfpVrTxtOp) 0x01)
#define CSR_BT_HFP_VR_REPLACE_TEXT_OP            ((CsrBtHfpVrTxtOp) 0x02)
#define CSR_BT_HFP_VR_APPEND_TEXT_OP             ((CsrBtHfpVrTxtOp) 0x03)

#ifdef CSR_BT_HF_ENABLE_SWB_SUPPORT
/* Definition of HF QCE codec type */
typedef CsrUint8 CsrBtHfQceCodecType;
#define CSR_BT_HF_QCE_CODEC_TYPE_64_2_EV3        ((CsrBtHfQceCodecType) 0x00)
#define CSR_BT_HF_QCE_CODEC_TYPE_64_2_EV3_QHS3   ((CsrBtHfQceCodecType) 0x04)
#define CSR_BT_HF_QCE_CODEC_TYPE_128_QHS3        ((CsrBtHfQceCodecType) 0x06)
#define CSR_BT_HF_QCE_CODEC_TYPE_64_QHS3         ((CsrBtHfQceCodecType) 0x07)

/* Definition of HF QCE codec masks */
typedef CsrUint16 CsrBtHfQceCodecMask;
#define CSR_BT_HF_QCE_CODEC_MASK_64_2_EV3        ((CsrBtHfQceCodecMask) (1 << CSR_BT_HF_QCE_CODEC_TYPE_64_2_EV3))
#define CSR_BT_HF_QCE_CODEC_MASK_64_2_EV3_QHS3   ((CsrBtHfQceCodecMask) (1 << CSR_BT_HF_QCE_CODEC_TYPE_64_2_EV3_QHS3))
#define CSR_BT_HF_QCE_CODEC_MASK_128_QHS3        ((CsrBtHfQceCodecMask) (1 << CSR_BT_HF_QCE_CODEC_TYPE_128_QHS3))
#define CSR_BT_HF_QCE_CODEC_MASK_64_QHS3         ((CsrBtHfQceCodecMask) (1 << CSR_BT_HF_QCE_CODEC_TYPE_64_QHS3))
#endif /* CSR_BT_HF_ENABLE_SWB_SUPPORT */
