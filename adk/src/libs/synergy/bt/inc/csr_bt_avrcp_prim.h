...
#define CSR_BT_RESULT_CODE_AVRCP_INVALID_SDP_RECORD         ((CsrBtResultCode) (0x800f))
/*@}*/
...
/***** AVC define for invalid transaction label *****/
#define CSR_BT_AVRCP_TLABEL_INVALID                    (0xFF)
...
/* Do not initiate Browsing connection just after outgoing Control channel is established */
#define AVRCP_CONFIG_ROLE_NO_BROWSING_AFTER_CONTROL ((CsrBtAvrcpConfigRoleMask)(0x00000002))
...
typedef struct
{
    ...
    CsrBtAvrcpPTState           state;              /**< The state requested by the controller (\ref avrcp_pt_states) */
...
#define CSR_BT_AVRCP_PLAYBACK_POS_INVALID                      ((CsrBtAvrcpPlaybackPos)0xFFFFFFFFU)
/*@}*/
...
/** \defgroup avrcp_pas_interface avrcp_pas_interface
    \ingroup avrcp_pas
...
#define CSR_BT_AVRCP_FEATURE_MASK_0_LEFT_UP            (0x80000000U)
...
#define CSR_BT_AVRCP_FEATURE_MASK_1_MUTE               (0x80000000U)
...
typedef struct
{
    ...
    CsrBtResultCode             resultCode;
    CsrBtSupplier               resultSupplier;
    CsrBtAvrcpCharSet           charsetId;          /**< Character Set Id */
...
#define CSR_BT_AVRCP_ITEM_ATT_INVALID              ((CsrBtAvrcpItemMediaAttributeId)0xFFFFFFFFu)
...
#define CSR_BT_AVRCP_ITEM_ATT_MASK_NONE            ((CsrBtAvrcpItemAttMask)0xFFFFFFFFu)
...
typedef struct
{
    ...
    CsrUint8                     volume;
    CsrUint32                    msgId;              /**< \msgId */
    CsrUint8                    tLabel;             /**< Transaction label */
