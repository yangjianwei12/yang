...
#define CSR_BT_SPP_EXTENDED_ACTIVATE_REQ         ((CsrBtSppPrim) (0x0010 + CSR_BT_SPP_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_SPP_REGISTER_DATA_PATH_HANDLE_REQ ((CsrBtSppPrim) (0x0011 + CSR_BT_SPP_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_SPP_DATA_PATH_STATUS_REQ          ((CsrBtSppPrim) (0x0012 + CSR_BT_SPP_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_SPP_GET_INSTANCES_QID_REQ         ((CsrBtSppPrim) (0x0013 + CSR_BT_SPP_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_SPP_REGISTER_QID_REQ              ((CsrBtSppPrim) (0x0014 + CSR_BT_SPP_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_SPP_AUDIO_ACCEPT_CONNECT_RES      ((CsrBtSppPrim) (0x0015 + CSR_BT_SPP_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_SPP_AUDIO_RENEGOTIATE_REQ         ((CsrBtSppPrim) (0x0016 + CSR_BT_SPP_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_SPP_CANCEL_CONNECT_REQ            ((CsrBtSppPrim) (0x0017 + CSR_BT_SPP_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_SPP_SECURITY_IN_REQ               ((CsrBtSppPrim) (0x0018 + CSR_BT_SPP_PRIM_DOWNSTREAM_LOWEST))
#define CSR_BT_SPP_SECURITY_OUT_REQ              ((CsrBtSppPrim) (0x0019 + CSR_BT_SPP_PRIM_DOWNSTREAM_LOWEST))

#define CSR_BT_SPP_PRIM_DOWNSTREAM_HIGHEST                    (0x0019 + CSR_BT_SPP_PRIM_DOWNSTREAM_LOWEST)
...
#define CSR_BT_SPP_STATUS_IND                    ((CsrBtSppPrim) (0x000E + CSR_BT_SPP_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_SPP_REGISTER_DATA_PATH_HANDLE_CFM ((CsrBtSppPrim) (0x000F + CSR_BT_SPP_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_SPP_DATA_PATH_STATUS_IND          ((CsrBtSppPrim) (0x0010 + CSR_BT_SPP_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_SPP_GET_INSTANCES_QID_CFM         ((CsrBtSppPrim) (0x0011 + CSR_BT_SPP_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_SPP_AUDIO_RENEGOTIATE_CFM         ((CsrBtSppPrim) (0x0012 + CSR_BT_SPP_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_SPP_AUDIO_RENEGOTIATE_IND         ((CsrBtSppPrim) (0x0013 + CSR_BT_SPP_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_SPP_AUDIO_ACCEPT_CONNECT_IND      ((CsrBtSppPrim) (0x0014 + CSR_BT_SPP_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_SPP_SECURITY_IN_CFM               ((CsrBtSppPrim) (0x0015 + CSR_BT_SPP_PRIM_UPSTREAM_LOWEST))
#define CSR_BT_SPP_SECURITY_OUT_CFM              ((CsrBtSppPrim) (0x0016 + CSR_BT_SPP_PRIM_UPSTREAM_LOWEST))

#define CSR_BT_SPP_PRIM_UPSTREAM_HIGHEST                      (0x0016 + CSR_BT_SPP_PRIM_UPSTREAM_LOWEST)
...
typedef struct
{
    ...
    CsrBtConnId             btConnId;                             /* Unique identifier for the connection established */
} CsrBtSppConnectInd;
