...
#define CSR_LOG_LEVEL_TASK_TEXT_LOC            ((CsrLogLevelTask) 0x00000002) /* The location where the text string call occurred are logged. NB: This is a supplement to CSR_LOG_LEVEL_TASK_TEXT, it has no effect without it */
...
#define CSR_LOG_LEVEL_TASK_TASK_SWITCH         ((CsrLogLevelTask) 0x00000020) /* Activation and deactivation of a task are logged */
...
typedef CsrUint16 CsrLogSource;

#define CSR_LOG_SOURCE_SCHEDULER                         ((CsrLogSource) 0x0001)
#define CSR_LOG_SOURCE_MODULE                            ((CsrLogSource) 0x0002)

typedef CsrUint16 CsrLogCategory;

#define CSR_LOG_CATEGORY_TASK                            ((CsrLogCategory) 0x0001)
#define CSR_LOG_CATEGORY_ENVIRONMENT                     ((CsrLogCategory) 0x0002)
#define CSR_LOG_CATEGORY_HCI                             ((CsrLogCategory) 0x0003)

typedef CsrUint32 CsrLogSubCategory;
...
typedef CsrBool (*CsrLogCallbackFunctionPointer)(CsrLogSource source, CsrLogCategory category, CsrLogSubCategory sub_category,
                                                 CsrUint16 prim_type, const void *msg);

void CsrLogRegisterCallback(CsrLogCallbackFunctionPointer cb);
