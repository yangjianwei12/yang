...
static Source getAnyAncMicSourceForInstance(audio_anc_instance instance)
{
    ...
    if((ancDataGetTopology()==anc_parallel_filter_topology) || (ancDataGetTopology()==anc_dual_filter_topology))
    {
...
void setRxMixGains(anc_filter_topology_t topology)
{
    ...
    else if((topology == anc_parallel_filter_topology) || (topology == anc_dual_filter_topology))
    {
