...
/*!
    @brief Set the ANC filter path Coarse gains. If the ANC functionality is enabled then
           the ANC filter path Coarse gains will be applied immediately otherwise it will be ignored.
           This function shall be used along with AncEnableWithMutePathGains() to supress pops/clicks in ANC path.

    @return TRUE indicating the ANC filter path Coarse gain was successfully changed
            otherwise FALSE.
*/
