...
static void configureMicGain(anc_path_enable mic_path)
{
    ...
    if(mic_params->type == mic_type_analog)
    {
...
/******************************************************************************/
static void ancConfigurePathGains(bool enable_coarse_gains, bool enable_fine_gains)
{
    if (enable_coarse_gains && enable_fine_gains)
    {
...
bool ancConfigureAfterModeChange(bool update_filter_coefficients, bool enable_coarse_gains, bool enable_fine_gains)
{
    ...
    ancConfigurePathGains(enable_coarse_gains, enable_fine_gains);
