...
#define GATT_BASS_SERVER_NOT_ENCRYPTED            (0x00u) /*!> Not encrypted*/
#define GATT_BASS_SERVER_BROADCAST_CODE_REQUIRED  (0x01u) /*!> Broadcast_Code required*/
#define GATT_BASS_SERVER_DECRYPTING               (0x02u) /*!> Decrypting */
#define GATT_BASS_BAD_CODE                        (0x03u) /*!> Incorrect encryption key */
#define GATT_BASS_BIG_ENCRYPTION_LAST             (0x04u)
/*! } */
...
#define GATT_BASS_SERVER_NOT_SYNCHRONIZED         (0x00u)  /*!> Not synchronized to PA*/
#define GATT_BASS_SERVER_SYNC_INFO_REQUEST        (0x01u)  /*!> SyncInfo Request*/
#define GATT_BASS_SERVER_SYNCHRONIZED             (0x02u)  /*!> Synchronized to PA*/
#define GATT_BASS_SERVER_FAILED_TO_SYNCHRONIZE    (0x03u)  /*!> Failed to synchronize to PA*/
#define GATT_BASS_SERVER_NO_PAST                  (0x04u)  /*!> No PAST*/
#define GATT_BASS_SERVER_PA_SYNC_STATE_LAST       (0x05u)
/*! } */
...
#define GATT_BASS_SERVER_STATUS_SUCCESS              (0x0000u)  /*!> Request was a success*/
#define GATT_BASS_SERVER_STATUS_REGISTRATION_FAILED  (0x0001u)  /*!> Server failed to register
                                                                     with GATT Manager.*/
#define GATT_BASS_SERVER_STATUS_INVALID_PARAMETER    (0x0002u)  /*!> Invalid parameter was supplied*/
#define GATT_BASS_SERVER_STATUS_NOT_ALLOWED          (0x0003u)  /*!> Request is not allowed*/
#define GATT_BASS_SERVER_STATUS_FAILED               (0x0004u)  /*!> Request has failed*/
#define GATT_BASS_SERVER_STATUS_BC_SOURCE_IN_SYNC    (0x0005u)  /*!> Request has failed, because the
                                                                     selected Broadcast Source is in sync
                                                                     with the PA and/or BIS/BIG*/
#define GATT_BASS_SERVER_STATUS_INVALID_SOURCE_ID    (0x0006u)  /*!> Request has failed, because an invalid
                                                                     source id was supplied*/
#define GATT_BASS_SERVER_STATUS_NO_EMPTY_BRS         (0x0007u)  /*!> Request has failed, because no source id
...
/*!
    \brief IDs of messages an application task can receive from the
           GATT BASS Server library.
*/
typedef uint16 GattBassServerMessageId;

/*! { */
/*! Values for GattBassServerMessageId */
#define GATT_BASS_SERVER_BROADCAST_CODE_IND  (GATT_BASS_SERVER_MESSAGE_BASE)
#define GATT_BASS_SERVER_SCANNING_STATE_IND  (GATT_BASS_SERVER_MESSAGE_BASE + 0x0001u)
#define GATT_BASS_SERVER_ADD_SOURCE_IND      (GATT_BASS_SERVER_MESSAGE_BASE + 0x0002u)
#define GATT_BASS_SERVER_REMOVE_SOURCE_IND   (GATT_BASS_SERVER_MESSAGE_BASE + 0x0003u)
#define GATT_BASS_SERVER_MODIFY_SOURCE_IND   (GATT_BASS_SERVER_MESSAGE_BASE + 0x0004u)
#define GATT_BASS_SERVER_MESSAGE_TOP         (GATT_BASS_SERVER_MESSAGE_BASE + 0x0005u)
/*! } */
