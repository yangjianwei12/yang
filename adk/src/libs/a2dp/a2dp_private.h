...
typedef enum
{
    ...
    avdtp_invalid_codec_type                    = (0xc1),   /*!< Media Codec Type is not valid. */
    avdtp_not_supported_codec_type              = (0xc2),   /*!< Media Codec Type is not supported. */
    avdtp_invalid_sampling_frequency            = (0xc3),   /*!< Sampling Frequency is not valid or multiple values have been selected. */
    avdtp_not_supported_sampling_frequency      = (0xc4),   /*!< Sampling Frequency is not supported. */
    avdtp_invalid_channel_mode                  = (0xc5),   /*!< Channel Mode is not valid or multiple values have been selected. */
    avdtp_not_supported_channel_mode            = (0xc6),   /*!< Channel Mode is not supported. */
    avdtp_invalid_subbands                      = (0xc7),   /*!< None or multiple values have been selected for Number of Subbands. */
    avdtp_not_supported_subbands                = (0xc8),   /*!< Number of Subbands is not supported. */
    avdtp_invalid_allocation_methods            = (0xc9),   /*!< None or multiple values have been selected for Allocation Method. */
    avdtp_not_supported_allocation_methods      = (0xca),   /*!< Allocation Method is not supported. */
    avdtp_invalid_minimum_bitpool_value         = (0xcb),   /*!< Minimum Bitpool Value is not valid. */
    avdtp_not_supported_minimum_bitpool_value   = (0xcc),   /*!< Minimum Bitpool Value is not supported. */
    avdtp_invalid_maximum_bitpool_value         = (0xcd),   /*!< Maximum Bitpool Value is not valid. */
    avdtp_not_supported_maximum_bitpool_value   = (0xce),   /*!< Maximum Bitpool Value is not supported. */
    avdtp_invalid_layer                         = (0xcf),   /*!< None or multiple values have been selected for Layer. */
    avdtp_not_supported_layer                   = (0xd0),   /*!< Layer is not supported. */
    avdtp_not_supported_crc                     = (0xd1),   /*!< CRC is not supported. */
    avdtp_not_supported_mpf                     = (0xd2),   /*!< MPF-2 is not supported. */
    avdtp_not_supported_vbr                     = (0xd3),   /*!< VBR is not supported. */
    avdtp_invalid_bit_rate                      = (0xd4),   /*!< None or multiple values have been selected for Bit Rate. */
    avdtp_not_supported_bit_rate                = (0xd5),   /*!< Bit Rate is not supported. */
    avdtp_invalid_object_type                   = (0xd6),   /*!< Either Object type is not valid None or multiple values have been selected for Object Type. */
    avdtp_not_supported_object_type             = (0xd7),   /*!< Object Type is not supported. */
    avdtp_invalid_channels                      = (0xd8),   /*!< None or multiple values have been selected for Channels. */
    avdtp_not_supported_channels                = (0xd9),   /*!< Channels is not supported. */
    avdtp_invalid_version                       = (0xda),   /*!< Version is not valid. */
    avdtp_not_supported_version                 = (0xdb),   /*!< Version is not supported. */
    avdtp_not_supported_maximum_sul             = (0xdc),   /*!< Maximum SUL is not acceptable for the Decoder in the SNK. */
    avdtp_invalid_block_length                  = (0xdd),   /*!< None or multiple values have been selected for Block Length. */
    avdtp_invalid_cp_type                       = (0xe0),   /*!< The requested CP Type is not supported. */
    avdtp_invalid_cp_format                     = (0xe1),   /*!< The format of Content Protection Service Capability/Content Protection Scheme Dependent Data is not correct. */
    avdtp_invalid_codec_parameter               = (0xe2),   /*!< The codec parameter is invalid. Used if a more specific error code does not exist for the codec in use. */
    avdtp_not_supported_codec_parameter         = (0xe3)    /*!< The codec parameter is not supported. Used if a more specific error code does not exist for the codec in use. */
    /* 0xe4 - 0xff RFU */
} avdtp_error_code;
