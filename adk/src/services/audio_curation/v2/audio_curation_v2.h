/*!
    ...
    \file       audio_curation_v2.h
    \defgroup   audio_curation_v2 Audio Curation V2
    @{
        \ingroup    audio_curation
...
#ifndef AUDIO_CURATION_V2_H_
#define AUDIO_CURATION_V2_H_
