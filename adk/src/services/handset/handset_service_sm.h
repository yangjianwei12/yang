...
typedef struct
{
    ...
    /*! Flag indicates the first BREDR profile has got connected.*/
    bool first_bredr_profile_connected;
...
/*! \brief Check if the maximum number of handset LE connections has been reached.
    \return TRUE if the max num of LE handsets are connected; FALSE otherwise.
*/
