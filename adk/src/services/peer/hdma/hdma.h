/*!
    ...
    @{
        ...
        \brief      Component is used to decide when handover is required between primary and secondary earbuds. It currently uses placement of earbud (in case, in ear, out ear) and 
                    critical battery level for making a handover decision.
...
/*! \brief Enumeration of messages the HDMA module can send to its clients */
typedef enum {
...
/*! \brief Structure describing handover data */
typedef struct {
