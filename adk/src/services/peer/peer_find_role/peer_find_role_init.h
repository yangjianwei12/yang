...
/*! \brief Finish the find role procedure sending a message to registered tasks 
...
/*! \brief Cancel the timeout for finding a peer
...
/*! \brief inform clients that we did not find our role in the requested time
...
/*! \brief if a specific response is pending inform clients that we have finished
...
/*! \brief brief Send a "prepare for role selection" request to the registered client 
...
/*! \brief Initiate disconnection of the peer link - if active
...
/*! \brief Transition to next state after link has disconnected
...
/*! \brief Checks to see if we have a valid figure of merit from the peer.
...
/*! \brief Actually enable advertising
