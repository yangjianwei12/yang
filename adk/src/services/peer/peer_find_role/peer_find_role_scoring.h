...
/*! \brief Collection of information used in scoring peer devices.
...
/*! \brief Make any initialisation required for scoring 
...
/*! \brief Get the local score to use
...
/*! \brief The list of enumerated values that are used in scoring. These
