...
/*! \brief Send current mode back to the case. */
...
/*! \brief  Save the requested mode and set the preserve flag. */
...
/*! \brief  Multiplex management sub-channel message type to handlers. */
