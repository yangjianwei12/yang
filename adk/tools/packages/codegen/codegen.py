...
class ConditionalBlock(object):
    ''' Use this class to generate a conditional block '''
    def __init__(self, conditional_macro, outfile=None):
        self.outfile = outfile
        self.conditional_name = '{}'.format(conditional_macro.upper())
    def __enter__(self):
        print('#ifdef {}\n'.format(self.conditional_name), file=self.outfile)
    def __exit__(self, type, value, traceback):
        print('#endif /* {} */\n'.format(self.conditional_name), file=self.outfile)
