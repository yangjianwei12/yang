...
class PrepareSingleImage(object):
    ...
    def create_flash_image(self, devkit, output_path, encrypted = False,
        hardware_encrypted = False, delay_encrypt = False, software_encryption_file = False,
        ...
        ImageBuilder.partition_aliases["ra_unnamed_partition"] = "ra_partition"
        ...
        if "customer_ra" in self._projects:
            for ptn_index, ptn in enumerate(flash0["layout"]):
                ...
                if "ra_partition" in ptn and 'id' not in ptn[1]:
                    ...
                    flash0["layout"][ptn_index] = self._add_layout("ra_unnamed_partition",
        ...
        flash0["delay_encrypt"] = delay_encrypt
